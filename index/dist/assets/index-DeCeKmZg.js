...
`)),a.questions=l.map(m=>m.trim()).filter(Boolean),t[s].push(a),a=null,c=[],l=[],o="idle")},u=m=>{const v=String(m||"").trim().toLowerCase();return v==="жанр"||v==="genre"?"genre":v==="опора"||v==="source"||v==="basis"?"source":v==="цель"||v==="goal"?"goal":v};for(const m of n){const v=String(m??""),h=v.trim(),w=h.match(/^#\s*JLPT\s*(N[1-5])\b/i);if(w){d(),s=w[1].toUpperCase();continue}const $=h.match(/^##\s*(N[1-5])\s*(.+)$/i);if($){d(),s=$[1].toUpperCase(),a={id:`${s.toLowerCase()}-reading-${String((t[s]||[]).length+1).padStart(2,"0")}`,level:s,title:Km($[2]),genre:"",source:"",goal:"",text:"",questions:[]},o="meta";continue}if(/^#{1,2}(?!#)\s+/.test(h)&&!w&&!$){d(),s=null;continue}if(!a)continue;if(/^###\s*Проверочные вопросы/i.test(h)){o="questions";continue}if(o==="code"){/^```/.test(h)?o="body":c.push(v);continue}if(/^```/.test(h)){o="code";continue}if(o==="questions"){const L=h.match(/^[-*]\s+(.*)$/),b=h.match(/^\d+\.\s+(.*)$/);if(L){l.push(L[1]);continue}if(b){l.push(b[1]);continue}if(!h||/^---+$/.test(h))continue;l.push(h);continue}const y=h.match(/^\*\*(Жанр|Опора|Цель|Genre|Source|Goal)\:\*\*\s*(.*)$/i);if(y){const L=u(y[1]);a[L]=y[2].trim()}}return d(),t}function Em(e){return String(e||"").replace(/^\s*\n+/,"").replace(/\n+\s*$/,"")}function Km(e){return String(e||"").replace(/^[\s\-–—::]+/u,"").trim()}function Dm(e){const t=e&&typeof e=="object"&&!Array.isArray(e)?e.items&&typeof e.items=="object"&&!Array.isArray(e.items)?e.items:e:{},n={};return Object.entries(t||{}).forEach(([s,a])=>{!s||!a||typeof a!="object"||(n[String(s)]={titleRu:String(a.titleRu||a.ruTitle||a.title_ru||"").trim(),titleEn:String(a.titleEn||a.enTitle||a.title_en||"").trim(),ru:String(a.ru||a.translationRu||a.translation_ru||"").trim(),en:String(a.en||a.translationEn||a.translation_en||"").trim()})}),n}function hc(e){const t=String(e||"").trim();if(!t)return[t];if(/^https?:\/\//i.test(t)||t.startsWith("file:"))return[t];const n=t.replace(/^\.\/+/,"").replace(/^\.\.\/+/,"").replace(/^\/+/,""),s=[t,`./${n}`,`../${n}`,`index/${n}`,`/index/${n}`,`/${n}`];return[...new Set(s.filter(Boolean))]}function Fm(e,t){return{...e,id:String(e.id),lessonId:t,examples:Array.isArray(e.examples)?e.examples:[],apps:Array.isArray(e.apps)?e.apps:[],stroke_order:Array.isArray(e.stroke_order)?e.stroke_order:[]}}function Om(e){const t=e?.items&&typeof e.items=="object"?e.items:{};return Object.fromEntries(Object.entries(t).map(([n,s])=>{const a=Array.isArray(s?.strokeOrder)?s.strokeOrder.filter(o=>typeof o?.path=="string"&&o.path.trim()):[];return a.length?[n,{...s,kanji:s.kanji||n,strokes:Number(s.strokes||a.length),viewBox:s.viewBox||"0 0 109 109",strokeOrder:a}]:null}).filter(Boolean))}function Bn(){return{owned:[],selected:{background:"bg_study_hub",outfit:"outfit_default_assassin",theme:"theme_default_dark",decoration:null,frame:null,effect:null},seen:[],updatedAt:new Date().toISOString()}}function Bm(){try{const e=localStorage.getItem(T);if(!e)return Bn();const t=JSON.parse(e),n=Bn();return{owned:Array.isArray(t.owned)?t.owned.map(String):n.owned,selected:{...n.selected,...t&&t.selected||{}},seen:Array.isArray(t.seen)?t.seen.map(String):n.seen,updatedAt:t.updatedAt||n.updatedAt}}catch(e){return console.warn("Customization storage failed.",e),Bn()}}function ds(){if(!r.customization)return!1;if(na)return!0;na=!0;const e=()=>{Fn=0,na=!1,r.customization.updatedAt=new Date().toISOString();try{localStorage.setItem(T,JSON.stringify(r.customization))}catch(t){console.warn("Customization save failed.",t)}};return"requestIdleCallback"in window?Fn=window.requestIdleCallback(e,{timeout:1200}):Fn=window.setTimeout(e,160),!0}function Um(){if(!r.customization)return!1;na=!1,Fn&&("cancelIdleCallback"in window?window.cancelIdleCallback(Fn):window.clearTimeout(Fn),Fn=0),r.customization.updatedAt=new Date().toISOString();try{return localStorage.setItem(T,JSON.stringify(r.customization)),!0}catch(e){return console.warn("Customization save failed.",e),!1}}function da(){const e=Bm(),t=new Set;(e.owned||[]).forEach(s=>{const a=ge(s)||Un(s);a&&t.add(a.id)}),st().forEach(s=>{(s.defaultOwned||s.price===0)&&t.add(s.id)}),(r.progress.unlockedBackgrounds||[]).forEach(s=>{const a=ge(s)||Un(s);a&&t.add(a.id)}),(r.progress.unlockedEvaSprites||[]).forEach(s=>{const a=Gn(s);a&&t.add(a.id),r.progress.shop?.owned?.includes(`eva_sprite:${s}`)&&a&&t.add(a.id)}),(r.progress.shop?.owned||[]).forEach(s=>{const a=String(s),o=ge(a)||Un(a);if(o&&t.add(o.id),!o&&a.startsWith("eva_sprite:")){const c=Gn(a.replace("eva_sprite:",""));c&&t.add(c.id)}});const n=Gm({...Bn().selected,...e.selected||{}});r.progress.selectedEvaRoomBackground&&(n.background=Jt(r.progress.selectedEvaRoomBackground)),r.progress.selectedEvaSprite&&(n.outfit=Gn(r.progress.selectedEvaSprite)?.id||n.outfit),t.has(n.background)||(n.background="bg_study_hub"),t.has(n.outfit)||(n.outfit="outfit_default_assassin"),t.has(n.theme)||(n.theme="theme_default_dark"),n.decoration&&!t.has(n.decoration)&&(n.decoration=null),n.effect&&!t.has(n.effect)&&(n.effect=null),r.customization={owned:[...t],selected:n,seen:[...new Set([...e.seen||[],...t])],updatedAt:e.updatedAt||new Date().toISOString()},Zs(),ds()}function Zs(){var n;if(!r.customization||!r.progress)return;ce();const e=r.customization.selected||{};e.background&&(r.progress.selectedEvaRoomBackground=e.background);const t=ge(e.outfit);t?.spriteId&&(r.progress.selectedEvaSprite=t.spriteId),r.progress.unlockedBackgrounds=[...new Set([...r.progress.unlockedBackgrounds||[],...r.customization.owned.filter(s=>ge(s)?.type==="background")])],r.progress.unlockedEvaSprites=[...new Set([...r.progress.unlockedEvaSprites||[],...r.customization.owned.map(s=>ge(s)).filter(s=>s?.type==="outfit"&&s.spriteId).map(s=>s.spriteId)])],(n=r.progress).shop||(n.shop={owned:[],equipped:{}}),r.progress.shop.owned=[...new Set([...r.progress.shop.owned||[],...r.customization.owned,...r.progress.unlockedEvaSprites.map(s=>`eva_sprite:${s}`)])],r.progress.shop.equipped={...r.progress.shop.equipped||{},background:e.background||null,outfit:e.outfit||null,theme:e.theme||null,decoration:e.decoration||e.frame||null,effect:e.effect||null}}function st(){return r.customizationCatalog?.items||[]}function ge(e){return st().find(t=>t.id===e)||null}function Un(e){const t=String(e||"");return t&&st().find(n=>Array.isArray(n.legacyIds)&&n.legacyIds.map(String).includes(t))||null}function Jt(e){return(ge(e)||Un(e))?.id||e||null}function Gm(e={}){return{background:Jt(e.background),outfit:Jt(e.outfit),theme:Jt(e.theme),decoration:Jt(e.decoration||e.frame),effect:Jt(e.effect)}}function Gn(e){const t=String(e||"");if(!t)return null;const n=`eva_sprite:${t}`;return st().find(s=>s.type!=="outfit"?!1:s.spriteId===t||s.legacySpriteId===t?!0:Array.isArray(s.legacyIds)&&s.legacyIds.map(String).includes(n))||null}function Jm(e){return(Array.isArray(e?.items)?e.items:Array.isArray(e)?e:[]).map(n=>({...n,jlpt:String(n.jlpt||"").toUpperCase(),title:n.title||{ru:n.jlpt||"JLPT",en:n.jlpt||"JLPT"},summary:n.summary||{ru:"",en:""},goals:Array.isArray(n.goals)?n.goals:[],sections:Array.isArray(n.sections)?n.sections:[],practice:Array.isArray(n.practice)?n.practice:[],checkpoint:Array.isArray(n.checkpoint)?n.checkpoint:[]})).filter(n=>n.jlpt)}function zm(e){const t=Array.isArray(e?.items)?e.items:Array.isArray(e)?e:[];return{version:Number(e?.version||1),generatedAt:e?.generatedAt||null,items:t.map(n=>({...n,jlpt:String(n.jlpt||"").toUpperCase(),slug:String(n.slug||String(n.jlpt||"").toLowerCase()),title:n.title||{ru:n.displayTitle?.ru||n.jlpt||"JLPT",en:n.displayTitle?.en||n.jlpt||"JLPT"},displayTitle:n.displayTitle||n.title||{ru:n.jlpt||"JLPT",en:n.jlpt||"JLPT"},description:n.description||{ru:"",en:""},goal:n.goal||{ru:"",en:""},recommendedCycle:n.recommendedCycle||{ru:"",en:""},previousLevels:Array.isArray(n.previousLevels)?n.previousLevels:[],nextLevels:Array.isArray(n.nextLevels)?n.nextLevels:[],lessonIds:Array.isArray(n.lessonIds)?n.lessonIds:[],files:n.files||{},lessonCount:Number(n.lessonCount||0),kanjiCount:Number(n.kanjiCount||0),cardCount:Number(n.cardCount||0)})).filter(n=>n.jlpt).sort((n,s)=>Ke.indexOf(n.jlpt)-Ke.indexOf(s.jlpt))}}function Hm(e){return(Array.isArray(e?.items)?e.items:Array.isArray(e)?e:[]).map(n=>({...n,jlpt:String(n.jlpt||"").toUpperCase(),apps:Array.isArray(n.apps)?n.apps:[],kana:n.kana||{hiragana:[],katakana:[]},kanjiFocus:Array.isArray(n.kanjiFocus)?n.kanjiFocus:[],drills:Array.isArray(n.drills)?n.drills:[],sources:Array.isArray(n.sources)?n.sources:[]})).filter(n=>n.jlpt)}function qm(e){return{version:Number(e?.version||1),level:"N5",title:e?.title||{ru:"JLPT N5",en:"JLPT N5"},description:e?.description||{ru:"",en:""},principle:e?.principle||{ru:"",en:""},kanjiCount:Number(e?.kanjiCount||80),lessonCount:Number(e?.lessonCount||10),kanjiPerLesson:Number(e?.kanjiPerLesson||8),pdfUrl:e?.pdfUrl||"docs/flashkanji_N5_expanded_textbook.pdf",reviewPlan:Array.isArray(e?.reviewPlan)?e.reviewPlan:[],rewards:{addToSrsXp:4,knowXp:6,hardXp:2,exerciseXp:7,exerciseMoon:1,lessonCompleteXp:45,lessonCompleteMoon:6,finalTestXp:120,finalTestMoon:20,...e?.rewards||{}}}}function vc(e){const t=Array.isArray(e?.items)?e.items:[];return{version:Number(e?.version||1),level:"N5",textbook:e?.textbook||{},items:t.map((n,s)=>({...n,id:String(n.id||`n5-lesson-${s+1}`),order:Number(n.order||s+1),title:n.title||{ru:`Урок ${s+1}`,en:`Lesson ${s+1}`},theme:n.theme||n.title||{ru:"",en:""},kanji:Array.isArray(n.kanji)?n.kanji.map(String).filter(Boolean):[],goal:n.goal||{ru:"",en:""},sentences:Array.isArray(n.sentences)?n.sentences:[],writing:Array.isArray(n.writing)?n.writing.map(String).filter(Boolean):[],reviewAfterDays:Array.isArray(n.reviewAfterDays)?n.reviewAfterDays.map(Number).filter(Boolean):[1,3,7,14,30]})).filter(n=>n.kanji.length)}}function Wm(e){return(Array.isArray(e?.items)?e.items:Array.isArray(e)?e:[]).map(n=>({...n,id:String(n.id||n.courseCardId||n.kanji||""),courseCardId:String(n.courseCardId||n.id||n.kanji||""),lessonId:n.lessonId||n.lesson_id||null,kanji:String(n.kanji||""),meaning:n.meaning||{ru:n.meaning_ru||"",en:n.meaning_en||n.meaning_ru||""},readings:n.readings||{},examples:Array.isArray(n.examples)?n.examples:[],jlpt:"N5"})).filter(n=>n.kanji)}function Xm(){if(!Array.isArray(r.n5KanjiCatalog)||!r.n5KanjiCatalog.length)return;const e=new Map(r.n5KanjiCatalog.map(n=>[n.kanji,n])),t=new Set;r.cards=r.cards.map(n=>{const s=e.get(n.kanji);if(!s)return n;const a=String(n.jlpt||s.jlpt||"").toUpperCase();return a&&a!=="N5"?n:(t.add(s.kanji),ua(n,s))}),r.n5KanjiCatalog.forEach(n=>{t.has(n.kanji)||(r.cards.push(ua({id:n.courseCardId||n.id,kanji:n.kanji,lessonId:n.lessonId||null,jlpt:"N5",examples:[],source:"n5-catalog"},n)),t.add(n.kanji))})}function ua(e,t){const n=t.readings||{},s=l=>Array.isArray(l)?l.filter(Boolean).join(" / "):String(l||""),a=(t.examples||[]).map(l=>({...l,reading:Q(l.reading||l.hiragana||l.kana||""),translation:l.translation_ru||l.translation||""})),o=a[0]||{},c=Array.isArray(t.strokeOrder)?t.strokeOrder.map(l=>l.description_ru||l.description_en||"").filter(Boolean):e.stroke_order;return{...e,jlpt:"N5",lessonId:e.lessonId||t.lessonId||null,meaning_ru:t.meaning?.ru||e.meaning_ru||"",meaning_en:t.meaning?.en||e.meaning_en||t.meaning?.ru||e.meaning_ru||"",onyomi:Q(s(n.onyomi)||e.onyomi||""),kunyomi:Q(s(n.kunyomi)||e.kunyomi||""),hiragana:Q((Array.isArray(n.hiragana)?n.hiragana[0]:n.hiragana)||o.reading||e.hiragana||""),romaji:(Array.isArray(n.romaji)?n.romaji[0]:n.romaji)||o.romaji||e.romaji||"",examples:a.length?a:e.examples,apps:Array.isArray(t.apps)&&t.apps.length?t.apps:e.apps,interface_use:t.interfaceUse||e.interface_use||"",interface_use_en:t.interfaceUseEn||t.interfaceUse||e.interface_use_en||e.interface_use||"",strokes:Number(t.strokes||e.strokes||0),stroke_order:c,meta:{...e.meta||{},...t.meta||{}},n5Detail:t}}function Qm(e){return{version:Number(e?.version||1),level:"N5",types:Array.isArray(e?.types)?e.types:[],lessonQuestionCount:Number(e?.lessonQuestionCount||6),reviewModes:Array.isArray(e?.reviewModes)?e.reviewModes:[]}}function Vm(e){return{version:Number(e?.version||1),level:"N5",title:e?.title||{ru:"Финальный тест JLPT N5",en:"JLPT N5 Final Test"},description:e?.description||{ru:"",en:""},questionCount:Number(e?.questionCount||24),passingPercent:Number(e?.passingPercent||80),types:Array.isArray(e?.types)&&e.types.length?e.types:["meaning","reading","sentence","kanji","word","srs"],rewards:{completeXp:120,completeMoon:20,passXp:80,passMoon:12,...e?.rewards||{}}}}function Ym(e){return{version:Number(e?.version||1),level:"N4",title:e?.title||{ru:"JLPT N4",en:"JLPT N4"},description:e?.description||{ru:"",en:""},principle:e?.principle||{ru:"",en:""},kanjiCount:Number(e?.kanjiCount||170),lessonCount:Number(e?.lessonCount||17),kanjiPerLesson:Number(e?.kanjiPerLesson||10),grammarCount:Number(e?.grammarCount||48),readingCount:Number(e?.readingCount||0),listeningCount:Number(e?.listeningCount||0),pdfUrl:e?.pdfUrl||"docs/flashkanji_N4_textbook_flashkanji_space.pdf",reviewPlan:Array.isArray(e?.reviewPlan)?e.reviewPlan:[],n5Bridge:Array.isArray(e?.n5Bridge)?e.n5Bridge.map(String).filter(Boolean):[],rewards:{addToSrsXp:5,knowXp:7,hardXp:2,exerciseXp:9,exerciseMoon:1,grammarXp:10,grammarMoon:1,lessonCompleteXp:65,lessonCompleteMoon:8,readingXp:35,readingMoon:4,listeningXp:30,listeningMoon:3,finalTestXp:180,finalTestMoon:35,...e?.rewards||{}}}}function Zm(e){const t=Array.isArray(e?.items)?e.items:[];return{version:Number(e?.version||1),level:"N4",textbook:e?.textbook||{},items:t.map((n,s)=>({...n,id:String(n.id||`n4-lesson-${s+1}`),order:Number(n.order||s+1),title:n.title||{ru:`Урок ${s+1}`,en:`Lesson ${s+1}`},theme:n.theme||n.title||{ru:"",en:""},kanji:Array.isArray(n.kanji)?n.kanji.map(String).filter(Boolean):[],goal:n.goal||{ru:"",en:""},durationMinutes:Number(n.durationMinutes||30),grammarFocus:Array.isArray(n.grammarFocus)?n.grammarFocus.map(String).filter(Boolean):[],sentences:Array.isArray(n.sentences)?n.sentences:[],writing:Array.isArray(n.writing)?n.writing.map(String).filter(Boolean):[],reviewAfterDays:Array.isArray(n.reviewAfterDays)?n.reviewAfterDays.map(Number).filter(Boolean):[1,3,7,14,30,45]})).filter(n=>n.kanji.length)}}function ef(e){return(Array.isArray(e?.items)?e.items:Array.isArray(e)?e:[]).map(n=>({...n,id:String(n.id||n.courseCardId||n.kanji||""),courseCardId:String(n.courseCardId||n.id||n.kanji||""),kanji:String(n.kanji||""),meaning:n.meaning||{ru:n.meaning_ru||"",en:n.meaning_en||n.meaning_ru||""},readings:n.readings||{},examples:Array.isArray(n.examples)?n.examples:Array.isArray(n.words)?n.words:[],jlpt:"N4",lessonId:n.lessonId||n.lesson_id||null})).filter(n=>n.kanji)}function tf(){if(!Array.isArray(r.n4KanjiCatalog)||!r.n4KanjiCatalog.length)return;const e=new Map(r.n4KanjiCatalog.map(n=>[n.kanji,n])),t=new Set;r.cards=r.cards.map(n=>{const s=e.get(n.kanji);return!s||!(String(n.jlpt||s.jlpt||"").toUpperCase()==="N4"||String(n.id)===s.courseCardId||String(n.id)===s.id)?n:(t.add(s.kanji),pa(n,s))}),r.n4KanjiCatalog.forEach(n=>{t.has(n.kanji)||(r.cards.push(pa({id:n.courseCardId||n.id,kanji:n.kanji,lessonId:n.lessonId,jlpt:"N4",examples:[],source:"n4-catalog"},n)),t.add(n.kanji))})}function pa(e,t){const n=t.readings||{},s=l=>Array.isArray(l)?l.filter(Boolean).join(" / "):String(l||""),a=(t.examples||[]).map(l=>({...l,reading:Q(l.reading||l.hiragana||l.kana||""),translation:l.translation_ru||l.translation||l.translation_en||""})),o=a[0]||{},c=Array.isArray(t.strokeOrder)?t.strokeOrder.map(l=>typeof l=="string"?l:l.description_ru||l.description_en||"").filter(Boolean):e.stroke_order;return{...e,id:String(e.id||t.courseCardId||t.id),jlpt:"N4",lessonId:e.lessonId||t.lessonId||null,meaning_ru:t.meaning?.ru||e.meaning_ru||"",meaning_en:t.meaning?.en||e.meaning_en||t.meaning?.ru||e.meaning_ru||"",onyomi:Q(s(n.onyomi)||e.onyomi||""),kunyomi:Q(s(n.kunyomi)||e.kunyomi||""),hiragana:Q((Array.isArray(n.hiragana)?n.hiragana[0]:n.hiragana)||o.reading||e.hiragana||""),romaji:(Array.isArray(n.romaji)?n.romaji[0]:n.romaji)||o.romaji||e.romaji||"",examples:a.length?a:e.examples,apps:Array.isArray(t.apps)&&t.apps.length?t.apps:e.apps,interface_use:t.interfaceUse||e.interface_use||"",interface_use_en:t.interfaceUseEn||t.interfaceUse||e.interface_use_en||e.interface_use||"",strokes:Number(t.strokes||e.strokes||0),stroke_order:c,meta:{...e.meta||{},...t.meta||{}},n4Detail:t}}function nf(e){return(Array.isArray(e?.items)?e.items:Array.isArray(e)?e:[]).map((n,s)=>({...n,id:String(n.id||`n4-grammar-${String(s+1).padStart(2,"0")}`),level:"N4",order:Number(n.order||s+1),pattern:String(n.pattern||n.id||""),title:n.title||{ru:n.pattern||"",en:n.pattern||""},explanation:n.explanation||{ru:"",en:""},formula:String(n.formula||""),examples:Array.isArray(n.examples)?n.examples:[],question:n.question||{ru:"",en:""},answer:String(n.answer||""),options:Array.isArray(n.options)?n.options.map(String).filter(Boolean):[]})).filter(n=>n.pattern)}function sf(e){return{version:Number(e?.version||1),level:"N4",lessonQuestionCount:Number(e?.lessonQuestionCount||8),types:Array.isArray(e?.types)?e.types:[],reviewModes:Array.isArray(e?.reviewModes)?e.reviewModes:[]}}function wc(e){return(Array.isArray(e?.items)?e.items:Array.isArray(e)?e:[]).map((n,s)=>({...n,id:String(n.id||`n4-item-${s+1}`),title:n.title||{ru:n.id||"",en:n.id||""},questions:Array.isArray(n.questions)?n.questions:n.question?[{prompt:n.question,answer:n.answer,options:Array.isArray(n.options)?n.options:[]}]:[]})).filter(n=>n.id)}function rf(e){return{version:Number(e?.version||1),level:"N4",title:e?.title||{ru:"Финальный тест JLPT N4",en:"JLPT N4 Final Test"},description:e?.description||{ru:"",en:""},questionCount:Number(e?.questionCount||32),passingPercent:Number(e?.passingPercent||80),kanjiPool:Array.isArray(e?.kanjiPool)?e.kanjiPool.map(String).filter(Boolean):[],grammarPool:Array.isArray(e?.grammarPool)?e.grammarPool.map(String).filter(Boolean):[],readingPool:Array.isArray(e?.readingPool)?e.readingPool.map(String).filter(Boolean):[],types:Array.isArray(e?.types)&&e.types.length?e.types:["meaning","reading","sentence","kanji","word","grammar","mini-reading","srs"],rewards:{completeXp:Number(e?.rewards?.xp||e?.rewards?.completeXp||180),completeMoon:Number(e?.rewards?.moon||e?.rewards?.completeMoon||35),passXp:Number(e?.rewards?.passXp||90),passMoon:Number(e?.rewards?.passMoon||15)}}}function af(e){return{version:Number(e?.version||1),level:"N3",title:e?.title||{ru:"JLPT N3",en:"JLPT N3"},description:e?.description||{ru:"",en:""},principle:e?.principle||{ru:"",en:""},kanjiCount:Number(e?.kanjiCount||370),lessonCount:Number(e?.lessonCount||37),kanjiPerLesson:Number(e?.kanjiPerLesson||10),grammarCount:Number(e?.grammarCount||80),readingCount:Number(e?.readingCount||0),listeningCount:Number(e?.listeningCount||0),pdfUrl:e?.pdfUrl||"docs/flashkanji_N3_textbook_flashkanji_space.pdf",reviewPlan:Array.isArray(e?.reviewPlan)?e.reviewPlan:[],n5Bridge:Array.isArray(e?.n5Bridge)?e.n5Bridge.map(String).filter(Boolean):[],rewards:{addToSrsXp:6,knowXp:8,hardXp:2,exerciseXp:10,exerciseMoon:1,grammarXp:11,grammarMoon:1,lessonCompleteXp:75,lessonCompleteMoon:9,readingXp:38,readingMoon:4,listeningXp:34,listeningMoon:4,finalTestXp:220,finalTestMoon:40,...e?.rewards||{}}}}function of(e){const t=Array.isArray(e?.items)?e.items:[];return{version:Number(e?.version||1),level:"N3",textbook:e?.textbook||{},items:t.map((n,s)=>({...n,id:String(n.id||`n3-lesson-${s+1}`),order:Number(n.order||s+1),title:n.title||{ru:`Урок ${s+1}`,en:`Lesson ${s+1}`},theme:n.theme||n.title||{ru:"",en:""},kanji:Array.isArray(n.kanji)?n.kanji.map(String).filter(Boolean):[],goal:n.goal||{ru:"",en:""},durationMinutes:Number(n.durationMinutes||30),grammarFocus:Array.isArray(n.grammarFocus)?n.grammarFocus.map(String).filter(Boolean):[],sentences:Array.isArray(n.sentences)?n.sentences:[],writing:Array.isArray(n.writing)?n.writing.map(String).filter(Boolean):[],reviewAfterDays:Array.isArray(n.reviewAfterDays)?n.reviewAfterDays.map(Number).filter(Boolean):[1,3,7,14,30,45,60]})).filter(n=>n.kanji.length)}}function lf(e){return(Array.isArray(e?.items)?e.items:Array.isArray(e)?e:[]).map(n=>({...n,id:String(n.id||n.courseCardId||n.kanji||""),courseCardId:String(n.courseCardId||n.id||n.kanji||""),kanji:String(n.kanji||""),meaning:n.meaning||{ru:n.meaning_ru||"",en:n.meaning_en||n.meaning_ru||""},readings:n.readings||{},examples:Array.isArray(n.examples)?n.examples:Array.isArray(n.words)?n.words:[],jlpt:"N3",lessonId:n.lessonId||n.lesson_id||null})).filter(n=>n.kanji)}function cf(){if(!Array.isArray(r.n3KanjiCatalog)||!r.n3KanjiCatalog.length)return;const e=new Map(r.n3KanjiCatalog.map(n=>[n.kanji,n])),t=new Set;r.cards=r.cards.map(n=>{const s=e.get(n.kanji);return!s||!(String(n.jlpt||s.jlpt||"").toUpperCase()==="N3"||String(n.id)===s.courseCardId||String(n.id)===s.id)?n:(t.add(s.kanji),ga(n,s))}),r.n3KanjiCatalog.forEach(n=>{t.has(n.kanji)||(r.cards.push(ga({id:n.courseCardId||n.id,kanji:n.kanji,lessonId:n.lessonId,jlpt:"N3",examples:[],source:"n3-catalog"},n)),t.add(n.kanji))})}function ga(e,t){const n=t.readings||{},s=l=>Array.isArray(l)?l.filter(Boolean).join(" / "):String(l||""),a=(t.examples||[]).map(l=>({...l,reading:Q(l.reading||l.hiragana||l.kana||""),translation:l.translation_ru||l.translation||l.translation_en||""})),o=a[0]||{},c=Array.isArray(t.strokeOrder)?t.strokeOrder.map(l=>typeof l=="string"?l:l.description_ru||l.description_en||"").filter(Boolean):e.stroke_order;return{...e,id:String(e.id||t.courseCardId||t.id),jlpt:"N3",lessonId:e.lessonId||t.lessonId||null,meaning_ru:t.meaning?.ru||e.meaning_ru||"",meaning_en:t.meaning?.en||e.meaning_en||t.meaning?.ru||e.meaning_ru||"",onyomi:Q(s(n.onyomi)||e.onyomi||""),kunyomi:Q(s(n.kunyomi)||e.kunyomi||""),hiragana:Q((Array.isArray(n.hiragana)?n.hiragana[0]:n.hiragana)||o.reading||e.hiragana||""),romaji:(Array.isArray(n.romaji)?n.romaji[0]:n.romaji)||o.romaji||e.romaji||"",examples:a.length?a:e.examples,apps:Array.isArray(t.apps)&&t.apps.length?t.apps:e.apps,interface_use:t.interfaceUse||e.interface_use||"",interface_use_en:t.interfaceUseEn||t.interfaceUse||e.interface_use_en||e.interface_use||"",strokes:Number(t.strokes||e.strokes||0),stroke_order:c,meta:{...e.meta||{},...t.meta||{}},n3Detail:t}}function df(e){return(Array.isArray(e?.items)?e.items:Array.isArray(e)?e:[]).map((n,s)=>({...n,id:String(n.id||`n3-grammar-${String(s+1).padStart(2,"0")}`),level:"N3",order:Number(n.order||s+1),pattern:String(n.pattern||n.id||""),title:n.title||{ru:n.pattern||"",en:n.pattern||""},explanation:n.explanation||{ru:"",en:""},formula:String(n.formula||""),examples:Array.isArray(n.examples)?n.examples:[],question:n.question||{ru:"",en:""},answer:String(n.answer||""),options:Array.isArray(n.options)?n.options.map(String).filter(Boolean):[]})).filter(n=>n.pattern)}function uf(e){return{version:Number(e?.version||1),level:"N3",lessonQuestionCount:Number(e?.lessonQuestionCount||8),types:Array.isArray(e?.types)?e.types:[],reviewModes:Array.isArray(e?.reviewModes)?e.reviewModes:[]}}function bc(e){return(Array.isArray(e?.items)?e.items:Array.isArray(e)?e:[]).map((n,s)=>({...n,id:String(n.id||`n3-item-${s+1}`),title:n.title||{ru:n.id||"",en:n.id||""},questions:Array.isArray(n.questions)?n.questions:n.question?[{prompt:n.question,answer:n.answer,options:Array.isArray(n.options)?n.options:[]}]:[]})).filter(n=>n.id)}function pf(e){return{version:Number(e?.version||1),level:"N3",title:e?.title||{ru:"Финальный тест JLPT N3",en:"JLPT N3 Final Test"},description:e?.description||{ru:"",en:""},questionCount:Number(e?.questionCount||40),passingPercent:Number(e?.passingPercent||80),kanjiPool:Array.isArray(e?.kanjiPool)?e.kanjiPool.map(String).filter(Boolean):[],grammarPool:Array.isArray(e?.grammarPool)?e.grammarPool.map(String).filter(Boolean):[],readingPool:Array.isArray(e?.readingPool)?e.readingPool.map(String).filter(Boolean):[],types:Array.isArray(e?.types)&&e.types.length?e.types:["meaning","reading","sentence","kanji","word","grammar","mini-reading","srs"],rewards:{completeXp:Number(e?.rewards?.xp||e?.rewards?.completeXp||220),completeMoon:Number(e?.rewards?.moon||e?.rewards?.completeMoon||40),passXp:Number(e?.rewards?.passXp||110),passMoon:Number(e?.rewards?.passMoon||18)}}}function gf(e){return{version:Number(e?.version||1),level:"N2",title:e?.title||{ru:"JLPT N2",en:"JLPT N2"},description:e?.description||{ru:"",en:""},principle:e?.principle||{ru:"",en:""},kanjiCount:Number(e?.kanjiCount||380),lessonCount:Number(e?.lessonCount||38),kanjiPerLesson:Number(e?.kanjiPerLesson||10),grammarCount:Number(e?.grammarCount||120),readingCount:Number(e?.readingCount||46),listeningCount:Number(e?.listeningCount||6),pdfUrl:e?.pdfUrl||"docs/flashkanji_N2_textbook_flashkanji_space.pdf",reviewPlan:Array.isArray(e?.reviewPlan)?e.reviewPlan:[],n5Bridge:Array.isArray(e?.n5Bridge)?e.n5Bridge.map(String).filter(Boolean):[],rewards:{addToSrsXp:7,knowXp:9,hardXp:2,exerciseXp:11,exerciseMoon:1,grammarXp:12,grammarMoon:1,lessonCompleteXp:85,lessonCompleteMoon:10,readingXp:42,readingMoon:4,listeningXp:38,listeningMoon:4,finalTestXp:260,finalTestMoon:48,...e?.rewards||{}}}}function mf(e){const t=Array.isArray(e?.items)?e.items:[];return{version:Number(e?.version||1),level:"N2",textbook:e?.textbook||{},items:t.map((n,s)=>({...n,id:String(n.id||`n2-lesson-${s+1}`),order:Number(n.order||s+1),title:n.title||{ru:`Урок ${s+1}`,en:`Lesson ${s+1}`},theme:n.theme||n.title||{ru:"",en:""},kanji:Array.isArray(n.kanji)?n.kanji.map(String).filter(Boolean):[],goal:n.goal||{ru:"",en:""},durationMinutes:Number(n.durationMinutes||30),grammarFocus:Array.isArray(n.grammarFocus)?n.grammarFocus.map(String).filter(Boolean):[],sentences:Array.isArray(n.sentences)?n.sentences:[],writing:Array.isArray(n.writing)?n.writing.map(String).filter(Boolean):[],reviewAfterDays:Array.isArray(n.reviewAfterDays)?n.reviewAfterDays.map(Number).filter(Boolean):[1,3,7,14,30,60,90]})).filter(n=>n.kanji.length)}}function ff(e){return(Array.isArray(e?.items)?e.items:Array.isArray(e)?e:[]).map(n=>({...n,id:String(n.id||n.courseCardId||n.kanji||""),courseCardId:String(n.courseCardId||n.id||n.kanji||""),kanji:String(n.kanji||""),meaning:n.meaning||{ru:n.meaning_ru||"",en:n.meaning_en||n.meaning_ru||""},readings:n.readings||{},examples:Array.isArray(n.examples)?n.examples:Array.isArray(n.words)?n.words:[],jlpt:"N2",lessonId:n.lessonId||n.lesson_id||null})).filter(n=>n.kanji)}function hf(){if(!Array.isArray(r.n2KanjiCatalog)||!r.n2KanjiCatalog.length)return;const e=new Map(r.n2KanjiCatalog.map(n=>[n.kanji,n])),t=new Set;r.cards=r.cards.map(n=>{const s=e.get(n.kanji);return!s||!(String(n.jlpt||s.jlpt||"").toUpperCase()==="N2"||String(n.id)===s.courseCardId||String(n.id)===s.id)?n:(t.add(s.kanji),ma(n,s))}),r.n2KanjiCatalog.forEach(n=>{t.has(n.kanji)||(r.cards.push(ma({id:n.courseCardId||n.id,kanji:n.kanji,lessonId:n.lessonId,jlpt:"N2",examples:[],source:"n2-catalog"},n)),t.add(n.kanji))})}function ma(e,t){const n=t.readings||{},s=l=>Array.isArray(l)?l.filter(Boolean).join(" / "):String(l||""),a=(t.examples||[]).map(l=>({...l,reading:Q(l.reading||l.hiragana||l.kana||""),translation:l.translation_ru||l.translation||l.translation_en||""})),o=a[0]||{},c=Array.isArray(t.strokeOrder)?t.strokeOrder.map(l=>typeof l=="string"?l:l.description_ru||l.description_en||"").filter(Boolean):e.stroke_order;return{...e,id:String(e.id||t.courseCardId||t.id),jlpt:"N2",lessonId:e.lessonId||t.lessonId||null,meaning_ru:t.meaning?.ru||e.meaning_ru||"",meaning_en:t.meaning?.en||e.meaning_en||t.meaning?.ru||e.meaning_ru||"",onyomi:Q(s(n.onyomi)||e.onyomi||""),kunyomi:Q(s(n.kunyomi)||e.kunyomi||""),hiragana:Q((Array.isArray(n.hiragana)?n.hiragana[0]:n.hiragana)||o.reading||e.hiragana||""),romaji:(Array.isArray(n.romaji)?n.romaji[0]:n.romaji)||o.romaji||e.romaji||"",examples:a.length?a:e.examples,apps:Array.isArray(t.apps)&&t.apps.length?t.apps:e.apps,interface_use:t.interfaceUse||e.interface_use||"",interface_use_en:t.interfaceUseEn||t.interfaceUse||e.interface_use_en||e.interface_use||"",strokes:Number(t.strokes||e.strokes||0),stroke_order:c,meta:{...e.meta||{},...t.meta||{}},n2Detail:t}}function vf(e){return(Array.isArray(e?.items)?e.items:Array.isArray(e)?e:[]).map((n,s)=>({...n,id:String(n.id||`n2-grammar-${String(s+1).padStart(2,"0")}`),level:"N2",order:Number(n.order||s+1),pattern:String(n.pattern||n.id||""),title:n.title||{ru:n.pattern||"",en:n.pattern||""},explanation:n.explanation||{ru:"",en:""},formula:String(n.formula||""),examples:Array.isArray(n.examples)?n.examples:[],question:n.question||{ru:"",en:""},answer:String(n.answer||""),options:Array.isArray(n.options)?n.options.map(String).filter(Boolean):[]})).filter(n=>n.pattern)}function wf(e){return{version:Number(e?.version||1),level:"N2",lessonQuestionCount:Number(e?.lessonQuestionCount||8),types:Array.isArray(e?.types)?e.types:[],reviewModes:Array.isArray(e?.reviewModes)?e.reviewModes:[]}}function kc(e){return(Array.isArray(e?.items)?e.items:Array.isArray(e)?e:[]).map((n,s)=>({...n,id:String(n.id||`n2-item-${s+1}`),title:n.title||{ru:n.id||"",en:n.id||""},questions:Array.isArray(n.questions)?n.questions:n.question?[{prompt:n.question,answer:n.answer,options:Array.isArray(n.options)?n.options:[]}]:[]})).filter(n=>n.id)}function bf(e){return{version:Number(e?.version||1),level:"N2",title:e?.title||{ru:"Финальный тест JLPT N2",en:"JLPT N2 Final Test"},description:e?.description||{ru:"",en:""},questionCount:Number(e?.questionCount||40),passingPercent:Number(e?.passingPercent||80),kanjiPool:Array.isArray(e?.kanjiPool)?e.kanjiPool.map(String).filter(Boolean):[],grammarPool:Array.isArray(e?.grammarPool)?e.grammarPool.map(String).filter(Boolean):[],readingPool:Array.isArray(e?.readingPool)?e.readingPool.map(String).filter(Boolean):[],types:Array.isArray(e?.types)&&e.types.length?e.types:["meaning","reading","sentence","kanji","word","grammar","mini-reading","srs"],rewards:{completeXp:Number(e?.rewards?.xp||e?.rewards?.completeXp||260),completeMoon:Number(e?.rewards?.moon||e?.rewards?.completeMoon||48),passXp:Number(e?.rewards?.passXp||130),passMoon:Number(e?.rewards?.passMoon||20)}}}function yc(e){return{version:Number(e?.version||1),level:"N1",title:e?.title||{ru:"JLPT N1",en:"JLPT N1"},description:e?.description||{ru:"",en:""},principle:e?.principle||{ru:"",en:""},kanjiCount:Number(e?.kanjiCount||1047),lessonCount:Number(e?.lessonCount||53),kanjiPerLesson:Number(e?.kanjiPerLesson||20),grammarCount:Number(e?.grammarCount||142),readingCount:Number(e?.readingCount||8),listeningCount:Number(e?.listeningCount||6),pdfUrl:e?.pdfUrl||"docs/flashkanji_N1_textbook_flashkanji_space.pdf",reviewPlan:Array.isArray(e?.reviewPlan)?e.reviewPlan:[],n5Bridge:Array.isArray(e?.n5Bridge)?e.n5Bridge.map(String).filter(Boolean):[],rewards:{addToSrsXp:7,knowXp:9,hardXp:2,exerciseXp:11,exerciseMoon:1,grammarXp:12,grammarMoon:1,lessonCompleteXp:85,lessonCompleteMoon:10,readingXp:42,readingMoon:4,listeningXp:38,listeningMoon:4,finalTestXp:260,finalTestMoon:48,...e?.rewards||{}}}}function $c(e){const t=Array.isArray(e?.items)?e.items:[];return{version:Number(e?.version||1),level:"N1",textbook:e?.textbook||{},items:t.map((n,s)=>({...n,id:String(n.id||`n1-lesson-${s+1}`),order:Number(n.order||s+1),title:n.title||{ru:`Урок ${s+1}`,en:`Lesson ${s+1}`},theme:n.theme||n.title||{ru:"",en:""},kanji:Array.isArray(n.kanji)?n.kanji.map(String).filter(Boolean):[],goal:n.goal||{ru:"",en:""},durationMinutes:Number(n.durationMinutes||30),grammarFocus:Array.isArray(n.grammarFocus)?n.grammarFocus.map(String).filter(Boolean):[],sentences:Array.isArray(n.sentences)?n.sentences:[],writing:Array.isArray(n.writing)?n.writing.map(String).filter(Boolean):[],reviewAfterDays:Array.isArray(n.reviewAfterDays)?n.reviewAfterDays.map(Number).filter(Boolean):[1,3,7,14,30,60,90]})).filter(n=>n.kanji.length)}}function jc(e){return(Array.isArray(e?.items)?e.items:Array.isArray(e)?e:[]).map(n=>({...n,id:String(n.id||n.courseCardId||n.kanji||""),courseCardId:String(n.courseCardId||n.id||n.kanji||""),kanji:String(n.kanji||""),meaning:n.meaning||{ru:n.meaning_ru||"",en:n.meaning_en||n.meaning_ru||""},readings:n.readings||{},examples:Array.isArray(n.examples)?n.examples:Array.isArray(n.words)?n.words:[],jlpt:"N1",lessonId:n.lessonId||n.lesson_id||null})).filter(n=>n.kanji)}function Sc(){if(!Array.isArray(r.n1KanjiCatalog)||!r.n1KanjiCatalog.length)return;const e=new Map(r.n1KanjiCatalog.map(n=>[n.kanji,n])),t=new Set;r.cards=r.cards.map(n=>{const s=e.get(n.kanji);return!s||!(String(n.jlpt||s.jlpt||"").toUpperCase()==="N1"||String(n.id)===s.courseCardId||String(n.id)===s.id)?n:(t.add(s.kanji),fa(n,s))}),r.n1KanjiCatalog.forEach(n=>{t.has(n.kanji)||(r.cards.push(fa({id:n.courseCardId||n.id,kanji:n.kanji,lessonId:n.lessonId,jlpt:"N1",examples:[],source:"n1-catalog"},n)),t.add(n.kanji))})}function fa(e,t){const n=t.readings||{},s=l=>Array.isArray(l)?l.filter(Boolean).join(" / "):String(l||""),a=(t.examples||[]).map(l=>({...l,reading:Q(l.reading||l.hiragana||l.kana||""),translation:l.translation_ru||l.translation||l.translation_en||""})),o=a[0]||{},c=Array.isArray(t.strokeOrder)?t.strokeOrder.map(l=>typeof l=="string"?l:l.description_ru||l.description_en||"").filter(Boolean):e.stroke_order;return{...e,id:String(e.id||t.courseCardId||t.id),jlpt:"N1",lessonId:e.lessonId||t.lessonId||null,meaning_ru:t.meaning?.ru||e.meaning_ru||"",meaning_en:t.meaning?.en||e.meaning_en||t.meaning?.ru||e.meaning_ru||"",onyomi:Q(s(n.onyomi)||e.onyomi||""),kunyomi:Q(s(n.kunyomi)||e.kunyomi||""),hiragana:Q((Array.isArray(n.hiragana)?n.hiragana[0]:n.hiragana)||o.reading||e.hiragana||""),romaji:(Array.isArray(n.romaji)?n.romaji[0]:n.romaji)||o.romaji||e.romaji||"",examples:a.length?a:e.examples,apps:Array.isArray(t.apps)&&t.apps.length?t.apps:e.apps,interface_use:t.interfaceUse||e.interface_use||"",interface_use_en:t.interfaceUseEn||t.interfaceUse||e.interface_use_en||e.interface_use||"",strokes:Number(t.strokes||e.strokes||0),stroke_order:c,meta:{...e.meta||{},...t.meta||{}},n1Detail:t}}function Nc(e){return(Array.isArray(e?.items)?e.items:Array.isArray(e)?e:[]).map((n,s)=>({...n,id:String(n.id||`n1-grammar-${String(s+1).padStart(2,"0")}`),level:"N1",order:Number(n.order||s+1),pattern:String(n.pattern||n.id||""),title:n.title||{ru:n.pattern||"",en:n.pattern||""},explanation:n.explanation||{ru:"",en:""},formula:String(n.formula||""),examples:Array.isArray(n.examples)?n.examples:[],question:n.question||{ru:"",en:""},answer:String(n.answer||""),options:Array.isArray(n.options)?n.options.map(String).filter(Boolean):[]})).filter(n=>n.pattern)}function Lc(e){return{version:Number(e?.version||1),level:"N1",lessonQuestionCount:Number(e?.lessonQuestionCount||10),types:Array.isArray(e?.types)?e.types:[],reviewModes:Array.isArray(e?.reviewModes)?e.reviewModes:[]}}function ha(e){return(Array.isArray(e?.items)?e.items:Array.isArray(e)?e:[]).map((n,s)=>({...n,id:String(n.id||`n1-item-${s+1}`),title:n.title||{ru:n.id||"",en:n.id||""},questions:Array.isArray(n.questions)?n.questions:n.question?[{prompt:n.question,answer:n.answer,options:Array.isArray(n.options)?n.options:[]}]:[]})).filter(n=>n.id)}function xc(e){return{version:Number(e?.version||1),level:"N1",title:e?.title||{ru:"Финальный тест JLPT N1",en:"JLPT N1 Final Test"},description:e?.description||{ru:"",en:""},questionCount:Number(e?.questionCount||45),passingPercent:Number(e?.passingPercent||82),kanjiPool:Array.isArray(e?.kanjiPool)?e.kanjiPool.map(String).filter(Boolean):[],grammarPool:Array.isArray(e?.grammarPool)?e.grammarPool.map(String).filter(Boolean):[],readingPool:Array.isArray(e?.readingPool)?e.readingPool.map(String).filter(Boolean):[],types:Array.isArray(e?.types)&&e.types.length?e.types:["meaning","reading","sentence","kanji","word","grammar","mini-reading","srs"],rewards:{completeXp:Number(e?.rewards?.xp||e?.rewards?.completeXp||320),completeMoon:Number(e?.rewards?.moon||e?.rewards?.completeMoon||60),passXp:Number(e?.rewards?.passXp||160),passMoon:Number(e?.rewards?.passMoon||25)}}}function kf(e){return Array.isArray(e)?e.map(t=>({value:String(t?.value||t?.id||""),label:t?.label||t?.title||t?.text||{ru:String(t?.labelRu||t?.ru||t?.value||""),en:String(t?.labelEn||t?.en||t?.value||"")}})).filter(t=>t.value):[]}function yf(e){return Array.isArray(e)?e.map(t=>({answer:Array.isArray(t?.answer)?t.answer.map(String).filter(Boolean):[],reading:Array.isArray(t?.reading)?t.reading.map(n=>Q(n)):[]})):[]}function $f(e,t){const n=Array.isArray(t)?t.flatMap(s=>Array.isArray(s?.answer)?s.answer.map((a,o)=>({kanji:String(a||""),reading:String(s?.reading?.[o]||"")})):[]):[];return[...Array.isArray(e)?e:[],...n].map(s=>({kanji:String(s?.kanji||""),reading:String(s?.reading||"")})).filter(s=>s.kanji).filter((s,a,o)=>o.findIndex(c=>c.kanji===s.kanji&&c.reading===s.reading)===a)}function jf(e){const t=Array.isArray(e?.items)?e.items:Array.isArray(e)?e:[],n=t.find(a=>String(a?.kind||"").toLowerCase()==="sentences")||t[0]||null;return(Array.isArray(n?.items)?n.items:[]).map((a,o)=>({id:String(a.id||`${String(n?.id||"reading-n5-sentence")}-${o+1}`),level:String(a.jlpt||n?.level||"N5").toUpperCase(),kind:"cloze",sourceKind:"sentences",sourceId:String(n?.id||"reading-n5-sentences"),sourceTitle:n?.title||{ru:"Предложения",en:"Sentences"},title:{ru:"Предложение",en:"Sentence"},sentence:String(a.sentence||""),reading:Q(a.reading||""),translationRu:String(a.translationRu||a.translation_ru||a.ru||""),translationEn:String(a.translationEn||a.translation_en||a.en||""),blanks:yf(a.blanks),tiles:$f(a.tiles,a.blanks),source:"reading"})).filter(a=>a.id)}function Cc(e,t=[]){const n=Array.isArray(e?.achievements)&&e.achievements.length?e.achievements:t,s=Array.isArray(e?.categories)?e.categories.map(c=>({id:String(c.id),title:c.title||{ru:c.id,en:c.id},icon:c.icon||"moon"})):[],a=n.map(c=>Oi(c)),o=new Set(s.map(c=>c.id));return a.forEach(c=>{o.has(c.category)||(o.add(c.category),s.push({id:c.category,title:{ru:c.category,en:c.category},icon:c.icon||"moon"}))}),{categories:s,items:a}}function Oi(e){const t=Number(e.rewardXp??e.xp??0),n=Number(e.rewardFragments??e.coins??0);return{...e,id:String(e.id),category:e.category||e.kind||"learning",title:e.title||e.name||{ru:e.id,en:e.id},description:e.description||{ru:"",en:""},icon:e.icon||"moon",kind:e.kind||"learned",target:Number(e.target||1),rewardXp:t,rewardFragments:n,unlocked:!!e.unlocked,secret:!!e.secret}}function Ac(){return[navigator.language,...navigator.languages||[]].filter(Boolean).map(t=>String(t).toLowerCase()).some(t=>t==="ru"||t.startsWith("ru-")||t==="be"||t.startsWith("be-"))?"ru":"en"}function us(){const e=Ac();return{version:3,createdAt:new Date().toISOString(),updatedAt:new Date().toISOString(),settings:{theme:"dark",themeManuallySelected:!1,sound:!0,uxSound:!0,uxVolume:.75,language:e,languageAutoDetected:!0,languageManuallySelected:!1,dailyGoal:10},xp:0,level:1,moonFragments:0,totalCorrect:0,totalWrong:0,correctCombo:0,bestCorrectCombo:0,appOpens:0,totalMoonFragmentsEarned:0,cards:{},seenCards:{},seenKanji:{},daily:{},favorites:{},transactions:[],streakHistory:[],streak:{current:0,best:0,lastStudyDate:null,pendingReward:null},visits:{firstVisitDate:null,lastVisitDate:null,lastDailyBonusDate:null,streak:0,bestStreak:0},lessonCompletions:{},achievements:{},dailyBonuses:{},dailyBonusPending:null,lastOpenedJlptLesson:null,lastOpenedJlptLessons:{},viewedReadingLevels:{},writingPractice:{completed:0,cards:{}},secrets:{evaClicks:0,nightVisit:!1},learningPath:Ui(),jlptLessonStudy:Gi(),sentencePractice:{activeId:null,selected:[],checked:!1,result:null,tileKeys:[],completed:{},attempts:0,recentIds:[],recentAnswers:[],custom:[],customSentences:[],customEditingId:null,customDraft:{jp:"",hiragana:"",ru:"",en:""},customMessage:"",customStatus:""},jlptLessonPractice:{activeIds:{},selected:{},checked:{},results:{},completed:{}},readingExercises:{},n5Course:zi(),n4Course:Hi(),n3Course:qi(),n2Course:Wi(),n1Course:Xi(),unlockedJlptLevels:Ke.slice(),unlockedBackgrounds:["bg_study_hub"],selectedEvaRoomBackground:"bg_study_hub",unlockedEvaSprites:["idle","default"],selectedEvaSprite:"idle",evaRoomDialogueProgress:{currentNode:"intro",rewardsClaimed:{},visited:{},lineHistory:[]},evaRoomQuiz:{answered:0,correct:0,wrong:0,streak:0,rewarded:{},history:[]},evaAutonomy:Gc(),evaRelationship:Vi(),shop:{owned:[],equipped:{}}}}function Sf(){const e=us();try{const t=wL();return t?Tc(e,t):e}catch(t){return console.warn("Progress reset because stored JSON is invalid.",t),e}}function Tc(e,t){return{...e,...t,version:3,settings:Nf(e.settings,t.settings||{}),cards:bL({...e.cards,...t.cards||{}}),seenCards:{...e.seenCards,...t.seenCards||{}},seenKanji:{...e.seenKanji,...t.seenKanji||{}},daily:{...e.daily,...t.daily||{}},favorites:{...e.favorites,...t.favorites||{}},transactions:Array.isArray(t.transactions)?t.transactions:e.transactions,streakHistory:Array.isArray(t.streakHistory)?t.streakHistory:e.streakHistory,streak:xf(e.streak,t.streak||{}),visits:{...e.visits,...t.visits||{}},lessonCompletions:{...e.lessonCompletions,...t.lessonCompletions||{}},achievements:{...e.achievements,...t.achievements||{}},dailyBonuses:{...e.dailyBonuses,...t.dailyBonuses||{}},dailyBonusPending:va(t.dailyBonusPending||null),lastOpenedJlptLesson:Ue(t.lastOpenedJlptLesson||null),lastOpenedJlptLessons:a0(t.lastOpenedJlptLessons||{}),viewedReadingLevels:rs(t.viewedReadingLevels||{}),appOpens:Number(t.appOpens||e.appOpens),totalMoonFragmentsEarned:Number(t.totalMoonFragmentsEarned||e.totalMoonFragmentsEarned),writingPractice:{...e.writingPractice,...t.writingPractice||{}},secrets:{...e.secrets,...t.secrets||{}},learningPath:Ec(e.learningPath,t.learningPath||{}),jlptLessonStudy:Pc(e.jlptLessonStudy,t.jlptLessonStudy||{}),sentencePractice:Qi(e.sentencePractice,t.sentencePractice||{}),jlptLessonPractice:Uc(e.jlptLessonPractice,t.jlptLessonPractice||{}),readingExercises:{...e.readingExercises,...t.readingExercises||{}},n5Course:Kc(e.n5Course,t.n5Course||{}),n4Course:Dc(e.n4Course,t.n4Course||{}),n3Course:Fc(e.n3Course,t.n3Course||{}),n2Course:Oc(e.n2Course,t.n2Course||{}),n1Course:Bc(e.n1Course,t.n1Course||{}),unlockedJlptLevels:[...new Set([...Array.isArray(e.unlockedJlptLevels)?e.unlockedJlptLevels:[],...Array.isArray(t.unlockedJlptLevels)?t.unlockedJlptLevels:[],...Ke])],unlockedBackgrounds:[...new Set([...e.unlockedBackgrounds||[],...t.unlockedBackgrounds||[]])],selectedEvaRoomBackground:t.selectedEvaRoomBackground||e.selectedEvaRoomBackground,unlockedEvaSprites:[...new Set([...e.unlockedEvaSprites||[],...t.unlockedEvaSprites||[],...(t.shop&&t.shop.owned||[]).filter(n=>String(n).startsWith("eva_sprite:")).map(n=>String(n).replace("eva_sprite:",""))])],selectedEvaSprite:t.selectedEvaSprite||e.selectedEvaSprite,evaRoomDialogueProgress:{...e.evaRoomDialogueProgress,...t.evaRoomDialogueProgress||{},rewardsClaimed:{...e.evaRoomDialogueProgress.rewardsClaimed,...t.evaRoomDialogueProgress&&t.evaRoomDialogueProgress.rewardsClaimed||{}},visited:{...e.evaRoomDialogueProgress.visited,...t.evaRoomDialogueProgress&&t.evaRoomDialogueProgress.visited||{}},lineHistory:Array.isArray(t.evaRoomDialogueProgress?.lineHistory)?t.evaRoomDialogueProgress.lineHistory:e.evaRoomDialogueProgress.lineHistory||[]},evaRoomQuiz:{...e.evaRoomQuiz,...t.evaRoomQuiz||{},rewarded:{...e.evaRoomQuiz.rewarded,...t.evaRoomQuiz&&t.evaRoomQuiz.rewarded||{}},history:Array.isArray(t.evaRoomQuiz?.history)?t.evaRoomQuiz.history.slice(0,40):e.evaRoomQuiz.history},evaAutonomy:zc(e.evaAutonomy,t.evaAutonomy||{}),evaRelationship:Jc(e.evaRelationship,t.evaRelationship||{}),shop:{owned:[...new Set([...e.shop.owned||[],...t.shop&&t.shop.owned||[]])],equipped:{...e.shop.equipped,...t.shop&&t.shop.equipped||{}}}}}function Nf(e,t){const n={...e,...t||{}};return n.theme=Lf(n.theme,e.theme||"dark"),n.themeManuallySelected=ln(n.themeManuallySelected,e.themeManuallySelected===!0),n.themeManuallySelected||(n.theme="dark"),n.sound=ln(n.sound,e.sound!==!1),n.uxSound=n.sound!==!1,n.languageAutoDetected=ln(n.languageAutoDetected,e.languageAutoDetected!==!1),n.languageManuallySelected=ln(n.languageManuallySelected,e.languageManuallySelected===!0),n}function Lf(e,t="dark"){return e==="light"||e==="dark"?e:t}function xf(e,t){const n={...e,...t||{}};return n.current=Bi(n.current,e.current||0),n.best=Bi(n.best,e.best||0),n.lastStudyDate=n.lastStudyDate||null,n.pendingReward=Ic(n.pendingReward),n}function Ic(e){if(!e||typeof e!="object")return null;const t=Bi(e.milestone,0),n=typeof e.availableOn=="string"?e.availableOn:"";return!t||!n?null:{milestone:t,availableOn:n}}function va(e){if(!e||typeof e!="object")return null;const t=typeof e.availableOn=="string"?e.availableOn:"";return t?{availableOn:t}:null}function ln(e,t=!0){if(typeof e=="boolean")return e;if(typeof e=="number")return e!==0;if(typeof e=="string"){const n=e.trim().toLowerCase();if(["false","0","off","no","disabled"].includes(n))return!1;if(["true","1","on","yes","enabled"].includes(n))return!0}return t}function Bi(e,t=0){const n=Number(e);return Number.isFinite(n)?n:t}function Ui(){return{version:Yl,currentLevel:Zl,currentNodeId:je,completedNodes:{},unlockedNodes:{[je]:!0},activeSession:null,resultHistory:{},lastUpdatedAt:null}}function Gi(){return{activeSessionKey:null,sessions:{},lastUpdatedAt:null}}function Rc(){return{level:"",lessonId:"",currentIndex:0,answers:{},phase:"study",startedAt:null,updatedAt:null,completedAt:null,testOpenedAt:null}}function _c(e){const t=String(e||"").toLowerCase();return["study","test","done"].includes(t)?t:"study"}function Mc(e,t){const n=Rc(),s=t&&typeof t=="object"?t:{},a={...e?.answers||n.answers,...s.answers||{}};return{...n,...e||{},...s,level:String(s.level||e?.level||n.level||"").toUpperCase(),lessonId:String(s.lessonId||e?.lessonId||n.lessonId||""),currentIndex:Math.max(0,Number(s.currentIndex??e?.currentIndex??n.currentIndex??0)),answers:a,phase:_c(s.phase||e?.phase||n.phase),startedAt:s.startedAt||e?.startedAt||n.startedAt||null,updatedAt:s.updatedAt||e?.updatedAt||n.updatedAt||null,completedAt:s.completedAt||e?.completedAt||n.completedAt||null,testOpenedAt:s.testOpenedAt||e?.testOpenedAt||n.testOpenedAt||null}}function Pc(e,t){const n=Gi(),s=t&&typeof t=="object"?t:{},a={},o=e?.sessions||{},c=s.sessions||{};return Object.keys(o).forEach(l=>{a[l]=Mc(o[l],c[l])}),Object.keys(c).forEach(l=>{a[l]||(a[l]=Mc(null,c[l]))}),{...n,...e||{},...s||{},sessions:a,activeSessionKey:s.activeSessionKey||e?.activeSessionKey||n.activeSessionKey||null,lastUpdatedAt:s.lastUpdatedAt||e?.lastUpdatedAt||n.lastUpdatedAt||null}}function Ec(e,t){return{...e,...t||{},version:Yl,currentLevel:String(t?.currentLevel||e.currentLevel||Zl).toUpperCase(),currentNodeId:String(t?.currentNodeId||e.currentNodeId||je),completedNodes:{...e.completedNodes,...t?.completedNodes||{}},unlockedNodes:{...e.unlockedNodes,...t?.unlockedNodes||{}},activeSession:Ji(t?.activeSession||e.activeSession||null),resultHistory:{...e.resultHistory,...t?.resultHistory||{}},lastUpdatedAt:t?.lastUpdatedAt||e.lastUpdatedAt||null}}function Ji(e){return!e||typeof e!="object"?null:{nodeId:String(e.nodeId||""),mode:String(e.mode||Ct),stepIndex:Math.max(0,Number(e.stepIndex||0)),answers:{...e.answers||{}},mistakes:Array.isArray(e.mistakes)?e.mistakes.slice(0,80):[],reviewStepIds:Array.isArray(e.reviewStepIds)?e.reviewStepIds.map(String).filter(Boolean).slice(0,80):[],score:Number(e.score||0),startedAt:e.startedAt||new Date().toISOString(),updatedAt:e.updatedAt||new Date().toISOString()}}function zi(){return{currentLessonId:"n5-lesson-1",completedLessons:{},viewedLessons:{},studiedKanji:{},srsKanji:{},difficultKanji:{},kanjiMistakes:{},wordMistakes:{},completedExercises:{},exerciseResults:{},exerciseSrs:{},writingPractice:{},activeReviewMode:"due",finalTest:{answers:{},completedAt:null,score:0,percent:0,passed:!1,mistakes:[],attempts:0,correctAnswers:0,incorrectAnswers:0,unansweredAnswers:0,totalQuestions:0,mistakeQuestionIds:[],bestScore:0,lastScore:0,passedAt:null,lastRewardXp:0,lastRewardMoon:0},customSentences:[]}}function Kc(e,t){return{...e,...t||{},currentLessonId:t?.currentLessonId||e.currentLessonId,completedLessons:{...e.completedLessons,...t?.completedLessons||{}},viewedLessons:rs(t?.viewedLessons||{}),studiedKanji:{...e.studiedKanji,...t?.studiedKanji||{}},srsKanji:{...e.srsKanji,...t?.srsKanji||{}},difficultKanji:{...e.difficultKanji,...t?.difficultKanji||{}},kanjiMistakes:{...e.kanjiMistakes,...t?.kanjiMistakes||{}},wordMistakes:{...e.wordMistakes,...t?.wordMistakes||{}},completedExercises:{...e.completedExercises,...t?.completedExercises||{}},exerciseResults:{...e.exerciseResults,...t?.exerciseResults||{}},exerciseSrs:Cr(e.exerciseSrs,t?.exerciseSrs||{},"N5"),writingPractice:{...e.writingPractice,...t?.writingPractice||{}},activeReviewMode:t?.activeReviewMode||e.activeReviewMode,finalTest:{...e.finalTest,...t?.finalTest||{},answers:{...e.finalTest.answers,...t?.finalTest&&t.finalTest.answers||{}},mistakes:Array.isArray(t?.finalTest?.mistakes)?t.finalTest.mistakes:e.finalTest.mistakes},customSentences:Array.isArray(t?.customSentences)?t.customSentences:e.customSentences}}function Hi(){return{opened:!1,currentLessonId:"n4-lesson-1",completedLessons:{},viewedLessons:{},studiedKanji:{},srsKanji:{},difficultKanji:{},kanjiMistakes:{},wordMistakes:{},completedExercises:{},exerciseResults:{},exerciseSrs:{},completedGrammar:{},grammarResults:{},completedReading:{},readingAnswers:{},completedListening:{},listeningAnswers:{},writingPractice:{},activeReviewMode:"due",finalTest:{answers:{},completedAt:null,score:0,percent:0,passed:!1,mistakes:[],attempts:0},customSentences:[]}}function Dc(e,t){return{...e,...t||{},opened:!!(t?.opened||e.opened),currentLessonId:t?.currentLessonId||e.currentLessonId,completedLessons:{...e.completedLessons,...t?.completedLessons||{}},viewedLessons:rs(t?.viewedLessons||{}),studiedKanji:{...e.studiedKanji,...t?.studiedKanji||{}},srsKanji:{...e.srsKanji,...t?.srsKanji||{}},difficultKanji:{...e.difficultKanji,...t?.difficultKanji||{}},kanjiMistakes:{...e.kanjiMistakes,...t?.kanjiMistakes||{}},wordMistakes:{...e.wordMistakes,...t?.wordMistakes||{}},completedExercises:{...e.completedExercises,...t?.completedExercises||{}},exerciseResults:{...e.exerciseResults,...t?.exerciseResults||{}},exerciseSrs:Cr(e.exerciseSrs,t?.exerciseSrs||{},"N4"),completedGrammar:{...e.completedGrammar,...t?.completedGrammar||{}},grammarResults:{...e.grammarResults,...t?.grammarResults||{}},completedReading:{...e.completedReading,...t?.completedReading||{}},readingAnswers:{...e.readingAnswers,...t?.readingAnswers||{}},completedListening:{...e.completedListening,...t?.completedListening||{}},listeningAnswers:{...e.listeningAnswers,...t?.listeningAnswers||{}},writingPractice:{...e.writingPractice,...t?.writingPractice||{}},activeReviewMode:t?.activeReviewMode||e.activeReviewMode,finalTest:{...e.finalTest,...t?.finalTest||{},answers:{...e.finalTest.answers,...t?.finalTest&&t.finalTest.answers||{}},mistakes:Array.isArray(t?.finalTest?.mistakes)?t.finalTest.mistakes:e.finalTest.mistakes},customSentences:Array.isArray(t?.customSentences)?t.customSentences:e.customSentences}}function qi(){return{opened:!1,currentLessonId:"n3-lesson-1",completedLessons:{},viewedLessons:{},studiedKanji:{},srsKanji:{},difficultKanji:{},kanjiMistakes:{},wordMistakes:{},completedExercises:{},exerciseResults:{},exerciseSrs:{},completedGrammar:{},grammarResults:{},completedReading:{},readingAnswers:{},completedListening:{},listeningAnswers:{},writingPractice:{},activeReviewMode:"due",finalTest:{answers:{},completedAt:null,score:0,percent:0,passed:!1,mistakes:[],attempts:0},customSentences:[]}}function Fc(e,t){return{...e,...t||{},opened:!!(t?.opened||e.opened),currentLessonId:t?.currentLessonId||e.currentLessonId,completedLessons:{...e.completedLessons,...t?.completedLessons||{}},viewedLessons:rs(t?.viewedLessons||{}),studiedKanji:{...e.studiedKanji,...t?.studiedKanji||{}},srsKanji:{...e.srsKanji,...t?.srsKanji||{}},difficultKanji:{...e.difficultKanji,...t?.difficultKanji||{}},kanjiMistakes:{...e.kanjiMistakes,...t?.kanjiMistakes||{}},wordMistakes:{...e.wordMistakes,...t?.wordMistakes||{}},completedExercises:{...e.completedExercises,...t?.completedExercises||{}},exerciseResults:{...e.exerciseResults,...t?.exerciseResults||{}},exerciseSrs:Cr(e.exerciseSrs,t?.exerciseSrs||{},"N3"),completedGrammar:{...e.completedGrammar,...t?.completedGrammar||{}},grammarResults:{...e.grammarResults,...t?.grammarResults||{}},completedReading:{...e.completedReading,...t?.completedReading||{}},readingAnswers:{...e.readingAnswers,...t?.readingAnswers||{}},completedListening:{...e.completedListening,...t?.completedListening||{}},listeningAnswers:{...e.listeningAnswers,...t?.listeningAnswers||{}},writingPractice:{...e.writingPractice,...t?.writingPractice||{}},activeReviewMode:t?.activeReviewMode||e.activeReviewMode,finalTest:{...e.finalTest,...t?.finalTest||{},answers:{...e.finalTest.answers,...t?.finalTest&&t.finalTest.answers||{}},mistakes:Array.isArray(t?.finalTest?.mistakes)?t.finalTest.mistakes:e.finalTest.mistakes},customSentences:Array.isArray(t?.customSentences)?t.customSentences:e.customSentences}}function Wi(){return{opened:!1,currentLessonId:"n2-lesson-1",completedLessons:{},viewedLessons:{},studiedKanji:{},srsKanji:{},difficultKanji:{},kanjiMistakes:{},wordMistakes:{},completedExercises:{},exerciseResults:{},exerciseSrs:{},completedGrammar:{},grammarResults:{},completedReading:{},readingAnswers:{},completedListening:{},listeningAnswers:{},writingPractice:{},activeReviewMode:"due",finalTest:{answers:{},completedAt:null,score:0,percent:0,passed:!1,mistakes:[],attempts:0},customSentences:[]}}function Oc(e,t){return{...e,...t||{},opened:!!(t?.opened||e.opened),currentLessonId:t?.currentLessonId||e.currentLessonId,completedLessons:{...e.completedLessons,...t?.completedLessons||{}},viewedLessons:rs(t?.viewedLessons||{}),studiedKanji:{...e.studiedKanji,...t?.studiedKanji||{}},srsKanji:{...e.srsKanji,...t?.srsKanji||{}},difficultKanji:{...e.difficultKanji,...t?.difficultKanji||{}},kanjiMistakes:{...e.kanjiMistakes,...t?.kanjiMistakes||{}},wordMistakes:{...e.wordMistakes,...t?.wordMistakes||{}},completedExercises:{...e.completedExercises,...t?.completedExercises||{}},exerciseResults:{...e.exerciseResults,...t?.exerciseResults||{}},exerciseSrs:Cr(e.exerciseSrs,t?.exerciseSrs||{},"N2"),completedGrammar:{...e.completedGrammar,...t?.completedGrammar||{}},grammarResults:{...e.grammarResults,...t?.grammarResults||{}},completedReading:{...e.completedReading,...t?.completedReading||{}},readingAnswers:{...e.readingAnswers,...t?.readingAnswers||{}},completedListening:{...e.completedListening,...t?.completedListening||{}},listeningAnswers:{...e.listeningAnswers,...t?.listeningAnswers||{}},writingPractice:{...e.writingPractice,...t?.writingPractice||{}},activeReviewMode:t?.activeReviewMode||e.activeReviewMode,finalTest:{...e.finalTest,...t?.finalTest||{},answers:{...e.finalTest.answers,...t?.finalTest&&t.finalTest.answers||{}},mistakes:Array.isArray(t?.finalTest?.mistakes)?t.finalTest.mistakes:e.finalTest.mistakes},customSentences:Array.isArray(t?.customSentences)?t.customSentences:e.customSentences}}function Xi(){return{opened:!1,currentLessonId:"bulk-n1-01",completedLessons:{},viewedLessons:{},studiedKanji:{},srsKanji:{},difficultKanji:{},kanjiMistakes:{},wordMistakes:{},completedExercises:{},exerciseResults:{},exerciseSrs:{},completedGrammar:{},grammarResults:{},completedReading:{},readingAnswers:{},completedListening:{},listeningAnswers:{},writingPractice:{},activeReviewMode:"due",finalTest:{answers:{},completedAt:null,score:0,percent:0,passed:!1,mistakes:[],attempts:0},customSentences:[]}}function Bc(e,t){return{...e,...t||{},opened:!!(t?.opened||e.opened),currentLessonId:t?.currentLessonId||e.currentLessonId,completedLessons:{...e.completedLessons,...t?.completedLessons||{}},viewedLessons:rs(t?.viewedLessons||{}),studiedKanji:{...e.studiedKanji,...t?.studiedKanji||{}},srsKanji:{...e.srsKanji,...t?.srsKanji||{}},difficultKanji:{...e.difficultKanji,...t?.difficultKanji||{}},kanjiMistakes:{...e.kanjiMistakes,...t?.kanjiMistakes||{}},wordMistakes:{...e.wordMistakes,...t?.wordMistakes||{}},completedExercises:{...e.completedExercises,...t?.completedExercises||{}},exerciseResults:{...e.exerciseResults,...t?.exerciseResults||{}},exerciseSrs:Cr(e.exerciseSrs,t?.exerciseSrs||{},"N1"),completedGrammar:{...e.completedGrammar,...t?.completedGrammar||{}},grammarResults:{...e.grammarResults,...t?.grammarResults||{}},completedReading:{...e.completedReading,...t?.completedReading||{}},readingAnswers:{...e.readingAnswers,...t?.readingAnswers||{}},completedListening:{...e.completedListening,...t?.completedListening||{}},listeningAnswers:{...e.listeningAnswers,...t?.listeningAnswers||{}},writingPractice:{...e.writingPractice,...t?.writingPractice||{}},activeReviewMode:t?.activeReviewMode||e.activeReviewMode,finalTest:{...e.finalTest,...t?.finalTest||{},answers:{...e.finalTest.answers,...t?.finalTest&&t.finalTest.answers||{}},mistakes:Array.isArray(t?.finalTest?.mistakes)?t.finalTest.mistakes:e.finalTest.mistakes},customSentences:Array.isArray(t?.customSentences)?t.customSentences:e.customSentences}}function Qi(e,t){return{...e,...t,selected:Array.isArray(t.selected)?t.selected:e.selected,tileKeys:Array.isArray(t.tileKeys)?t.tileKeys:e.tileKeys,recentIds:Array.isArray(t.recentIds)?t.recentIds:e.recentIds,recentAnswers:Array.isArray(t.recentAnswers)?t.recentAnswers:e.recentAnswers,completed:{...e.completed,...t.completed||{}},custom:Array.isArray(t.custom)?t.custom.slice(0,80):e.custom,customSentences:Cf(t.customSentences,t.custom),customEditingId:typeof t.customEditingId=="string"?t.customEditingId:null,customDraft:wa(t.customDraft||e.customDraft),customMessage:typeof t.customMessage=="string"?t.customMessage:e.customMessage,customStatus:typeof t.customStatus=="string"?t.customStatus:e.customStatus}}function wa(e={}){return{jp:String(e.jp??e.sentence??""),hiragana:String(e.hiragana??e.reading??""),ru:String(e.ru??e.translationRu??""),en:String(e.en??e.translationEn??"")}}function Cf(e,t){const n=[],s=new Set,a=o=>{if(!o)return;const c=Sn(o.jp||dp(o)),l=Ls(c);if(!l||s.has(l))return;s.add(l);const d=String(o.id||"").startsWith("custom_")?String(o.id):`custom_${Te(l).toString(36)}`;n.push({id:d,jp:c,hiragana:Sn(o.hiragana||o.reading||""),ru:Sn(o.ru||o.translationRu||""),en:Sn(o.en||o.translationEn||""),source:"user"})};return(Array.isArray(e)?e:[]).forEach(a),(Array.isArray(t)?t:[]).forEach(a),n.slice(0,160)}function Uc(e,t){return{...e,...t,activeIds:{...e.activeIds,...t.activeIds||{}},selected:{...e.selected,...t.selected||{}},checked:{...e.checked,...t.checked||{}},results:{...e.results,...t.results||{}},completed:{...e.completed,...t.completed||{}}}}function Vi(){return{warmth:44,trust:40,discipline:35,curiosity:42,mood:"neutral",conversationCount:0,totalDialogueChoices:0,lastInteractionAt:null,lastInteractionDate:null,lastDecayDate:re(),lastKnown:{learned:0,mastered:0,reviews:0,lessons:0,streak:0,wrong:0,writing:0,sentence:0},history:[]}}function Gc(){return{enabled:!0,frequency:"normal",roomMode:"auto",outfitMode:"auto",currentLine:null,currentQuestion:null,currentDecoration:null,currentEffect:null,mood:"neutral",emotion:"calm",lastSpokeAt:null,nextSpeakAt:null,recentLineIds:[],lastRoomId:null,lastSprite:null}}function Jc(e,t){return{...e,...t,warmth:de(Number(t.warmth??e.warmth),0,100),trust:de(Number(t.trust??e.trust),0,100),discipline:de(Number(t.discipline??e.discipline),0,100),curiosity:de(Number(t.curiosity??e.curiosity),0,100),lastKnown:{...e.lastKnown,...t.lastKnown||{}},history:Array.isArray(t.history)?t.history.slice(0,40):e.history}}function zc(e,t){return{...e,...t,enabled:!0,frequency:"normal",roomMode:"auto",outfitMode:"auto",recentLineIds:Array.isArray(t.recentLineIds)?t.recentLineIds.slice(0,32):e.recentLineIds,currentLine:t.currentLine&&typeof t.currentLine=="object"?t.currentLine:e.currentLine,currentQuestion:t.currentQuestion&&typeof t.currentQuestion=="object"?t.currentQuestion:e.currentQuestion,currentDecoration:typeof t.currentDecoration=="string"?t.currentDecoration:e.currentDecoration,currentEffect:typeof t.currentEffect=="string"?t.currentEffect:e.currentEffect,mood:typeof t.mood=="string"?t.mood:e.mood,emotion:typeof t.emotion=="string"?t.emotion:e.emotion}}function zt(){return{lastSeenDate:null,lastInteractionDate:null,lastRoute:null,recentLineIds:[],recentTopics:[],daysSinceReturn:0,lastPraiseAt:null,lastWarningAt:null,timesUserChoseTalkOverStudy:0,timesUserReturnedAfterGap:0,lastReturnCountedDate:null,preferredEvaRoomBackground:null,lastKnownMood:"neutral",recentProblemCluster:null}}function Jn(e,t={}){return{...e,...t,recentLineIds:Array.isArray(t.recentLineIds)?t.recentLineIds.slice(0,30):e.recentLineIds,recentTopics:Array.isArray(t.recentTopics)?t.recentTopics.slice(0,20):e.recentTopics,daysSinceReturn:Number(t.daysSinceReturn||e.daysSinceReturn||0),timesUserChoseTalkOverStudy:Number(t.timesUserChoseTalkOverStudy||e.timesUserChoseTalkOverStudy||0),timesUserReturnedAfterGap:Number(t.timesUserReturnedAfterGap||e.timesUserReturnedAfterGap||0),lastKnownMood:typeof t.lastKnownMood=="string"?t.lastKnownMood:e.lastKnownMood}}function Rt(){return{version:3,createdAt:new Date().toISOString(),updatedAt:new Date().toISOString(),presenceState:"idle",mood:"neutral",emotion:"calm",currentPhrase:null,pendingQuestion:null,currentSkin:"idle",currentBackground:"bg_study_hub",currentDecoration:null,currentEffect:"none",activeSkin:"idle",activeBackground:"bg_study_hub",ownedSkins:["idle","default"],ownedBackgrounds:["bg_study_hub"],ownedEffects:[],ownedDecorations:[],lastEvent:null,lastQuestion:null,lastPhraseAt:0,lastEmotionChangeAt:0,lastQuestionAt:0,lastVisualChangeAt:0,lastPlayerActionAt:Date.now(),textRevealSkippedLineId:null,memory:zt(),questionHistory:[],clickCount:0,eventHistory:[],recentEvents:[],cooldowns:{emotion:18e3,phrase:65e3,question:24e4,visual:72e4}}}function Af(){const e=Rt();let t=null;try{const n=localStorage.getItem(x);t=n?JSON.parse(n):null}catch(n){console.warn("Eva state reset because stored JSON is invalid.",n)}r.evaRuntime=Rf(e,t||If()),Tf(),zn()}function Tf(){if(!r.evaRuntime)return;r.evaRuntime.memory=Jn(zt(),r.evaRuntime.memory||{});const e=r.evaRuntime.memory,t=re(),n=e.lastSeenDate||null,s=n?Math.max(0,Rn(n,t)):0;e.daysSinceReturn=s,s>0&&e.lastReturnCountedDate!==t&&(e.timesUserReturnedAfterGap=Number(e.timesUserReturnedAfterGap||0)+1,e.lastReturnCountedDate=t),e.lastSeenDate=t,e.lastRoute=r.route,e.preferredEvaRoomBackground=r.progress?.selectedEvaRoomBackground||e.preferredEvaRoomBackground||"bg_study_hub",e.lastKnownMood=r.evaRuntime.mood||e.lastKnownMood||"neutral"}function If(){const e=r.progress?.evaAutonomy||{};return{currentSkin:r.progress?.selectedEvaSprite||e.lastSprite||"idle",currentBackground:r.progress?.selectedEvaRoomBackground||e.lastRoomId||"bg_study_hub",currentDecoration:r.customization?.selected?.decoration||r.customization?.selected?.frame||null,currentEffect:r.customization?.selected?.effect||"none",activeSkin:r.progress?.selectedEvaSprite||e.lastSprite||"idle",activeBackground:r.progress?.selectedEvaRoomBackground||e.lastRoomId||"bg_study_hub",lastEvent:e.currentLine?.reason?{type:e.currentLine.reason,at:e.currentLine.at}:null}}function Rf(e,t={}){return{...e,...t,version:3,updatedAt:new Date().toISOString(),presenceState:typeof t.presenceState=="string"?t.presenceState:e.presenceState,mood:typeof t.mood=="string"?t.mood:e.mood,emotion:typeof t.emotion=="string"?t.emotion:e.emotion,currentPhrase:t.currentPhrase&&typeof t.currentPhrase=="object"?t.currentPhrase:e.currentPhrase,pendingQuestion:t.pendingQuestion&&typeof t.pendingQuestion=="object"?t.pendingQuestion:e.pendingQuestion,currentSkin:typeof t.currentSkin=="string"?t.currentSkin:e.currentSkin,currentBackground:typeof t.currentBackground=="string"?t.currentBackground:e.currentBackground,currentDecoration:typeof t.currentDecoration=="string"?t.currentDecoration:null,currentEffect:typeof t.currentEffect=="string"?t.currentEffect:e.currentEffect,activeSkin:typeof t.activeSkin=="string"?t.activeSkin:t.currentSkin||e.activeSkin,activeBackground:typeof t.activeBackground=="string"?t.activeBackground:t.currentBackground||e.activeBackground,ownedSkins:Array.isArray(t.ownedSkins)?t.ownedSkins:e.ownedSkins,ownedBackgrounds:Array.isArray(t.ownedBackgrounds)?t.ownedBackgrounds:e.ownedBackgrounds,ownedEffects:Array.isArray(t.ownedEffects)?t.ownedEffects:e.ownedEffects,ownedDecorations:Array.isArray(t.ownedDecorations)?t.ownedDecorations:e.ownedDecorations,lastPhraseAt:Number(t.lastPhraseAt||e.lastPhraseAt||0),lastEmotionChangeAt:Number(t.lastEmotionChangeAt||e.lastEmotionChangeAt||0),lastQuestionAt:Number(t.lastQuestionAt||e.lastQuestionAt||0),lastVisualChangeAt:Number(t.lastVisualChangeAt||e.lastVisualChangeAt||0),lastPlayerActionAt:Number(t.lastPlayerActionAt||e.lastPlayerActionAt||Date.now()),textRevealSkippedLineId:typeof t.textRevealSkippedLineId=="string"?t.textRevealSkippedLineId:null,memory:Jn(e.memory||zt(),t.memory||{}),questionHistory:Array.isArray(t.questionHistory)?t.questionHistory.slice(0,40):e.questionHistory,eventHistory:Array.isArray(t.eventHistory)?t.eventHistory.slice(0,80):e.eventHistory,recentEvents:Array.isArray(t.recentEvents)?t.recentEvents.slice(0,80):e.recentEvents,cooldowns:{...e.cooldowns,...t.cooldowns||{}},clickCount:Number(t.clickCount||e.clickCount||0)}}function Yi(){if(!r.evaRuntime)return!1;Hc(),r.evaRuntime.updatedAt=new Date().toISOString(),xi=!1,Dn&&("cancelIdleCallback"in window?window.cancelIdleCallback(Dn):window.clearTimeout(Dn),Dn=0);try{return localStorage.setItem(x,JSON.stringify(r.evaRuntime)),!0}catch(e){return console.warn("Eva state could not be saved.",e),!1}}function zn(e={}){if(!r.evaRuntime)return!1;if(e?.immediate)return Yi();if(xi)return!0;xi=!0;const t=()=>{Dn=0,Yi()};return"requestIdleCallback"in window?Dn=window.requestIdleCallback(t,{timeout:1200}):Dn=window.setTimeout(t,160),!0}function Zi(){eo(),Yi(),Um()}function Hc(){if(!r.evaRuntime||!r.progress)return;const e=r.progress.selectedEvaRoomBackground||r.customization?.selected?.background||"bg_study_hub",t=st().filter(n=>Kt(n.id));r.evaRuntime.ownedSkins=[...new Set(["idle","default",...r.progress.unlockedEvaSprites||[],...t.filter(n=>n.type==="outfit").map(n=>n.spriteId||n.id)].filter(Boolean))],r.evaRuntime.ownedBackgrounds=[...new Set(["bg_study_hub",...r.progress.unlockedBackgrounds||[],...t.filter(n=>n.type==="background").map(n=>n.id)].filter(Boolean))],r.evaRuntime.ownedEffects=[...new Set(t.filter(n=>n.type==="effect").map(n=>n.id))],r.evaRuntime.ownedDecorations=[...new Set(t.filter(n=>n.type==="decoration").map(n=>n.id))],r.evaRuntime.currentBackground=e,r.evaRuntime.activeSkin=r.evaRuntime.currentSkin||r.progress.selectedEvaSprite||"idle",r.evaRuntime.activeBackground=e}function eo(){return r.progress?(r.progress.level=di(r.progress.xp),r.progress.updatedAt=new Date().toISOString(),Li=!1,Kn&&("cancelIdleCallback"in window?window.cancelIdleCallback(Kn):window.clearTimeout(Kn),Kn=0),kL(r.progress)):!1}function N(e={}){if(!r.progress)return!1;if(e?.immediate)return eo();if(Li)return!0;Li=!0;const t=()=>{Kn=0,eo()};return"requestIdleCallback"in window?Kn=window.requestIdleCallback(t,{timeout:1200}):Kn=window.setTimeout(t,120),!0}function qc(e,t,{timeout:n=0}={}){const s=()=>{try{const a=t?.();a&&typeof a.then=="function"&&a.catch(o=>console.warn(`[Flash Kanji] ${e} failed.`,o))}catch(a){console.warn(`[Flash Kanji] ${e} failed.`,a)}};requestAnimationFrame(()=>window.setTimeout(s,n))}function _t(e,t){qc(e,()=>{const n=t?.();n&&typeof n.then=="function"&&n.catch(s=>console.warn(`[Flash Kanji] ${e} failed.`,s)),N(),Ht()})}function _f(e){const t=e?.dataset?.action||"",n=Mf(t,e);return n?Pi.has(n)?!1:(Pi.add(n),requestAnimationFrame(()=>window.setTimeout(()=>Pi.delete(n),0)),!0):!0}function Mf(e,t){return e?e==="rate"?`rate:${r.activeCardId||""}:${t?.dataset?.rating||""}`:e==="jlpt-lesson-answer"?`jlpt:${t?.dataset?.level||""}:${t?.dataset?.lesson||t?.dataset?.lessonId||""}:${t?.dataset?.card||t?.dataset?.id||""}`:e==="reading-review-answer"?`reading-review:${r.activeExerciseReviewLevel||""}:${r.activeExerciseReviewId||""}:${t?.dataset?.question||""}`:/^n[1-5]-(answer|srs|check-input|grammar-complete|reading-complete|listening-complete)$/.test(e)?`${e}:${t?.dataset?.id||""}:${t?.dataset?.rating||t?.dataset?.value||t?.dataset?.question||""}`:"":""}function er(){r.cards.forEach(s=>D(s.id)),r.progress.level=di(r.progress.xp),r.progress.totalMoonFragmentsEarned=Math.max(Number(r.progress.totalMoonFragmentsEarned||0),Number(r.progress.moonFragments||0),xS()),ce(),ir(),ur(),To(),Mo(),Do(),typeof Fa=="function"&&Fa();const e=_s(),t=[Za(Z(),"N5"),Za(W(),"N4"),Za(H(),"N3"),Za(q(),"N2"),ei(Z(),"N5"),ei(W(),"N4"),ei(H(),"N3"),ei(q(),"N2")].some(Boolean);[Z(),W(),H(),q(),typeof ee=="function"?ee():null].filter(Boolean).forEach(s=>Pf(s)),(t||e)&&N(),ba();const n=r.lessons.find(s=>Me(s));r.activeLessonId||(r.activeLessonId=n?.id||r.lessons[0]?.id||null)}function Pf(e){e&&(e.studiedKanji||(e.studiedKanji={}),e.srsKanji||(e.srsKanji={}),e.viewedLessons=rs(e.viewedLessons||{}),Object.entries(e.srsKanji).forEach(([t,n])=>{e.studiedKanji[t]||(e.studiedKanji[t]=n)}),Object.entries(e.studiedKanji).forEach(([t,n])=>{e.srsKanji[t]||(e.srsKanji[t]=n)}))}function ps(e,t,n=new Date().toISOString()){if(!e||!t)return"";e.studiedKanji||(e.studiedKanji={}),e.srsKanji||(e.srsKanji={});const s=e.studiedKanji[t],a=e.srsKanji[t],o=s||a||n;return e.studiedKanji[t]=o,e.srsKanji[t]=a||o,o}function ba(){r.progress.learningPath=Ec(Ui(),r.progress.learningPath||{});const e=r.progress.learningPath,t=e.completedNodes,n=e.unlockedNodes;n[je]=!0,(Object.keys(r.progress.seenKanji||{}).length>0||Object.keys(Z().studiedKanji||{}).length>0||Object.keys(Z().completedLessons||{}).length>0||Object.keys(r.progress.lessonCompletions||{}).length>0)&&!t[je]&&(t[je]=r.progress.visits?.firstVisitDate||new Date().toISOString()),to().forEach((o,c)=>{Z().completedLessons?.[o]&&!t[o]&&(t[o]=Z().completedLessons[o]),n[o]=!0});const a=Wc();e.currentNodeId=a,n[a]=!0,e.activeSession?.nodeId&&t[e.activeSession.nodeId]&&(e.activeSession=null),e.lastUpdatedAt=new Date().toISOString()}function to(){const e=(r.n5Textbook?.items||[]).map(t=>String(t.id||"")).filter(Boolean);return e.length?e:pm.filter(t=>/^n5-lesson-\d+$/i.test(t))}function Wc(){const e=r.progress?.learningPath||Ui(),t=[je,...to(),os];return t.find(n=>!e.completedNodes?.[n])||t[t.length-1]||je}function no(){return r.n5Textbook?.items?.length?Promise.resolve(r.n5Textbook):Vs||(Vs=nt(O.n5Lessons).then(e=>(r.n5Textbook=vc(e),ba(),(r.route==="learn"||r.route==="home")&&C(),r.n5Textbook)).catch(e=>{throw Vs=null,e}),Vs)}function Ef(e){const t=String(e||"");if(!t)return Promise.resolve(null);if(r.learningPathLessonPayloads[t])return Promise.resolve(r.learningPathLessonPayloads[t]);const n=gm[t];if(!n){const a=lr(t);return a&&(r.learningPathLessonPayloads[t]=a),Promise.resolve(a)}if(oa.has(t))return oa.get(t);const s=nt(n).then(a=>(r.learningPathLessonPayloads[t]=a||lr(t),r.route==="learn"&&r.activeLearnNodeId===t&&C(),r.learningPathLessonPayloads[t])).catch(a=>{const o=lr(t);if(o)return r.learningPathLessonPayloads[t]=o,r.route==="learn"&&r.activeLearnNodeId===t&&C(),o;throw a}).finally(()=>{oa.delete(t)});return oa.set(t,s),s}function cn(){return ba(),r.progress.learningPath}function so(){const e=cn().activeSession;return!e?.nodeId||cn().completedNodes?.[e.nodeId]?null:e}function gs(){const e=so();return e?.nodeId?e.nodeId:cn().currentNodeId||Wc()||je}function Xc(e){const t=Hn(e);return t?f(t.title):Kf(e)}function Kf(e){const t=String(e||"");if(t===je)return p()==="ru"?"Введение в маршрут":"Route introduction";if(t===os)return p()==="ru"?"Контрольная точка N5":"N5 checkpoint";const n=wt(t);if(n)return f(n.title);const s=t.match(/n5-lesson-(\d+)/i);return s?p()==="ru"?`N5 · Урок ${s[1]}`:`N5 · Lesson ${s[1]}`:t}function Df(e){const t=Hn(e);return t?f(t.summary):""}function le(){return p()==="ru"?{route:"Маршрут обучения",intro:"Введение",checkpoint:"Контрольная точка",review:"Повторение",available:"доступно",current:"сейчас",completed:"завершено",locked:"закрыто",due:"нужно повторить",minutes:"мин",lessons:"уроки",start:"Начать учиться",resume:"Продолжить урок",next:"Следующий урок",reviewAction:"Повторить",reviewOld:"Повторить старое",continue:"Дальше",finish:"Завершить",backToMap:"К маршруту",openTextbook:"Открыть учебник",openCheckpoint:"К тесту",score:"Результат",mistakes:"Ошибки",retryMistakes:"Повторить ошибки",continuePath:"Продолжить путь",ready:"Готово",introTitle:"Как тут учиться",introSummary:"Кандзи идут по цепочке: знак -> смысл -> чтение -> пример -> повторение.",introBody:"Сначала берём один маленький блок, потом отправляем его в повторение. Не нужно держать всё в голове за раз.",introBridge:"Если что-то тяжело, это не провал. Значит, карточка просто раньше вернётся в повторение.",introQuestion:"Куда отправляются карточки после урока?",introQuestionHint:"Выбери правильный путь.",loading:"Подгружаю маршрут...",empty:"Маршрут скоро появится.",nextLesson:"Следующий шаг",lessonTrack:"Текущий уровень",reviewQueue:"К повторению",streak:"Стрик",level:"Уровень",xp:"XP",mapHint:"Сначала идём по текущему уровню. Остальные уровни остаются в учебниках.",step:"Шаг",finishHint:"После урока карточки попадут в повторение.",scoreHint:"Вернёмся к ошибкам или двинемся дальше."}:{route:"Learning path",intro:"Intro",checkpoint:"Checkpoint",review:"Review",available:"available",current:"current",completed:"done",locked:"locked",due:"review due",minutes:"min",lessons:"lessons",start:"Start learning",resume:"Resume lesson",next:"Next lesson",reviewAction:"Review",reviewOld:"Review old material",continue:"Next",finish:"Finish",backToMap:"Back to path",openTextbook:"Open textbook",openCheckpoint:"Open test",score:"Score",mistakes:"Ошибки",retryMistakes:"Retry mistakes",continuePath:"Continue path",ready:"Done",introTitle:"How this route works",introSummary:"Kanji move through a chain: sign -> meaning -> reading -> example -> review.",introBody:"Take one small block first, then send it into review. You do not need to hold everything at once.",introBridge:"If something feels hard, that is not failure. It only means the card should return sooner.",introQuestion:"Where do cards go after the lesson?",introQuestionHint:"Choose the correct path.",loading:"Loading the path...",empty:"The path will appear soon.",nextLesson:"Next step",lessonTrack:"Current level",reviewQueue:"Due now",streak:"Streak",level:"Level",xp:"XP",mapHint:"Stay on the current level here. The rest remains in textbooks.",step:"Шаг",finishHint:"After the lesson the cards move to review.",scoreHint:"Retry mistakes or keep moving."}}function Ff(){const e=le();return{id:je,type:"lesson",level:"INTRO",title:{ru:e.introTitle,en:e.introTitle},summary:{ru:e.introSummary,en:e.introSummary},durationMinutes:3}}function Of(){const e=Be();return le(),{id:is,type:"review",level:"SRS",title:{ru:`Повторение: ${e}`,en:`Review: ${e}`},summary:{ru:e>0?"Карточки, которые уже нужно вернуть в память.":"Очередь пуста, можно идти дальше.",en:e>0?"Cards that should return now.":"Queue is empty, move on."},durationMinutes:Math.max(2,Math.min(12,e))}}function Bf(){return{id:os,type:"checkpoint",level:"N5",title:{ru:"Контрольная точка N5",en:"N5 checkpoint"},summary:{ru:"Повторение блока и переход к финальному тесту уровня.",en:"Review the block and move into the level final test."},durationMinutes:12}}function Uf(){return to().map((e,t)=>({id:e,type:"lesson",level:"N5",title:{ru:`N5 · Урок ${t+1}`,en:`N5 · Lesson ${t+1}`},summary:t===0?{ru:"Первый интерактивный урок: 4 знака, чтения, примеры и мини-практика.",en:"First interactive lesson: 4 signs, readings, examples, and mini practice."}:{ru:"Откроем карточки урока прямо из учебника.",en:"Open this lesson directly from the textbook."},durationMinutes:t===0?12:10}))}function Qc(){const e=Ff(),t=Of(),n=Bf(),s=r.n5Textbook?.items?.length?r.n5Textbook.items.map((o,c)=>({id:o.id,type:"lesson",level:"N5",title:o.title,summary:o.goal||o.theme||{ru:"",en:""},durationMinutes:Number(o.durationMinutes||o.estimatedMinutes||10)})):Uf(),a=[e];return Be()>0&&a.push(t),[...a,...s,n]}function Hn(e){const t=String(e||"");return t&&Qc().find(n=>n.id===t)||null}function Vc(e){if(!e)return"locked";if(e.id===is)return Be()>0?"review":"available";const t=cn();return t.completedNodes?.[e.id]?"completed":gs()===e.id?"current":t.unlockedNodes?.[e.id]?e.type==="checkpoint"?"checkpoint":"available":"locked"}function Gf(e){const t=le();return e==="completed"?t.completed:e==="current"?t.current:e==="available"?t.available:e==="review"?t.due:e==="checkpoint"?t.checkpoint:t.locked}function Yc(){const e=cn(),t=Be(),n=so(),s=gs(),a=Hn(s),o=Number(Vt().reviews||0)>=Number(r.progress.settings.dailyGoal||0);return!e.completedNodes?.[je]&&!n?{kind:"node",label:le().start,nodeId:je}:n?.nodeId?{kind:"node",label:le().resume,nodeId:n.nodeId}:t>0?{kind:"review",label:`${le().reviewAction}: ${t}`,nodeId:is}:o&&a?{kind:"node",label:le().next,nodeId:a.id}:a?{kind:"node",label:e.completedNodes?.[je]?le().resume:le().start,nodeId:a.id}:{kind:"review",label:le().reviewOld,nodeId:is}}function Jf(){const e=le(),t=l0(),n=t?.level||tn(),s=t?.lessonId||Sl(n),a=ns(n),o=bg(n);return{label:!!(t?.lessonId||a&&(Object.keys(a.completedLessons||{}).length>0||a.currentLessonId&&a.currentLessonId!==o))?e.resume:e.start,level:n,lessonId:s}}function zf(){const e=en(),t=Be(),n=le();return[{label:n.streak,value:r.progress.streak.current},{label:n.level,value:r.progress.level},{label:n.xp,value:`${e.current}/${e.next}`},{label:n.reviewQueue,value:t}]}function Hf(e){return`
    ...
    `}function Zc(){const e=gs();return{title:Xc(e),summary:Df(e)}}function D(e){const t=String(e);r.progress.cards[t]||(r.progress.cards[t]={state:"New",intervalDays:0,srsStep:-1,easeFactor:2.5,dueAt:null,lastReviewedAt:null,lastRating:null,reviewCount:0,lapses:0,correct:0,wrong:0,successRate:0,history:[]});const n=ji(r.progress.cards[t]);return n.successRate=Ag(n),Number.isFinite(Number(n.srsStep))?n.srsStep=de(Math.trunc(Number(n.srsStep)),-1,63):n.srsStep=ao(n),r.progress.cards[t]=n,n}function tr(e,t="seen"){if(!r.progress||!e?.id)return!1;ce();const n=new Date().toISOString();let s=!1;const a=String(e.id);return r.progress.seenCards[a]||(r.progress.seenCards[a]=n,s=!0),e.kanji&&!r.progress.seenKanji[e.kanji]&&(r.progress.seenKanji[e.kanji]={at:n,cardId:a,source:t,jlpt:e.jlpt||""},s=!0),s}function nr(e,t="seen"){tr(e,t)&&N()}const ft=[5/1440,1/24,12/24,1,2,4],ro=1;function ao(e){const t=Number(e?.intervalDays||0);if(!(t>0))return-1;for(let s=0;s<ft.length;s+=1)if(t<=ft[s]*1.08)return s;const n=ft[ft.length-1];return ft.length-1+Math.max(1,Math.round(Math.log2(t/n)))}function Qf(e){const t=Math.trunc(e);return t<0?0:t<ft.length?ft[t]||ft[0]:ft[ft.length-1]*2**(t-(ft.length-1))}function Vf(e,t,n=ro){const s=Array.isArray(e)?e.slice():[],a=Array.isArray(t)?t.slice():[],o=[],c=Math.max(1,Math.trunc(Number(n)||ro));let l=0,d=0,u=0;for(;l<s.length||d<a.length;){if(u>=c&&d<a.length){o.push(a[d++]),u=0;continue}if(l<s.length){o.push(s[l++]),u+=1;continue}if(d<a.length){o.push(a[d++]),u=0;continue}break}return o}function Yf(e,t){const n=ao(e);return t==="again"?0:t==="hard"?n<1?1:n:t==="easy"?n<0?2:n+2:n<0?0:n+1}function Zf(e){const t=Math.max(1,Math.round(e*24*60));if(t<60)return p()==="ru"?`${t} мин.`:`${t} min`;const n=Math.round(t/60);if(n<24)return p()==="ru"?`${n} ?.`:`${n} h`;const s=Math.round(n/24);return p()==="ru"?`${s} ??.`:`${s} d`}function ka(e){const t=e.state==="Learning"?3:e.state==="Review"?2:e.state==="Mastered"?1:0,n=Number(e.lapses||0),s=Number(e.wrong||0),a=Number(e.correct||0);return t+n*4+s*2-a*.05}function Mt(e,t,n="jlpt_lesson"){if(!t)return!1;const a=ed(e,t).reduce((o,c)=>tr(c,n)||o,!1);return a&&N(),a}function ed(e,t){const n=String(e||"").toUpperCase();return n==="N5"?mn(t):n==="N4"?wr(t):n==="N3"?kr(t):n==="N2"?$r(t):(t?.kanji||[]).map(s=>r.cards.find(a=>a.kanji===s&&String(a.jlpt||"").toUpperCase()===n)).filter(Boolean)}function eh(e){const t=r.progress?.cards?.[String(e?.id||"")];return t?t.state&&t.state!=="New"?!0:!!(t.lastReviewedAt||t.lastReviewedAt||Number(t.reviewCount||0)>0||Number(t.correct||0)>0||Number(t.wrong||0)>0||Number(t.lapses||0)>0):!1}function td(){return ce(),r.progress.evaRoomQuiz}function nd(){const e=[r.cards||[],typeof Dt=="function"?Dt():[],typeof qe=="function"?qe():[],typeof Xe=="function"?Xe():[],typeof Ve=="function"?Ve():[]];return sd(e.flat().filter(Boolean))}function th(){if(!r.progress)return[];ce();const e=new Set(Object.keys(r.progress.seenCards||{})),t=new Set(Object.keys(r.progress.seenKanji||{})),n=new Set(Object.keys(r.progress.lessonCompletions||{})),s=nh(),a=nd().filter(o=>{if(!o?.id||!o.kanji||!Pe(o,"ru")||!Pe(o,"en"))return!1;const c=String(o.jlpt||"").toUpperCase();return e.has(String(o.id))||t.has(o.kanji)||eh(o)||n.has(o.lessonId)||s.has(`${c}:${o.kanji}`)||s.has(o.kanji)});return sd(a)}function nh(){const e=new Set,t=(n,s)=>{if(!s)return;const a=String(n||"").toUpperCase();e.add(String(s)),a&&e.add(`${a}:${s}`)};return io().forEach(n=>{const s=n.course();Object.keys(s.studiedKanji||{}).forEach(a=>t(n.level,a)),Object.keys(s.completedLessons||{}).forEach(a=>{(n.lessonById(a)?.kanji||[]).forEach(c=>t(n.level,c))})}),e}function io(){return[{level:"N5",course:Z,lessonById:wt,markStudied:ys,markDifficult:hr},{level:"N4",course:W,lessonById:hn,markStudied:$s,markDifficult:br},{level:"N3",course:H,lessonById:wn,markStudied:js,markDifficult:yr},{level:"N2",course:q,lessonById:kn,markStudied:Ss,markDifficult:jr}]}function sd(e){const t=new Set;return e.filter(n=>{const s=`${n.kanji}:${Pe(n,"ru")}:${Pe(n,"en")}`;return t.has(s)?!1:(t.add(s),!0)})}function sh(e){!(e instanceof HTMLElement)||e.hasAttribute("disabled")||(e.classList.add("is-action-pressed"),window.requestAnimationFrame(()=>{window.setTimeout(()=>e.classList.remove("is-action-pressed"),120)}))}function rh(e){if(e.target.classList?.contains("detail-backdrop")){P("menu_close"),r.detailCardId=null,oe();return}if(e.target.classList?.contains("final-test-backdrop")){r.finalTestModal=null,r.finalTestBusy=!1,oe();return}if(e.target.classList?.contains("changelog-backdrop")){Fi();return}const t=e.target.closest(".nav-popover, .bottom-nav");if(r.navMenu&&!t&&!e.target.closest("[data-action]")){r.navMenu=null,oe();return}const n=e.target.closest("[data-action]");if(!n)return;const s=n.dataset.action,a=n.dataset.id;if(sh(n),!!_f(n)&&!(["eva-click","eva-autonomy-next","eva-question-answer"].includes(s)&&Date.now()-dc<280)){if(s&&s.endsWith("-complete-lesson")){const c=`${s.split("-")[0]}:${a||""}`;if(ae.has(c)){n&&(n.disabled=!0,n.textContent=p()==="ru"?"Урок завершён":"Lesson completed");return}}if(oo(s),requestAnimationFrame(()=>window.setTimeout(()=>oh(s,n),0)),s==="route"){const o=n.dataset.route;if(n.closest(".bottom-nav")&&Sa(o)){Rh(o);return}r.navMenu=null,o==="writing"&&r.detailCardId&&(r.activeCardId=r.detailCardId),ze(o,n.dataset.focus||null,n.dataset.subroute||null)}if(s==="nav-menu-route"){const o=n.dataset.route;r.navMenu=null,o==="writing"&&r.detailCardId&&(r.activeCardId=r.detailCardId),ze(o,n.dataset.focus||null,n.dataset.subroute||null)}if(s==="share-page"&&yg(n.dataset.shareSection||r.route,r0(n)).catch(()=>J(p()==="ru"?"Не удалось поделиться":"Share failed")),s==="toggle-header-socials"&&Lg(!Al()),s==="notification-center"){if(r.notificationPromptVisible){Rg();return}(r.notificationPrompt?.docked||wi("header"))&&bi("header");return}if(s==="repeat-onboarding"){go({force:!0});return}if(s==="onboarding-next"){wd();return}if(s==="onboarding-prev"){bd();return}if(s==="onboarding-continue"){Ah();return}if(s==="onboarding-close"||s==="onboarding-skip"){ar({completed:s==="onboarding-close"});return}if(s==="dismiss-mascot-speech"){Cp(n.dataset.speechKey||"");return}if(s==="contact-email"&&(r.navMenu=null,r.contactModal=!0,oe()),s==="copy-contact-email"&&Sg(rn).then(o=>{J(o?p()==="ru"?"Email скопирован":"Email copied":p()==="ru"?"Не удалось скопировать email":"Could not copy email")}),s==="close-contact-modal"&&(r.contactModal=!1,oe()),s==="close-changelog"){Fi();return}if(s==="close-pwa-install-help"&&(r.pwaInstallHelpVisible=!1,oe()),s==="close-nav-menu"&&(r.navMenu=null,oe()),s==="close-final-test-modal"&&(r.finalTestModal=null,r.finalTestBusy=!1,r.pendingFocus=null,oe()),s==="final-test-focus-missing"){const o=n.dataset.focus||r.finalTestModal?.focusSelector||null;r.finalTestModal=null,r.finalTestBusy=!1,r.pendingFocus=o,oe()}if(s==="final-test-force-submit"){const o=String(n.dataset.level||r.finalTestModal?.level||"N5").toUpperCase();o==="N4"?$u(!0):o==="N3"?Mu(!0):o==="N2"?Hu(!0):o==="N1"?sp(!0):du(!0)}if(s==="final-test-next-level"){const o=V(n.dataset.nextLevel||""),c=String(n.dataset.nextLesson||"");if(!o||!c)return;r.finalTestModal=null,r.finalTestBusy=!1,r.pendingFocus=null,ci(o,c);return}if(s==="scroll-page-edge"&&((n.dataset.direction||mo())==="up"?ja():Th()),s==="theme"&&L0(),s==="language"&&x0(),s==="sound"&&Ng(),s==="toggle-ux-sound"&&C0(),s==="export"&&s0(),s==="import"&&uc.click(),s==="reset"&&N0(),s==="share-achievement"&&w0().catch(()=>J(A("shareFallback"))),s==="pwa-install"&&Y0(),s==="pwa-later"&&El(),s==="notification-allow"&&sN(),s==="notification-later"&&ki(),s==="mascot-click"&&qj(n.dataset.character),s==="eva-click"&&_p(),s==="eva-dialogue-skip"&&ih(n),s==="dictionary-favorites-tab"&&(r.filters.favorites=n.dataset.favorites||"all",r.dictionaryVisibleCount=zs,oe()),s==="set-learn-jlpt"){r.activeLearnJlpt=String(n.dataset.jlpt||"all").toUpperCase();const o=No();Hd(o),r.activeCardId=null,oe()}if(s==="dictionary-load-more"&&(r.dictionaryVisibleCount+=um,oe()),s==="toggle-favorite"&&IS(a),s==="eva-room-choice"&&Gv(n),s==="eva-question-answer"&&Mv(n),s==="eva-room-reset"&&zv(),s==="toggle-eva-autonomy"&&ew(),s==="cycle-eva-autonomy"&&tw(),s==="eva-autonomy-room-mode"&&nw(),s==="eva-autonomy-outfit-mode"&&sw(),s==="eva-autonomy-next"&&Jd(),s==="eva-autonomy-clear"&&rw(),s==="eva-room-shop-open"&&(r.evaRoomShopOpen=!0,Ne("shop_opened"),oe()),s==="eva-room-shop-close"&&(r.evaRoomShopOpen=!1,oe()),s==="eva-bg-buy"&&Hv(a),s==="eva-bg-select"&&qv(a),s==="eva-sprite-buy"&&Wv(a),s==="eva-sprite-select"&&Xv(a),s==="shop-category"&&(r.shopFilters.category=n.dataset.category||"all",oe()),s==="shop-filter"&&(r.shopFilters.view=n.dataset.filter||"all",oe()),s==="shop-sort"&&(r.shopFilters.sort=n.dataset.sort||"featured",oe()),s==="shop-buy"&&Ma(a),s==="shop-select"&&Pa(a),s==="shop-clear-effect"&&Gd(a),s==="shop-clear-item"&&Yv(a),s==="clear-writing"&&rS(),s==="undo-writing"&&aS(),s==="check-writing"&&iS(!0),s==="replay-writing"&&Dp(),s==="play-writing-step"&&Fp(),s==="writing-step-prev"&&Op(-1),s==="writing-step-next"&&Op(1),s==="select-writing-step"&&Bp(Number(n.dataset.index||0),!0),s==="insert-sentence-tile"&&A$(Number(n.dataset.index)),s==="undo-sentence-tile"&&T$(),s==="clear-sentence"&&I$(),s==="check-sentence"&&R$(),s==="next-sentence"&&M$(),s==="reading-review-tile"&&Vw(Number(n.dataset.index)),s==="reading-review-undo"&&Yw(),s==="reading-review-clear"&&Zw(),s==="reading-review-check"&&iu(),s==="reading-review-answer"&&Qw(n),s==="toggle-reading-translation"&&eb(),s==="add-custom-sentence"&&m$(),s==="edit-custom-sentence"&&h$(n.dataset.id),s==="delete-custom-sentence"&&v$(n.dataset.id),s==="cancel-custom-sentence-edit"&&w$(),s==="insert-jlpt-tile"&&YS(Number(n.dataset.index)),s==="undo-jlpt-tile"&&ZS(),s==="clear-jlpt-practice"&&e0(),s==="check-jlpt-practice"&&t0(),s==="next-jlpt-practice"&&n0(),s==="n5-open-lesson"&&ib(a),s==="n5-overview"&&ob(),s==="n5-review"&&lb(n.dataset.mode||null),s==="n5-answer"&&tb(n),s==="n5-check-input"&&nb(a),s==="n5-srs"&&lu(a,n.dataset.rating||"good",n.dataset.source||"review"),s==="n5-writing-done"&&rb(a),s==="n5-complete-lesson"&&ab(a),s==="jlpt-lesson-answer"&&sb(n.dataset.level||"",n.dataset.lesson||n.dataset.lessonId||"",n.dataset.card||a,String(n.dataset.value||"")==="remember"),s==="n5-final-answer"&&ub(n),s==="n5-final-submit"&&du(),s==="n5-final-reset"&&pb(),s==="n4-open-lesson"&&Kb(a),s==="n4-overview"&&Db(),s==="n4-review"&&Fb(n.dataset.mode||null),s==="n4-kanji"&&Ob(),s==="n4-grammar"&&Bb(),s==="n4-reading"&&Ub(),s==="n4-listening"&&Gb(),s==="n4-final"&&Jb(),s==="n4-answer"&&Tb(n),s==="n4-check-input"&&Ib(a),s==="n4-srs"&&bu(a,n.dataset.rating||"good",n.dataset.source||"review"),s==="n4-writing-done"&&Rb(a),s==="n4-complete-lesson"&&_b(a),s==="n4-grammar-complete"&&Mb(a,n.dataset.value||""),s==="n4-reading-complete"&&Pb(a,n.dataset.question||"",n.dataset.value||""),s==="n4-listening-complete"&&Eb(a,n.dataset.question||"",n.dataset.value||""),s==="n4-final-answer"&&qb(n),s==="n4-final-submit"&&$u(),s==="n4-final-reset"&&Wb(),s==="n3-open-lesson"&&kk(a),s==="n3-overview"&&yk(),s==="n3-review"&&$k(n.dataset.mode||null),s==="n3-kanji"&&jk(),s==="n3-grammar"&&Sk(),s==="n3-reading"&&Nk(),s==="n3-listening"&&Lk(),s==="n3-final"&&xk(),s==="n3-answer"&&gk(n),s==="n3-check-input"&&mk(a),s==="n3-srs"&&Iu(a,n.dataset.rating||"good",n.dataset.source||"review"),s==="n3-writing-done"&&fk(a),s==="n3-complete-lesson"&&hk(a),s==="n3-grammar-complete"&&vk(a,n.dataset.value||""),s==="n3-reading-complete"&&wk(a,n.dataset.question||"",n.dataset.value||""),s==="n3-listening-complete"&&bk(a,n.dataset.question||"",n.dataset.value||""),s==="n3-final-answer"&&Tk(n),s==="n3-final-submit"&&Mu(),s==="n3-final-reset"&&Ik(),s==="n2-open-lesson"&&sy(a),s==="n2-overview"&&ry(),s==="n2-review"&&ay(n.dataset.mode||null),s==="n2-kanji"&&iy(),s==="n2-grammar"&&oy(),s==="n2-reading"&&ly(),s==="n2-listening"&&cy(),s==="n2-final"&&dy(),s==="n2-answer"&&Qk(n),s==="n2-check-input"&&Vk(a),s==="n2-srs"&&Gu(a,n.dataset.rating||"good",n.dataset.source||"review"),s==="n2-writing-done"&&Yk(a),s==="n2-complete-lesson"&&Zk(a),s==="n2-grammar-complete"&&ey(a,n.dataset.value||""),s==="n2-reading-complete"&&ty(a,n.dataset.question||"",n.dataset.value||""),s==="n2-listening-complete"&&ny(a,n.dataset.question||"",n.dataset.value||""),s==="n2-final-answer"&&gy(n),s==="n2-final-submit"&&Hu(),s==="n2-final-reset"&&my(),s==="n1-open-lesson"&&By(a),s==="n1-overview"&&Uy(),s==="n1-review"&&Gy(n.dataset.mode||null),s==="n1-kanji"&&Jy(),s==="n1-grammar"&&zy(),s==="n1-reading"&&Hy(),s==="n1-listening"&&qy(),s==="n1-final"&&Wy(),s==="n1-answer"&&My(n),s==="n1-check-input"&&Py(a),s==="n1-srs"&&ep(a,n.dataset.rating||"good",n.dataset.source||"review"),s==="n1-writing-done"&&Ey(a),s==="n1-complete-lesson"&&Ky(a),s==="n1-grammar-complete"&&Dy(a,n.dataset.value||""),s==="n1-reading-complete"&&Fy(a,n.dataset.question||"",n.dataset.value||""),s==="n1-listening-complete"&&Oy(a,n.dataset.question||"",n.dataset.value||""),s==="n1-final-answer"&&Vy(n),s==="n1-final-submit"&&sp(),s==="n1-final-reset"&&Yy(),s==="review-exercise-next"){Lr(),r.pendingFocus="__scroll-top__",C();return}if(s==="play-kanji-audio"){const o=ne(a)||ne(r.activeCardId);o&&(n.dataset.ttsText||n.dataset.ttsKind?mg(o,{text:n.dataset.ttsText||"",kind:n.dataset.ttsKind||"cycle",label:n.dataset.ttsLabel||"",fallback:()=>gg(o)}):pg(o))}if(s==="open-jlpt-lesson"){const o=String(n.dataset.jlpt||"").toUpperCase();if(Yt(o)){if(!pt(o)){r.activeTextbookLevel=o,r.activeJlptLesson=o,ze("textbooks",null,o),J(Zt(o));return}r.activeJlptLesson=o,ze("jlpt-lesson",null,o)}}if(s==="open-jlpt-lesson-start"&&ci(n.dataset.jlpt||tn()),s==="social-link"&&Tn(`social_${String(n.dataset.network||"").toLowerCase()}_opened`,{network:n.dataset.network||"",section:r.route}),s==="play-audio"&&zS(n.dataset.audio,n.dataset.label),s==="close-reward"&&(r.rewardModal=r.rewardQueue.shift()||null,r.rewardModal&&Pp(r.rewardModal),Ht()),s==="set-goal"&&(r.progress.settings.dailyGoal=Number(n.dataset.goal),N(),J(`${A("dailyGoal")}: ${r.progress.settings.dailyGoal}`),C()),s==="buy-shop"&&Ma(a),s==="start-due"&&(ze("textbooks"),Be()||J(Ee("eva","welcome"))),s==="home-lesson"){const o=V(n.dataset.level||"")||tn(),c=String(n.dataset.lessonId||"");ci(o,c)}if(s==="home-review"&&(Be()?ze("review"):J(p()==="ru"?"Пока нет повторений.":"No reviews are due right now.")),s==="home-primary"&&pw(),s==="learning-path-node"&&qd(n.dataset.node||a),s==="learning-path-back"&&qn(),s==="learning-path-choice"){const o=String(n.dataset.node||""),c=String(n.dataset.step||""),l=String(n.dataset.value||""),d=cr(o),u=d.steps.find(m=>m.id===c);if(!u||u.kind!=="quiz"||d.session.answers?.[c])return;d.session.answers[c]={selected:l,correct:l===u.answer,at:new Date().toISOString()},l===u.answer?d.session.score=Number(d.session.score||0)+1:d.session.mistakes=[...new Set([...d.session.mistakes||[],c])],d.session.updatedAt=new Date().toISOString(),N(),C()}if(s==="learning-path-step-next"){const o=String(n.dataset.node||r.activeLearnNodeId||""),c=cr(o);if(!c.steps.length)return;const l=c.steps[c.session.stepIndex];if(l?.kind==="quiz"&&!c.session.answers?.[l.id])return;c.session.stepIndex=Math.min(c.session.stepIndex+1,c.steps.length),c.session.updatedAt=new Date().toISOString(),N(),C()}if(s==="learning-path-retry"){const o=String(n.dataset.node||r.activeLearnNodeId||""),l=(cr(o).session.mistakes||[]).slice();cn().activeSession=Ji({nodeId:o,mode:"mistakes",stepIndex:0,answers:{},mistakes:[],reviewStepIds:l,score:0,startedAt:new Date().toISOString(),updatedAt:new Date().toISOString()}),N(),C()}if(s==="learning-path-continue"){const o=String(n.dataset.node||r.activeLearnNodeId||""),c=cr(o);vw(o,c.session,c.steps),qn();return}if(s==="start-lesson"||s==="select-lesson"){const o=r.lessons.find(c=>c.id===a);if(!o||!Me(o)){J(`${A("unlockedAt")} ${li(o)}`);return}if(r.activeLessonId=a,r.activeCardId=null,r.revealed=!1,jt(),s==="start-lesson"){Ne("lesson_start",{lessonId:a,jlpt:o.jlpt});const c=String(o.jlpt||"").toUpperCase();/^n[2-5]-lesson-\d+$/i.test(o.id)&&["N5","N4","N3","N2"].includes(c)?(ze("textbooks",null,c),r.activeTextbookSubroute=o.id,history.replaceState(null,"",`#textbooks/${encodeURIComponent(c)}/${encodeURIComponent(o.id)}`),C()):qn(Gt,o.id)}else C()}if(s==="show-answer"&&(nr(ne(r.activeCardId),"show_answer"),r.revealed=!0,jt(),He()),s==="check-reading"){const o=document.getElementById(`readingCheck-${a||r.activeCardId}`);o&&(r.readingCheck.value=o.value,r.readingCheck.cardId=a||r.activeCardId),eg()}if(s==="rate"&&Oj(n.dataset.rating),s==="open-card"&&(nr(ne(a),"card_details"),r.detailCardId=a,C()),s==="open-kanji-page"&&uh(a),s==="close-detail"&&(r.detailCardId=null,oe()),s==="study-card"){const o=ne(a);if(!o)return;nr(o,"study_card"),r.activeLessonId=o.lessonId,r.activeCardId=o.id,r.revealed=!1,jt(o.id),r.detailCardId=null,qn(Gt,o.lessonId)}}}function ah(e){const t=e.target.closest?.('[data-action="eva-click"], [data-action="eva-autonomy-next"]');if(!t||t.disabled)return;const n=t.dataset.action;dc=Date.now(),e.preventDefault(),oo(n),n==="eva-click"&&_p(),n==="eva-autonomy-next"&&Jd()}function oo(e="activity"){r.evaRuntime&&(r.evaRuntime.lastPlayerActionAt=Date.now(),r.evaRuntime.memory=Jn(zt(),r.evaRuntime.memory||{}),r.evaRuntime.memory.lastRoute=r.route,e.startsWith("eva")&&(r.evaRuntime.memory.lastInteractionDate=re()),["eva-autonomy-next","eva-question-answer"].includes(e)&&(r.evaRuntime.lastPlayerActionAt=Date.now()))}function ih(e){if(!r.evaRuntime)return;const t=e?.dataset?.lineId||te().currentLine?.id||"";!t||r.evaRuntime.textRevealSkippedLineId===t||(r.evaRuntime.textRevealSkippedLineId=t,zn(),C())}function oh(e,t){if(!(!e||t?.disabled)&&!lh(e,t)&&!["eva-room-choice","eva-bg-buy","eva-bg-select"].includes(e)){if(e==="eva-room-shop-open"){P("menu_open");return}if(e==="eva-room-shop-close"){P("menu_close");return}if(e==="route"){if(t?.closest(".bottom-nav")&&Sa(t.dataset.route)){P(r.navMenu===t.dataset.route?"menu_close":"menu_open");return}P("tab_switch");return}if(e==="nav-menu-route"){P("tab_switch");return}if(e==="close-nav-menu"){P("menu_close");return}if(e==="toggle-header-socials"){P(Al()?"menu_close":"menu_open");return}if(e==="show-answer"||e==="open-card"){P("card_flip");return}if(["close-reward","close-detail","close-pwa-install-help","pwa-later","notification-later","dismiss-mascot-speech"].includes(e)){P("menu_close");return}if(e==="notification-center"){P("notification_soft");return}if(["start-lesson","select-lesson","next-sentence","study-card","rate","open-jlpt-lesson","n5-open-lesson","n5-overview","n5-review","n4-open-lesson","n4-overview","n4-review","n4-kanji","n4-grammar","n4-reading","n4-listening","n4-final","n3-open-lesson","n3-overview","n3-review","n3-kanji","n3-grammar","n3-reading","n3-listening","n3-final","n2-open-lesson","n2-overview","n2-review","n2-kanji","n2-grammar","n2-reading","n2-listening","n2-final","n1-open-lesson","n1-overview","n1-review","n1-kanji","n1-grammar","n1-reading","n1-listening","n1-final"].includes(e)){P("page_turn");return}if(["n5-answer","n5-check-input","n5-srs","n5-writing-done","n5-complete-lesson","n5-final-answer","n5-final-submit","n4-answer","n4-check-input","n4-srs","n4-writing-done","n4-complete-lesson","n4-grammar-complete","n4-reading-complete","n4-listening-complete","n4-final-answer","n4-final-submit","n3-answer","n3-check-input","n3-srs","n3-writing-done","n3-complete-lesson","n3-grammar-complete","n3-reading-complete","n3-listening-complete","n3-final-answer","n3-final-submit","n2-answer","n2-check-input","n2-srs","n2-writing-done","n2-complete-lesson","n2-grammar-complete","n2-reading-complete","n2-listening-complete","n2-final-answer","n2-final-submit","n1-answer","n1-check-input","n1-srs","n1-writing-done","n1-complete-lesson","n1-grammar-complete","n1-reading-complete","n1-listening-complete","n1-final-answer","n1-final-submit","jlpt-lesson-answer"].includes(e)){P("button_click");return}if(["pwa-install","notification-allow","notification-center","set-goal"].includes(e)){P("notification_soft");return}t?.matches("button, .btn, [role='button']")&&P("button_click"),e!=="toggle-header-socials"&&Lg(!1)}}function lh(e,t){return["learn","review"].includes(r.route)?new Set(["show-answer","rate","check-reading","play-kanji-audio","start-lesson","select-lesson","study-card"]).has(e)||!!t?.closest(".study-card, .study-layout"):!1}function rd(e){oo("input");const t=e.target.closest("[data-ux-volume]");if(t){_0(Number(t.value)/100);const l=document.querySelector("[data-ux-volume-label]");l&&(l.textContent=`${Math.round(gi()*100)}%`);return}const n=e.target.closest("[data-reading-input]");if(n){r.readingCheck={cardId:n.dataset.id||r.activeCardId,value:n.value,status:null,message:""};return}const s=e.target.closest("[data-sentence-draft]");if(s){const l=Ae(),d=s.dataset.sentenceDraft;l.customDraft=wa(l.customDraft||{}),d&&Object.prototype.hasOwnProperty.call(l.customDraft,d)&&(l.customDraft[d]=s.value,l.customMessage="",l.customStatus="",N());return}const a=e.target.closest("[data-filter]");if(!a)return;const o=a.dataset.filter,c=a.selectionStart;r.filters[o]=a.value,r.dictionaryVisibleCount=zs,C(),requestAnimationFrame(()=>{const l=document.getElementById(a.id);l&&(l.focus(),typeof c=="number"&&"setSelectionRange"in l&&l.setSelectionRange(c,c))})}function ch(e){if(xh(e)||dh(e))return;if(e.key==="Escape"&&(r.detailCardId||r.rewardModal||r.finalTestModal||r.contactModal||r.pwaInstallHelpVisible||r.changelogModal||r.navMenu)){r.detailCardId=null,r.rewardModal=null,r.finalTestModal=null,r.contactModal=!1,r.pwaInstallHelpVisible=!1,r.navMenu=null,r.changelogModal?Fi():C();return}const t=e.target.closest?.("[data-reading-input]");!t||e.key!=="Enter"||(e.preventDefault(),r.readingCheck.value=t.value,r.readingCheck.cardId=t.dataset.id||r.activeCardId,eg())}function dh(e){return e.target?.closest?.("input, textarea, select, [contenteditable='true']")||e.ctrlKey||e.metaKey||e.altKey||e.key.length!==1||(la=`${la}${e.key.toLowerCase()}`.slice(-$e.length),la!==$e)?!1:(la="",ad(5e3),!0)}function ad(e=5e3){const t=Math.max(1,Math.min(999999,Math.floor(Number(e)||5e3)));return r.progress?(G(0,t,"cheat:moon_farm"),X(),N(),P("moon_fragment_gain"),J(p()==="ru"?`Чит активирован: +${t} Moon`:`Cheat activated: +${t} Moon`),C(),r.progress.moonFragments):0}function qn(e=Ut,t=null,n=null){r.route="learn",r.activeLearnView=e,r.activeLearnNodeId=e===Ct&&String(t||"")||null,r.activeLearnLegacyLessonId=e===Gt&&String(t||"")||null;const s=e===Ct&&t?`#learn/lesson/${encodeURIComponent(String(t))}`:e===Gt&&t?`#learn/legacy/${encodeURIComponent(String(t))}`:"#learn";location.hash!==s&&history.replaceState(null,"",s),r.activeTextbookLevel=null,r.activeTextbookSubroute=null,r.kanjiPageId=null,r.detailCardId=null,r.revealed=!1,r.navMenu=null,r.finalTestModal=null,r.finalTestBusy=!1,r.contactModal=!1,r.pendingFocus=n,r.evaRoomShopOpen=!1,jt(),Pt(),oe()}function ze(e,t=null,n=null){if(e==="learn"){qn(Ut,null,t);return}if(!Qg(e)){const a=String(e||"");Xr(we("hash","unknown-route",a,a?[a]:[])),tt(a?`#${encodeURIComponent(a)}`:"#not-found"),r.pendingFocus=t,r.navMenu=null,jt(),Pt(),He();return}const s=r.route;if(r.route=e,r.routeMatch=null,r.routeNotFound=null,s!==r.route&&(s==="review"||r.route==="review")&&(r.reviewSession=null),r.route==="textbooks"){const a=n?String(n).toUpperCase():"";if(a&&!V(a)){Xr(we("hash","invalid-parameter",`textbooks/${a}`,["textbooks",a])),tt(`#textbooks/${encodeURIComponent(a)}`),r.pendingFocus=t,He();return}r.activeTextbookLevel=a||null,r.activeTextbookSubroute=null}else if(r.route==="jlpt-lesson"){const a=n?String(n).toUpperCase():r.activeJlptLesson||wN()||"";if(a&&!V(a)){Xr(we("hash","invalid-parameter",`jlpt-lesson/${a}`,["jlpt-lesson",a])),tt(`#jlpt-lesson/${encodeURIComponent(a)}`),r.pendingFocus=t,He();return}r.activeJlptLesson=a||null}else r.activeTextbookLevel=null,r.activeTextbookSubroute=null;if(r.route!=="review"&&Lr(),r.route==="textbooks")tt(Fg(r.activeTextbookLevel||"",r.activeTextbookSubroute||""));else{const a=r.route==="learn"?"#learn":r.route==="jlpt-lesson"&&r.activeJlptLesson?`#jlpt-lesson/${encodeURIComponent(r.activeJlptLesson)}`:`#${r.route}`;tt(a)}r.route!=="kanji"&&(r.kanjiPageId=null),r.detailCardId=null,r.revealed=!1,r.navMenu=null,r.finalTestModal=null,r.finalTestBusy=!1,r.contactModal=!1,r.pendingFocus=t,r.route!=="eva-room"&&(r.evaRoomShopOpen=!1),jt(),Pt(),He(),Ys(r.route)&&ca({route:r.route,delay:0}),r.route==="eva-room"&&Ne("room_opened")}function uh(e){const t=ne(e);if(!t)return;r.route="kanji",r.kanjiPageId=t.id,r.detailCardId=null,r.revealed=!1,r.navMenu=null,r.pendingFocus=null,r.finalTestModal=null,r.finalTestBusy=!1,r.contactModal=!1,r.evaRoomShopOpen=!1,jt();const n=`#kanji/${encodeURIComponent(t.id)}`;tt(n),Pt(),He()}function id(){const e=hm.begin(r.route);ra=!0,aa=null,vS();try{Jh(),gh();let t="";if(r.route===Jl&&(t=lo(r.routeNotFound)),r.route==="home"&&(t=Hh()),r.route==="download"&&(t=Fh()),r.route==="about"&&(t=Bh()),r.route==="learn"&&(t=uw(),r.pendingFocus!=="lesson-tabs"&&requestAnimationFrame(bl)),r.route==="review"&&(t=a$(),r.pendingFocus!=="sentence-practice"&&requestAnimationFrame(bl)),r.route==="dictionary"&&(t=Y$()),r.route==="kanji"&&(t=sj()),r.route==="writing"&&(t=kj(),requestAnimationFrame(eS)),r.route==="stats"&&(t=Sj(),requestAnimationFrame(Ep)),r.route==="achievements"&&(t=xj()),r.route==="eva-room"&&(t=Vh()),r.route==="jlpt-lesson"&&(t=kw()),r.route==="textbooks"&&(t=yw()),t||(t=lo(we("hash","unknown-route",String(r.route||""),r.route?[String(r.route)]:[]))),!e.isCurrent())return;on.innerHTML=`${t}${Eh()}${mh()}`,document.body.classList.toggle("modal-open",!!(r.detailCardId||r.rewardModal||r.finalTestModal||r.contactModal||r.pwaInstallHelpVisible||r.changelogModal)),Dj(),requestAnimationFrame(()=>{Gh(),fo(),Sh()})}catch(t){e.isCurrent()&&(console.error(`[Flash Kanji] route=${r.route} build=${_}`,t?.stack||t),on.innerHTML=od(t))}finally{ra=!1}}function oe(){ls||(ls=requestAnimationFrame(()=>{ls=0,id()}))}function He(){ls&&(cancelAnimationFrame(ls),ls=0),id()}function sr(e,t){if(typeof window>"u")return;const n=Math.max(0,document.documentElement.scrollHeight-window.innerHeight);window.scrollTo({left:Math.max(0,Number(e)||0),top:Math.min(Math.max(0,Number(t)||0),n),behavior:"auto"})}function Ht(){if(typeof window>"u"){He();return}const e=window.scrollX,t=window.scrollY;He(),sr(e,t),requestAnimationFrame(()=>{sr(e,t),requestAnimationFrame(()=>sr(e,t))}),window.setTimeout(()=>sr(e,t),120),window.setTimeout(()=>sr(e,t),320)}function C(){oe()}function od(e){const t=e instanceof Error?e.message:String(e||"Unknown route error");return`<section class="page empty-state" data-route-error="${g(r.route)}"><h1>${i(p()==="ru"?"Не удалось открыть раздел":"Could not open this section")}</h1><p>${i(t)}</p><button class="btn primary" type="button" data-action="route" data-route="home">${i(p()==="ru"?"На главную":"Home")}</button></section>`}function lo(e=r.routeNotFound){ph();const t=p()==="ru",n=e?.reason||"unknown-route",s={"unknown-locale":t?"Язык из адреса не зарегистрирован для Flash Kanji.":"The URL locale is not registered in Flash Kanji.","unknown-route":t?"Такого раздела или шаблона URL нет в реестре маршрутов.":"This section or URL pattern is not registered.","invalid-parameter":t?"Параметр в адресе имеет неверный формат.":"A URL parameter has an invalid format.","entity-not-found":t?"Адрес похож на правильный, но такой страницы или сущности нет в данных.":"The URL shape is known, but the referenced page or entity does not exist."},a=e?.raw||location.pathname||location.hash||"";return`
    ...
    `}function ph(){document.title=(p()==="ru","404 — Flash Kanji"),ld("robots","noindex, follow"),cd("/404.html")}function gh(){r.route!==Jl&&(document.title=bm,ld("robots","index, follow"),cd("/"))}function ld(e,t){let n=document.querySelector(`meta[name="${e}"]`);n||(n=document.createElement("meta"),n.setAttribute("name",e),document.head.append(n)),n.setAttribute("content",t)}function cd(e){let t=document.querySelector('link[rel="canonical"]');t||(t=document.createElement("link"),t.setAttribute("rel","canonical"),document.head.append(t)),t.setAttribute("href",new URL(e,location.origin).href)}function mh(){const e=`${Uh()}${$j()}${Tj()}${D$()}${Ij()}${Rj()}${_j()}${Mj()}${Pj()}${Ih()}`;return e?`<div class="modal-layer">${e}</div>`:""}function dd(){return ue?.isConnected?ue:document.body?(ue||(ue=document.createElement("div"),ue.className="flash-kanji-onboarding-root",ue.setAttribute("role","presentation"),ue.setAttribute("aria-hidden","false")),ue.isConnected||document.body.appendChild(ue),ue):null}const co=[{target:null,title:{ru:"Добро пожаловать",en:"Welcome"},text:{ru:"Привет! Я Ева. Быстро покажу, где что находится и как пользоваться Flash Kanji.",en:"Hi! I am Eva. I will quickly show you where everything is and how Flash Kanji works."}},{target:"[data-tour='home-lesson']",title:{ru:"Учебники",en:"Textbooks"},text:{ru:"Это главный вход в Flash Kanji. Здесь открываются учебники N5-N1 и путь к урокам каждого уровня.",en:"This is the main entrance to Flash Kanji. Open N5-N1 textbooks here and continue into each level's lessons."}},{target:"[data-tour='srs-review']",title:{ru:"Повторение",en:"Review"},text:{ru:"Изученные карточки возвращаются в повторение, чтобы закрепляться в памяти.",en:"Learned cards come back here for spaced repetition so they stay in memory."}},{target:"[data-tour='dictionary']",title:{ru:"Словарь",en:"Dictionary"},text:{ru:"В словаре можно посмотреть значения, чтения, примеры и подробности по каждому кандзи.",en:"The dictionary lets you check meanings, readings, examples, and kanji details."}},{target:["[data-tour='eva-room']","[data-tour='profile-progress']","[data-tour='profile-progress-nav']"],title:{ru:"Комната Евы",en:"Eva room"},text:e=>e?.dataset?.tour==="eva-room"?{ru:"Это моя комната. Здесь можно поговорить со мной, менять облик и тратить Moon Fragments.",en:"This is my room. You can talk to me here, change the look, and spend Moon Fragments."}:{ru:"Если комнаты Евы на этой странице нет, посмотри на стрик и статистику.",en:"If Eva Room is not on this page, check the streak and progress stats instead."}}],ya={title:{ru:"Готово!",en:"All set!"},text:{ru:"Открой учебники и начни с N5. Я рядом.",en:"Open the textbooks and start with N5. I will be right here."},start:{ru:"Открыть учебники",en:"Open textbooks"},close:{ru:"Закрыть",en:"Close"}};function ud(){try{return localStorage.getItem(Wl)==="true"}catch{return!1}}function fh(){try{return localStorage.getItem(Ql)||""}catch{return""}}function $a(e){try{localStorage.setItem(Ql,e)}catch(t){console.warn("Could not save onboarding audience.",t)}}function hh(e=r.progress){return e?Number(e.appOpens||0)>0||Object.keys(e.lessonCompletions||{}).length>0||Object.keys(e.cards||{}).length>0||Object.keys(e.seenKanji||{}).length>0||Object.keys(e.daily||{}).length>0||Object.keys(e.favorites||{}).length>0||Object.keys(e.transactions||{}).length>0||Number(e.totalMoonFragmentsEarned||0)>0||Number(e.secrets?.evaClicks||0)>0||(e.secrets?.nightVisit?1:0)>0||Number(e.visits?.streak||0)>0||Number(e.visits?.bestStreak||0)>0:!1}function vh(e=!1){const t=fh();return t==="returning"||t==="completed"?t:ud()?($a("completed"),"completed"):e?($a("returning"),"returning"):($a("new"),"new")}function pd(){return!ud()}function wh(){try{localStorage.getItem(Xl)==="true"&&localStorage.removeItem(Xl)}catch(e){console.warn("Could not clear legacy onboarding state.",e)}}function bh(){try{localStorage.setItem(Wl,"true"),$a("completed")}catch(e){console.warn("Could not save onboarding completion.",e)}}function gd(){return mt}function rr(){return co.length}function uo(){return co[de(Tt,0,rr()-1)]||co[0]}function kh(e=uo()){return e?.target?Array.isArray(e.target)?e.target:[e.target]:[]}function yh(e){if(!(e instanceof HTMLElement))return!1;const t=window.getComputedStyle(e);return t.display==="none"||t.visibility==="hidden"||Number(t.opacity||"1")<=0?!1:e.getClientRects().length>0}function md(e=uo()){for(const t of kh(e)){const s=Array.from(document.querySelectorAll(t)).find(a=>yh(a));if(s)return s}return null}function fd(e,t=null){return typeof e=="function"?fd(e(t),t):f(e||{ru:"",en:""})}function $h(){return typeof window.matchMedia=="function"&&window.matchMedia("(prefers-reduced-motion: reduce)").matches}function jh(){return!(mt||!r.progress||!r.i18n||!r.lessons.length||!document.body||document.visibilityState!=="visible"||r.detailCardId||r.rewardModal||r.finalTestModal||r.contactModal||r.changelogModal||r.navMenu)}function po(e=!1,t=cm){clearTimeout(cs),!(!e&&!pd())&&(cs=window.setTimeout(()=>{cs=0,go({force:e})},t))}function go(e={}){const t=!!e.force;let n=!1;if(mt){if(!t)return!0;ar({completed:!1,silent:!0})}if(!t&&!pd())return!1;if(!jh())return po(t,Vl),!1;clearTimeout(cs);try{Ai=document.activeElement instanceof HTMLElement?document.activeElement:null,mt=!0,be="step",Tt=0,document.body.classList.add("onboarding-open");const s=document.querySelector(".app-shell");if(s){s.setAttribute("aria-hidden","true");try{s.inert=!0}catch(a){console.warn("Could not make the app shell inert.",a)}}return dd(),ms(),hd(),n=!0,window.addEventListener("scroll",dn,{passive:!0}),window.addEventListener("resize",dn),window.addEventListener("orientationchange",dn),dn(),vd(),!0}catch(s){return console.error("Flash Kanji onboarding failed to start.",s),ar({completed:!1,silent:!0}),n||po(t,Vl),!1}}function ar(e={}){const{completed:t=!0,silent:n=!1,routeTo:s=null}=e;clearTimeout(cs),cs=0,cancelAnimationFrame(qs),qs=0,window.removeEventListener("scroll",dn),window.removeEventListener("resize",dn),window.removeEventListener("orientationchange",dn),It&&It.classList.remove("is-onboarding-target"),It=null,mt=!1,be="step",Tt=0,ue&&(ue.remove(),ue=null,Je=null,Le=null),document.body.classList.remove("onboarding-open");const a=document.querySelector(".app-shell");if(a){a.removeAttribute("aria-hidden");try{a.inert=!1}catch(o){console.warn("Could not restore app shell interactivity.",o)}}t&&bh(),n||(s?ze(s):C()),Ai?.focus&&requestAnimationFrame(()=>{try{Ai.focus()}catch(o){console.warn("Could not restore onboarding focus.",o)}})}function ms(){if(!dd())return;const e=be==="final"?null:uo(),t=be==="final"?null:md(e),n=be==="final"?ya.title:e.title,s=be==="final"?ya.text:fd(e.text,t),a=be==="final"?p()==="ru"?"Готово":"Done":`${Tt+1} ${p()==="ru"?"из":"of"} ${rr()}`,o=f(n),c=f(s),l=Va("eva","calm","welcome"),d=rr();ue.classList.toggle("is-final",be==="final"),ue.classList.toggle("has-target",!!t),ue.dataset.view=be;const u=be==="final"?`
    ...
    `,Je=xe("[data-onboarding-spotlight]",ue),Le=xe(".flash-kanji-onboarding-dialog",ue),It&&It!==t&&It.classList.remove("is-onboarding-target"),It=t||null,It&&It.classList.add("is-onboarding-target"),Le&&(Le.dataset.totalSteps=String(d)),dn()}function dn(){mt&&(qs||(qs=requestAnimationFrame(()=>{qs=0,hd()})))}function hd(){if(!mt||!ue||!Le)return;const e=be==="final"?null:It||md();$h();const t=window.innerWidth,n=window.innerHeight;if(Le.style.maxWidth=`${Math.min(dm,Math.max(280,t-16))}px`,Le.style.maxHeight=`${Math.max(180,n-24)}px`,Le.style.left="50%",Le.style.top="50%",Le.style.transform="translate(-50%, -50%)",Le.dataset.placement="center",e){const s=e.isConnected?e.getBoundingClientRect():null;!!s&&s.top>=8&&s.bottom<=n-8&&s.left>=8&&s.right<=t-8&&Je?(Je.hidden=!1,Je.style.left=`${Math.round(s.left-12)}px`,Je.style.top=`${Math.round(s.top-12)}px`,Je.style.width=`${Math.round(s.width+12*2)}px`,Je.style.height=`${Math.round(s.height+12*2)}px`,Je.style.borderRadius=`${Math.max(6,Math.round(parseFloat(getComputedStyle(e).borderRadius||"8")||8))}px`):Je&&(Je.hidden=!0)}else Je&&(Je.hidden=!0);ue.style.visibility="visible",vd()}function Sh(){mt&&ms()}function vd(){if(!Le)return;const e=Le.querySelector('[data-action="onboarding-next"], [data-action="onboarding-continue"], [data-action="onboarding-start"], [data-action="onboarding-prev"]'),t=Le.querySelectorAll("button"),n=e||t[0]||Le;try{n.focus?.()}catch(s){console.warn("Could not focus onboarding control.",s)}}function Nh(){return Le?Array.from(Le.querySelectorAll('button:not([disabled]), [href], [tabindex]:not([tabindex="-1"])')).filter(e=>e instanceof HTMLElement):[]}function Lh(e=1){const t=Nh();if(!t.length)return;const n=document.activeElement,s=t.indexOf(n),a=s===-1?e>0?0:t.length-1:(s+e+t.length)%t.length;t[a]?.focus?.()}function xh(e){return mt?e.key==="Tab"?(e.preventDefault(),Lh(e.shiftKey?-1:1),!0):e.key==="Escape"?(e.preventDefault(),ar({completed:be==="final"}),!0):e.key==="ArrowRight"?(e.preventDefault(),wd(),!0):e.key==="ArrowLeft"?(e.preventDefault(),bd(),!0):!1:!1}function wd(){if(!mt)return;const e=rr()-1;if(be!=="final"){if(Tt<e){Tt+=1,ms();return}be="final",ms()}}function bd(){if(mt){if(be==="final"){be="step",Tt=rr()-1,ms();return}Tt>0&&(Tt-=1,ms())}}function Ch(e=null){ar({completed:!0,routeTo:e})}function Ah(){Ch("textbooks")}function ja(){if(typeof window>"u")return;const e=document.scrollingElement||document.documentElement;e&&(e.scrollTop=0),document.body&&(document.body.scrollTop=0),window.scrollTo({top:0,left:0,behavior:"auto"})}function Pt(){typeof window>"u"||requestAnimationFrame(()=>requestAnimationFrame(()=>ja()))}function Th(){if(typeof window>"u")return;const e=Math.max(0,document.documentElement.scrollHeight-window.innerHeight);window.scrollTo({top:e,behavior:"auto"})}function kd(){return typeof window>"u"||!document.documentElement?!1:document.documentElement.scrollHeight>window.innerHeight+24}function mo(){return kd()?window.scrollY>32?"up":"down":null}function Ih(){const e=mo()||"down",t=kd()?"":" hidden",n=p()==="ru",s=e==="up"?n?"Наверх":"Scroll to top":n?"Вниз":"Scroll to bottom",a=e==="up"?"↑":"↓";return`
            ...
            <section class="site-footer-section">
              ...
              <div class="site-footer-socials" aria-label="${g(e?"Социальные ссылки":"Social links")}">
                <a class="btn ghost footer-social-link" href="${g(sn.youtube)}" target="_blank" rel="noopener noreferrer">
                  <span class="btn-icon" aria-hidden="true">${kg("youtube")}</span>
                  <span>YouTube</span>
                </a>
                <a class="btn ghost footer-social-link" href="${g(sn.instagram)}" target="_blank" rel="noopener noreferrer">
                  <span class="btn-icon" aria-hidden="true">${kg("instagram")}</span>
                  <span>Instagram</span>
                </a>
              </div>
            </section>
        ...
        <article class="home-hero-card download-hero-card" data-section="download-top" aria-labelledby="downloadTitle">
          ...
          <div class="home-hero-copy download-hero-copy">
            ...
            <div class="hero-actions home-hero-actions">
              <a class="btn primary home-primary-cta apk-download" href="${g(sm)}" target="_blank" rel="noopener noreferrer">
          ...
          <figure class="download-app-preview">
            <img src="${g(am)}" alt="${g(e.screenshotAlt)}" loading="eager" decoding="async" />
          </figure>
        </article>
    ...
    `}function Uh(){const e=yd(r.navMenu);if(!e.length)return"";const t=r.navMenu,n=t?ho(t):"";return`
    ...
    `}function Gh(){if(!r.pendingFocus)return;const e=r.pendingFocus;if(r.pendingFocus=null,e==="__scroll-top__"){Pt();return}const t={"lesson-card":".study-card, .daily-lesson-card","lesson-tabs":".lesson-tabs","review-card":"[data-section='review-card']","sentence-practice":"[data-section='sentence-practice']","writing-demo":"[data-section='writing-demo']","writing-canvas":"[data-section='writing-canvas']","eva-room":".eva-room-entry, .eva-room-page, .eva-room-shell",about:".about-page","download-top":"[data-section='download-top']","stats-top":".metric-grid","achievements-top":".achievements-page .metric-grid","shop-panel":"[data-section='shop-panel']"},n=document.querySelector(t[e]||e);n&&(n.scrollIntoView({behavior:"smooth",block:"start"}),n.classList.add("is-focus-pulse"),window.setTimeout(()=>n.classList.remove("is-focus-pulse"),900))}function Jh(){Ki(".nav-btn").forEach(t=>{const n=t.dataset.route,s=n===r.route||n==="learn"&&r.route==="textbooks"||n==="stats"&&r.route==="achievements"||n==="dictionary"&&r.route==="kanji";t.classList.toggle("is-active",s),t.classList.toggle("has-menu",!!t.closest(".bottom-nav")&&Sa(n)),t.setAttribute("aria-expanded",r.navMenu===n?"true":"false"),s?t.setAttribute("aria-current","page"):t.removeAttribute("aria-current");const a=t.querySelector("small");a&&n&&(a.textContent=ho(n))});const e=xe('[data-action="language"]');e&&(e.textContent=p().toUpperCase()),xl(),R0(),Cl(),zh()}function zh(){const e=xe("#sidebarProgressBar"),t=xe("#sidebarProgressLabel"),n=xe("#sidebarProgressPercent"),s=xe("#sidebarProgressNote"),a=xe("#sidebarUserAvatar"),o=xe("#sidebarUserTitle"),c=xe("#sidebarUserSubtitle"),l=en(),d=Zc(),u=Be(),m=Math.max(1,Number(r.progress?.level||1)),v=Math.max(0,Math.min(100,Math.round(l.percent||0)));e&&(e.max=100,e.value=v),t&&(t.textContent=`${p()==="ru"?"Уровень":"Level"} ${m}`),n&&(n.textContent=`${v}%`),s&&(s.textContent=u>0?`${u} ${le().reviewQueue} · ${d.title||le().mapHint}`:`${d.title||le().mapHint}${d.summary?` · ${d.summary}`:""}`),a&&(a.textContent=`N${m}`),o&&(o.textContent=(p()==="ru","Flash Kanji")),c&&(c.textContent=`${le().level} ${m} · ${r.progress?.streak?.current||0} ${le().streak}`)}function Hh(){r.n5Textbook?.items?.length||no();const e=qh(),t=Jf(),n=Be(),s=Zc(),a=zf(),o=le(),c=en(),l=Math.max(0,Math.min(100,Math.round(c.percent||0))),d=p()==="ru",u=d?[{action:"home-review",icon:"↻",title:"Повторение",detail:n>0?`${n} карточек ждут тебя.`:"Очередь пуста, но тренировка всегда под рукой.",count:n},{action:"home-lesson",icon:"文",title:t.label,detail:s.title||o.mapHint,count:r.progress.level,level:t.level,lessonId:t.lessonId||""},{action:"route",route:"eva-room",icon:"☾",title:"Комната Евы",detail:"Диалоги, фон и Moon Fragments.",count:r.progress.moonFragments}]:[{action:"home-review",icon:"↻",title:"Review",detail:n>0?`${n} cards are waiting.`:"The queue is empty, but practice is always ready.",count:n},{action:"home-lesson",icon:"文",title:t.label,detail:s.title||o.mapHint,count:r.progress.level,level:t.level,lessonId:t.lessonId||""},{action:"route",route:"eva-room",icon:"☾",title:"Eva Room",detail:"Dialogue, backgrounds, and Moon Fragments.",count:r.progress.moonFragments}],m=Ig();return`
    ...
    `}function qh(){Wh();const e=te(),t=e.currentLine||r.evaRuntime?.currentPhrase||null,n=_a(),s=f(Fs("eva").name||{ru:"Ева",en:"Eva"}),a=r.evaRuntime?.mood||e.mood||Et().mood,o=r.evaRuntime?.emotion||e.emotion||t?.emotion||"calm",c=t?.state||r.evaRuntime?.presenceState||(n?"wait_choice":"speak"),l=ws(t?.sprite||r.evaRuntime?.currentSkin||vo());return{line:t,question:n,speaker:s,mood:a,emotion:o,presenceState:c,sprite:l}}function Wh(){ce();const e=te();return e.currentLine?.text||r.evaRuntime?.currentPhrase?.text?e.currentLine||r.evaRuntime.currentPhrase:(zd("manual"),te().currentLine||r.evaRuntime?.currentPhrase||null)}function Xh(e){const t=pn(),n=un(),s=e.question?p()==="ru"?"Вопрос":"Question":p()==="ru"?"Диалог":"Dialogue",a=e.line||{text:{ru:"Я здесь.",en:"I'm here."}},o=a.id||"home_eva_line";return`
      <section class="home-eva-vn" role="region" aria-label="${g(p()==="ru"?"Диалог Евы":"Eva dialogue")}" data-home-eva-mode="${g(e.question?"question":"dialogue")}" data-eva-state="${g(e.presenceState)}" data-eva-mood="${g(e.mood)}" data-eva-emotion="${g(e.emotion)}">
        <div class="home-eva-copy">
          ...
          ${Sd(f(a.text||{ru:"Я здесь.",en:"I'm here."}),o)}
          ${e.question?`
        ...
        <button class="home-eva-avatar" type="button" data-action="eva-click" data-character="eva" aria-label="${g(e.speaker)}">
          <img class="${g(jd({line:e.line,isAutonomy:!0}))}" src="${g(e.sprite)}" alt="${g(e.speaker)}" loading="eager" decoding="async" onerror="this.src='assets/mascots/eva_normal.webp'" />
        </button>
      </section>
    `}function $d(e){return e.line?.state||r.evaRuntime?.presenceState||(e.isAutonomy?"speak":"wait_choice")}function jd(e){const t=["eva-vn-sprite"],n=$d(e);return["speak","soften","warning"].includes(n)&&t.push("is-speaking"),(["react","warning"].includes(n)||Date.now()-Number(r.evaRuntime?.lastVisualChangeAt||0)<1400)&&t.push("is-reacting"),n==="quiet"&&t.push("is-quiet"),t.join(" ")}function Qh(e){const t=String(e||"").trim();return t?(t.match(/[^.!?гЂ'пјЃпјџ]+[.!?гЂ'пјЃпјџ]?/g)||[t]).map(s=>s.trim()).filter(Boolean):[]}function Sd(e,t=""){const n=Qh(e),a=`eva-dialogue-text ${r.evaRuntime?.textRevealSkippedLineId===t?"is-skipped":""}`,o=n.length?n.map((c,l)=>`<span class="eva-line-piece" style="--i:${l}">${i(c)}</span>`).join(" "):i(e);return`<p class="${a}" data-action="eva-dialogue-skip" data-line-id="${g(t)}">${o}</p>`}function Vh(){ce(),ir(),ur(),X();const e=Uv(),t=e.node,n=qt()||e.bg||hs(t.background),s=e.sprite||e.spriteSrc||ws(e.spriteId||gn(t.sprite)),a=pn(),o=un(),c=Array.isArray(t.choices)?t.choices:[],l=$d(e),d=e.line?.id||t.id||"eva_dialogue";return`
      <section class="page eva-room-page">
        ...
        <article class="eva-vn-scene ${e.isAutonomy?"is-autonomous":""} is-${g(l)}" data-eva-state="${g(l)}" data-eva-mood="${g(e.mood||Et().mood)}" data-eva-emotion="${g(e.emotion||"calm")}" style="--eva-bg:url('${g(n.file)}')">
          ...
          <button class="eva-sprite-button" type="button" data-action="eva-click" aria-label="${g(f(t.speaker||{ru:"Ева",en:"Eva"}))}">
            <img class="${g(jd(e))}" src="${g(s)}" alt="${g(f(t.speaker||{ru:"Ева",en:"Eva"}))}" onerror="this.src='assets/mascots/eva_normal.webp'" />
          </button>
          ${Zh(e)}
        ...
        ${r.evaRoomShopOpen?Yh():""}
      </section>
    `}function Yh(){const e=pn();return`
      <aside class="eva-shop-panel customization-shop-panel" role="dialog" aria-label="${g(e.shop)}">
        ${Nd({closable:!0})}
      </aside>
    `}function Zh(e={}){const t=ev(e);return t?`
      <div class="eva-room-decoration deco-${g(t.id)}" aria-label="${g(ht(t))}">
        <img src="${g(t.asset||t.preview)}" alt="" loading="lazy" />
      </div>
    `:""}function ev(e={}){const t=e.decoration||te().currentDecoration||r.customization?.selected?.decoration||r.customization?.selected?.frame,n=ge(t);return!n||n.type!=="decoration"||!Kt(n.id)?null:n}function Nd(e={}){const t=fs(),n=rv(),s=st().filter(a=>Kt(a.id)).length;return`
      <div class="custom-shop">
        ...
        <div class="custom-shop-grid">
          ${n.map(av).join("")||`<article class="empty-state"><h3>${i(t.empty)}</h3></article>`}
        </div>
        <div class="custom-shop-history">
          ${Np({limit:6})}
        </div>
      </div>
    `}function tv(){return r.customizationCatalog?.categories?.length?r.customizationCatalog.categories:[{id:"all",title_ru:"Все",title_en:"All"},{id:"background",title_ru:"Фоны",title_en:"Backgrounds"},{id:"outfit",title_ru:"Образы",title_en:"Outfits"},{id:"decoration",title_ru:"Декор",title_en:"Decorations"},{id:"theme",title_ru:"Темы",title_en:"Themes"},{id:"effect",title_ru:"Эффекты",title_en:"Effects"}]}function nv(){const e=p()==="ru";return[{id:"all",title:e?"Все":"All"},{id:"available",title:e?"Доступные":"Available"},{id:"owned",title:e?"Купленные":"Owned"},{id:"new",title:e?"Новые":"New"}]}function sv(){const e=p()==="ru";return[{id:"featured",title:e?"Рекомендовано":"Featured"},{id:"price",title:e?"По цене":"By price"},{id:"rarity",title:e?"По редкости":"By rarity"}]}function rv(){const e=r.shopFilters.category||"all",t=r.shopFilters.view||"all",n={common:1,rare:2,epic:3,legendary:4,mythic:5};let s=st().filter(a=>e==="all"||a.type===e);return t==="available"&&(s=s.filter(a=>Ud(a)==="available")),t==="owned"&&(s=s.filter(a=>Kt(a.id))),t==="new"&&(s=s.filter(a=>!r.customization?.seen?.includes(a.id))),r.shopFilters.sort==="price"&&(s=[...s].sort((a,o)=>a.price-o.price)),r.shopFilters.sort==="rarity"&&(s=[...s].sort((a,o)=>(n[o.rarity]||0)-(n[a.rarity]||0)||a.price-o.price)),s}function av(e){const t=Ud(e),n=fs(),s=n.status[t]||t,a=Zv(e),o=t==="available"?`<button class="btn primary" type="button" data-action="shop-buy" data-id="${g(e.id)}">${i(n.buy)}</button>`:t==="owned"?`<button class="btn" type="button" data-action="shop-select" data-id="${g(e.id)}">${i(n.select)}</button>`:t==="selected"?`<button class="btn warning" type="button" data-action="shop-clear-item" data-id="${g(e.id)}">${i(n.remove)}</button>`:`<button class="btn" type="button" disabled>${i(n.unavailable)}</button>`;return`
      <article class="custom-shop-card type-${g(e.type)} is-${g(t)} rarity-${g(e.rarity)}">
        <div class="custom-shop-preview">
          ...
          <span class="rarity-badge">${i(ov(e.rarity))}</span>
        </div>
    ...
    `}function dv(e){const t=un(),n=_a();return n?.id?`
    ...
    `}function aw(e){const t=fl(e.id),n=t.filter(d=>D(d.id).state!=="New").length,s=t.filter(d=>D(d.id).state==="Mastered").length,a=!Me(e),o=fg(e),c=a?"鎖":t[0]?.kanji||"文",l=E(s,t.length);return`
    ...
    `}function iw(e){const t=fg(e),n=e.id===r.activeLessonId,s=!Me(e);return`
      <button class="btn ${n?"primary":"ghost"} ${s?"is-disabled":""} ${yl(t)}" type="button" data-action="select-lesson" data-id="${g(e.id)}" title="${g($l(t))}">
        <span>${i(e.jlpt)}</span>
        ${HS(t)}
      </button>
    `}function No(){const e=String(r.activeLearnJlpt||"all").toUpperCase();return r.lessons.filter(t=>e==="ALL"||String(t.jlpt||"").toUpperCase()===e)}function ow(){const e=No();return e.find(t=>t.id===r.activeLessonId)||e.find(t=>Me(t))||e[0]||r.lessons.find(t=>t.id===r.activeLessonId)||r.lessons.find(t=>Me(t))||r.lessons[0]||null}function Lo(){return V(ow()?.jlpt)||tn()}function Hd(e){if(!e.length)return r.activeLessonId=null,null;const t=e.find(a=>a.id===r.activeLessonId);if(t&&Me(t))return t;const s=e.find(a=>Me(a))||e[0];return r.activeLessonId=s?.id||null,s||null}function lw(e){const t=e.length,n=e.filter(a=>Me(a)).length,s=["all",...Ke];return`
    ...
    `}function cw(e){if(!e)return"";const t=e.textbook||e;return`
    ...
    `}function dw(e){const t=St(e?.jlpt);return`
    ...
    `}function uw(){return r.activeLearnView===Gt?bw():r.activeLearnView===Ct?ww():Xd()}function pw(){const e=Yc();if(e.kind==="review"){ze("review");return}if(r.route==="home"){ci(Lo());return}qd(e.nodeId)}function qd(e){const t=Hn(e);if(!t){qn();return}if(Vc(t)==="locked"){J(p()==="ru"?"Сначала закончи предыдущий шаг.":"Finish the previous step first.");return}if(t.id===is){ze("review");return}if(t.id===os){vr("final-test");return}if(t.type==="textbook"){vr(t.id);return}qn(Ct,t.id)}function Wd(e){const t=String(e||"");return t&&(ne(t)||r.cards.find(n=>String(n.id)===t))||null}function gw(){const e=le();return[{id:"intro-1",kind:"info",eyebrow:e.intro,title:e.introTitle,text:e.introBody,note:e.finishHint},{id:"intro-2",kind:"info",eyebrow:e.route,title:e.nextLesson,text:e.introBridge,note:e.mapHint},{id:"intro-3",kind:"quiz",eyebrow:e.ready,title:e.introQuestion,text:e.introQuestionHint,answer:"review",options:[{value:"review",label:{ru:"В повторение",en:"Into review"}},{value:"memory",label:{ru:"В архив навсегда",en:"Into permanent archive"}},{value:"skip",label:{ru:"Никуда, пока не забудешь",en:"Nowhere, until you forget"}}]}]}function lr(e){const t=wt(e);if(!t)return null;const n=mn(t);if(!n.length)return null;const s=Array.isArray(t.sentences)?t.sentences:[],a=n.map((o,c)=>{const l=bt(o)[0]||null,d=s[c%Math.max(s.length,1)]||s[0]||null,u=l?{jp:l.word||o.kanji,hiragana:l.reading||o.hiragana||"",translation:l.translation||(d?{ru:d.ru||"",en:d.en||""}:"")}:d?{jp:d.jp||o.kanji,hiragana:Q(d.reading||d.hiragana||o.hiragana||""),translation:{ru:d.ru||"",en:d.en||""}}:{jp:o.kanji,hiragana:o.hiragana||"",translation:{ru:R(o),en:R(o)}};return{cardId:o.id,sentence:u}});return{id:t.id,title:t.title,summary:t.goal||t.theme||t.title,objectives:[t.goal,t.theme].filter(Boolean),kanjiIds:n.map(o=>o.id),kanjiBlocks:a,exercises:gr(t),source:"learning_path"}}function mw(e){if(e===je)return gw();const t=r.learningPathLessonPayloads[e]||lr(e);if(!t)return[];const n=le(),s=[],a=(t.objectives||[]).map(f).filter(Boolean).slice(0,3).join(" • ");return s.push({id:`${e}-overview`,kind:"info",eyebrow:"N5",title:f(t.title),text:f(t.summary),note:a||n.finishHint}),(t.kanjiBlocks||[]).forEach((o,c)=>{const l=Wd(o.cardId);if(!l)return;const d=o.sentence||null;s.push({id:`${e}-kanji-${c+1}`,kind:"kanji",eyebrow:l.jlpt||"N5",title:`${l.kanji} · ${R(l)}`,text:zw(l,{word:d?.jp||l.kanji,reading:d?.hiragana||l.hiragana||""}),note:d?.translation?f(d.translation):"",cardId:l.id,card:l,sentence:d})}),(t.exercises||[]).forEach(o=>{const c=(o.options||[]).map(l=>({value:String(l.value??l.id??l.label??l),label:f(l.label||l.text||l)}));s.push({id:String(o.id||`${e}-quiz-${s.length}`),kind:"quiz",eyebrow:"N5",title:f(o.prompt),text:f(o.promptHint||{ru:"",en:""}),answer:String(o.answer??""),options:c})}),s}function fw(e,t=null){const n=mw(e);if(!t||t.mode!=="mistakes"||!t.reviewStepIds?.length)return n;const s=new Set(t.reviewStepIds),a=n.filter(o=>o.kind==="quiz"&&s.has(o.id));return a.length?a:n.filter(o=>o.kind==="quiz")}function hw(e,t=Ct,n=[]){const s=cn(),a=s.activeSession,o=n.map(String).filter(Boolean);return a?.nodeId===e&&a.mode===t&&JSON.stringify(a.reviewStepIds||[])===JSON.stringify(o)?a:(s.activeSession=Ji({nodeId:e,mode:t,stepIndex:0,answers:{},mistakes:[],reviewStepIds:o,score:0,startedAt:new Date().toISOString(),updatedAt:new Date().toISOString()}),s.lastUpdatedAt=s.activeSession.updatedAt,N(),s.activeSession)}function cr(e){const t=so(),n=t?.nodeId===e?t:hw(e),s=fw(e,n),a=s.filter(l=>l.kind==="quiz"),o=Object.keys(n.answers||{}).length,c=Math.max(0,Number(n.stepIndex||0));return{session:n,steps:s,quizSteps:a,answeredCount:o,stepIndex:c,currentStep:s[c]||null,isResult:c>=s.length&&s.length>0}}function vw(e,t,n){var l;const s=cn(),a=new Date().toISOString(),o=n.filter(d=>d.kind==="quiz"),c=Array.isArray(t.mistakes)&&t.mistakes.length>0;if((l=s.completedNodes)[e]||(l[e]=a),s.resultHistory[e]={completedAt:a,score:Number(t.score||0),totalQuestions:o.length,mistakes:(t.mistakes||[]).slice(0,24)},s.activeSession=null,e===je&&G(12,0,"learning_path:intro"),/^n5-lesson-\d+$/i.test(e)){const d=wt(e),u=r.learningPathLessonPayloads[e]||lr(e),m=[...new Set([...u?.kanjiIds||[],...(u?.kanjiBlocks||[]).map(h=>h.cardId),...mn(d).map(h=>h.id)].map(String).filter(Boolean))],v=Z();if(m.forEach(h=>{const w=Wd(h);if(!w)return;tr(w,"learning_path"),ps(v,w.kanji);const $=se(D(w.id));$.state==="New"&&(r.progress.cards[w.id]=pe($,c?"hard":"good"))}),d){ae.add(`n5:${d.id}`),v.completedLessons[d.id]=a,v.currentLessonId=Fe().find($=>$.order===d.order+1)?.id||d.id,r.progress.n5Course=r.progress.n5Course||{},r.progress.n5Course.completedLessons=r.progress.n5Course.completedLessons||{},r.progress.n5Course.completedLessons[d.id]=a,N({immediate:!0}),Xn()>=10&&Object.keys(v.studiedKanji||{}).length>=80&&(r.progress.unlockedJlptLevels=r.progress.unlockedJlptLevels||[],r.progress.unlockedJlptLevels.includes("N5")||r.progress.unlockedJlptLevels.push("N5"),r.progress.unlockedJlptLevels.includes("N4")||r.progress.unlockedJlptLevels.push("N4"));const h=r.n5Meta?.rewards?.lessonCompleteXp||45,w=r.n5Meta?.rewards?.lessonCompleteMoon||6;G(h,w,`learning_path:${e}`),et({title:`${De().lessonComplete}: ${f(d.title)}`,message:De().lessonCompleteText,xp:h,coins:w,mascot:"eva",mood:"happy",dialog:"lessonComplete"}),P("lesson_complete"),Ne("lesson_complete",{lessonId:e,jlpt:"N5"})}}ba(),ve(),X(),N()}function Xd(){r.n5Textbook?.items?.length||no();const e=le(),t=Qc(),n=Yc(),s=Hn(gs()),a=en();return`
      <section class="page learning-path-page">
        ...
        <div class="learning-path-timeline">
          ${t.length?t.map((o,c)=>{const l=Vc(o),d=l==="locked",u=f(o.summary)||"",m=o.id===is?e.reviewAction:o.id===os?e.openCheckpoint:o.type==="textbook"?e.openTextbook:l==="current"?e.resume:e.continue;return`
    ...
    `}function ww(){const e=r.activeLearnNodeId||gs(),t=Hn(e),n=le();if(!t)return Xd();if(t.id!==je&&t.type==="lesson"&&!r.n5Textbook?.items?.length)return no(),`
        <section class="page learning-path-page">
      ...
      `;t.type==="lesson"&&Ef(e);const s=cr(e),{session:a,steps:o,quizSteps:c,currentStep:l,isResult:d}=s;if(!o.length)return`
        <section class="page learning-path-page">
          <article class="study-card lesson-player">
            <div class="section-head">
              <div>
      ...
      `;const u=o.length,m=u?E(Math.min(a.stepIndex,u),u):0,v=a.answers?.[l?.id||""]||null,h=v?.selected||"",w=!!v?.correct,$=c.length?Math.round(Number(a.score||0)/Math.max(c.length,1)*100):100;return d?`
        <section class="page learning-path-page">
          <article class="study-card lesson-player">
            <div class="section-head">
              <div>
      ...
      <section class="page learning-path-page">
        <article class="study-card lesson-player">
          ...
          <div class="lesson-player-card">
            ...
            `:l.kind==="quiz"?`
              ...
              <div class="lesson-choice-grid">
                ${(l.options||[]).map(y=>{const L=h===y.value,b=y.value===l.answer;return`<button class="btn ${L?w?"success":"danger":v&&b?"ghost is-correct":"ghost"}" type="button" data-action="learning-path-choice" data-node="${g(e)}" data-step="${g(l.id)}" data-value="${g(y.value)}">${i(y.label)}</button>`}).join("")}
              </div>
              ${v?`<p class="lesson-player-feedback ${w?"is-good":"is-warning"}">${i(w?p()==="ru"?"Верно.":"Correct.":`${p()==="ru"?"Правильно":"Correct"}: ${(l.options||[]).find(y=>y.value===l.answer)?.label||l.answer}`)}</p>`:""}
            `:`
              <p>${i(l.text||"")}</p>
          ...
          <div class="lesson-player-actions">
            <button class="btn ghost" type="button" data-action="learning-path-back">${i(n.backToMap)}</button>
            <button class="btn primary" type="button" data-action="learning-path-step-next" data-node="${g(e)}" ${l.kind==="quiz"&&!v?'disabled aria-disabled="true"':""}>${i(a.stepIndex+1>=u?n.finish:n.continue)}</button>
          </div>
        </article>
      </section>
    `}function bw(){const e=No(),t=Hd(e),n=!!(t&&Me(t)),s=n?wS(t.id):[];(!r.activeCardId||!s.some(c=>c.id===r.activeCardId))&&(r.activeCardId=s[0]?.id||null);const a=n&&r.activeCardId?ne(r.activeCardId):null,o=r.activeLearnJlpt!=="all"?St(r.activeLearnJlpt):null;return`
      <section class="page">
        <div class="section-head">
          <div>
            <h1>${i(A("learn"))}</h1>
    ...
    `}function kw(){const e=Yt(r.activeJlptLesson)||Yt(ne(r.activeCardId)?.jlpt)||r.jlptLessons[0];if(!e)return`
        <section class="page">
      ...
      `;r.activeJlptLesson=e.jlpt;const t=St(e.jlpt);if(!pt(e.jlpt))return Qd(t||e);const n=wg(e.jlpt),s=n.filter(c=>D(c.id).state==="Mastered").length,a=n.filter(c=>D(c.id).state!=="New").length,o={...Ll(),...Nl()};return`
    ...
    `}function $w(e){const t=String(e?.jlpt||"").toUpperCase();if(!pt(t))return Qd(e);if(String(e?.jlpt||"").toUpperCase()==="N5"&&r.n5Textbook?.items?.length)return Sw(e);if(String(e?.jlpt||"").toUpperCase()==="N4"&&r.n4Textbook?.items?.length)return gb(e);if(String(e?.jlpt||"").toUpperCase()==="N3"&&r.n3Textbook?.items?.length)return Xb(e);if(String(e?.jlpt||"").toUpperCase()==="N2"&&r.n2Textbook?.items?.length)return Rk(e);if(String(e?.jlpt||"").toUpperCase()==="N1")return r.n1Textbook?.items?.length?fy(e):(Tm().catch(()=>{}),ia?od(ia):jw(e,"N1"));r.activeTextbookLevel=e.jlpt,r.activeJlptLesson=e.jlpt;const n=(e.lessonIds||[]).map(h=>r.lessons.find(w=>w.id===h)).filter(Boolean),s=r.lessons.filter(h=>String(h.jlpt||"").toUpperCase()===String(e.jlpt||"").toUpperCase()&&!n.includes(h)),a=[...n,...s].slice(0,Math.max(e.lessonCount||n.length,n.length)),o=r.activeTextbookSubroute?a.find(h=>h.id===r.activeTextbookSubroute)||Yt(e.jlpt)||r.jlptLessons[0]:Yt(e.jlpt)||r.jlptLessons[0];r.activeTextbookSubroute&&o?.id&&gt(t,o.id,"textbook_page");const c=p()==="ru"?{title:"Страница учебника",back:"Все учебники",pdf:"Скачать PDF",lessonPage:"Страница урока",openLesson:"Открыть урок",outline:"Что внутри",practice:"Практика",lessons:"Уроки учебника",previous:"Предыдущие уровни",next:"Следующие уровни"}:{title:"Textbook page",back:"All textbooks",pdf:"Download PDF",lessonPage:"Lesson page",openLesson:"Open lesson",outline:"Inside the textbook",practice:"Practice",lessons:"Textbook lessons",previous:"Previous levels",next:"Next levels"},l=Sl(e.jlpt)||e.lessonIds?.[0]||a[0]?.id||"",d=f(e.recommendedCycle||{}),u=f(e.goal||{}),m=(e.previousLevels||[]).map(h=>`<a class="pill" href="#textbooks/${g(h)}">${i(h)}</a>`).join(""),v=(e.nextLevels||[]).map(h=>`<a class="pill" href="#textbooks/${g(h)}">${i(h)}</a>`).join("");return`
      <section class="page textbooks-page textbook-detail-page">
        <div class="section-head">
          <div>
        ...
        <article class="jlpt-textbook-hero">
          ...
          <div class="jlpt-textbook-body">
            ...
            <div class="textbook-route-links">
              ...
              ${v?`<div><strong>${i(c.next)}</strong><div class="tag-row">${v}</div></div>`:""}
            </div>
          </div>
        </article>
        ...
        <div class="metric-grid">
          ...
          ${M(p()==="ru"?"Уроки":"Lessons",a.length,c.practice,E(a.length,Math.max(1,r.lessons.filter(h=>String(h.jlpt||"").toUpperCase()===String(e.jlpt||"").toUpperCase()).length)))}
          ...
          <div class="jlpt-section-grid">
            ${o.goals?.length?`
              <article class="jlpt-section-card">
                ...
                <ul>${o.goals.map(h=>`<li>${i(f(h))}</li>`).join("")}</ul>
              </article>
            `:""}
            ${o.sections?.map(h=>`
              <article class="jlpt-section-card">
                <h3>${i(f(h.title))}</h3>
                <p>${i(f(h.body))}</p>
                ${Array.isArray(h.points)&&h.points.length?`<ul>${h.points.map(w=>`<li>${i(f(w))}</li>`).join("")}</ul>`:""}
              </article>
            `).join("")}
            ${o.practice?.length?`
              <article class="jlpt-section-card">
                <h3>${i(c.practice)}</h3>
                <ul>${o.practice.map(h=>`<li>${i(f(h))}</li>`).join("")}</ul>
              </article>
            `:""}
            ${o.checkpoint?.length?`
              <article class="jlpt-section-card">
                <h3>${i(p()==="ru"?"Чекпоинт":"Checkpoint")}</h3>
                <ul>${o.checkpoint.map(h=>`<li>${i(f(h))}</li>`).join("")}</ul>
              </article>
            `:""}
          </div>
        `:""}
        ...
        <div class="lesson-grid">
          ${a.map(h=>aw(h)).join("")||`<article class="empty-state"><h3>${i(p()==="ru"?"Уроки скоро появятся":"Lessons will appear soon")}</h3></article>`}
        </div>
      </section>
    `}function jw(e,t){const n=p()==="ru"?{eyebrow:`${t} · Flash Kanji`,title:`Готовлю интерактивный учебник ${t}`,text:"Подгружаю главы, карточки, грамматику и финальный тест. Сейчас откроется рабочая оболочка, не старый экран.",back:"Все учебники"}:{eyebrow:`${t} · Flash Kanji`,title:`Preparing the interactive ${t} textbook`,text:"Loading lessons, cards, grammar, and the final test. The full app shell will open in a moment.",back:"All textbooks"};return`
    ...
    `}function Sw(e){r.activeTextbookLevel="N5",r.activeJlptLesson="N5",ur();const t=String(r.activeTextbookSubroute||"");if(t==="final-test"||t==="final")return Kw();if(t==="review")return Pw();const n=wt(t);return n?(Z().currentLessonId=n.id,gt("N5",n.id,"n5_lesson_page"),Mt("N5",n,"n5_lesson_page"),_w(e,n)):Nw(e)}function Nw(e){const t=Hw(),n=De(),s=Fe(),a=Gw(),o=r.n5Meta||{},c=f(o.principle||{});return`
    ...
    `}function Lw(e){const t=Co(e.id),n=De();let s=e.kanji.filter(a=>Z().studiedKanji[a]).length;return t==="completed"&&(s=e.kanji.length),`
    ...
    `}function bs(){return r.progress.jlptLessonStudy=Pc(Gi(),r.progress.jlptLessonStudy||{}),r.progress.jlptLessonStudy}function xw(e,t){return`${String(e||"").toUpperCase()}:${String(t||"")}`}function vt(e,t,n="player"){return`jlpt-${String(e||"").toLowerCase()}-${n}-${String(t||"").replace(/[^a-z0-9_-]+/gi,"-")}`}function Wn(e,t,n){const s=bs(),a=xw(e,t?.id),o=Rc();let c=s.sessions[a];c||(c={...o,level:String(e||"").toUpperCase(),lessonId:String(t?.id||""),startedAt:new Date().toISOString(),updatedAt:new Date().toISOString()},s.sessions[a]=c),c.level=String(e||c.level||"").toUpperCase(),c.lessonId=String(t?.id||c.lessonId||""),c.answers||(c.answers={}),c.phase=_c(c.phase),c.startedAt||(c.startedAt=new Date().toISOString()),c.updatedAt||(c.updatedAt=new Date().toISOString());const l=Array.isArray(n)?n.length:0,d=l?n.findIndex(m=>!c.answers[m.id]):-1,u=Object.keys(c.answers||{}).length;return c.completedAt?(c.phase="done",c.currentIndex=l):d<0?(c.currentIndex=l,c.phase="test",c.testOpenedAt||(c.testOpenedAt=c.updatedAt||new Date().toISOString())):(c.currentIndex=d,c.phase!=="test"&&(c.phase="study")),s.activeSessionKey=a,s.lastUpdatedAt=new Date().toISOString(),{session:c,key:a,answeredCount:u,currentIndex:c.currentIndex,total:l}}function Cw(e,t){return!e||!Array.isArray(t)||!t.length||e.session?.phase!=="study"?null:t[Math.min(Math.max(Number(e.currentIndex||0),0),t.length-1)]||null}function Aw(e){const t=Array.isArray(e)?e:[];return t.length?`
      <ul class="example-list lesson-study-example-list">
        ${t.slice(0,2).map(Qa).join("")}
      </ul>
    `:""}function Tw(e){const t=Mr(e),n=t.length>0;return`
    ...
    `}function Iw(e,t,n,s,a,o,c={}){if(!n)return"";const l=typeof c.examples=="function"?c.examples(n,t)||[]:[],d=typeof c.sentence=="function"?c.sentence(n,t):"",u=typeof c.extra=="function"?c.extra(n,t):"",m=c.answerAction||"jlpt-lesson-answer",v=String(e||n.jlpt||"").toUpperCase(),h=Number(s||0),w=D(n.id),$=t?.id||"";return`
      <article class="lesson-player-card lesson-study-card">
        <div class="lesson-player-kanji">
          <div class="lesson-player-glyph">${i(n.kanji)}</div>
          <div class="lesson-player-kanji-copy">
            <div class="tag-row compact-tags">
              <span class="pill">${i(o.step)} ${i(h+1)}</span>
            ...
            <h2>${i(R(n))}</h2>
            <p class="label lesson-study-progress-label">${i(e||n.jlpt||"")} · ${i(p()==="ru"?`Кандзи ${Math.min(h+1,a)} из ${a}`:`Kanji ${Math.min(h+1,a)} of ${a}`)}</p>
            <dl class="n5-readings lesson-study-readings">
              ${fp(n,"onyomi",o.onyomi,n.onyomi)}
              ${fp(n,"kunyomi",o.kunyomi,n.kunyomi||n.hiragana)}
            </dl>
            ${Aw(l)}
            ${d}
        ...
        <div class="lesson-choice-grid lesson-study-actions">
          <button class="btn success" type="button" data-action="${g(m)}" data-level="${g(v)}" data-lesson="${g($)}" data-card="${g(n.id)}" data-value="remember">${i(o.remember)}<small>${i(p()==="ru"?"в повторение":"to review")}</small></button>
          <button class="btn danger" type="button" data-action="${g(m)}" data-level="${g(v)}" data-lesson="${g($)}" data-card="${g(n.id)}" data-value="forget">${i(o.notRemember)}<small>${i(p()==="ru"?"ещё раз":"show again")}</small></button>
        </div>
      </article>
    `}function Rw(e,t,n,s,a){return`
    ...
    `}function dr(e,t,n,s,a={}){const o=Wn(e,t,n),c=Cw(o,n),l=Number(o.answeredCount||0),d=Number(o.total||0),u=a.playerId||vt(e,t?.id,"player"),m=d?E(l,d):0,v=c?`${p()==="ru"?"Кандзи":"Kanji"} ${Math.min(l+1,d)}/${d}`:o.session?.phase==="done"?p()==="ru"?"Урок завершён":"Lesson complete":p()==="ru"?"Тест открыт":"Test open",h=c?R(c):s.lessonComplete;return`
      <article class="study-card lesson-player lesson-study-player" id="${g(u)}">
        ...
        ${c?Iw(e,t,c,o.currentIndex,d,s,a):Rw(e,t,s,d,l)}
      </article>
    `}function _w(e,t){const n=De(),s=mn(t),a=gr(t),o=Co(t.id),c=Wn("N5",t,s);let l=o==="completed";const d=`n5:${t.id}`;ae.has(d)&&(l=!0);const u=l,m=a.filter(U=>Ao(U.id)?.correct).length,v=a.length>0&&m===a.length,h=s.filter(U=>Z().studiedKanji[U.kanji]).length,w=t.kanji.length,$=h>=w,y=!l&&v&&$,L=t.kanji.filter(U=>Z().difficultKanji[U]).join(" · "),b=Fe().find(U=>U.order===t.order+1),k=vt("N5",t.id,"player"),B=vt("N5",t.id,"test");return`
      <section class="page textbooks-page n5-course-page n5-lesson-page">
        ...
        ${dr("N5",t,s,n,{playerId:k,answerAction:"jlpt-lesson-answer",examples:U=>bt(U),sentence:U=>Mw(U,t)})}
    ...
    `:""}function Vd(e){const t=De(),n=Ao(e.id),s=n?n.correct?"is-correct":"is-wrong":"",a=r.route==="review"&&fn("N5",e.id)&&!!n;return e.type==="active-recall"?`
        <article class="n5-exercise-card ${s}">
          <span class="pill">${i(f(e.title))}</span>
          <h3>${i(e.prompt)}</h3>
          <div class="n5-input-row">
            <input id="${g(uu(e.id))}" type="text" maxlength="2" autocomplete="off" value="${g(n?.selected||"")}" aria-label="${g(f(e.title))}" ${a?"disabled":""} />
    ...
    `}function Yd(e,t){if(!t)return"";const n=De(),s=t.correct?n.correctAnswer:`${n.wrongAnswer}: ${e.answerLabel||e.answer}`;return`<p class="n5-feedback">${i(s)}</p>`}function Pw(e){const t=De(),n=Z().activeReviewMode||"due",s=cb(n);return`
      <section class="page textbooks-page n5-course-page">
        <div class="section-head">
          <div>
    ...
    `}function Ew(e,t){const n=De(),s=D(e.id);return`
    ...
    `}function Kw(e){const t=De(),n=r.n5FinalTest||{},s=cu(),a=Z().finalTest,o=Bt(a,s),c=o.answered,l=o.ready,d=r.finalTestBusy;if(a&&typeof a.score=="number"&&a.score>0&&a.totalQuestions>0){const v=Math.round(a.score/a.totalQuestions*100);(!a.percent||a.percent===0||a.percent!==v)&&(a.percent=v),a.completedAt||(a.completedAt=new Date().toISOString()),N()}const u=!!a.completedAt||typeof a.percent=="number"&&a.percent>0||typeof a.score=="number"&&a.score>0,m=typeof a.percent=="number"&&a.percent>0?a.percent:Number(a.score||0)&&a.totalQuestions?Math.round(a.score/a.totalQuestions*100):0;return`
    ...
    `}function Dw(e,t){const n=Z().finalTest.answers?.[e.id],s=!!Z().finalTest.completedAt,a=r.finalTestModal&&r.finalTestModal.level==="N5"&&r.finalTestModal.kind==="warning"?r.finalTestModal:null,o=!!(a&&Array.isArray(a.missingIds)&&a.missingIds.includes(e.id));return`
    ...
    `}function ks(e){const t=tu(e);if(!t.length)return"";const n=Zd(),s=eu(e),a=Fr(s,"textbook_reading_block"),o=_s(s);return(a||o)&&N(),`
      <section class="n5-panel jlpt-reading-panel">
        ...
        <div class="jlpt-reading-grid">
          ${t.map((c,l)=>Uw(c,s,l)).join("")}
        </div>
      </section>
    `}function Uw(e,t,n){const s=Zd(),a=xo(e),o=Array.isArray(e?.questions)?e.questions:[];return`
    ...
    `}function ur(){r.progress.n5Course=Kc(zi(),r.progress.n5Course||{});const e=Fe();!wt(r.progress.n5Course.currentLessonId)&&e[0]&&(r.progress.n5Course.currentLessonId=e[0].id);const n=e.find(s=>!r.progress.n5Course.completedLessons[s.id]);return!r.progress.n5Course.currentLessonId&&n&&(r.progress.n5Course.currentLessonId=n.id),r.progress.n5Course}function Z(){return ur()}function Fe(){return r.n5Textbook?.items||[]}function wt(e){const t=String(e||"");return t&&Fe().find(n=>n.id===t||n.id===`n5-${t}`||n.id.endsWith(`-${t}`))||null}function Gw(){return wt(Z().currentLessonId)||Fe().find(e=>!Z().completedLessons[e.id])||Fe()[0]||null}function mn(e){return(e?.kanji||[]).map(t=>Jw(t,e)).filter(Boolean)}function Dt(){const e=new Set;return Fe().flatMap(t=>mn(t)).filter(t=>e.has(t.kanji)?!1:(e.add(t.kanji),!0))}function Jw(e,t=null){const n=String(e||""),s=r.n5KanjiCatalog?.find(c=>c.kanji===n)||null,a=r.cards.find(c=>c.kanji===n&&String(c.jlpt||"").toUpperCase()==="N5")||r.cards.find(c=>c.kanji===n)||null,o=t?.id||s?.lessonId||null;return a&&s?ua({...a,lessonId:a.lessonId||o},s):a||(s?ua({id:s.courseCardId||s.id,kanji:s.kanji,lessonId:o,jlpt:"N5",examples:[]},s):null)}function pr(e,t=[]){const n=(Array.isArray(t)?t:[]).slice(0,3).map(s=>({...s,reading:Q(s.reading||s.hiragana||s.kana||e.hiragana||"")}));return n.length?n:[{word:e.kanji,reading:Q(e.hiragana||""),romaji:e.romaji||"",translation:R(e)}]}function bt(e){return pr(e,e.examples)}function zw(e,t){const n=t?.word||e.kanji,s=Q(t?.reading||e.hiragana||"");return p()==="ru"?`Свяжи ${e.kanji} со значением «${R(e)}» и сразу проговори слово: ${n}${s?` (${s})`:""}.`:`Connect ${e.kanji} with "${R(e)}" and say the word right away: ${n}${s?` (${s})`:""}.`}function Hw(){const e=Dt(),t=Z(),n=new Set(Object.keys(t.studiedKanji||{}));return e.forEach(s=>{D(s.id).state!=="New"&&n.add(s.kanji)}),{total:r.n5Meta?.kanjiCount||e.length||80,studied:n.size,completedLessons:Xn(),reviews:e.reduce((s,a)=>s+Number(D(a.id).reviewCount||0),0),difficult:Object.keys(t.difficultKanji||{}).length}}function Co(e){const t=Z(),n=`n5:${e}`;return ae.has(n)||t.completedLessons[e]?"completed":wt(e)?.kanji?.some(a=>t.studiedKanji[a]||t.difficultKanji[a])?"started":"new"}function qw(e){return e==="completed"?p()==="ru"?"завершён":"completed":e==="started"?p()==="ru"?"начат":"started":p()==="ru"?"не начат":"new"}function Xn(){return Fe().filter(t=>Co(t.id)==="completed").length}function gr(e){const t=mn(e);if(!t.length)return[];const n=e.sentences||[],s=Object.fromEntries((r.n5Exercises?.types||[]).map(y=>[y.type,y.title])),a=Object.fromEntries((r.n5Exercises?.types||[]).map(y=>[y.type,y])),o=y=>a[y]||{rewardXp:r.n5Meta?.rewards?.exerciseXp||7,rewardMoon:r.n5Meta?.rewards?.exerciseMoon||1},c=[],l=t[0];c.push({id:`${e.id}-meaning-0`,type:"meaning",title:s.meaning||{ru:"Узнавание значения",en:"Meaning recognition"},prompt:l.kanji,answer:l.id,answerLabel:R(l),kanji:l.kanji,cardId:l.id,options:Ft({value:l.id,label:R(l)},t.slice(1).map(y=>({value:y.id,label:R(y)})),1),...o("meaning")});const d=t[1]||t[0];c.push({id:`${e.id}-kanji-1`,type:"kanji",title:s.kanji||{ru:"Кандзи по значению",en:"Kanji from meaning"},prompt:R(d),answer:d.kanji,answerLabel:d.kanji,kanji:d.kanji,cardId:d.id,options:Ft({value:d.kanji,label:d.kanji},t.filter(y=>y.id!==d.id).map(y=>({value:y.kanji,label:y.kanji})),2),...o("kanji")});const u=t[2]||t[0],m=bt(u)[0];c.push({id:`${e.id}-reading-2`,type:"reading",title:s.reading||{ru:"Чтение слова",en:"Word reading"},prompt:m.word,answer:m.reading,answerLabel:m.reading,kanji:u.kanji,cardId:u.id,options:Ft({value:m.reading,label:m.reading},t.flatMap(y=>bt(y).map(L=>({value:L.reading,label:L.reading}))).filter(y=>y.value!==m.reading),3),...o("reading")});const v=n[0];v&&c.push({id:`${e.id}-sentence-3`,type:"sentence",title:s.sentence||{ru:"Перевод предложения",en:"Sentence translation"},prompt:v.jp,answer:f({ru:v.ru,en:v.en}),answerLabel:f({ru:v.ru,en:v.en}),kanji:t[0].kanji,cardId:t[0].id,options:Ft({value:f({ru:v.ru,en:v.en}),label:f({ru:v.ru,en:v.en})},n.slice(1).map(y=>({value:f({ru:y.ru,en:y.en}),label:f({ru:y.ru,en:y.en})})),1),...o("sentence")});const h=t[3]||t[0],w=bt(h)[0];c.push({id:`${e.id}-word-4`,type:"missing-word",title:s["missing-word"]||{ru:"Вставь слово",en:"Insert the word"},prompt:p()==="ru"?`Какое слово подходит к значению «${Ie(w)}В»?`:`Which word matches "${Ie(w)}"?`,answer:w.word,answerLabel:w.word,kanji:h.kanji,cardId:h.id,options:Ft({value:w.word,label:w.word},t.flatMap(y=>bt(y).map(L=>({value:L.word,label:L.word}))).filter(y=>y.value!==w.word),2),...o("missing-word")});const $=t[4]||t[0];return c.push({id:`${e.id}-active-5`,type:"active-recall",title:s["active-recall"]||{ru:"Активное вспоминание",en:"Active recall"},prompt:p()==="ru"?`Введи кандзи для значения: ${R($)}`:`Type the kanji for: ${R($)}`,answer:$.kanji,answerLabel:$.kanji,kanji:$.kanji,cardId:$.id,options:[],...o("active-recall")}),c.slice(0,r.n5Exercises?.lessonQuestionCount||6).map(y=>({...y,level:"N5",lessonId:e.id}))}function Ft(e,t,n=0){const s=new Set([String(e.value)]),a=[e];if(t.forEach(l=>{const d=String(l.value||"");!d||s.has(d)||a.length>=4||(s.add(d),a.push(l))}),Dt().forEach(l=>{if(a.length>=4)return;const d={value:l.id,label:l.kanji};s.has(String(d.value))||(s.add(String(d.value)),a.push(d))}),a.length<=1)return a;const c=n%a.length;return[...a.slice(c),...a.slice(0,c)]}function su(e){for(const t of Fe()){const n=gr(t).find(s=>s.id===e);if(n)return n}return null}function fn(e,t,n=""){return r.route==="review"&&r.activeExerciseReviewLevel===String(e||"").toUpperCase()&&String(r.activeExerciseReviewId||"")===String(t||"")&&(!n||String(r.activeExerciseReviewSource||"")===String(n||""))}function mr(e,t,n){return fn(e,n)?r.reviewExerciseResults?.[String(n)]||null:t.exerciseResults?.[String(n)]||null}function Ww(e,t,n){const s=V(t);if(!e||!s||!n)return null;e.exerciseSrs||(e.exerciseSrs={});const a=e.exerciseSrs[String(n.id)]||null;if(a)return es(a,{level:s,lessonId:n.lessonId||a.lessonId||"",exerciseId:n.id,cardId:n.cardId||a.cardId||"",kanji:n.kanji||a.kanji||"",type:n.type||a.type||"",title:n.title||a.title||null,prompt:n.prompt||a.prompt||"",answer:n.answer||a.answer||"",answerLabel:n.answerLabel||a.answerLabel||""});const o=Is(s,n.lessonId||"",n.id,n);return e.exerciseSrs[String(n.id)]=o,o}function Xw(e,t,n,s){if(!e||!n)return;const a=V(t);a&&(e.exerciseSrs||(e.exerciseSrs={}),e.exerciseSrs[String(n.id)]=es(s,{level:a,lessonId:n.lessonId||s?.lessonId||"",exerciseId:n.id,cardId:n.cardId||s?.cardId||"",kanji:n.kanji||s?.kanji||"",type:n.type||s?.type||"",title:n.title||s?.title||null,prompt:n.prompt||s?.prompt||"",answer:n.answer||s?.answer||"",answerLabel:n.answerLabel||s?.answerLabel||""}))}function fr(e,t,n,s,a,o={}){const c=V(e);if(!c||!t||!n)return;const l=new Date().toISOString(),d=fn(c,n.id);if(d&&r.reviewExerciseResults?.[n.id])return;const u={selected:s,correct:a,checkedAt:l};d?(r.reviewExerciseResults||(r.reviewExerciseResults={}),r.reviewExerciseResults[n.id]=u,r.reviewQueueLastKind="exercise"):t.exerciseResults[n.id]=u;const m=se(Ww(t,c,n)||Is(c,n.lessonId||"",n.id,n)),v=pe(m,a?"good":"again");if(Xw(t,c,n,v),Qt(m,v,a?"good":"again"),ve(),a){if(r.progress.totalCorrect+=1,!d&&!t.completedExercises[n.id]){t.completedExercises[n.id]=l,o.markCompleted?.(l),(o.markStudied||(()=>{}))();const w=Number(o.rewardXp||0),$=Number(o.rewardMoon||0);(w||$)&&G(w,$,o.rewardKey||`exercise:${n.id}`)}}else if(r.progress.totalWrong+=1,o.markWrong?.(),(o.markDifficult||(()=>{}))(),n.type==="reading"||n.type==="missing-word"){const w=n.answerLabel||n.answer;w&&o.markWordMistake?.(w)}d&&(r.pendingFocus="__scroll-top__"),C(),N(),_t("textbook exercise post-render effects",()=>{P(a?"answer_correct":"answer_wrong"),X()})}function ru(e){const t=V(e?.level||"");return t==="N5"?{xp:Number(r.n5Meta?.rewards?.exerciseXp||7),moon:Number(r.n5Meta?.rewards?.exerciseMoon||1)}:t==="N4"?{xp:Number(r.n4Meta?.rewards?.readingXp||r.n4Meta?.rewards?.exerciseXp||10),moon:Number(r.n4Meta?.rewards?.readingMoon||r.n4Meta?.rewards?.exerciseMoon||1)}:t==="N3"?{xp:Number(r.n3Meta?.rewards?.readingXp||r.n3Meta?.rewards?.exerciseXp||10),moon:Number(r.n3Meta?.rewards?.readingMoon||r.n3Meta?.rewards?.exerciseMoon||1)}:t==="N2"?{xp:Number(r.n2Meta?.rewards?.readingXp||r.n2Meta?.rewards?.exerciseXp||10),moon:Number(r.n2Meta?.rewards?.readingMoon||r.n2Meta?.rewards?.exerciseMoon||1)}:{xp:Number(r.n1Meta?.rewards?.readingXp||r.n1Meta?.rewards?.exerciseXp||10),moon:Number(r.n1Meta?.rewards?.readingMoon||r.n1Meta?.rewards?.exerciseMoon||1)}}function au(e,t,n,s={}){if(!e?.id)return;const a=new Date().toISOString(),o=fn(e.level,e.id,"reading"),c=se(Cn(e)||xn(e));if(r.reviewExerciseResults||(r.reviewExerciseResults={}),e.kind==="cloze"){c.selectedIndices=Array.isArray(s.selectedIndices)?s.selectedIndices.slice():c.selectedIndices||[],c.selectedTiles=Array.isArray(s.selectedTiles)?s.selectedTiles.map(L=>({kanji:String(L?.kanji||""),reading:String(L?.reading||"")})).filter(L=>L.kanji):c.selectedTiles||[],c.selectedText=String(t||""),c.wrongIndexes=Array.isArray(s.wrongIndexes)?s.wrongIndexes.slice():c.wrongIndexes||[],c.completed=!0,c.completedAt=a,c.correct=!!n,c.answers={cloze:{selected:String(t||""),correct:!!n,checkedAt:a}},ts(e,c),r.reviewExerciseResults[e.id]=se(c),n?r.progress.totalCorrect+=1:r.progress.totalWrong+=1;const w=se(c),$=pe(w,n?"good":"again");$.selectedIndices=c.selectedIndices,$.selectedTiles=c.selectedTiles,$.selectedText=c.selectedText,$.wrongIndexes=c.wrongIndexes,$.completed=!0,$.completedAt=a,$.correct=!!n,$.answers=c.answers,ts(e,$),r.reviewExerciseResults[e.id]=se($),Qt(w,$,n?"good":"again"),ve();const y=ru(e);n?G(y.xp,y.moon,`reading:${e.id}`):G(Math.max(1,Math.round(y.xp*.35)),0,`reading:${e.id}:again`),o&&(r.pendingFocus="__scroll-top__"),C(),N(),_t("reading cloze post-render effects",()=>{P(n?"answer_correct":"answer_wrong"),X()});return}const l=e.question||e.questions?.[0]||null,d=String(s.questionKey||l?.id||e.id);if(c.answers||(c.answers={}),c.answers[d])return;if(c.answers[d]={selected:String(t||""),correct:!!n,checkedAt:a},c.completed=!!d&&Object.keys(c.answers).length>=ll(),c.completedAt=c.completed?a:c.completedAt||null,c.correct=c.completed?Object.values(c.answers).every(w=>!!w?.correct):!1,c.selectedText=String(t||""),ts(e,c),r.reviewExerciseResults[e.id]=se(c),n?r.progress.totalCorrect+=1:r.progress.totalWrong+=1,N(),!c.completed){C(),_t("reading question post-render sound",()=>{P(n?"answer_correct":"answer_wrong")});return}const u=se(c),m=Object.values(c.answers).every(w=>!!w?.correct),v=pe(u,m?"good":"again");v.answers=c.answers,v.completed=!0,v.completedAt=a,v.correct=m,v.selectedText=String(t||""),v.wrongQuestions=Object.entries(c.answers).filter(([,w])=>!w?.correct).map(([w])=>w),ts(e,v),r.reviewExerciseResults[e.id]=se(v),Qt(u,v,m?"good":"again"),ve();const h=ru(e);m?G(h.xp,h.moon,`reading:${e.id}`):G(Math.max(1,Math.round(h.xp*.25)),0,`reading:${e.id}:again`),o&&(r.pendingFocus="__scroll-top__"),C(),N(),_t("reading exercise post-render effects",()=>{P(n?"answer_correct":"answer_wrong"),X()})}function Qw(e){const t=Cs();if(!t||t.source!=="reading"||!t.exercise)return;const n=t.exercise.question||t.exercise.questions?.[0]||null;if(!n)return;const s=String(e.dataset.value||""),a=s===String(n.answer||"");au(t.exercise,s,a,{questionKey:String(e.dataset.question||n.id||t.exercise.id)})}function Vw(e){const t=Cs();if(!t||t.source!=="reading"||t.exercise?.kind!=="cloze")return;const n=t.exercise,s=se(Cn(n)||xn(n));if(s.completed||s.selectedIndices?.includes(e))return;const a=Math.max(1,yt(n).length);if(s.selectedIndices=Array.isArray(s.selectedIndices)?s.selectedIndices.slice():[],s.selectedIndices.length>=a){J(p()==="ru"?"Все пропуски уже заполнены.":"All blank slots are already filled.");return}if(s.selectedIndices.push(e),s.selectedTiles=s.selectedIndices.map(o=>n.tiles?.[o]).filter(Boolean),s.selectedText=s.selectedTiles.map(o=>o.kanji).join(""),ts(n,s),r.activeExerciseReviewSelection=s.selectedIndices.slice(),r.reviewExerciseResults[n.id]=se(s),N(),s.selectedIndices.length>=a){iu();return}C()}function Yw(){const e=Cs();if(!e||e.source!=="reading"||e.exercise?.kind!=="cloze")return;const t=e.exercise,n=se(Cn(t)||xn(t));n.completed||!n.selectedIndices?.length||(n.selectedIndices=n.selectedIndices.slice(0,-1),n.selectedTiles=n.selectedIndices.map(s=>t.tiles?.[s]).filter(Boolean),n.selectedText=n.selectedTiles.map(s=>s.kanji).join(""),r.activeExerciseReviewSelection=n.selectedIndices.slice(),r.reviewExerciseResults[t.id]=se(n),ts(t,n),N(),C())}function Zw(){const e=Cs();if(!e||e.source!=="reading"||!e.exercise)return;const t=e.exercise,n=se(Cn(t)||xn(t));n.completed||(n.selectedIndices=[],n.selectedTiles=[],n.selectedText="",n.wrongIndexes=[],r.activeExerciseReviewSelection=[],r.reviewExerciseResults[t.id]=se(n),ts(t,n),N(),C())}function iu(){const e=Cs();if(!e||e.source!=="reading"||e.exercise?.kind!=="cloze")return;const t=e.exercise,n=yt(t),s=se(Cn(t)||xn(t)),a=Array.isArray(s.selectedIndices)?s.selectedIndices:[];if(a.length<n.length){J(p()==="ru"?"Заполни все пропуски перед проверкой.":"Fill every blank before checking.");return}const o=a.map(d=>t.tiles?.[d]).filter(Boolean),c=o.length===n.length&&o.every((d,u)=>d?.kanji===n[u]?.kanji),l=o.map((d,u)=>d?.kanji===n[u]?.kanji?-1:u).filter(d=>d>=0);au(t,o.map(d=>d.kanji).join(""),c,{selectedIndices:a,selectedTiles:o,wrongIndexes:l})}function eb(){r.activeExerciseReviewTranslationOpen=!r.activeExerciseReviewTranslationOpen,C()}function Ao(e){return mr("N5",Z(),e)}function tb(e){const t=su(e.dataset.id);if(!t)return;const n=e.dataset.value||"",s=n===t.answer;ou(t,n,s)}function nb(e){const t=su(e);if(!t)return;const n=document.getElementById(uu(t.id)),s=n?String(n.value||"").trim():"";ou(t,s,s===t.answer)}function ou(e,t,n){const s=Z();fr("N5",s,e,t,n,{rewardXp:Number(e.rewardXp||r.n5Meta?.rewards?.exerciseXp||7),rewardMoon:Number(e.rewardMoon||r.n5Meta?.rewards?.exerciseMoon||1),rewardKey:`n5_exercise:${e.id}`,markStudied:()=>ys(e.kanji,e.cardId),markDifficult:()=>hr(e.kanji,e.cardId),markWordMistake:a=>{s.wordMistakes[a]=Number(s.wordMistakes[a]||0)+1}})}function sb(e,t,n,s){var v;const a=V(e)||String(e||"").toUpperCase(),o=a==="N5"?wt(t):a==="N4"?hn(t):a==="N3"?wn(t):a==="N2"?kn(t):a==="N1"?Qn(t):null;if(!o)return;const c=ed(a,o),l=c.find(h=>String(h.id)===String(n))||ne(n);if(!l)return;const d=Wn(a,o,c);if(d.session.answers?.[l.id])return;const u=new Date().toISOString();d.session.answers[l.id]={remembered:!!s,rating:s?"good":"again",answeredAt:u};const m=c.findIndex(h=>String(h.id)===String(l.id));d.session.currentIndex=m>=0?m+1:Math.min(Number(d.session.currentIndex||0)+1,c.length),d.session.phase=d.session.currentIndex>=c.length?"test":"study",d.session.updatedAt=u,d.session.phase==="test"&&((v=d.session).testOpenedAt||(v.testOpenedAt=u)),r.pendingFocus=null,Ht(),N(),qc(`${a} lesson SRS post-render commit`,()=>{const h=s?"good":"again";a==="N5"?lu(l.id,h,"review"):a==="N4"?bu(l.id,h,"review"):a==="N3"?Iu(l.id,h,"review"):a==="N2"?Gu(l.id,h,"review"):a==="N1"&&ep(l.id,h,"review")})}function lu(e,t,n="review"){const s=ne(e);if(!s)return;const a=n==="lesson"&&t==="again",o=a?"good":t,c=a?"hard":t,l=se(D(s.id)),d=pe(l,o,c);r.progress.cards[s.id]=d,Qt(l,d,c),ve(),ys(s.kanji,s.id),Z().srsKanji[s.kanji]=new Date().toISOString(),a?(hr(s.kanji,s.id,!1),r.progress.totalCorrect+=1,G(r.n5Meta?.rewards?.hardXp||2,1,`n5_srs_lesson_hard:${s.id}`)):Oe(t)?(hr(s.kanji,s.id),r.progress.totalWrong+=1,G(r.n5Meta?.rewards?.hardXp||2,0,`n5_srs_hard:${s.id}`)):(r.progress.totalCorrect+=1,G(t==="easy"?r.n5Meta?.rewards?.knowXp||6:r.n5Meta?.rewards?.addToSrsXp||4,1,`n5_srs:${s.id}`)),Ht(),N(),_t("N5 SRS post-render effects",()=>{P(Oe(t)?"answer_wrong":"answer_correct"),X()})}function rb(e){const t=ne(e);if(!t)return;const n=Z();n.writingPractice[t.kanji]||(n.writingPractice[t.kanji]=new Date().toISOString(),r.progress.writingPractice.completed=Number(r.progress.writingPractice.completed||0)+1,r.progress.writingPractice.cards[t.id]={completed:Number(r.progress.writingPractice.cards[t.id]?.completed||0)+1,lastAt:new Date().toISOString()},ys(t.kanji,t.id),G(8,1,`n5_writing:${t.id}`)),X(),N(),C()}function ab(e){const t=wt(e);if(!t)return;const n=Z(),s=`n5:${t.id}`;if(ae.has(s)||n.completedLessons[t.id]){C();return}const a=mn(t);if(a.filter(h=>n.studiedKanji[h.kanji]).length<t.kanji.length){const h=p()==="ru"?"Сначала изучите все кандзи урока (8/8).":"Study all kanji in the lesson first (8/8).";typeof J=="function"&&J(h);return}const c=gr(t);if(!(c.length>0&&c.every(h=>Ao(h.id)?.correct))){const h=p()==="ru"?"Сначала выполните все упражнения правильно.":"Complete all exercises correctly first.";typeof J=="function"&&J(h);return}ae.add(s),mn(t).forEach(h=>{ys(h.kanji,h.id),n.srsKanji[h.kanji]=n.srsKanji[h.kanji]||new Date().toISOString();const w=D(h.id);w.state==="New"&&(r.progress.cards[h.id]=pe(se(w),"good"))}),n.completedLessons[t.id]=new Date().toISOString(),n.currentLessonId=Fe().find(h=>h.order===t.order+1)?.id||t.id;const d=bs(),u=d.sessions[n5SessKey];if(u){const h=new Date().toISOString();u.phase="done",u.completedAt=h,u.updatedAt=h,u.currentIndex=a.length,d.activeSessionKey=n5SessKey,d.lastUpdatedAt=h}Z(),r.progress.n5Course=r.progress.n5Course||{},r.progress.n5Course.completedLessons=r.progress.n5Course.completedLessons||{},r.progress.n5Course.completedLessons[t.id]=new Date().toISOString(),N({immediate:!0}),Xn()>=10&&Object.keys(n.studiedKanji||{}).length>=80&&(r.progress.unlockedJlptLevels=r.progress.unlockedJlptLevels||[],r.progress.unlockedJlptLevels.includes("N5")||r.progress.unlockedJlptLevels.push("N5"),r.progress.unlockedJlptLevels.includes("N4")||r.progress.unlockedJlptLevels.push("N4"));const m=r.n5Meta?.rewards?.lessonCompleteXp||45,v=r.n5Meta?.rewards?.lessonCompleteMoon||6;G(m,v,`n5_lesson:${t.id}`),et({title:`${De().lessonComplete}: ${f(t.title)}`,message:De().lessonCompleteText,xp:m,coins:v,mascot:"eva",mood:"happy",dialog:"lessonComplete"}),P("lesson_complete"),X(),N(),C()}function ys(e,t=null){if(!e)return;const n=Z();ps(n,e)}function hr(e,t=null,n=!0){if(e&&(Z().difficultKanji[e]=new Date().toISOString(),n&&t)){const s=D(t);s.state!=="New"&&(r.progress.cards[t]=pe(se(s),"again"))}}function ib(e){const t=wt(e);t&&(Z().currentLessonId=t.id,gt("N5",t.id,"n5_lesson_open"),Mt("N5",t,"n5_lesson_open"),vr(t.id))}function ob(){vr("")}function lb(e=null){e&&(Z().activeReviewMode=e),vr("review")}function vr(e){r.route="textbooks",r.activeTextbookLevel="N5",r.activeTextbookSubroute=e||null;const t=e?`#textbooks/N5/${encodeURIComponent(e)}`:"#textbooks/N5";tt(t),N(),oe(),Pt()}function cb(e="due"){const t=Date.now(),n=Z(),s=Dt();return e==="difficult"?s.filter(a=>n.difficultKanji[a.kanji]):e==="all"?s:s.filter(a=>{const o=D(a.id);return o.state!=="New"&&(!o.dueAt||new Date(o.dueAt).getTime()<=t)})}function cu(){const e=Dt(),t=Fe(),n=r.n5FinalTest?.types||["meaning","reading","sentence","kanji","word","srs"],s=Math.min(r.n5FinalTest?.questionCount||24,Math.max(e.length,1)),a=[];for(let o=0;o<s;o+=1){const c=e[o*7%e.length]||e[o%e.length],l=n[o%n.length],d=t.find(u=>u.kanji.includes(c.kanji))||t[0];a.push(db(l,c,d,o))}return a.filter(Boolean)}function db(e,t,n,s){const o=bt(t)[0],c=(n?.sentences||[]).find(l=>l.jp.includes(t.kanji))||n?.sentences?.[0];if(e==="meaning")return{id:`n5-final-${s}`,type:e,cardId:t.id,kanji:t.kanji,prompt:t.kanji,answer:t.id,answerLabel:R(t),options:Ft({value:t.id,label:R(t)},Dt().filter(l=>l.id!==t.id).map(l=>({value:l.id,label:R(l)})),s)};if(e==="reading")return{id:`n5-final-${s}`,type:e,cardId:t.id,kanji:t.kanji,prompt:o.word,answer:o.reading,answerLabel:o.reading,options:Ft({value:o.reading,label:o.reading},Dt().flatMap(l=>bt(l).map(d=>({value:d.reading,label:d.reading}))).filter(l=>l.value!==o.reading),s)};if(e==="sentence"&&c){const l=f({ru:c.ru,en:c.en});return{id:`n5-final-${s}`,type:e,cardId:t.id,kanji:t.kanji,prompt:c.jp,answer:l,answerLabel:l,options:Ft({value:l,label:l},Fe().flatMap(d=>d.sentences||[]).map(d=>({value:f({ru:d.ru,en:d.en}),label:f({ru:d.ru,en:d.en})})).filter(d=>d.value!==l),s)}}if(e==="word"){const l=o.word;return{id:`n5-final-${s}`,type:e,cardId:t.id,kanji:t.kanji,prompt:Ie(o),answer:l,answerLabel:l,options:Ft({value:l,label:l},Dt().flatMap(d=>bt(d).map(u=>({value:u.word,label:u.word}))).filter(d=>d.value!==l),s)}}return e==="srs"?{id:`n5-final-${s}`,type:e,cardId:t.id,kanji:t.kanji,prompt:p()==="ru"?`Мини-повторение: ${t.kanji} — ${R(t)}. Что нажмёшь, если помнишь?`:`Mini review: ${t.kanji} — ${R(t)}. What do you press if you remember?`,answer:"remember",answerLabel:p()==="ru"?"Помню":"Remember",options:[{value:"again",label:p()==="ru"?"Сложно":"Hard"},{value:"remember",label:p()==="ru"?"Помню":"Remember"},{value:"skip",label:p()==="ru"?"Пропустить":"Skip"}]}:{id:`n5-final-${s}`,type:"kanji",cardId:t.id,kanji:t.kanji,prompt:R(t),answer:t.kanji,answerLabel:t.kanji,options:Ft({value:t.kanji,label:t.kanji},Dt().filter(l=>l.id!==t.id).map(l=>({value:l.kanji,label:l.kanji})),s)}}function ub(e){const t=e.dataset.id,n=e.dataset.value||"";t&&(Z().finalTest.answers[t]=n,N(),C())}function du(e=!1){if(r.finalTestBusy)return;const t=Z().finalTest;if(t.completedAt||typeof t.percent=="number"&&t.percent>0){C();return}r.finalTestBusy=!0;try{const n=cu(),s=r.n5FinalTest||{},a=De(),o=Bt(t,n),c=K$(s),l=!!(s.allowIncompleteFinish||s.allowUnansweredFinish),d=new Date().toISOString();if(t.attempts=Number(t.attempts||0)+1,o.missingCount&&!e&&!l){const k=o.firstMissingId?`#${xs("n5",o.firstMissingId)}`:null;r.finalTestModal={kind:"warning",level:"N5",title:p()==="ru"?"Ответь на все вопросы":"Answer all questions",message:p()==="ru"?`Вы ответили не на все вопросы. Пропусков: ${o.missingCount}.`:`You left some questions unanswered. Missing: ${o.missingCount}.`,answered:o.answered,missingCount:o.missingCount,totalQuestions:o.totalQuestions,threshold:c,focusSelector:k,focusLabel:p()==="ru"?"К первому пропуску":"Jump to first missing",closeLabel:p()==="ru"?"Продолжить":"Continue",forceLabel:p()==="ru"?"Завершить без ответов":"Finish anyway",allowIncomplete:l},r.pendingFocus=k,N();return}let u=0;const m=[],v=[];n.forEach(k=>{const B=String(t.answers?.[k.id]||"").trim();B===k.answer?(u+=1,ys(k.kanji,k.cardId)):(B||v.push(k),m.push({id:k.id,kanji:k.kanji,answer:k.answerLabel,selected:B}),hr(k.kanji,k.cardId))});const h=n.length?Math.round(u/n.length*100):0,w=!!t.completedAt,$=!!t.passed,y=Math.max(0,m.length-v.length);let L=0,b=0;if(t.answers=t.answers||{},t.score=u,t.percent=h,t.passed=h>=c,t.correctAnswers=u,t.incorrectAnswers=y,t.unansweredAnswers=v.length,t.totalQuestions=n.length,t.mistakes=m,t.mistakeQuestionIds=m.map(k=>k.id),t.completedAt=d,t.lastScore=h,t.bestScore=Math.max(Number(t.bestScore||0),h),t.passedAt=t.passed?$&&t.passedAt||d:t.passedAt||null,!w){const k=Number(s?.rewards?.completeXp||120),B=Number(s?.rewards?.completeMoon||20);L+=k,b+=B,G(k,B,"n5_final_complete")}if(t.passed&&!$){const k=Number(s?.rewards?.passXp||80),B=Number(s?.rewards?.passMoon||12);L+=k,b+=B,G(k,B,"n5_final_pass")}t.lastRewardXp=L,t.lastRewardMoon=b,Z(),r.progress.n5Course=r.progress.n5Course||{},r.progress.n5Course.finalTest=r.progress.n5Course.finalTest||{},Object.assign(r.progress.n5Course.finalTest,{percent:t.percent,score:t.score,completedAt:t.completedAt,passed:t.passed,totalQuestions:t.totalQuestions,correctAnswers:t.correctAnswers||t.score}),N({immediate:!0}),r.finalTestModal={kind:"result",level:"N5",title:t.passed?a.finalPassed:a.finalNeedsReview,message:t.passed?a.finalPassedText:a.finalNeedsReviewText,passed:t.passed,percent:h,correct:u,incorrect:y,unanswered:v.length,totalQuestions:n.length,rewardXp:L,rewardMoon:b,attempts:t.attempts,threshold:c,reviewAction:"n5-review",reviewAllAction:"n5-review",closeLabel:(p()==="ru","OK"),repeatLabel:a.repeatMistakes,reviewAllLabel:a.reviewAll},X(),N()}catch(n){console.error(n),J(p()==="ru"?"Не удалось завершить тест.":"Could not finish the test.")}finally{r.finalTestBusy=!1,C()}}function pb(){Z().finalTest=zi().finalTest,r.finalTestModal=null,r.finalTestBusy=!1,N(),C()}function uu(e){return`n5-input-${String(e||"").replace(/[^a-z0-9_-]+/gi,"-")}`}function gb(e){r.activeTextbookLevel="N4",r.activeJlptLesson="N4";const t=To();t.opened||(t.opened=!0,X(),N());const n=String(r.activeTextbookSubroute||"");if(n==="final-test"||n==="final")return Nb();if(n==="review")return bb();if(n==="kanji")return yb();if(n==="grammar")return $b();if(n==="reading")return jb();if(n==="listening")return Sb();const s=hn(n);return s?(W().currentLessonId=s.id,gt("N4",s.id,"n4_lesson_page"),Mt("N4",s,"n4_lesson_page"),hb(e,s)):mb(e)}function mb(e){const t=Cb(),n=ke(),s=rt(),a=xb(),o=r.n4Meta||{},c=f(o.principle||{});return`
    ...
    `}function fb(e){const t=hu(e.id),n=ke();let s=e.kanji.filter(a=>W().studiedKanji[a]).length;return t==="completed"&&(s=e.kanji.length),`
      <a class="n5-lesson-tile ${t}" href="#jlpt/n4/${g(e.id)}" data-action="n4-open-lesson" data-id="${g(e.id)}">
        ...
        <div class="achievement-progress" aria-label="${g(`${s}/${e.kanji.length}`)}"><i style="width:${E(s,e.kanji.length)}%"></i></div>
        <small>${i(s)}/${i(e.kanji.length)} · ${i(Ab(t))}</small>
      </a>
    `}function hb(e,t){const n=ke(),s=wr(t),a=Ea(t),o=hu(t.id),c=Wn("N4",t,s);let l=o==="completed";const d=`n4:${t.id}`;ae.has(d)&&(l=!0);const u=l,m=a.filter(U=>Ro(U.id)?.correct).length,v=a.length>0&&m===a.length,h=s.filter(U=>W().studiedKanji[U.kanji]).length,w=t.kanji.length,$=h>=w,y=!l&&v&&$,L=t.kanji.filter(U=>W().difficultKanji[U]).join(" · "),b=rt().find(U=>U.order===t.order+1),k=vt("N4",t.id,"player"),B=vt("N4",t.id,"test");return`
      <section class="page textbooks-page n5-course-page n4-course-page n5-lesson-page">
        ...
        ${dr("N4",t,s,n,{playerId:k,answerAction:"jlpt-lesson-answer",examples:U=>at(U),sentence:U=>vb(U,t)})}
    ...
    `}function vb(e,t){const n=t.sentences.find(a=>a.jp.includes(e.kanji))||t.sentences[0];if(!n)return"";const s=(t.grammarFocus||[]).find(a=>n.jp.includes(String(a).replace(/[гЂњ~].*/,"")))||t.grammarFocus?.[0]||"";return`
      <div class="n5-card-sentence">
        <strong>${i(n.jp)}</strong>
        <span>${i(Q(n.reading||""))}</span>
        <small>${i(f({ru:n.ru,en:n.en}))}</small>
    ...
    `}function wb(e){const t=ke(),n=(e.grammarFocus||[]).map(s=>Io(s)).filter(Boolean).slice(0,3);return n.length?`
    ...
    `:""}function pu(e){const t=ke(),n=Ro(e.id),s=n?n.correct?"is-correct":"is-wrong":"",a=r.route==="review"&&fn("N4",e.id)&&!!n;return e.type==="active-recall"?`
        <article class="n5-exercise-card ${s}">
          <span class="pill">${i(f(e.title))}</span>
          <h3>${i(e.prompt)}</h3>
          <div class="n5-input-row">
    ...
    `}function gu(e,t){if(!t)return"";const n=ke(),s=t.correct?n.correctAnswer:`${n.wrongAnswer}: ${e.answerLabel||e.answer}`;return`<p class="n5-feedback">${i(s)}</p>`}function bb(e){const t=ke(),n=W().activeReviewMode||"due",s=zb(n);return`
      <section class="page textbooks-page n5-course-page n4-course-page">
        <div class="section-head">
          <div>
        ...
        <div class="n5-kanji-grid">
          ${s.map((a,o)=>kb(a,o)).join("")||`<article class="empty-state"><h3>${i(t.noReviewCards)}</h3></article>`}
        </div>
      </section>
    `}function kb(e,t){const n=ke(),s=D(e.id);return`
      <article class="n5-kanji-card n5-review-card">
        <div class="n5-kanji-topline">
          <span class="pill">${t+1}</span>
          <span class="pill">${i(s.state)} · ${i(_n(s.dueAt))}</span>
    ...
    `}function yb(e){const t=ke(),n=qe();return`
      <section class="page textbooks-page n5-course-page n4-course-page">
        <div class="section-head">
          <div>
    ...
    `}function jb(e){const t=ke(),n=Fr("N4","n4_reading_page"),s=_s("N4");return(n||s)&&N(),`
      <section class="page textbooks-page n5-course-page n4-course-page">
        <div class="section-head">
          <div>
        ...
        <div class="n4-section-grid">
          ${r.n4Reading.map(a=>mu(a,"reading")).join("")}
        </div>
      </section>
    `}function Sb(e){const t=ke();return`
      <section class="page textbooks-page n5-course-page n4-course-page">
        ...
        <div class="n4-section-grid">
          ${r.n4Listening.map(n=>mu(n,"listening")).join("")}
        </div>
      </section>
    `}function mu(e,t){const n=ke(),s=t==="reading"?W().completedReading[e.id]:W().completedListening[e.id],a=t==="reading"?W().readingAnswers:W().listeningAnswers,o=t==="reading"?"n4-reading-complete":"n4-listening-complete";return`
      <article class="n4-reading-card ${s?"is-correct":""}">
        ...
        ${(e.questions||[]).map((c,l)=>{const d=`${e.id}:${l}`,u=a?.[d],m=Array.isArray(c.options)?c.options:[];return`
            <div class="n4-question-block">
              ...
              <div class="n5-option-grid">
                ${m.map(v=>`<button class="btn ${u?.selected===v.value?u.correct?"success":"warning":"ghost"}" type="button" data-action="${g(o)}" data-id="${g(e.id)}" data-question="${g(l)}" data-value="${g(v.value)}">${i(f(v.label||v))}</button>`).join("")}
              </div>
              ${u?`<p class="n5-feedback">${i(u.correct?n.correctAnswer:n.wrongAnswer)}</p>`:""}
            </div>
          `}).join("")}
      </article>
    `}function Nb(e){const t=ke(),n=r.n4FinalTest||{},s=yu(),a=W().finalTest,o=Bt(a,s),c=o.answered,l=o.ready;if(a&&typeof a.score=="number"&&a.score>0&&a.totalQuestions>0){const m=Math.round(a.score/a.totalQuestions*100);(!a.percent||a.percent===0||a.percent!==m)&&(a.percent=m),a.completedAt||(a.completedAt=new Date().toISOString()),N()}const d=!!a.completedAt||typeof a.percent=="number"&&a.percent>0||typeof a.score=="number"&&a.score>0,u=typeof a.percent=="number"&&a.percent>0?a.percent:Number(a.score||0)&&a.totalQuestions?Math.round(a.score/a.totalQuestions*100):0;return`
    ...
    `}function Lb(e,t){const n=W().finalTest.answers?.[e.id],s=!!W().finalTest.completedAt;return`
    ...
    `}function Vb(e){const t=Cu(e.id),n=me();let s=e.kanji.filter(a=>H().studiedKanji[a]).length;return t==="completed"&&(s=e.kanji.length),`
    ...
    `}function Yb(e,t){const n=me(),s=kr(t),a=Ka(t),o=Cu(t.id),c=Wn("N3",t,s);let l=o==="completed";const d=`n3:${t.id}`;ae.has(d)&&(l=!0);const u=l,m=a.filter(F=>Eo(F.id)?.correct).length,v=a.length>0&&m===a.length,h=s.filter(F=>H().studiedKanji[F.kanji]).length,w=t.kanji.length,$=h>=w,y=!l&&v&&$,L=t.kanji.filter(F=>H().difficultKanji[F]).join(" · "),b=it().find(F=>F.order===t.order+1),k=Su(t),B=k?!!H().completedReading[k.id]:!1,U=vt("N3",t.id,"player"),as=vt("N3",t.id,"test");return`
      <section class="page textbooks-page n5-course-page n3-course-page n5-lesson-page">
        ...
        ${dr("N3",t,s,n,{playerId:U,answerAction:"jlpt-lesson-answer",examples:F=>ot(F),sentence:F=>ek(F,t)})}
    ...
    `}function Su(e){return e?.miniReadingId&&r.n3Reading.find(t=>t.id===e.miniReadingId)||null}function Zb(e){const t=me(),n=Su(e);return n?`
      <section class="n5-panel">
        <div>
    ...
    `}function tk(e){const t=me(),n=(e.grammarFocus||[]).map(s=>Po(s)).filter(Boolean).slice(0,3);return n.length?`
    ...
    `:""}function Nu(e){const t=me(),n=Eo(e.id),s=n?n.correct?"is-correct":"is-wrong":"",a=r.route==="review"&&fn("N3",e.id)&&!!n;return e.type==="active-recall"?`
        <article class="n5-exercise-card ${s}">
          <span class="pill">${i(f(e.title))}</span>
          <h3>${i(e.prompt)}</h3>
          <div class="n5-input-row">
    ...
    `}function Lu(e,t){if(!t)return"";const n=me(),s=t.correct?n.correctAnswer:`${n.wrongAnswer}: ${e.answerLabel||e.answer}`;return`<p class="n5-feedback">${i(s)}</p>`}function nk(e){const t=me(),n=H().activeReviewMode||"due",s=Ck(n);return`
      <section class="page textbooks-page n5-course-page n3-course-page">
        <div class="section-head">
          <div>
        ...
        <div class="n5-kanji-grid">
          ${s.map((a,o)=>sk(a,o)).join("")||`<article class="empty-state"><h3>${i(t.noReviewCards)}</h3></article>`}
        </div>
      </section>
    `}function sk(e,t){const n=me(),s=D(e.id);return`
      <article class="n5-kanji-card n5-review-card">
        <div class="n5-kanji-topline">
          <span class="pill">${t+1}</span>
          <span class="pill">${i(s.state)} · ${i(_n(s.dueAt))}</span>
    ...
    `}function rk(e){const t=me(),n=Xe();return`
      <section class="page textbooks-page n5-course-page n3-course-page">
        <div class="section-head">
          <div>
    ...
    `}function ik(e){const t=me(),n=Fr("N3","n3_reading_page"),s=_s("N3");return(n||s)&&N(),`
      <section class="page textbooks-page n5-course-page n3-course-page">
        <div class="section-head">
          <div>
    ...
    `}function ok(e){const t=me();return`
      <section class="page textbooks-page n5-course-page n3-course-page">
        <div class="section-head">
          <div>
    ...
    `}function lk(e){const t=me(),n=r.n3FinalTest||{},s=_u(),a=H().finalTest,o=Bt(a,s),c=o.answered,l=o.ready;if(a&&typeof a.score=="number"&&a.score>0&&a.totalQuestions>0){const m=Math.round(a.score/a.totalQuestions*100);(!a.percent||a.percent===0||a.percent!==m)&&(a.percent=m),a.completedAt||(a.completedAt=new Date().toISOString()),N()}const d=!!a.completedAt||typeof a.percent=="number"&&a.percent>0||typeof a.score=="number"&&a.score>0,u=typeof a.percent=="number"&&a.percent>0?a.percent:Number(a.score||0)&&a.totalQuestions?Math.round(a.score/a.totalQuestions*100):0;return`
    ...
    `}function ck(e,t){const n=H().finalTest.answers?.[e.id],s=!!H().finalTest.completedAt;return`
      <article class="n5-exercise-card ${s?n===e.answer?"is-correct":"is-wrong":""}">
        <span class="pill">${t+1} · ${i(e.type)}</span>
        <h3>${i(e.prompt)}</h3>
        <div class="n5-option-grid">
    ...
    `}function Mk(e){const t=Ou(e.id),n=fe();let s=e.kanji.filter(a=>q().studiedKanji[a]).length;return t==="completed"&&(s=e.kanji.length),`
    ...
    `}function Pk(e,t){const n=fe(),s=$r(t),a=Da(t),o=Ou(t.id),c=Wn("N2",t,s);let l=o==="completed";const d=`n2:${t.id}`;ae.has(d)&&(l=!0);const u=l,m=a.filter(F=>Oo(F.id)?.correct).length,v=a.length>0&&m===a.length,h=s.filter(F=>q().studiedKanji[F.kanji]).length,w=t.kanji.length,$=h>=w,y=!l&&v&&$,L=t.kanji.filter(F=>q().difficultKanji[F]).join(" · "),b=lt().find(F=>F.order===t.order+1),k=Eu(t),B=k?!!q().completedReading[k.id]:!1,U=vt("N2",t.id,"player"),as=vt("N2",t.id,"test");return`
      <section class="page textbooks-page n5-course-page n2-course-page n5-lesson-page">
        ...
        ${dr("N2",t,s,n,{playerId:U,answerAction:"jlpt-lesson-answer",examples:F=>ct(F),sentence:F=>Kk(F,t)})}
    ...
    `}function Eu(e){return e?.miniReadingId&&r.n2Reading.find(t=>t.id===e.miniReadingId)||null}function Ek(e){const t=fe(),n=Eu(e);return n?`
      <section class="n5-panel">
        <div>
          <h2>${i(t.miniReadingTitle)}</h2>
          <p>${i(t.miniReadingText)}</p>
    ...
    `}function Dk(e){const t=fe(),n=(e.grammarFocus||[]).map(s=>Fo(s)).filter(Boolean).slice(0,3);return n.length?`
    ...
    `:""}function Ku(e){const t=fe(),n=Oo(e.id),s=n?n.correct?"is-correct":"is-wrong":"",a=r.route==="review"&&fn("N2",e.id)&&!!n;return e.type==="active-recall"?`
        <article class="n5-exercise-card ${s}">
          <span class="pill">${i(f(e.title))}</span>
          <h3>${i(e.prompt)}</h3>
          <div class="n5-input-row">
    ...
    `}function Du(e,t){if(!t)return"";const n=fe(),s=t.correct?n.correctAnswer:`${n.wrongAnswer}: ${e.answerLabel||e.answer}`;return`<p class="n5-feedback">${i(s)}</p>`}function Fk(e){const t=fe(),n=q().activeReviewMode||"due",s=uy(n);return`
      <section class="page textbooks-page n5-course-page n2-course-page">
        <div class="section-head">
          <div>
        ...
        <div class="n5-kanji-grid">
          ${s.map((a,o)=>Ok(a,o)).join("")||`<article class="empty-state"><h3>${i(t.noReviewCards)}</h3></article>`}
        </div>
      </section>
    `}function Ok(e,t){const n=fe(),s=D(e.id);return`
      <article class="n5-kanji-card n5-review-card">
        <div class="n5-kanji-topline">
          <span class="pill">${t+1}</span>
          <span class="pill">${i(s.state)} · ${i(_n(s.dueAt))}</span>
    ...
    `}function Bk(e){const t=fe(),n=Ve();return`
      <section class="page textbooks-page n5-course-page n2-course-page">
        <div class="section-head">
          <div>
    ...
    `}function Gk(e){const t=fe(),n=Fr("N2","n2_reading_page"),s=_s("N2");return(n||s)&&N(),`
      <section class="page textbooks-page n5-course-page n2-course-page">
        <div class="section-head">
          <div>
    ...
    `}function zk(e){const t=fe(),n=r.n2FinalTest||{},s=zu(),a=q().finalTest,o=Bt(a,s),c=o.answered,l=o.ready;if(a&&typeof a.score=="number"&&a.score>0&&a.totalQuestions>0){const m=Math.round(a.score/a.totalQuestions*100);(!a.percent||a.percent===0||a.percent!==m)&&(a.percent=m),a.completedAt||(a.completedAt=new Date().toISOString()),N()}const d=!!a.completedAt||typeof a.percent=="number"&&a.percent>0||typeof a.score=="number"&&a.score>0,u=typeof a.percent=="number"&&a.percent>0?a.percent:Number(a.score||0)&&a.totalQuestions?Math.round(a.score/a.totalQuestions*100):0;return`
    ...
    `}function Hk(e,t){const n=q().finalTest.answers?.[e.id],s=!!q().finalTest.completedAt;return`
      <article class="n5-exercise-card ${s?n===e.answer?"is-correct":"is-wrong":""}">
        <span class="pill">${t+1} · ${i(e.type)}</span>
        <h3>${i(e.prompt)}</h3>
        <div class="n5-option-grid">
    ...
    `}function vy(e){const t=Vu(e.id),n=he();let s=e.kanji.filter(a=>ee().studiedKanji[a]).length;return t==="completed"&&(s=e.kanji.length),`
      <a class="n5-lesson-tile ${t}" href="#jlpt/n1/${g(e.id)}" data-action="n1-open-lesson" data-id="${g(e.id)}">
        ...
        <div class="achievement-progress" aria-label="${g(`${s}/${e.kanji.length}`)}"><i style="width:${E(s,e.kanji.length)}%"></i></div>
        <small>${i(s)}/${i(e.kanji.length)} · ${i(_y(t))}</small>
      </a>
    `}function wy(e,t){const n=he(),s=Oa(t),a=Ba(t),o=Vu(t.id),c=Wn("N1",t,s);let l=o==="completed";const d=`n1:${t.id}`;ae.has(d)&&(l=!0);const u=l,m=a.filter(F=>Go(F.id)?.correct).length,v=a.length>0&&m===a.length,h=s.filter(F=>ee().studiedKanji[F.kanji]).length,w=t.kanji.length,$=h>=w,y=!l&&v&&$,L=t.kanji.filter(F=>ee().difficultKanji[F]).join(" · "),b=dt().find(F=>F.order===t.order+1),k=Wu(t),B=k?!!ee().completedReading[k.id]:!1,U=vt("N1",t.id,"player"),as=vt("N1",t.id,"test");return`
      <section class="page textbooks-page n5-course-page n1-course-page n5-lesson-page">
        ...
        ${dr("N1",t,s,n,{playerId:U,answerAction:"jlpt-lesson-answer",examples:F=>ut(F),sentence:F=>ky(F,t)})}
    ...
    `}function Wu(e){return e?.miniReadingId&&r.n1Reading.find(t=>t.id===e.miniReadingId)||null}function by(e){const t=he(),n=Wu(e);return n?`
      <section class="n5-panel">
        <div>
          <h2>${i(t.miniReadingTitle)}</h2>
          <p>${i(t.miniReadingText)}</p>
    ...
    `:""}function ky(e,t){const n=t.sentences.find(a=>a.jp.includes(e.kanji))||t.sentences[0];if(!n)return"";const s=(t.grammarFocus||[]).find(a=>n.jp.includes(String(a).replace(/[гЂњ~].*/,"")))||t.grammarFocus?.[0]||"";return`
      <div class="n5-card-sentence">
        <strong>${i(n.jp)}</strong>
        <span>${i(Q(n.reading||""))}</span>
        <small>${i(f({ru:n.ru,en:n.en}))}</small>
    ...
    `}function yy(e){const t=he(),n=(e.grammarFocus||[]).map(s=>Uo(s)).filter(Boolean).slice(0,3);return n.length?`
    ...
    `:""}function $y(e){const t=he(),n=Go(e.id),s=n?n.correct?"is-correct":"is-wrong":"",a=r.route==="review"&&fn("N1",e.id)&&!!n;return e.type==="active-recall"?`
        <article class="n5-exercise-card ${s}">
          <span class="pill">${i(f(e.title))}</span>
          <h3>${i(e.prompt)}</h3>
          <div class="n5-input-row">
    ...
    `}function Xu(e,t){if(!t)return"";const n=he(),s=t.correct?n.correctAnswer:`${n.wrongAnswer}: ${e.answerLabel||e.answer}`;return`<p class="n5-feedback">${i(s)}</p>`}function jy(e){const t=he(),n=ee().activeReviewMode||"due",s=Xy(n);return`
      <section class="page textbooks-page n5-course-page n1-course-page">
        <div class="section-head">
          <div>
        ...
        <div class="n5-kanji-grid">
          ${s.map((a,o)=>Sy(a,o)).join("")||`<article class="empty-state"><h3>${i(t.noReviewCards)}</h3></article>`}
        </div>
      </section>
    `}function Sy(e,t){const n=he(),s=D(e.id);return`
      <article class="n5-kanji-card n5-review-card">
        <div class="n5-kanji-topline">
          <span class="pill">${t+1}</span>
          <span class="pill">${i(s.state)} · ${i(_n(s.dueAt))}</span>
    ...
    `}function Ny(e){const t=he(),n=kt(),s=n.slice(0,160);return`
      <section class="page textbooks-page n5-course-page n1-course-page">
        <div class="section-head">
          <div>
    ...
    `}function xy(e){const t=he(),n=Fr("N1","n1_reading_page"),s=_s("N1");return(n||s)&&N(),`
      <section class="page textbooks-page n5-course-page n1-course-page">
        <div class="section-head">
          <div>
    ...
    `}function Cy(e){const t=he();return`
      <section class="page textbooks-page n5-course-page n1-course-page">
        <div class="section-head">
          <div>
    ...
    `}function Ay(e){const t=he(),n=r.n1FinalTest||{},s=np(),a=ee().finalTest,o=Bt(a,s),c=o.answered,l=o.ready;if(a&&typeof a.score=="number"&&a.score>0&&a.totalQuestions>0){const m=Math.round(a.score/a.totalQuestions*100);(!a.percent||a.percent===0||a.percent!==m)&&(a.percent=m),a.completedAt||(a.completedAt=new Date().toISOString()),N()}const d=!!a.completedAt||typeof a.percent=="number"&&a.percent>0||typeof a.score=="number"&&a.score>0,u=typeof a.percent=="number"&&a.percent>0?a.percent:Number(a.score||0)&&a.totalQuestions?Math.round(a.score/a.totalQuestions*100):0;return`
    ...
    `}function Ty(e,t){const n=ee().finalTest.answers?.[e.id],s=!!ee().finalTest.completedAt;return`
      <article class="n5-exercise-card ${s?n===e.answer?"is-correct":"is-wrong":""}">
        <span class="pill">${t+1} · ${i(e.type)}</span>
        <h3>${i(e.prompt)}</h3>
        <div class="n5-option-grid">
    ...
    `}function Zy(e,t){return e.apps.length?`
    ...
    `:""}function e$(e,t){const n=Array.isArray(e.kana?.hiragana)?e.kana.hiragana:[],s=Array.isArray(e.kana?.katakana)?e.kana.katakana:[];return!n.length&&!s.length?"":`
      <article class="jlpt-practice-card">
        <h3>${i(t.kana)}</h3>
    ...
    `}function ip(e,t){return t.length?`
    ...
    `:""}function t$(e,t){return e.kanjiFocus.length?`
    ...
    `:""}function n$(e){const t=Array.isArray(e.furigana)?e.furigana:[];return t.length?t.map(n=>n.rt?`<ruby>${i(n.text)}<rt>${i(n.rt)}</rt></ruby>`:i(n.text)).join(""):i(e.word||e.kanji||"")}function s$(e,t){const n=Es(e);if(!n)return"";const s=ss(),a=s.selected[n.id]||[],o=!!s.checked[n.id],c=s.results[n.id]||null,l=a.map(m=>n.tiles[m]).filter(Boolean),d=o&&c?.correct,u=o&&c?c.wrongIndexes||[]:[];return`
      <article class="jlpt-practice-card jlpt-drill-card">
        ...
        <div class="jlpt-sentence-line">${r$(n,l,u)}</div>
        <p class="label">${i(Q(n.reading))}</p>
        <div class="sentence-tiles jlpt-tiles">
          ${n.tiles.map((m,v)=>{const h=a.includes(v);return`
              <button class="sentence-tile ${h?"is-used":""}" type="button" data-action="insert-jlpt-tile" data-index="${v}" ${h||d?"disabled":""}>
    ...
    `}function r$(e,t,n){let s=0;return String(e.sentence||"").split("___").map((a,o,c)=>{if(o===c.length-1)return i(a);const d=(e.blanks[o]||{answer:[]}).answer.length||1,u=t.slice(s,s+d),m=u.some((h,w)=>n.includes(s+w));s+=d;const v=u.length?u.map(h=>`<span>${i(h.kanji)}</span>`).join(""):`<span>${i("в–Ў".repeat(d))}</span>`;return`${i(a)}<span class="sentence-blank ${m?"is-wrong":""}">${v}</span>`}).join("")}function a$(){const e=xr($S()),t=G$(e),n=e.length,s=t?.kind==="card"?t.card:t?.kind==="exercise"?ne(t.card?.id||t.cardId||t.progress?.cardId||""):null;B$(t);const a=t?t.kind==="card"?s?vp(s):As():Q$(t):As();return`
      <section class="page">
        <div class="section-head">
          <div>
            <h1>${i(A("review"))}</h1>
            ...
            <div class="mini-stat-row">
              ...
              ${M(p()==="ru"?"Позже":"Learning later",jS(),"learning")}
              ${M(p()==="ru"?"Всего SRS":"Total SRS",SS(),"cards")}
            </div>
          </div>
          <div class="actions">
            ${Ks("srs")}
    ...
    `}function i$(){try{return o$()}catch(e){return console.warn("[Flash Kanji] sentence practice skipped after stale saved progress.",e),r.progress&&(r.progress.sentencePractice=Qi(us().sentencePractice,{})),""}}function o$(){const e=Ot(),t=Ja(e),n={...Ns(),...Jo()},s=l$(e,n);if(!e.length)return`
      ...
      `;const a=Ho(t,e);if(!a)return"";const{exercise:o,tiles:c,selectedTiles:l,answerFlat:d,wrongIndexes:u,complete:m,awarded:v}=a,h=new Set(r.progress.sentencePractice.selected),w=r.progress.sentencePractice.result||{};return`
      <article class="sentence-practice${r.progress.sentencePractice.checked?m?" is-success":" is-error":""}" data-section="sentence-practice" aria-live="polite">
        <div class="section-head sentence-head">
          ...
          <div class="tag-row">
            ...
            ${o.source?`<span class="pill">${i(d$(o.source,n))}</span>`:""}
        ...
        <div class="sentence-card">
          <div class="sentence-line">${lp(o,l,u)}</div>
          <p class="sentence-reading">${i(o.reading||"")}</p>
          <p class="sentence-translation">${i(u$(o))}</p>
        </div>
        <div class="sentence-tiles">
          ${c.map((y,L)=>{const b=h.has(L),k=u.includes(r.progress.sentencePractice.selected.indexOf(L));return`
    ...
    `}function l$(e,t){const n=Ae(),s=wa(n.customDraft||{}),a=Array.isArray(n.customSentences)?n.customSentences:[],o=a.length,c=!!n.customEditingId,l=n.customStatus?` is-${n.customStatus}`:"";return`
    ...
    `}function c$(e,t,n){return e.length?`
    ...
    `:`<p class="sentence-custom-empty">${i(n.customEmpty)}</p>`}function d$(e,t){return e==="user"||e==="custom"?t.userSource||t.customSource:e==="dynamic"?t.dynamicSource:e}function Ns(){return p()==="ru"?{title:"Практика предложений",subtitle:"Только из изученных кандзи: {learned}/{total}",progress:"{done}/{total} готово",noLearned:"Сначала изучи несколько кандзи в уроках или повторении. После этого появятся предложения.",notEnough:"Изучено {count} кандзи. Для упражнения нужно минимум 4 изученных кандзи, чтобы собрать варианты.",noExercise:"Изученные кандзи пока не складываются в доступные предложения. Продолжай уроки, и блок откроется.",tip:"Заполни {count} пропуск(а) плитками по порядку.",check:"Проверить",clear:"Очистить",next:"Следующее",undo:"Убрать",completedBefore:"Награда за это предложение уже получена.",fillAll:"Заполни все пропуски перед проверкой.",correct:"Верно. Предложение собрано правильно.",wrong:"Проверь красные места и попробуй ещё раз.",full:"Все пропуски уже заполнены.",inserted:"Плитка вставлена.",removed:"Последняя плитка убрана."}:{title:"Sentence practice",subtitle:"Only learned kanji: {learned}/{total}",progress:"{done}/{total} done",noLearned:"Study a few kanji first. Sentence practice will unlock after that.",notEnough:"{count} kanji learned. You need at least 4 learned kanji for tile choices.",noExercise:"Your learned kanji do not form an available sentence yet. Continue lessons to unlock this block.",tip:"Fill {count} blank slot(s) with tiles in order.",check:"Check",clear:"Clear",next:"Next",undo:"Undo",completedBefore:"Reward for this sentence was already claimed.",fillAll:"Fill every blank before checking.",correct:"Correct. The sentence is complete.",wrong:"Check the red slots and try again.",full:"All blank slots are already filled.",inserted:"Tile inserted.",removed:"Last tile removed."}}function Jo(){return p()==="ru"?{customTitle:"Своё предложение",customCount:"Своих: {count}",customSentence:"Японское предложение",customSentencePlaceholder:"私は日本語を勉強します。",customReading:"Чтение хираганой",customReadingPlaceholder:"わたしは にほんごを べんきょうします。",customTranslationRu:"Перевод RU",customTranslationRuPlaceholder:"Я изучаю японский.",customTranslationEn:"Translation EN",customTranslationEnPlaceholder:"I study Japanese.",addCustom:"Добавить",customHelp:"Вставь фразу. Приложение спрячет только изученные кандзи: {learned}.",customAdded:"Предложение добавлено.",customNoSentence:"Вставь японское предложение.",customNoKnown:"В этом предложении нет изученных кандзи.",customNoTiles:"Нужно минимум 4 изученных кандзи для вариантов.",customDuplicate:"Такое предложение уже есть.",customUpdated:"Предложение обновлено.",customDeleted:"Предложение удалено.",customEmpty:"Свои предложения появятся здесь.",customReady:"Доступно",customLocked:"Позже",updateCustom:"Сохранить",cancelEdit:"Отмена",editCustom:"Редактировать",deleteCustom:"Удалить",customSource:"Своё",userSource:"USER",dynamicSource:"JSON"}:{customTitle:"Custom sentence",customCount:"Custom: {count}",customSentence:"Japanese sentence",customSentencePlaceholder:"私は日本語を勉強します。",customReading:"Hiragana reading",customReadingPlaceholder:"わたしは にほんごを べんきょうします。",customTranslationRu:"Translation RU",customTranslationRuPlaceholder:"Я изучаю японский.",customTranslationEn:"Translation EN",customTranslationEnPlaceholder:"I study Japanese.",addCustom:"Add",customHelp:"Paste a phrase. The app will hide only learned kanji: {learned}.",customAdded:"Sentence added.",customNoSentence:"Paste a Japanese sentence.",customNoKnown:"No learned kanji found in this sentence.",customNoTiles:"You need at least 4 learned kanji for tile choices.",customDuplicate:"This sentence already exists.",customUpdated:"Sentence updated.",customDeleted:"Sentence deleted.",customEmpty:"Your sentences will appear here.",customReady:"Ready",customLocked:"Later",updateCustom:"Save",cancelEdit:"Cancel",editCustom:"Edit",deleteCustom:"Delete",customSource:"Custom",userSource:"USER",dynamicSource:"JSON"}}function u$(e){return p()==="en"?e?.translationEn||e?.translationRu||"":e?.translationRu||e?.translationEn||""}function op(e=Ot()){const t=p$(e),n=g$(e),s=Array.isArray(r.sentenceExercises)?r.sentenceExercises:[],a=new Set;return[...t,...n,...s].filter(o=>!o?.id||a.has(o.id)?!1:(a.add(o.id),!0))}function p$(e=Ot()){const t=Ae();return(Array.isArray(t.customSentences)?t.customSentences:[]).map(s=>zo(s,e)).filter(Boolean)}function zo(e,t=Ot()){return e?.jp?qo({id:e.id,jlpt:L$(e.jp,t),sentence:e.jp,reading:e.hiragana||Nr(e.jp),translationRu:e.ru||"",translationEn:e.en||"",source:"user"},t,{maxBlanks:3,maxBlankChars:5}):null}function lp(e,t,n){const s=e?.blanks||[],a=String(e?.sentence||"").split("___");let o=0;return a.map((c,l)=>{const d=s[l];if(!d)return i(c);const u=d.answer||[],m=u.map((v,h)=>{const w=o+h,$=t[w],y=n.includes(w);return`<span class="sentence-slot ${$?"is-filled":""} ${y?"is-wrong":""}">${$?i($.kanji):""}</span>`}).join("");return o+=u.length,`${i(c)}<span class="sentence-blank">${m}</span>`}).join("")}function Ho(e=Ja(),t=Ot()){const n=Vn(t),s=(Array.isArray(e)?e:[]).filter($=>$?.id),a=Ae();new Set(s.map($=>$.id)).has(a.activeId)||Ga(Wo(s)?.id||null);const c=s.find($=>$.id===r.progress.sentencePractice.activeId)||s[0];if(!c)return null;const l=yt(c);(!Array.isArray(r.progress.sentencePractice.tileKeys)||!r.progress.sentencePractice.tileKeys.length)&&(r.progress.sentencePractice.tileKeys=jn(c,n).map(qa));let d=(Array.isArray(r.progress.sentencePractice.tileKeys)?r.progress.sentencePractice.tileKeys:[]).map(C$).filter(Boolean);const u=()=>l.every($=>d.some(y=>y.kanji===$.kanji));(d.length<Math.max(4,l.length)||!u())&&(d=jn(c,n),r.progress.sentencePractice.tileKeys=d.map(qa),r.progress.sentencePractice.selected=[],r.progress.sentencePractice.checked=!1,r.progress.sentencePractice.result=null);const m=Array.isArray(r.progress.sentencePractice.selected)?r.progress.sentencePractice.selected:[];r.progress.sentencePractice.selected=m.filter(($,y,L)=>Number.isInteger($)&&$>=0&&$<d.length&&L.indexOf($)===y).slice(0,l.length);const v=r.progress.sentencePractice.selected.map($=>d[$]).filter(Boolean),h=r.progress.sentencePractice.checked&&r.progress.sentencePractice.result?r.progress.sentencePractice.result.wrongIndexes:[],w=Array.isArray(h)?h.filter($=>Number.isInteger($)&&$>=0&&$<l.length):[];return{exercise:c,tiles:d,selectedTiles:v,answerFlat:l,wrongIndexes:w,complete:!!(r.progress.sentencePractice.checked&&r.progress.sentencePractice.result?.correct),awarded:!!r.progress.sentencePractice.completed?.[c.id]}}function Ae(){return r.progress.sentencePractice=Qi(us().sentencePractice,r.progress.sentencePractice||{}),r.progress.sentencePractice}function Ga(e){r.progress.sentencePractice={...Ae(),activeId:e,selected:[],checked:!1,result:null,tileKeys:[]};const t=op(Ot()).find(n=>n?.id===e);t&&pp(t)}function Vn(e){return(Array.isArray(e)?e:[]).filter(t=>t?.id&&t.kanji)}function Ot(){return Vn(r.cards).filter(e=>{const t=r.lessons.find(s=>s.id===e.lessonId);if(t&&!Me(t))return!1;const n=D(e.id);return n.state!=="New"||n.reviewCount>0||n.lastReviewedAt||r.progress.lessonCompletions[e.lessonId]})}function Ja(e=Ot()){const t=Vn(e),n=new Set(t.map(s=>s.kanji));return op(t).filter(s=>{if(!s?.id)return!1;const a=yt(s);return!a.length||a.some(o=>!n.has(o.kanji))?!1:jn(s,t).length>=Math.max(4,a.length)})}function yt(e){return(e?.blanks||[]).flatMap(t=>(t.answer||[]).map((n,s)=>({kanji:n,reading:t.reading?.[s]||""})))}function cp(e){return yt(e).map(t=>t.kanji).join("")}function jn(e,t){if(!e?.id)return[];const n=Vn(t),s=yt(e),a=new Set(s.map(h=>h.kanji)),o=new Set(n.map(h=>h.kanji)),c=new Map;[...e.tiles||[],...s].forEach(h=>{h?.kanji&&h?.reading&&c.set(h.kanji,h.reading)});const l=s.map(h=>({kanji:h.kanji,reading:h.reading||c.get(h.kanji)||Xt(h.kanji)})),d=(e.tiles||[]).filter(h=>h?.kanji&&!a.has(h.kanji)&&o.has(h.kanji)).map(h=>({kanji:h.kanji,reading:h.reading||Xt(h.kanji)})).filter((h,w,$)=>$.findIndex(y=>y.kanji===h.kanji)===w),u=n.filter(h=>h.kanji&&!a.has(h.kanji)).map(h=>({kanji:h.kanji,reading:c.get(h.kanji)||Xt(h.kanji,h)})).filter((h,w,$)=>$.findIndex(y=>y.kanji===h.kanji)===w).sort((h,w)=>Te(`${e.id}:${h.kanji}`)-Te(`${e.id}:${w.kanji}`)),m=[...d,...u].filter(h=>!a.has(h.kanji)).filter((h,w,$)=>$.findIndex(y=>y.kanji===h.kanji)===w),v=Math.min(Math.max(6,l.length+2),l.length+m.length);return E$([...l,...m.slice(0,v-l.length)],e.id)}function g$(e){const t=Vn(e);if(!t.length)return[];const n=new Set(t.map(c=>c.kanji)),s=new Set,a=[];return t.flatMap(c=>(c.examples||[]).map(l=>({...l,card:c}))).forEach((c,l)=>{const d=Ls(c.word||"");if(!d||s.has(d)||!x$(d)||up(d).some($=>!n.has($)))return;s.add(d);const u=Yn(c.reading||Nr(d)),m=c.translation||d,v=[{sentence:`今日は${d}をアプリで見ます。`,reading:`きょうは ${u}を あぷりで みます。`,translationRu:`Сегодня я смотрю в приложении: ${m}.`,translationEn:`Today I check ${d} in an app.`},{sentence:`駅で${d}について話します。`,reading:`えきで ${u}について はなします。`,translationRu:`На станции говорю про: ${m}.`,translationEn:`At the station, I talk about ${d}.`},{sentence:`メモに${d}を書きます。`,reading:`めもに ${u}を かきます。`,translationRu:`Я записываю в заметку: ${m}.`,translationEn:`I write ${d} in a memo.`}],h=v[l%v.length],w=qo({id:`sentence-json-${Te(`${d}:${h.sentence}`).toString(36)}`,jlpt:c.card?.jlpt||"N5",sentence:h.sentence,reading:h.reading,translationRu:h.translationRu,translationEn:h.translationEn,source:"dynamic"},t,{maxBlanks:2,maxBlankChars:4});w&&a.push(w)}),a.slice(0,160)}function m$(){const e=Ae(),t={...Ns(),...Jo()},n=wa(f$()||e.customDraft||{}),s=Ot(),a=Sn(n.jp);if(!a){za(t.customNoSentence,"error");return}const o=e.customEditingId||null;if(b$(a,o)){za(t.customDuplicate,"error");return}const l=Ae(),d={id:o||`custom_${Date.now().toString(36)}_${Te(a).toString(36)}`,jp:a,hiragana:Yn(Sn(n.hiragana)||Nr(a)),ru:Sn(n.ru),en:Sn(n.en),source:"user"},u=(l.customSentences||[]).findIndex(v=>v.id===d.id);u>=0?l.customSentences[u]=d:l.customSentences=[d,...l.customSentences||[]].slice(0,160),l.customDraft={jp:"",hiragana:"",ru:"",en:""},l.customEditingId=null,za(o?t.customUpdated:t.customAdded,"success",!1);const m=zo(d,s);m&&jn(m,s).length>=Math.max(4,yt(m).length)&&(Ga(m.id),r.progress.sentencePractice.tileKeys=jn(m,s).map(qa)),N(),C()}function f$(){const e=document.querySelector(".sentence-builder");if(!e)return null;const t=n=>e.querySelector(`[data-sentence-draft="${n}"]`)?.value||"";return{jp:t("jp"),hiragana:t("hiragana"),ru:t("ru"),en:t("en")}}function h$(e){const t=Ae(),n=(t.customSentences||[]).find(s=>s.id===e);n&&(t.customEditingId=n.id,t.customDraft={jp:n.jp||"",hiragana:n.hiragana||"",ru:n.ru||"",en:n.en||""},t.customMessage="",t.customStatus="",N(),C())}function v$(e){const t=Ae(),n={...Ns(),...Jo()},s=(t.customSentences||[]).length;if(t.customSentences=(t.customSentences||[]).filter(a=>a.id!==e),t.customSentences.length!==s){if(t.customEditingId===e&&(t.customEditingId=null,t.customDraft={jp:"",hiragana:"",ru:"",en:""}),t.completed?.[e]&&delete t.completed[e],t.recentIds=(t.recentIds||[]).filter(a=>a!==e),t.activeId===e){const a=Ot(),o=Wo(Ja(a));Ga(o?.id||null)}za(n.customDeleted,"success",!1),N(),C()}}function w$(){const e=Ae();e.customEditingId=null,e.customDraft={jp:"",hiragana:"",ru:"",en:""},e.customMessage="",e.customStatus="",N(),C()}function b$(e,t=null){const n=Ls(e);return(Ae().customSentences||[]).some(a=>a.id!==t&&Ls(a.jp)===n)?!0:r.sentenceExercises.some(a=>Ls(dp(a))===n)}function za(e,t,n=!0){const s=Ae();s.customMessage=e,s.customStatus=t,N(),n&&C()}function qo(e,t,n={}){if(!e||typeof e!="object")return null;const s=Vn(t),a=Ls(e.sentence||"");if(!a||!e.id||!s.length)return null;const o=k$(a,s).filter(m=>m.answer.length<=Number(n.maxBlankChars||5));if(!o.length)return null;const c=y$(o,a,n);if(!c.length)return null;let l="",d=0;const u=c.map(m=>(l+=a.slice(d,m.start)+"___",d=m.end,{answer:m.answer,reading:$$(m.text)}));return l+=a.slice(d),{id:e.id,kind:e.kind||"cloze",jlpt:e.jlpt||"N5",sentence:l,originalSentence:a,reading:Yn(e.reading||Nr(a)),translationRu:e.translationRu||"",translationEn:e.translationEn||"",blanks:u,tiles:u.flatMap(m=>m.answer.map((v,h)=>({kanji:v,reading:m.reading[h]||Xt(v)}))),source:e.source||"custom",createdAt:e.createdAt}}function k$(e,t){const n=new Map(Vn(t).map(o=>[o.kanji,o])),s=[];let a=null;return Array.from(e).forEach((o,c)=>{if(Ha(o)&&n.has(o)){a||(a={start:c,end:c,text:"",answer:[]}),a.end=c+1,a.text+=o,a.answer.push(o);return}a&&s.push(a),a=null}),a&&s.push(a),s}function y$(e,t,n={}){const s=Number(n.maxBlanks||2),a=Number(n.maxBlankChars||5),o=e.filter(m=>m.start>0&&m.end<t.length),c=e.filter(m=>m.start>0),l=(o.length?o:c.length?c:e).slice().sort((m,v)=>{const h=v.answer.length-m.answer.length;return h||Math.abs(m.start-t.length/2)-Math.abs(v.start-t.length/2)}),d=[];let u=0;return l.forEach(m=>{d.length>=s||u+m.answer.length>a||(d.push(m),u+=m.answer.length)}),d.sort((m,v)=>m.start-v.start)}function $$(e){const t=Array.from(e),n=j$(e);return n?S$(t,Yn(n)):t.map(s=>Xt(s))}function j$(e){for(const t of r.cards)for(const n of t.examples||[])if(n.word===e&&n.reading)return n.reading;return""}function S$(e,t){const n=Array(e.length).fill("");let s=t;for(let a=e.length-1;a>0;a-=1){const c=N$(e[a]).sort((l,d)=>d.length-l.length).find(l=>l&&s.endsWith(l));c&&(n[a]=c,s=s.slice(0,-c.length))}return n[0]=s||Xt(e[0]),n.map((a,o)=>a||Xt(e[o]))}function N$(e){const t=r.cards.find(s=>s.kanji===e),n=[t?.hiragana,t?.onyomi,t?.kunyomi].flatMap(s=>String(s||"").split(/[\/,;гѓ»гЂЃ\s]+/)).map(s=>Yn(s.trim())).filter(Boolean);return[...new Set(n)]}function Nr(e){return Yn(Array.from(e).map(t=>Ha(t)?Xt(t):t).join(""))}function L$(e,t){const n=["N5","N4","N3","N2","N1"],s=new Map(t.map(o=>[o.kanji,o]));return up(e).map(o=>s.get(o)?.jlpt).filter(Boolean).sort((o,c)=>n.indexOf(c)-n.indexOf(o))[0]||"N5"}function Ls(e){return String(e||"").replace(/\s+/g,"").trim()}function Sn(e){return String(e||"").replace(/\s+/g," ").trim()}function dp(e){if(!e)return"";if(e.jp)return e.jp;if(e.originalSentence)return e.originalSentence;let t=0;return String(e.sentence||"").replace(/___/g,()=>(e.blanks?.[t++]?.answer||[]).join(""))}function x$(e){return Array.from(String(e||"")).some(Ha)}function up(e){return Array.from(String(e||"")).filter(Ha)}function Ha(e){return/[㐀-鿿]/u.test(e)}function Yn(e){return String(e||"").replace(/[ァ-ヶ]/g,t=>String.fromCharCode(t.charCodeAt(0)-96))}function Q(e){return Yn(String(e||""))}function Xt(e,t=r.cards.find(n=>n.kanji===e)){const n=t?.onyomi||t?.kunyomi||t?.hiragana||"";return String(n).split("/")[0].trim()||"かな"}function qa(e){return`${e.kanji}	${e.reading||""}`}function C$(e){const[t,n]=String(e||"").split("	");return t?{kanji:t,reading:n||Xt(t)}:null}function A$(e){const t=Ho();if(!t||!Number.isInteger(e))return;const n=Ns(),s=r.progress.sentencePractice;if(!(s.result?.correct||s.selected.includes(e))){if(s.selected.length>=t.answerFlat.length){J(n.full);return}s.selected.push(e),s.checked=!1,s.result={correct:!1,message:n.inserted,wrongIndexes:[]},N(),C()}}function T$(){const e=Ae();!e.selected.length||e.result?.correct||(e.selected.pop(),e.checked=!1,e.result={correct:!1,message:Ns().removed,wrongIndexes:[]},N(),C())}function I$(){const e=Ae();e.result?.correct||(e.selected=[],e.checked=!1,e.result=null,N(),C())}function R$(){const e=Ho();if(!e)return;const t=Ns(),n=r.progress.sentencePractice;if(n.selected.length<e.answerFlat.length){n.checked=!0,n.result={correct:!1,message:t.fillAll,wrongIndexes:[]},N(),C();return}const s=e.answerFlat.map((o,c)=>e.selectedTiles[c]?.kanji===o.kanji?-1:c).filter(o=>o>=0),a=s.length===0;if(n.checked=!0,n.attempts=(n.attempts||0)+1,n.result={correct:a,wrongIndexes:s,message:a?t.correct:t.wrong},a)_$(e.exercise),Se({trust:.8,curiosity:.5,discipline:.4},"sentence_correct"),Ne("sentence_complete",{exerciseId:e.exercise.id,source:e.exercise.source||"builtin"}),hi("ok");else{r.progress.totalWrong+=1,r.progress.correctCombo=0,Se({discipline:-.6,curiosity:.2},"sentence_wrong"),Ne("answer_wrong",{exerciseId:e.exercise.id,mode:"sentence"});const o=Vt();o.mistakes+=1,r.progress.daily[re()]=o,hi("again")}N(),C()}function _$(e){const t=Ae();if(t.completed[e.id])return;const n=r.rewards?.rewards||{},s=n.sentencePracticeXp||ql.xp,a=n.sentencePracticeCoins||ql.coins;t.completed[e.id]=new Date().toISOString(),r.progress.totalCorrect+=1,r.progress.correctCombo+=1,r.progress.bestCorrectCombo=Math.max(r.progress.bestCorrectCombo,r.progress.correctCombo);const o=Vt();o.reviews+=1,o.minutes=yi((o.minutes||0)+.8,1),r.progress.daily[re()]=o,G(s,a,`sentence:${e.id}`),Se({trust:.8,curiosity:.7},"sentence_complete"),ve(),il(),X()}function M$(){const e=Ot(),t=Ja(e);if(!t.length)return;const n=r.progress.sentencePractice?.activeId,s=t.find(o=>o?.id===n);s&&pp(s);const a=Wo(t,{excludeCurrent:!0,preferUncompleted:!0});a?.id&&(Ga(a.id),r.progress.sentencePractice.tileKeys=jn(a,e).map(qa),N(),C())}function Wo(e,t={}){const n=(Array.isArray(e)?e:[]).filter(y=>y?.id);if(!n.length)return null;const s=Ae(),a=s.activeId,o=new Set(s.recentIds||[]),c=new Set(s.recentAnswers||[]),l=y=>!t.excludeCurrent||n.length===1||y.id!==a,d=y=>!t.preferUncompleted||!s.completed?.[y.id],u=y=>!c.has(cp(y)),m=y=>!o.has(y.id),h=[n.filter(l).filter(d).filter(u).filter(m),n.filter(l).filter(d).filter(u),n.filter(l).filter(u).filter(m),n.filter(l).filter(m),n.filter(l),n].find(y=>y.length)||n,w=h.filter(P$),$=w.length?w:h;return $[Math.floor(Math.random()*$.length)]}function P$(e){return e?.source==="user"||e?.source==="custom"||e?.source==="dynamic"||String(e?.sentence||"").indexOf("___")>0}function pp(e){if(!e?.id)return;const t=Ae(),n=cp(e),s=Array.isArray(t.recentIds)?t.recentIds:[],a=Array.isArray(t.recentAnswers)?t.recentAnswers:[];t.recentIds=[e.id,...s.filter(o=>o!==e.id)].slice(0,14),t.recentAnswers=[n,...a.filter(o=>o!==n)].slice(0,8)}function Te(e){return String(e).split("").reduce((t,n)=>(t<<5)-t+n.charCodeAt(0)|0,0)>>>0}function E$(e,t){return[...e].sort((n,s)=>Te(`${t}:${n.kanji}:${n.reading}`)-Te(`${t}:${s.kanji}:${s.reading}`))}function Bt(e,t=[]){const n=t.filter(a=>String(e?.answers?.[a.id]||"").trim()).length,s=t.filter(a=>!String(e?.answers?.[a.id]||"").trim());return{answered:n,missingCount:s.length,missingIds:s.map(a=>a.id),firstMissingId:s[0]?.id||null,totalQuestions:t.length,ready:t.length>0&&s.length===0}}function xs(e,t){const n=String(e||"n5").toLowerCase(),s=String(t||"").replace(/[^a-z0-9_-]+/gi,"-");return`${n}-final-question-${s}`}function K$(e){return Number(e?.passingPercent??e?.passThreshold??70)}function D$(){const e=r.finalTestModal;if(!e)return"";const t=e.kind==="warning",n=t?"thinking":e.passed?"proud":"sad",s=t?"":Nt(e.level,"btn ghost");!t&&(!e.percent||e.percent===0)&&typeof e.correct=="number"&&e.totalQuestions>0&&(e.percent=Math.round(e.correct/e.totalQuestions*100));const a=t?[`<span>${i(p()==="ru"?"Вопросов":"Questions")} ${e.totalQuestions}</span>`,`<span>${i(p()==="ru"?"Пропусков":"Missing")} ${e.missingCount}</span>`,`<span>${i(p()==="ru"?"Порог":"Pass")} ${e.threshold}%</span>`]:[`<span>${i(p()==="ru"?"Результат":"Score")} ${e.percent}%</span>`,`<span>${i(p()==="ru"?"Верно":"Correct")} ${e.correct}/${e.totalQuestions}</span>`,`<span>${i(p()==="ru"?"Ошибки":"Errors")} ${e.incorrect}</span>`,`<span>${i(p()==="ru"?"Пропуски":"Missing")} ${e.unanswered}</span>`,`<span>+${e.rewardXp} XP</span>`,`<span>+${e.rewardMoon} ${i(A("coins"))}</span>`];return`
    ...
    `}function gp(e){const t=GS(e);if(!t&&!BS(e))return"";const n=t?p()==="ru"?"Озвучить следующее чтение кандзи":"Speak the next kanji reading":p()==="ru"?"Проиграть озвучку кандзи":"Play kanji audio";return`
    ...
    `}function Wa(e){const t=Dr(e);return`
      <div class="reading-row reading-split">
        ${mp(e,"onyomi",lg("onyomi"),t.onyomi.kana,t.onyomi.romaji)}
        ${mp(e,"kunyomi",lg("kunyomi"),t.kunyomi.kana,t.kunyomi.romaji)}
      </div>
    `}function mp(e,t,n,s,a){const o=hp(e,t,n);return`
    ...
    `}function F$(e){const t=r.readingCheck.cardId===e.id?r.readingCheck:{value:"",status:null,message:""},n=t.status?` is-${t.status}`:"",s=t.message||(p()==="ru"?"Напиши любое чтение этого кандзи хираганой или катаканой.":"Type any reading for this kanji in hiragana or katakana.");return`
    ...
    `}function O$(e){return`
      <div class="answer-section">
        ...
        <div class="rating-grid srs-binary-grid">
          ...
          <button class="btn success" type="button" data-action="rate" data-rating="remember">${i(Ya().remember)} <small>${i(Bj(e))}</small></button>
        </div>
      </div>
    ...
    `}function Lr(){r.reviewExerciseResults={},r.activeExerciseReviewId=null,r.activeExerciseReviewLevel="",r.activeExerciseReviewSource="",r.activeExerciseReviewSelection=[],r.activeExerciseReviewChoice="",r.activeExerciseReviewTranslationOpen=!1}function B$(e){if(!e){r.activeCardId=null,Lr();return}if(r.reviewQueueLastKind=e.kind,e.kind==="card"){const t=ne(e.card?.id||e.cardId||e.progress?.cardId||"");if(!t?.id){r.activeCardId=null,Lr();return}r.activeCardId!==t.id&&(r.activeCardId=t.id,Lr());return}if(e.kind==="exercise"){const t=r.activeExerciseReviewId===e.exerciseId&&r.activeExerciseReviewLevel===e.level&&r.activeExerciseReviewSource===String(e.source||"textbook");r.activeCardId=null,r.activeExerciseReviewId=e.exerciseId,r.activeExerciseReviewLevel=e.level,r.activeExerciseReviewSource=String(e.source||"textbook"),t||(r.reviewExerciseResults={}),t||(r.activeExerciseReviewSelection=[],r.activeExerciseReviewChoice="",r.activeExerciseReviewTranslationOpen=!1)}}function Qo(e,t,n="",s=null,a=null,o="textbook"){const c=V(e);if(!c||!t)return null;if(String(o||"textbook")==="reading"){const h=a||qp(t,c);if(!h)return null;const w=Er(s||{},h);return{kind:"exercise",source:"reading",key:`reading:${String(c)}:${t}`,level:c,exerciseId:t,lessonId:String(h.sourceId||n||w.lessonId||""),cardId:"",dueAt:w.dueAt?new Date(w.dueAt).getTime():0,progress:w,exercise:h,card:null}}const d=es(s||{},{level:c,lessonId:n,exerciseId:t,cardId:s?.cardId||"",kanji:s?.kanji||"",type:s?.type||"",title:s?.title||null,prompt:s?.prompt||"",answer:s?.answer||"",answerLabel:s?.answerLabel||""}),u=a||al(c,t,n||d.lessonId||"");if(!u)return null;const m=String(u.lessonId||d.lessonId||n||""),v=String(u.cardId||d.cardId||"");return{kind:"exercise",source:"textbook",key:`exercise:${c}:${t}`,level:c,exerciseId:t,lessonId:m,cardId:v,dueAt:d.dueAt?new Date(d.dueAt).getTime():0,progress:d,exercise:u,card:ne(v)||ne(d.cardId||"")}}function Cs(){if(!r.activeExerciseReviewId||!r.activeExerciseReviewLevel)return null;const e=r.activeExerciseReviewLevel,t=r.activeExerciseReviewId;if(String(r.activeExerciseReviewSource||"textbook")==="reading"){const o=qp(t,e),c=o?Cn(o):r.progress.readingExercises?.[t]||null;return Qo(e,t,c?.lessonId||o?.sourceId||"",c,o,"reading")}const a=Gj(e)?.exerciseSrs?.[t]||null;return Qo(e,t,a?.lessonId||"",a,null,"textbook")}function Vo(e){return!e||e.kind!=="exercise"?null:Qo(e.level,e.exerciseId,e.lessonId||e.progress?.lessonId||"",e.progress,e.exercise||null,e.source||"textbook")}function U$(e){if(!e||typeof e!="object")return null;if(e.kind==="card"){const t=String(e.card?.id||e.cardId||e.progress?.cardId||""),n=ne(t);if(!n?.id)return null;const s=e.progress||D(n.id);return{...e,kind:"card",key:e.key||`card:${n.id}`,card:n,cardId:String(n.id),progress:s,dueAt:e.dueAt||(s.dueAt?new Date(s.dueAt).getTime():0)}}return e.kind==="exercise"?Vo(e):null}function xr(e){return(Array.isArray(e)?e:[]).map(U$).filter(Boolean)}function G$(e){const t=xr(e),n=Cs();if(n&&r.reviewExerciseResults?.[n.exerciseId]||n&&!t.some(o=>o.kind==="exercise"&&o.exerciseId===n.exerciseId&&o.level===n.level))return n;const s=r.activeCardId?t.find(o=>o.kind==="card"&&o.card?.id===r.activeCardId):null;if(s)return s;const a=r.reviewQueueLastKind==="card"?"exercise":r.reviewQueueLastKind==="exercise"?"card":"";if(a){const o=t.find(c=>c.kind===a);if(o)return o}return t[0]||n||null}function J$(e,t){const n=V(e);return n==="N5"?Vd(t):n==="N4"?pu(t):n==="N3"?Nu(t):n==="N2"?Ku(t):""}function z$(e){return p()==="ru"?e?.kind==="cloze"?"Предложение":"Вопрос":e?.kind==="cloze"?"Sentence":"Question"}function Yo(){return p()==="ru"?"Перевод":"Translation"}function wp(e){const t=String(e||"").trim();return t?t.split(/([гЂ'пјЃпјџгЂЃ\n]+)/u).map(n=>{if(!n)return"";if(/^[гЂ'пјЃпјџгЂЃ\n]+$/u.test(n))return n===`
`?`
`:`${n} `;const s=ig(n);return s?`${s} `:""}).join("").replace(/\s+\n/gu,`
`).replace(/[ \t]+/gu," ").replace(/\s+([гЂ'пјЃпјџгЂЃ])/gu,"$1 ").replace(/([гЂ'пјЃпјџгЂЃ])\s*$/gu,"$1").trim():""}function H$(e){const t=!!r.activeExerciseReviewTranslationOpen,n=e?.reading?Q(e.reading):"",s=e?.reading?wp(e.reading):"",a=f({ru:e?.translationRu||e?.ru||"",en:e?.translationEn||e?.en||""});return`
    ...
    `}function q$(e){return r.reviewExerciseResults?.[e.exerciseId]||Cn(e.exercise)||null}function W$(e,t,n,s){const a=String(t?.id||n),o=s?.answers?.[a]||null,c=Array.isArray(t?.options)?t.options:[],l=c.find(u=>String(u.value||"")===String(t?.answer||"")),d=l?f(l.label||l):String(t?.answer||"");return`
      <div class="n4-question-block reading-question-block">
        <h3>${i(f(t?.prompt||e.exercise.question?.prompt||{}))}</h3>
        <div class="n5-option-grid">
          ${c.map(u=>{const m=o?.selected===u.value,v=o?.correct&&u.value===t.answer,h=o&&!o.correct&&u.value===t.answer;return`<button class="btn ${v||h?"success":m?"warning":"ghost"}" type="button" data-action="reading-review-answer" data-question="${g(a)}" data-value="${g(u.value)}" ${o||s?.completed?"disabled":""}>${i(f(u.label||u))}</button>`}).join("")}
        </div>
        ${o?`<p class="n5-feedback">${i(o.correct?p()==="ru"?"Верно.":"Correct.":`${p()==="ru"?"Неверно":"Wrong"} · ${d}`)}</p>`:""}
      </div>
    `}function X$(e){const t=Vo(e);if(!t||!t.exercise)return As();const n=q$(t),s=!!n?.completed,a=t.progress||Cn(t.exercise),o=z$(t.exercise),c=f(t.exercise.sourceTitle||t.exercise.title||{}),l=yt(t.exercise),d=(t.exercise.kind==="question"?[t.exercise.question||t.exercise.questions?.[0]]:[]).filter(L=>L?.id),u=t.exercise.kind==="cloze"||!d.length&&l.length>0;if(!u&&!d.length)return As();const m=u?s?1:Array.isArray(a?.selectedIndices)?a.selectedIndices.length:0:Object.keys(n?.answers||{}).length,v=u?Math.max(1,l.length):Math.max(1,d.length),h=Array.isArray(a?.selectedIndices)?a.selectedIndices:Array.isArray(r.activeExerciseReviewSelection)?r.activeExerciseReviewSelection:[],w=h.map(L=>t.exercise.tiles?.[L]).filter(Boolean),$=Array.isArray(a?.wrongIndexes)?a.wrongIndexes:[],y=H$(t.exercise);return`
      <article class="study-card textbook-review-card reading-review-card ${s?n?.correct===!1?"is-wrong":"is-correct":""}" data-review-exercise-id="${g(t.exerciseId)}">
        ...
        ${u?`
          <div class="sentence-card reading-cloze-card">
            <div class="sentence-line">${lp(t.exercise,w,$)}</div>
          ...
          <div class="sentence-tiles">
            ${(t.exercise.tiles||[]).map((L,b)=>{const k=h.includes(b),B=$.includes(b);return`
          ...
          <div class="actions sentence-actions">
            ...
            <button class="btn" type="button" data-action="reading-review-undo" ${!h.length||s?"disabled":""}>${i(p()==="ru"?"Убрать":"Undo")}</button>
            <button class="btn" type="button" data-action="reading-review-clear" ${!h.length||s?"disabled":""}>${i(p()==="ru"?"Очистить":"Clear")}</button>
          </div>
        `:d.map((L,b)=>W$(t,L,b,n)).join("")}
    ...
    `}function Q$(e){const t=Vo(e);if(!t||!t.exercise)return As();if(t.source==="reading")return X$(t);const n=!!r.reviewExerciseResults?.[t.exerciseId];return`
    ...
    `}function Y$(){const e=NS(),t=Math.max(zs,Number(r.dictionaryVisibleCount||zs)),n=e.slice(0,t),s=n.length<e.length,a=r.cards.filter(u=>!!r.progress.favorites[u.id]).length,o=["all",...new Set(r.cards.map(u=>u.jlpt))],c=["all",...new Set(r.cards.map(u=>Kr(u.id).radical).filter(Boolean))],l=p()==="ru"?`Показано ${n.length} из ${e.length}`:`Showing ${n.length} of ${e.length}`,d=p()==="ru"?"Показать ещё":"Show more";return`
      <section class="page">
        <div class="section-head">
          <div>
        ...
        <div class="dictionary-grid" style="margin-top:12px">${n.map(ej).join("")||nj()}</div>
        ${s?`
    ...
    `}function Z$(e){const t=r.filters.favorites==="yes",n=p()==="ru"?"Все кандзи":"All kanji",s=p()==="ru"?"Избранные":"Favorites";return`
    ...
    `}function ej(e){const t=D(e.id),n=Kr(e.id),s=!!r.progress.favorites[e.id];return`
      <button class="kanji-tile" type="button" data-action="open-card" data-id="${g(e.id)}">
        ...
        <div class="tag-row">
          ...
          <span class="pill">${i(A("learnedStatus"))}: ${i(Cg(t.state))}</span>
    ...
    `}function nj(){const e=r.filters.favorites==="yes",t=e?p()==="ru"?"В избранном пока пусто":"No favorites yet":p()==="ru"?"Ничего не найдено":"Nothing found",n=e?p()==="ru"?"Открой кандзи и нажми звездочку, чтобы он появился здесь.":"Open a kanji and tap the star to keep it here.":"";return`<article class="empty-state"><span class="kanji-char">無</span><h2>${i(t)}</h2>${n?`<p>${i(n)}</p>`:""}</article>`}function sj(){const e=r.kanjiPageId||fN(),t=ne(e);if(!t)return r.deferredDataLoaded?lo(we("hash","entity-not-found",mN(),En(location.hash).segments)):(ca({route:"kanji",delay:0,force:!0}),Tg());const n=D(t.id),s=Kr(t.id),a=!!r.progress.favorites[t.id],o=bj(t,p()),c=rj(t),l=ol(t);return`
      <section class="page kanji-page">
        <div class="section-head kanji-page-head">
          <div>
            ...
            <h1>${i(c?`${t.kanji} — ${aj(c)}`:t.kanji)}</h1>
            <p>${i(c?ij(c):R(t))}</p>
          </div>
          <div class="actions">
    ...
    `}function rj(e){return r.kanjiPageSources?.[e?.kanji]||null}function aj(e){return bp(e.meanings)[0]||e.literal}function bp(e){return e?e[p()]||e.ru||e.en||[]:[]}function Ts(e){return!e||typeof e!="object"?String(e||""):e[p()]||e.ru||e.en||""}function ij(e){const t=e.editorial?.[p()]||e.editorial?.ru||e.editorial?.en||{};return[t.why,t.firstSeen].filter(Boolean).join(" ")}function oj(e){const t=e.kanjidic2||{},n=t.codepoints?.unicode||`U+${t.codepoints?.ucs||""}`;return`
      <article class="kanji-profile-card kanji-facts-card">
        <h2>${i(p()==="ru"?"Факты KANJIDIC2":"KANJIDIC2 facts")}</h2>
        <dl class="kanji-fact-grid">
          <div><dt>${i(p()==="ru"?"Значения":"Meanings")}</dt><dd>${i(bp(e.meanings).join(", "))}</dd></div>
    ...
    `}function dj(e){const t=new Set,n=new Set((e.commonWords||[]).map(s=>s.surface));return(e.sentences||[]).filter(s=>{const a=s.japanese||"";if(!a.includes(e.literal)||t.has(a))return!1;t.add(a);const o=a.replace(/[\sгЂ'гЂЃпјЃпјџ!?гЂЊгЂЌгЂЋгЂЏпј€пј‰()гѓ»гЂњгѓј]/g,"").length;return!(o<3||o>44)}).sort((s,a)=>Number(kp(a.japanese,n))-Number(kp(s.japanese,n))).slice(0,8)}function kp(e,t){return[...t].some(n=>e.includes(n))}function uj(e){return`
    ...
    `}function pj(e){const t=e.editorial?.[p()]||e.editorial?.ru||e.editorial?.en||{},n=p()==="ru"?["Почему этот кандзи важен","Частая путаница","Где встретишь раньше всего","На что обратить внимание"]:["Why this kanji matters","Common confusion","Where you will meet it first","What to watch"],s=[t.why,t.confusion,t.firstSeen,t.focus];return`
    ...
    `}function gj(e){return`../word/${encodeURIComponent(e.surface||"")}/`}function Zo(e,t){const n=String(t||""),s=String(e||"");return n?s.split(n).map(i).join(`<mark class="kanji-hit" data-kanji="${g(n)}">${i(n)}</mark>`):i(s)}function mj(e){const t=fj(e);return t.length?`
      <ul class="kanji-sentence-list">
        ${t.map(n=>`
          <li>
            <strong>${wj(n)}</strong>
    ...
    `:`<p class="label">${i(p()==="ru"?"Подходящие предложения появятся, когда база практики содержит этот кандзи.":"Matching sentences will appear when the practice database contains this kanji.")}</p>`}function fj(e){const t=e?.kanji||"";return t?(r.sentenceExercises||[]).filter(n=>{const s=yp(n),a=(n.blanks||[]).flatMap(o=>o.answer||[]).join("");return s.includes(t)||a.includes(t)}).slice(0,6):[]}function yp(e){return e?.sentence||e?.jp||""}function hj(e){return e?.reading||e?.hiragana||""}function vj(e){return p()==="en"?e?.translationEn||e?.en||e?.translationRu||e?.ru||"":e?.translationRu||e?.ru||e?.translationEn||e?.en||""}function wj(e){let t=i(yp(e));return(e?.blanks||[]).map(s=>(s.answer||[]).join("")).forEach(s=>{t=t.replace("___",`<mark>${i(s)}</mark>`)}),t}function bj(e,t="ru"){return`../${t==="en"?"en":"ru"}/kanji/${$p(e)}/`}function $p(e){const t=String(e?.kanji||""),n=Array.from(t).map(o=>`u${o.codePointAt(0).toString(16).padStart(4,"0")}`).join("-"),a=(String(e?.romaji||e?.onyomi_romaji||e?.kunyomi_romaji||"kanji").toLowerCase().split(/[\/,;|()\s]+/).find(o=>/[a-z]/.test(o))||"kanji").replace(/[^a-z0-9]+/g,"-").replace(/^-+|-+$/g,"")||"kanji";return`${n||"kanji"}-${a}`}function kj(){const e=ne(r.activeCardId)||pl()[0]||r.cards[0];e&&(r.activeCardId=e.id,r.activeLessonId=e.lessonId,r.writingStep=de(r.writingStep,0,Math.max(0,$t(e)-1)));const t=ol(e),n=$t(e),s=p()==="ru"?"Шаг":"Step",a=p()==="ru"?"Получилось":"Got it",o=p()==="ru"?"Показать образец":"Show sample",c=t?p()==="ru"?"Точные SVG-штрихи KanjiVG":"Precise KanjiVG SVG strokes":p()==="ru"?"Fallback: шаблон без фейковых штрихов":"Fallback: template without fake strokes";return`
      <section class="page">
        <div class="section-head">
          <div>
    ...
    `}function $j(){if(!r.detailCardId)return"";const e=ne(r.detailCardId);if(!e)return"";const t=D(e.id),n=Kr(e.id),s=!!r.progress.favorites[e.id];return`
    ...
    `}function jj(e,t=Ms(e)){return t.length?`
        ...
        `:""}function tl(e){return e.kind==="onyomi"?oi("onyomi"):e.kind==="kunyomi"?oi("kunyomi"):e.label||"TTS"}function Sj(){const e=gl(),t=Vt(),n=en();return`
      <section class="page">
        <div class="section-head">
          <div>
            <h1>${i(A("stats"))}</h1>
        ...
        <div class="metric-grid">
          ...
          ${M(A("successRate"),`${Vp()}%`,`${ml()} reviews`,Vp())}
        ...
        <div class="stats-grid" style="margin-top:12px">
          ...
          <article class="tool-panel">${Lj()}</article>
          <article class="tool-panel" data-section="shop-panel">${Cj()}</article>
          <article class="tool-panel">${Np()}</article>
    ...
    `}function Zn(){return r.achievements?.length?r.achievements:r.rewards?.achievements||[]}function Nj(){return r.achievementCategories?.length?r.achievementCategories:[...new Set(Zn().map(t=>t.category||"learning"))].map(t=>({id:t,title:{ru:t,en:t},icon:"moon"}))}function nl(e){return f(e.title||e.name||{ru:e.id,en:e.id})}function jp(e){return f(e.description||{})}function sl(e){return{moon:"月",book:"ж›ё",memory:"記",flame:"зЃ«",star:"星",brush:"з­†",text:"文",lock:"йЌµ",eye:"眼"}[e]||"в—†"}function Lj(){return`<h3>${i(A("achievements"))}</h3><div class="achievement-grid compact">${Zn().slice(0,8).map(Sp).join("")}</div>`}function xj(){const e=Zn(),t=bN(),n=e.reduce((s,a)=>({xp:s.xp+(a.rewardXp||0),coins:s.coins+(a.rewardFragments||0)}),{xp:0,coins:0});return`
      <section class="page achievements-page">
        ...
        <div class="achievement-category-list">
          ${Nj().map(s=>{const a=e.filter(c=>c.category===s.id);if(!a.length)return"";const o=a.filter(c=>Bs(c.id)).length;return`
              <section class="achievement-category">
                ...
                <div class="achievement-grid expanded">${a.map(c=>Sp(c,!0)).join("")}</div>
              </section>
            `}).join("")}
        </div>
      </section>
    `}function Sp(e,t=!1){const n=Bs(e.id),s=Mp(e),a=Math.max(1,Number(e.target||1)),o=E(s,a),c=Math.min(s,a),l=e.secret&&!n&&!t?p()==="ru"?"Секретное достижение":"Secret achievement":nl(e),d=e.secret&&!n&&!t?p()==="ru"?"Откроется при необычном действии.":"Unlocked by an unusual action.":jp(e);return`
    ...
    `}function Cj(){return Nd({closable:!1})}function Np(e={}){const t=e.limit||10,n=(r.progress.transactions||[]).slice(0,t);return`
      <h3>${i(A("transactions"))}</h3>
      <div class="transaction-list">
        ${n.map(s=>`
          <div class="transaction-row">
            <div>
              <strong>${i(Aj(s))}</strong>
              <small>${i(P0(s.at))}</small>
            </div>
    ...
    `}function Ij(){if(!r.contactModal)return"";const e=p()==="ru"?"Сообщить об ошибке":"Report a bug",t=p()==="ru"?"Если почтовое приложение не открывается, скопируй адрес и отправь сообщение вручную.":"If your mail app does not open, copy the address and send the message manually.",n=p()==="ru"?"Скопировать email":"Copy email",s=p()==="ru"?"Открыть почту":"Open email",a=p()==="ru"?"Закрыть":"Close",o=encodeURIComponent(nm),c=encodeURIComponent(p()==="ru"?`Привет! Я нашел ошибку в Flash Kanji:
...
`),l=`mailto:${rn}?subject=${o}&body=${c}`;return`
    ...
    `}function Mj(){if(gd()||r.pwaInstallHelpVisible||!Ml()||r.detailCardId||r.rewardModal||r.finalTestModal||r.contactModal||r.changelogModal)return"";const e=Ig(),t=!an&&Os();return`
    ...
    `}function Pj(){if(gd()||!r.notificationPromptVisible||!wi("visible")||r.detailCardId||r.rewardModal||r.finalTestModal||r.contactModal||r.changelogModal||r.pwaInstallHelpVisible||Ml())return"";const e=Kg();return`
    ...
    `}function Ej(e,t,n){const s=Fs(e),a=Va(e,t,n),o=Ap(Ee(e,n));return`
    ...
    `}function Nn(e,t,n,s){const a=Fs(e),o=Va(e,t,n),c=Ap(Ee(e,n)),l=`${s||"mascot"}:${e}:${n}:${r.route}:${r.activeTextbookLevel||r.activeJlptLesson||""}`.toLowerCase();return xp(l)?`
    ...
    `}function Lp(){try{const e=sessionStorage.getItem(_e);return e?JSON.parse(e)||{}:{}}catch{return{}}}function Kj(e){try{sessionStorage.setItem(_e,JSON.stringify(e||{}))}catch{}}function xp(e){return e?!!Lp()[e]:!1}function Cp(e){if(!e)return;const t=Lp();t[e]=Date.now(),Kj(t);const n=On.get(e);n&&(clearTimeout(n),On.delete(e)),C()}function Dj(){const e=new Set;Ki("[data-mascot-speech-key][data-autohide-ms]").forEach(t=>{const n=String(t.dataset.mascotSpeechKey||"");if(!n||xp(n)||(e.add(n),On.has(n)))return;const s=Number(t.dataset.autohideMs||0);if(!s)return;const a=window.setTimeout(()=>{On.delete(n),Cp(n)},s);On.set(n,a)});for(const[t,n]of On)e.has(t)||(clearTimeout(n),On.delete(t))}function Va(e,t="normal",n="welcome"){if(e==="eva")return ws(gn(null,Fj(t,n)));const s=Fs(e);return s.sprites?.[t]||Object.values(s.sprites||{})[0]||""}function Fj(e="normal",t="welcome"){const n=String(t||"").toLowerCase(),s=String(e||"").toLowerCase(),a={welcome:"welcome",correct:"approve",wrong:"sad",progress:"observe",streakloss:"sad",lessoncomplete:"proud",masterymilestone:"proud",achievement:"achievement",goal:"reward",combo:"proud",hint:"think",dailybonus:"reward"},o={normal:"welcome",calm:"neutral",happy:"happy",proud:"proud",thinking:"think",focus:"think",sad:"sad",angry:"strict",shy:"shy"},c=o[s]&&!["normal","calm"].includes(s)?o[s]:null;return c&&(!n||n==="welcome")?c:a[n]||o[s]||s||"neutral"}function Ap(e){if(p()!=="ru")return e;const t="[А-Яа-яЁё]";return String(e||"").replace(new RegExp(`(^|\\s)(${t})\\s+(?=${t}{4,})`,"gu"),"$1$2 ")}function Oj(e){const t=ne(r.activeCardId);if(!t||!im[e])return;tr(t,"srs_rating");const n=se(D(t.id)),s=pe(n,e);r.progress.cards[t.id]=s,Qt(n,s,e),ve();const a=Number(r.progress.correctCombo||0),o=Oe(e)?"again":"ok";Oe(e)?(r.progress.totalWrong+=1,r.progress.correctCombo=0,Se({discipline:-.8,trust:-.2},"answer_again"),Ne("answer_wrong",{cardId:t.id,kanji:t.kanji,rating:e,comboLost:a>0}),J(Ee("eva","wrong"))):(G(r.rewards.rewards.correctXp,r.rewards.rewards.correctCoins,"review_success"),r.progress.totalCorrect+=1,r.progress.correctCombo+=1,r.progress.bestCorrectCombo=Math.max(r.progress.bestCorrectCombo,r.progress.correctCombo),Se({trust:.35,discipline:.25,curiosity:s.lastDecision==="Easy"?.2:0},`answer_${e}`),Ne("answer_correct",{cardId:t.id,kanji:t.kanji,rating:e,combo:r.progress.correctCombo}),J(Ee("eva","correct")),r.progress.correctCombo>0&&r.progress.correctCombo%5===0&&(G(r.rewards.rewards.comboXp,0,"combo_bonus"),et({title:"Combo",message:Ee("leya","combo"),xp:r.rewards.rewards.comboXp,coins:0,mascot:"leya",mood:"proud",dialog:"combo"}))),r.reviewQueueLastKind="card",r.revealed=!1,r.activeCardId=null,jt(),r.pendingFocus=null,Ht(),N(),_t("review card post-render effects",()=>{ug(),hi(o),ir(),zj(t.lessonId),il(),X()})}function Ya(){return p()==="ru"?{forgot:"Не помню",remember:"Помню",forgotHint:"вернём быстро",rememberHint:"Повторение выберет срок"}:{forgot:"Forgot",remember:"Remember",forgotHint:"review soon",rememberHint:"review decides"}}function Bj(e){const t=Ya(),n=D(e.id),s=Uj(n,"remember"),a=Yf(n,s);return`${t.rememberHint}: ${Zf(Qf(a))}`}function Uj(e,t){if(Oe(t))return"again";const n=e.state||"New",s=Number(e.reviewCount||0),a=Number(e.correct||0),o=Number(e.wrong||0),c=Number(e.lapses||0),l=Number(e.successRate||(s?a/Math.max(a+o,1)*100:0));return n==="New"?"good":n==="Learning"?l>=70||a>=2?"good":"hard":l>=88&&a>=5&&c<=1?"easy":l<70||c>Math.max(1,Math.floor(a/3))?"hard":"good"}function Oe(e){return e==="forgot"||e==="again"}function Is(e="",t="",n="",s={}){return{level:String(e||"").toUpperCase(),lessonId:String(s.lessonId||t||""),exerciseId:String(s.exerciseId||n||""),cardId:String(s.cardId||""),kanji:String(s.kanji||""),type:String(s.type||""),title:s.title||null,prompt:String(s.prompt||""),answer:String(s.answer||""),answerLabel:String(s.answerLabel||""),state:"New",intervalDays:0,srsStep:-1,easeFactor:2.5,dueAt:null,lastReviewedAt:null,lastRating:null,reviewCount:0,lapses:0,correct:0,wrong:0,successRate:0,history:[]}}function es(e,t={}){const s={...Is(t.level||"",t.lessonId||"",t.exerciseId||"",t),...ji(e||{})};return s.level=String(t.level||s.level||"").toUpperCase(),s.lessonId=String(t.lessonId||s.lessonId||""),s.exerciseId=String(t.exerciseId||s.exerciseId||""),s.cardId=String(t.cardId||s.cardId||""),s.kanji=String(t.kanji||s.kanji||""),s.type=String(t.type||s.type||""),s.title=t.title||s.title||null,s.prompt=String(t.prompt||s.prompt||""),s.answer=String(t.answer||s.answer||""),s.answerLabel=String(t.answerLabel||s.answerLabel||""),s.successRate=Ag(s),Number.isFinite(Number(s.srsStep))?s.srsStep=de(Math.trunc(Number(s.srsStep)),-1,63):s.srsStep=ao(s),Tp(s)?s:Is(s.level,s.lessonId,s.exerciseId,s)}function Tp(e){return!e||typeof e!="object"?!1:!!(Number(e.reviewCount||0)>0||e.lastReviewedAt||e.lastRating||Number(e.correct||0)>0||Number(e.wrong||0)>0||Array.isArray(e.history)&&e.history.length)}function Cr(e,t,n){const s={...e||{}};return Object.entries(t||{}).forEach(([a,o])=>{s[a]=es(o,{level:n,exerciseId:a,lessonId:o?.lessonId||"",cardId:o?.cardId||"",kanji:o?.kanji||"",type:o?.type||"",title:o?.title||null,prompt:o?.prompt||"",answer:o?.answer||"",answerLabel:o?.answerLabel||""})}),s}function Gj(e){const t=V(e);return t==="N5"?Z():t==="N4"?W():t==="N3"?H():t==="N2"?q():t==="N1"?ee():null}function rl(e){const t=V(e);return t==="N5"?Fe():t==="N4"?rt():t==="N3"?it():t==="N2"?lt():t==="N1"?dt():[]}function Jj(e,t){const n=V(e),s=String(t||"");return!n||!s?null:rl(n).find(a=>a.id===s||a.id===`${n.toLowerCase()}-${s}`||a.id.endsWith(`-${s}`))||null}function Ip(e){const t=V(e);return t==="N5"?gr:t==="N4"?Ea:t==="N3"?Ka:t==="N2"?Da:t==="N1"?Ba:null}function al(e,t,n=""){const s=Ip(e),a=V(e),o=String(t||"");if(!s||!a||!o)return null;const c=Jj(a,n);if(c){const l=s(c).find(d=>String(d.id)===o);if(l)return l}for(const l of rl(a)){const d=s(l).find(u=>String(u.id)===o);if(d)return d}return null}function Za(e,t){const n=V(t);if(!e||!n)return!1;e.exerciseSrs||(e.exerciseSrs={});const s=new Set([...Object.keys(e.viewedLessons||{}),...Object.keys(e.completedLessons||{})]),a=new Set([...Object.keys(e.completedExercises||{}),...Object.keys(e.exerciseResults||{})]);let o=!1;return a.forEach(c=>{if(e.exerciseSrs[c])return;const l=al(n,c);if(!l||!s.has(String(l.lessonId||"")))return;const d=Is(n,l.lessonId||"",l.id,l),u=e.exerciseResults?.[c]||null,m=!!e.completedExercises?.[c],v=pe(se(d),m||u?.correct?"good":"again");v.level=n,v.lessonId=String(l.lessonId||v.lessonId||""),v.exerciseId=String(l.id||c||""),v.cardId=String(l.cardId||v.cardId||""),v.kanji=String(l.kanji||v.kanji||""),v.type=String(l.type||v.type||""),v.title=l.title||v.title||null,v.prompt=String(l.prompt||v.prompt||""),v.answer=String(l.answer||v.answer||""),v.answerLabel=String(l.answerLabel||v.answerLabel||""),e.exerciseSrs[c]=v,o=!0}),o}function ei(e,t){const n=V(t);if(!e||!n)return!1;const s=rl(n),a=Ip(n);if(!a?.length&&!a)return!1;e.exerciseSrs||(e.exerciseSrs={});const o=new Map;s.forEach(l=>{(a(l)||[]).forEach(d=>{d?.id&&o.set(String(d.id),{exercise:d,lesson:l})})});let c=!1;return Object.entries(e.exerciseSrs).forEach(([l,d])=>{const u=o.get(String(l));if(!u)return;const{exercise:m,lesson:v}=u,h=es(d,{level:n,lessonId:v.id,exerciseId:m.id,cardId:m.cardId||"",kanji:m.kanji||"",type:m.type||"",title:m.title||null,prompt:m.prompt||"",answer:m.answer||"",answerLabel:m.answerLabel||""});JSON.stringify(d)!==JSON.stringify(h)&&(e.exerciseSrs[l]=h,c=!0)}),c}function zj(e){if(r.progress.lessonCompletions[e])return;const t=fl(e);if(!(t.length>0&&t.every(o=>D(o.id).state!=="New")))return;const s=r.rewards.rewards.lessonCompleteXp,a=r.rewards.rewards.lessonCompleteCoins;r.progress.lessonCompletions[e]=new Date().toISOString(),P("lesson_complete"),G(s,a,"lesson_completion"),Se({warmth:2.4,trust:2,discipline:2.2,curiosity:.8},"lesson_completion"),Ne("lesson_complete",{lessonId:e,xp:s,coins:a}),et({title:f({ru:"Урок завершён",en:"Lesson complete"}),message:Ee("eva","lessonComplete"),xp:s,coins:a,mascot:"eva",mood:"happy",dialog:"lessonComplete"}),bi("lesson_complete")}function il(){const e=re(),t=Vt();if(t.goalClaimed||t.reviews<r.progress.settings.dailyGoal)return;t.goalClaimed=!0;const n=r.rewards.rewards.comboXp,s=r.rewards.rewards.streakCoins;G(n,s,"daily_goal"),et({title:A("dailyGoal"),message:Ee("leya","goal"),xp:n,coins:s,mascot:"leya",mood:"happy",dialog:"goal"}),r.progress.daily[e]=t}function Hj(){const e=ti(),t=re();e.firstVisitDate||(e.firstVisitDate=t),e.lastVisitDate=t,r.progress.appOpens=Number(r.progress.appOpens||0)+1;const n=new Date().getHours();(n>=22||n<5)&&(r.progress.secrets.nightVisit=!0),Rp()}function Rp(){const e=r.progress.streak,t=Ic(e.pendingReward);if(!t||re()<t.availableOn)return!1;e.pendingReward=null;const n=r.rewards.rewards.streakCoins;return P("streak_reward"),G(0,n,`streak:${t.milestone}:claim`),et({title:p()==="ru"?"Награда за стрик":"Streak reward",message:p()==="ru"?`Бонус за серию ${t.milestone} дней готов.`:`Your ${t.milestone}-day streak bonus is ready.`,xp:0,coins:n,mascot:"eva",mood:"achievement",dialog:"achievement"}),X(),N(),!0}function qj(e){if(e==="eva"){r.progress.secrets.evaClicks=Number(r.progress.secrets.evaClicks||0)+1,Se({warmth:.2,curiosity:.1},"eva_click"),J(Ee("eva","welcome")),X(),N(),C();return}e==="leya"&&J(Ee("leya","combo"))}function _p(){ce(),r.progress.secrets.evaClicks=Number(r.progress.secrets.evaClicks||0)+1,r.evaRuntime||(r.evaRuntime=Rt()),r.evaRuntime.clickCount=Number(r.evaRuntime.clickCount||0)+1,Ne("user_clicked_eva",{clickCount:r.evaRuntime.clickCount}),X(),P("notification_soft"),N(),C()}function Wj(){if(Y.completed)return;Y.completed=!0,r.progress.writingPractice.completed=Number(r.progress.writingPractice.completed||0)+1,Y.cardId&&(r.progress.writingPractice.cards[Y.cardId]=(r.progress.writingPractice.cards[Y.cardId]||0)+1),Se({curiosity:1,discipline:.8,trust:.4},"writing_complete"),Ne("writing_complete",{cardId:Y.cardId});const e=X();N(),e&&C()}function Xj(){const e=re();ti();const t=Qj(),n=va(r.progress.dailyBonusPending);n&&n.availableOn>e||(n&&n.availableOn<=e&&!t&&(r.progress.dailyBonusPending=null),r.progress.dailyBonusPending={availableOn:Dg(e,1)},N())}function Qj(){const e=re(),t=ti(),n=va(r.progress.dailyBonusPending);if(!n||re()<n.availableOn||r.progress.dailyBonuses[e]||t.lastDailyBonusDate===e)return!1;r.progress.dailyBonusPending=null;const s=t.lastDailyBonusDate||t.firstVisitDate||t.lastVisitDate;return Vj(s,e),t.lastVisitDate=e,t.lastDailyBonusDate=e,r.progress.dailyBonuses[e]=new Date().toISOString(),P("daily_bonus"),G(r.rewards.rewards.dailyBonusXp,r.rewards.rewards.dailyBonusCoins,"daily_bonus"),Se({warmth:1,discipline:.8},"daily_bonus"),et({title:A("dailyBonus"),message:Ee("leya","welcome"),xp:r.rewards.rewards.dailyBonusXp,coins:r.rewards.rewards.dailyBonusCoins,mascot:"leya",mood:"calm",dialog:"welcome"}),X(),Kl(),!0}function ti(){var t;(t=r.progress).visits||(t.visits={});const e=r.progress.visits;return e.firstVisitDate||(e.firstVisitDate=null),e.lastVisitDate||(e.lastVisitDate=null),e.lastDailyBonusDate||(e.lastDailyBonusDate=null),e.streak=Number(e.streak||0),e.bestStreak=Number(e.bestStreak||0),e}function Vj(e,t){const n=ti();n.streak=e&&Rn(e,t)===1?n.streak+1:1,n.bestStreak=Math.max(n.bestStreak||0,n.streak);const s=r.progress.streak.lastStudyDate;s!==t&&(r.progress.streak.current=s&&Rn(s,t)===1?r.progress.streak.current+1:1,r.progress.streak.lastStudyDate=t,r.progress.streak.best=Math.max(r.progress.streak.best||0,r.progress.streak.current),r.progress.streakHistory.push({date:t,value:r.progress.streak.current}),r.progress.streakHistory=r.progress.streakHistory.slice(-120))}function X(){if(!Zn().length)return 0;let e=0;return Zn().forEach(t=>{if(Bs(t.id)||!Yj(t))return;e+=1;const n=t.rewardXp||0,s=t.rewardFragments||0;r.progress.achievements[t.id]={unlockedAt:new Date().toISOString(),rewardXp:n,rewardFragments:s},et({type:"achievement",title:nl(t),message:jp(t),xp:n,coins:s,icon:t.icon,mascot:"eva",mood:"happy",dialog:"achievement"}),G(n,s,`achievement:${t.id}`)}),e}function Yj(e){return Mp(e)>=Number(e.target||1)}function Mp(e){if(e.kind==="lessonComplete")return Object.keys(r.progress.lessonCompletions).length;if(e.kind==="correct")return r.progress.totalCorrect;if(e.kind==="learned")return gl().learned;if(e.kind==="reviews")return ml();if(e.kind==="streak")return Math.max(r.progress.streak.current||0,r.progress.streak.best||0);if(e.kind==="level")return r.progress.level||1;if(e.kind==="moonFragments")return r.progress.totalMoonFragmentsEarned||0;if(e.kind==="writing")return r.progress.writingPractice?.completed||0;if(e.kind==="sentence")return Object.keys(r.progress.sentencePractice?.completed||{}).length;if(e.kind==="evaClicks")return r.progress.secrets?.evaClicks||0;if(e.kind==="nightVisit")return r.progress.secrets?.nightVisit?1:0;if(e.kind==="appOpens")return r.progress.appOpens||0;if(e.kind==="n5KanjiStudied")return Object.keys(Z().studiedKanji||{}).length;if(e.kind==="n5LessonComplete"||e.kind==="n5LessonsComplete")return Xn();if(e.kind==="n5Writing")return Object.keys(Z().writingPractice||{}).length;if(e.kind==="n5SrsAll")return Object.keys(Z().srsKanji||{}).length;if(e.kind==="n5FinalPass")return Z().finalTest?.passed?1:0;if(e.kind==="n4Opened")return W().opened?1:0;if(e.kind==="n4LessonComplete")return Object.keys(W().completedLessons||{}).length;if(e.kind==="n4LessonsComplete")return Object.keys(W().completedLessons||{}).length;if(e.kind==="n4SrsAll")return Object.keys(W().srsKanji||{}).length;if(e.kind==="n4GrammarComplete")return Object.keys(W().completedGrammar||{}).length;if(e.kind==="n4ReadingComplete")return Object.keys(W().completedReading||{}).length;if(e.kind==="n4ListeningComplete")return Object.keys(W().completedListening||{}).length;if(e.kind==="n4Writing")return Object.keys(W().writingPractice||{}).length;if(e.kind==="n4FinalPass")return W().finalTest?.passed?1:0;if(e.kind==="n3Opened")return H().opened?1:0;if(e.kind==="n3LessonComplete")return Object.keys(H().completedLessons||{}).length;if(e.kind==="n3LessonsComplete")return Object.keys(H().completedLessons||{}).length;if(e.kind==="n3SrsAll")return Object.keys(H().srsKanji||{}).length;if(e.kind==="n3GrammarComplete")return Object.keys(H().completedGrammar||{}).length;if(e.kind==="n3ReadingComplete")return Object.keys(H().completedReading||{}).length;if(e.kind==="n3ListeningComplete")return Object.keys(H().completedListening||{}).length;if(e.kind==="n3Writing")return Object.keys(H().writingPractice||{}).length;if(e.kind==="n3ComprehensionAnswers")return Object.values(H().readingAnswers||{}).filter(t=>t&&t.correct).length;if(e.kind==="n3FinalPass")return H().finalTest?.passed?1:0;if(e.kind==="n2Opened")return q().opened?1:0;if(e.kind==="n2LessonComplete")return Object.keys(q().completedLessons||{}).length;if(e.kind==="n2LessonsComplete")return Object.keys(q().completedLessons||{}).length;if(e.kind==="n2SrsAll")return Object.keys(q().srsKanji||{}).length;if(e.kind==="n2GrammarComplete")return Object.keys(q().completedGrammar||{}).length;if(e.kind==="n2ReadingComplete")return Object.keys(q().completedReading||{}).length;if(e.kind==="n2ListeningComplete")return Object.keys(q().completedListening||{}).length;if(e.kind==="n2Writing")return Object.keys(q().writingPractice||{}).length;if(e.kind==="n2ComprehensionAnswers")return Object.values(q().readingAnswers||{}).filter(t=>t&&t.correct).length;if(e.kind==="n2FinalPass")return q().finalTest?.passed?1:0;if(e.kind==="shopComplete"){const t=st().filter(n=>!n.defaultOwned&&n.price>0);return t.length&&t.every(n=>Kt(n.id))?1:0}if(e.kind==="jlpt"){const t=r.cards.filter(n=>n.jlpt===e.jlpt);return t.length>0&&t.every(n=>D(n.id).state==="Mastered")?1:0}return 0}function et(e){if(!r.rewardModal){r.rewardModal=e,Pp(e);return}if(e.type==="level"){r.rewardQueue.unshift(e);return}r.rewardQueue.push(e)}function Pp(e){if(J0(),e?.type==="achievement"){Ur()?P("achievement_unlock"):pi()&&G0();return}if(e?.type==="level"){P("level_up");return}((e?.xp||0)>0||(e?.coins||0)>0)&&P("notification_reward")}function G(e,t,n="reward"){const s=r.progress.level||di(r.progress.xp);r.progress.xp+=e,r.progress.moonFragments+=t;const a=Zj(n);if(!a&&e>0&&P("xp_gain"),!a&&t>0&&P("moon_fragment_gain"),t>0&&(r.progress.totalMoonFragmentsEarned=Number(r.progress.totalMoonFragmentsEarned||0)+t),r.progress.level=di(r.progress.xp),(e||t)&&(r.progress.transactions.unshift({at:new Date().toISOString(),reason:n,xp:e,coins:t,balance:r.progress.moonFragments}),r.progress.transactions=r.progress.transactions.slice(0,80)),r.progress.level>s){P("level_up"),Ne("level_up",{level:r.progress.level,xp:r.progress.xp,moonFragments:r.progress.moonFragments});const o=en();et({type:"level",title:A("levelUp"),message:`${A("level")} ${r.progress.level} - ${o.current}/${o.next} XP - ${r.progress.moonFragments} ${A("coins")}`,xp:0,coins:0,mascot:r.progress.level%2===0?"leya":"eva",mood:"happy",dialog:"achievement",level:r.progress.level,totalXp:r.progress.xp,moonFragments:r.progress.moonFragments})}}function Zj(e){return["learn","review"].includes(r.route)&&["review_success","combo_bonus"].includes(e)}function Qt(e,t,n){const s=Vt();s.reviews+=1,e.state==="New"&&t.state!=="New"&&(s.learned+=1),e.state!=="Mastered"&&t.state==="Mastered"&&(s.mastered+=1),Oe(n)&&(s.mistakes+=1),s.minutes=yi(s.reviews*.75+s.learned*1.25,1),r.progress.daily[re()]=s}function ve(){Rp();const e=re(),t=r.progress.streak.lastStudyDate;if(t===e)return;const n=!!(t&&Rn(t,e)>1&&r.progress.streak.current>0);r.progress.streak.current=t&&Rn(t,e)===1?r.progress.streak.current+1:1,r.progress.streak.lastStudyDate=e,r.progress.streak.best=Math.max(r.progress.streak.best,r.progress.streak.current),r.progress.streakHistory.push({date:e,value:r.progress.streak.current}),r.progress.streakHistory=r.progress.streakHistory.slice(-120),Se(n?{discipline:-3.5,trust:-1.4,warmth:-.8}:{discipline:1.4,trust:.8,warmth:.4},n?"streak_lost":"study_streak"),n&&J(Ee("eva","streakLoss")),[1,7,30,100].includes(r.progress.streak.current)&&(r.progress.streak.pendingReward={milestone:r.progress.streak.current,availableOn:Dg(e,1)}),Ne("streak_up",{streak:r.progress.streak.current,lost:n}),N()}function Ep(){if(r.route!=="stats")return;if(!window.Chart){xm().then(()=>{r.route==="stats"&&Ep()}).catch(a=>console.warn("Chart.js failed to load.",a));return}const e=pN(10),t=e.map(a=>a.slice(5)),n=F0(),s=O0(n);Ar("activityChart",{type:"bar",data:{labels:t,datasets:[{label:A("learned"),data:e.map(a=>r.progress.daily[a]?.learned||0),backgroundColor:n.green},{label:A("review"),data:e.map(a=>r.progress.daily[a]?.reviews||0),backgroundColor:n.red}]},options:s}),Ar("jlptChart",{type:"bar",data:{labels:Object.keys(Zp()),datasets:[{label:A("mastered"),data:Object.values(Zp()),backgroundColor:n.yellow}]},options:s}),Ar("streakChart",{type:"line",data:{labels:t,datasets:[{label:A("streak"),data:e.map(a=>r.progress.streakHistory.find(o=>o.date===a)?.value||(r.progress.daily[a]?.reviews?1:0)),borderColor:n.blue,backgroundColor:n.blueSoft,fill:!0,tension:.35}]},options:s}),Ar("stateChart",{type:"doughnut",data:{labels:Object.keys(Yp()),datasets:[{data:Object.values(Yp()),backgroundColor:[n.blue,n.yellow,n.green,n.pink],borderColor:n.line}]},options:{responsive:!0,maintainAspectRatio:!1,plugins:{legend:{labels:{color:n.text}}}}}),Ar("mistakeChart",{type:"line",data:{labels:t,datasets:[{label:A("errors"),data:e.map(a=>r.progress.daily[a]?.mistakes||0),borderColor:n.danger,backgroundColor:n.dangerSoft,fill:!0,tension:.35}]},options:s})}function Ar(e,t){const n=document.getElementById(e);n&&r.charts.push(new Chart(n,t))}function eS(){const e=Ln();e&&(r.activeCardId=e.id,r.activeLessonId=e.lessonId,r.writingStep=de(r.writingStep,0,Math.max(0,$t(e)-1)),Y.cardId!==String(e.id)&&tS(e)),nS(),Ir(),ni(),Pr(Tr(!1)),window.setTimeout(Dp,120)}function Ln(){return ne(r.activeCardId)||pl()[0]||r.cards[0]||null}function tS(e){Y.cardId=String(e?.id||""),Y.strokes=[],Y.currentStroke=[],Y.drawing=!1,Y.activePointerId=null,Y.completed=!1}function nS(){const e=document.getElementById("practiceCanvas");if(!e)return;Rs();const t=a=>{a.pointerType==="mouse"&&a.button!==0||(a.preventDefault(),e.setPointerCapture?.(a.pointerId),Y.drawing=!0,Y.activePointerId=a.pointerId,Y.currentStroke=[Kp(e,a)],Y.completed=!1,Rs())},n=a=>{if(!Y.drawing||a.pointerId!==Y.activePointerId)return;a.preventDefault();const o=Kp(e,a),c=Y.currentStroke[Y.currentStroke.length-1];(!c||Hp(c,o)>1.4)&&(Y.currentStroke.push(o),Rs())},s=a=>{if(!Y.drawing||a.pointerId!==Y.activePointerId)return;a.preventDefault();const o=sS(Y.currentStroke);o.length&&Y.strokes.push(o),Y.currentStroke=[],Y.drawing=!1,Y.activePointerId=null,Rs(),Pr(Tr(!1))};e.onpointerdown=t,e.onpointermove=n,e.onpointerup=s,e.onpointercancel=s,e.onpointerleave=s,e.oncontextmenu=a=>a.preventDefault()}function Kp(e,t){const n=e.getBoundingClientRect();return{x:de((t.clientX-n.left)*(e.width/n.width),0,e.width),y:de((t.clientY-n.top)*(e.height/n.height),0,e.height),pressure:t.pressure||.5,time:performance.now()}}function sS(e){if(!e.length)return[];const t=[e[0]];return e.slice(1).forEach(n=>{Hp(t[t.length-1],n)>=2.6&&t.push(n)}),t.length===1?[t[0],{...t[0],x:t[0].x+.1,y:t[0].y+.1}]:t}function Rs(){const e=document.getElementById("practiceCanvas");if(!e)return;const t=e.getContext("2d"),n=Ln();zp(t,e),n&&oS(t,e,n),Y.strokes.forEach((s,a)=>Jp(t,s,{color:getComputedStyle(document.documentElement).getPropertyValue("--text").trim(),width:13,shadow:a===Y.strokes.length-1})),Y.currentStroke.length&&Jp(t,Y.currentStroke,{color:getComputedStyle(document.documentElement).getPropertyValue("--accent-2").trim(),width:13,shadow:!0})}function rS(){Y.strokes=[],Y.currentStroke=[],Y.drawing=!1,Y.completed=!1,Rs(),Pr(Tr(!1))}function aS(){Y.strokes.pop(),Y.currentStroke=[],Y.completed=!1,Rs(),Pr(Tr(!1))}function iS(e=!1){const t=Tr(!0);Pr(t),e&&(hi(t.success?"good":"again"),J(t.message),t.success&&Wj())}function Tr(e){const t=document.getElementById("practiceCanvas"),n=Ln(),s=$t(n);if(!t||!n)return{score:0,success:!1,expectedCount:s,message:""};const a=Y.strokes;if(!a.length)return{score:0,success:!1,expectedCount:s,message:p()==="ru"?"Начни с первой черты.":"Start with the first stroke."};const o=de(Math.round(Math.min(a.length,s)/s*100),0,100),c=e?100:o,l=!!(e&&a.length);let d=p()==="ru"?`Черты: ${a.length}/${s}. Самопроверка без распознавания.`:`Strokes: ${a.length}/${s}. Self-check without recognition.`;return!e&&a.length<s?d=p()==="ru"?`Черта ${a.length+1}/${s}: продолжай по образцу.`:`Stroke ${a.length+1}/${s}: keep following the guide.`:!e&&a.length>s?d=p()==="ru"?`Черты: ${a.length}/${s}. Если лишняя линия случайная, нажми «Отменить черту».`:`Strokes: ${a.length}/${s}. If one was accidental, tap "Undo stroke".`:e&&(d=ol(n)?p()==="ru"?"Записано. Сравни с жёлтым порядком KanjiVG и двигайся дальше.":"Saved. Compare it with the yellow KanjiVG order and move on.":p()==="ru"?"Записано. Для этого кандзи пока есть только шаблон, без точной схемы штрихов.":"Saved. This kanji currently has a template only, without exact stroke paths."),{score:c,success:l,expectedCount:s,message:d}}function Dp(){const e=document.getElementById("strokeCanvas"),t=Ln();if(!e||!t)return;cancelAnimationFrame(Y.demoAnimationId);const n=$t(t),s=460,a=performance.now(),o=c=>{const l=c-a,d=de(Math.floor(l/s),0,n-1),u=de((l-d*s)/s,0,1);r.writingStep=d,Ir(d,u),ni(),l<n*s?Y.demoAnimationId=requestAnimationFrame(o):(r.writingStep=n-1,Ir(r.writingStep,1),ni())};Y.demoAnimationId=requestAnimationFrame(o)}function Fp(){const e=document.getElementById("strokeCanvas"),t=Ln();if(!e||!t)return;cancelAnimationFrame(Y.demoAnimationId);const n=performance.now(),s=520,a=de(r.writingStep,0,Math.max(0,$t(t)-1)),o=c=>{const l=de((c-n)/s,0,1);Ir(a,l),l<1&&(Y.demoAnimationId=requestAnimationFrame(o))};Y.demoAnimationId=requestAnimationFrame(o)}function Op(e){Bp(r.writingStep+e,!1)}function Bp(e,t){const n=Ln();n&&(r.writingStep=de(e,0,Math.max(0,$t(n)-1)),ni(),t?Fp():Ir(r.writingStep,1))}function ni(){const e=Ln();if(!e)return;const t=Mr(e),n=p()==="ru"?"Шаг":"Step",s=document.getElementById("writingStepCounter");s&&(s.textContent=`${n} ${r.writingStep+1}/${$t(e)}`);const a=document.querySelector(".writing-step-head .label");a&&(a.textContent=t[r.writingStep]||""),Ki(".writing-guide-list li").forEach((o,c)=>o.classList.toggle("is-active",c===r.writingStep))}function Ir(e=r.writingStep,t=1){const n=document.getElementById("strokeCanvas"),s=Ln();if(!n||!s)return;const a=n.getContext("2d");zp(a,n);const o=Rr(s);if(!o){Gp(a,n,s,e);return}Up(a,n,o,{activeIndex:e,progress:t,showFuture:!0,guideAlpha:1,showNumbers:!0})}function oS(e,t,n){const s=Rr(n);if(!s){Gp(e,t,n,r.writingStep);return}Up(e,t,s,{activeIndex:r.writingStep,progress:1,showFuture:!0,guideAlpha:.24,showNumbers:!1})}function Rr(e){if(!e?.kanji)return null;const t=r.kanjiStrokes?.[e.kanji];return t?.strokeOrder?.length?t:null}function ol(e){return!!Rr(e)}function $t(e){const t=Rr(e);return Math.max(1,t?.strokeOrder?.length||Number(e?.strokes||1))}function _r(){const e=getComputedStyle(document.documentElement),t=n=>e.getPropertyValue(n).trim();return{paper:t("--writing-paper")||t("--surface")||"#ffffff",border:t("--writing-paper-border")||t("--line")||"#d0d5dd",grid:t("--writing-grid")||t("--line")||"#d0d5dd",gridStrong:t("--writing-grid-strong")||t("--line-strong")||"#98a2b3",ink:t("--writing-ink")||t("--text")||"#111014",guide:t("--writing-guide")||t("--muted")||"#5f6670",templateOpacity:Number(t("--writing-template-opacity")||"0.16")||.16}}function Up(e,t,n,s={}){const a=de(Number(s.activeIndex||0),0,Math.max(0,n.strokeOrder.length-1)),o=lS(n,t,s.padding||22),c=_r(),l=getComputedStyle(document.documentElement).getPropertyValue("--accent").trim(),d=getComputedStyle(document.documentElement).getPropertyValue("--accent-2").trim(),u=c.guide;n.strokeOrder.forEach((m,v)=>{const h=v<a,w=v===a;v>a&&!s.showFuture||(e.save(),e.translate(o.x,o.y),e.scale(o.scale,o.scale),e.lineCap="round",e.lineJoin="round",e.strokeStyle=w?d:h?l:u,e.lineWidth=(w?8:5.5)/o.scale,e.globalAlpha=Number(s.guideAlpha??1)*(w?1:h?.86:.24),w&&s.progress<1&&(e.globalAlpha*=.45+de(s.progress,0,1)*.55),w&&(e.shadowColor="rgba(248, 216, 74, 0.34)",e.shadowBlur=13/o.scale),e.stroke(new Path2D(m.path)),e.restore(),s.showNumbers&&dS(e,m,o,v+1,w))})}function lS(e,t,n=22){const s=cS(e.viewBox),a=Math.min((t.width-n*2)/s.width,(t.height-n*2)/s.height),o=(t.width-s.width*a)/2-s.x*a,c=(t.height-s.height*a)/2-s.y*a;return{...s,scale:a,x:o,y:c}}function cS(e){const t=String(e||"0 0 109 109").trim().split(/\s+/).map(Number),[n=0,s=0,a=109,o=109]=t;return{x:n,y:s,width:Math.max(1,a),height:Math.max(1,o)}}function dS(e,t,n,s,a){const o=uS(t.path);if(!o)return;const c=n.x+o.x*n.scale,l=n.y+o.y*n.scale;pS(e,c,l,s,a)}function uS(e){const t=String(e||"").match(/M\s*(-?\d+(?:\.\d+)?)[,\s]+(-?\d+(?:\.\d+)?)/i);return t?{x:Number(t[1]),y:Number(t[2])}:null}function pS(e,t,n,s,a){e.save(),e.fillStyle=a?getComputedStyle(document.documentElement).getPropertyValue("--accent-2").trim():getComputedStyle(document.documentElement).getPropertyValue("--surface-2").trim(),e.strokeStyle=getComputedStyle(document.documentElement).getPropertyValue("--line-strong").trim(),e.lineWidth=1,e.beginPath(),e.arc(t,n,a?13:10,0,Math.PI*2),e.fill(),e.stroke(),e.fillStyle=a?"#111014":getComputedStyle(document.documentElement).getPropertyValue("--text").trim(),e.font="800 12px system-ui",e.textAlign="center",e.textBaseline="middle",e.fillText(String(s),t,n+.5),e.restore()}function Gp(e,t,n,s=0){const a=_r(),o=getComputedStyle(document.documentElement).getPropertyValue("--accent-2").trim();e.save(),e.globalAlpha=a.templateOpacity,e.fillStyle=a.ink,e.font=`900 ${Math.floor(t.height*.7)}px "Noto Sans JP", "Yu Gothic", serif`,e.textAlign="center",e.textBaseline="middle",e.fillText(n?.kanji||"文",t.width/2,t.height/2+t.height*.04),e.globalAlpha=1,e.fillStyle=o,e.font="800 15px system-ui",e.textAlign="left",e.textBaseline="top";const c=p()==="ru"?`Шаг ${s+1}/${$t(n)} · точной схемы пока нет`:`Step ${s+1}/${$t(n)} · exact paths not available yet`;e.fillText(c,18,16),e.restore()}function Jp(e,t,n={}){const s=t.map(fS).filter(Boolean);if(!e||!s.length)return;const a=_r();if(e.save(),e.strokeStyle=n.color||a.ink,e.lineWidth=n.width||12,e.lineCap="round",e.lineJoin="round",e.imageSmoothingEnabled=!0,n.shadow&&(e.shadowColor="rgba(255, 48, 92, 0.36)",e.shadowBlur=12),e.beginPath(),e.moveTo(s[0].x,s[0].y),s.length===1){e.arc(s[0].x,s[0].y,e.lineWidth/2,0,Math.PI*2),e.fillStyle=e.strokeStyle,e.fill(),e.restore();return}if(s.length===2)e.lineTo(s[1].x,s[1].y);else{for(let c=1;c<s.length-1;c+=1){const l=hS(s[c],s[c+1]);e.quadraticCurveTo(s[c].x,s[c].y,l.x,l.y)}const o=s[s.length-1];e.lineTo(o.x,o.y)}e.stroke(),e.restore()}function zp(e,t){if(!e||!t)return;const n=_r();e.clearRect(0,0,t.width,t.height),e.fillStyle=n.paper,e.fillRect(0,0,t.width,t.height),gS(e,t)}function gS(e,t){const n=_r();e.save(),e.strokeStyle=n.grid,e.lineWidth=1,e.setLineDash([8,8]),e.beginPath(),e.moveTo(t.width/2,0),e.lineTo(t.width/2,t.height),e.moveTo(0,t.height/2),e.lineTo(t.width,t.height/2),e.moveTo(0,0),e.lineTo(t.width,t.height),e.moveTo(t.width,0),e.lineTo(0,t.height),e.stroke(),e.setLineDash([]),e.strokeStyle=n.gridStrong,e.strokeRect(.5,.5,t.width-1,t.height-1),e.restore()}function Mr(e){const t=Rr(e);if(t?.strokeOrder?.length)return t.strokeOrder.map((s,a)=>p()==="ru"?s.description_ru||`Штрих ${a+1} по данным KanjiVG`:s.description_en||`Stroke ${a+1} from KanjiVG data`);const n=Array.isArray(e?.stroke_order)?e.stroke_order:[];return Array.from({length:$t(e)},(s,a)=>n[a]||mS(e,a))}function mS(e,t){return p()!=="ru"?`Step ${t+1}: exact stroke paths are not available yet. Use the translucent ${e?.kanji||"kanji"} template.`:`Шаг ${t+1}: для этого кандзи пока нет точной схемы штрихов. Обводи полупрозрачный шаблон ${e?.kanji||""}.`}function Pr(e){const t=document.getElementById("writingStrokeCounter");t&&(t.textContent=`${Y.strokes.length}/${e.expectedCount}`);const n=document.getElementById("writingScore");n&&(n.querySelector("span").textContent=`${e.score}%`,n.querySelector("i").style.width=`${e.score}%`);const s=document.getElementById("writingFeedback");s&&(s.textContent=e.message,s.classList.toggle("is-good",e.success),s.classList.toggle("is-warning",!e.success&&e.score>0))}function fS(e){return e?Array.isArray(e)?{x:e[0],y:e[1]}:{x:e.x,y:e.y}:null}function hS(e,t){return{x:(e.x+t.x)/2,y:(e.y+t.y)/2}}function Hp(e,t){return Math.hypot((e?.x||0)-(t?.x||0),(e?.y||0)-(t?.y||0))}function vS(){r.charts.forEach(e=>e.destroy()),r.charts=[]}function wS(e,t){const n=new Date;return r.cards.filter(s=>!e||s.lessonId===e).filter(s=>{const a=r.lessons.find(c=>c.id===s.lessonId);if(a&&!Me(a))return!1;const o=D(s.id);return o.state==="New"?!0:o.dueAt&&new Date(o.dueAt)<=n}).sort(ri)}function bS(){const e=new Date;return ul().filter(t=>{const n=D(t.id);return n.state==="New"?!1:n.dueAt&&new Date(n.dueAt)<=e}).sort(ri)}function kS(){const e=Date.now(),t=[];return[["N5",Z()],["N4",W()],["N3",H()],["N2",q()]].forEach(([n,s])=>{Object.entries(s?.exerciseSrs||{}).forEach(([a,o])=>{const c=es(o,{level:n,exerciseId:a,lessonId:o?.lessonId||"",cardId:o?.cardId||"",kanji:o?.kanji||"",type:o?.type||"",title:o?.title||null,prompt:o?.prompt||"",answer:o?.answer||"",answerLabel:o?.answerLabel||""});if(!c.dueAt||!Tp(c))return;const l=al(n,a,c.lessonId||"");if(!l)return;const d=String(l?.lessonId||c.lessonId||"");if(!XS(n,d))return;const u=new Date(c.dueAt).getTime();!u||u>e||t.push({kind:"exercise",source:"textbook",key:`exercise:${String(n).toUpperCase()}:${a}`,level:String(n||"").toUpperCase(),exerciseId:a,lessonId:d,cardId:String(c.cardId||""),dueAt:u,progress:c})})}),t.sort(dl)}function si(){const e=[];return r.n5Reading.forEach(t=>{t?.id&&e.push(t)}),[["N4",r.n4Reading],["N3",r.n3Reading],["N2",r.n2Reading],["N1",r.n1Reading]].forEach(([t,n])=>{(Array.isArray(n)?n:[]).forEach(s=>{(s.questions||[]).forEach((a,o)=>{const c={id:String(a.id||`${s.id}:${o}`),prompt:a.prompt||{ru:"",en:""},answer:String(a.answer||""),options:kf(a.options)};e.push({id:String(a.id||`${s.id}:${o}`),level:String(s.level||t||"").toUpperCase(),kind:"question",sourceKind:String(s.kind||"reading"),sourceId:String(s.id||""),sourceTitle:s.title||{ru:s.id||"",en:s.id||""},title:s.title||{ru:s.id||"",en:s.id||""},jp:String(s.jp||""),reading:String(s.reading||""),translationRu:String(s.ru||""),translationEn:String(s.en||""),passageSource:String(s.source||""),questionIndex:o,question:c,questions:[c]})})})}),[...e,...Ow()]}function qp(e,t=""){const n=String(e||""),s=String(t||"").toUpperCase();return si().find(a=>String(a.id||"")===n&&(!s||String(a.level||"").toUpperCase()===s))||si().find(a=>String(a.id||"")===n)||null}function Wp(e){const t=Array.isArray(e?.questions)?e.questions[0]||null:e?.question||null;return{level:String(e?.level||"").toUpperCase(),lessonId:String(e?.sourceId||""),exerciseId:String(e?.id||""),type:String(e?.kind||""),title:e?.sourceTitle||e?.title||null,prompt:String(e?.kind==="question"?f(t?.prompt||{}):e?.sentence||e?.jp||""),answer:String(e?.kind==="question"?t?.answer||"":yt(e).map(n=>n.kanji).join("")),answerLabel:String(e?.kind==="question"?t?.answer||"":yt(e).map(n=>n.kanji).join(""))}}function ll(e){return 1}function xn(e){const t=Wp(e);return{...Is(t.level,t.lessonId,t.exerciseId,t),sourceId:String(e?.sourceId||""),sourceKind:String(e?.sourceKind||""),sourceTitle:e?.sourceTitle||null,exerciseKind:String(e?.kind||""),questionCount:ll(),answers:{},selectedIndices:[],selectedTiles:[],selectedText:"",wrongIndexes:[],wrongQuestions:[],completed:!1,completedAt:null}}function Er(e,t){const n=xn(t),s=es({...n,...e||{}},Wp(t));return s.sourceId=String(t?.sourceId||s.sourceId||""),s.sourceKind=String(t?.sourceKind||s.sourceKind||""),s.sourceTitle=t?.sourceTitle||s.sourceTitle||null,s.exerciseKind=String(t?.kind||s.exerciseKind||""),s.questionCount=ll(),s.answers=s.answers&&typeof s.answers=="object"&&!Array.isArray(s.answers)?{...s.answers}:{},s.selectedIndices=Array.isArray(s.selectedIndices)?s.selectedIndices.map(a=>Number(a)).filter(a=>Number.isInteger(a)&&a>=0):[],s.selectedTiles=Array.isArray(s.selectedTiles)?s.selectedTiles.map(a=>({kanji:String(a?.kanji||""),reading:String(a?.reading||"")})).filter(a=>a.kanji):[],s.selectedText=String(s.selectedText||""),s.wrongIndexes=Array.isArray(s.wrongIndexes)?s.wrongIndexes.map(a=>Number(a)).filter(a=>Number.isInteger(a)&&a>=0):[],s.wrongQuestions=Array.isArray(s.wrongQuestions)?s.wrongQuestions.map(a=>String(a)).filter(Boolean):[],s.completed=!!s.completed,s.completedAt=s.completedAt||null,s}function Cn(e){var s;if(!e?.id)return null;(s=r.progress).readingExercises||(s.readingExercises={});const t=r.progress.readingExercises[String(e.id)]||null;if(t){const a=Er(t,e);return r.progress.readingExercises[String(e.id)]=a,a}const n=xn(e);return r.progress.readingExercises[String(e.id)]=n,n}function ts(e,t){var s;if(!e?.id)return null;(s=r.progress).readingExercises||(s.readingExercises={});const n=Er(t||{},e);return r.progress.readingExercises[String(e.id)]=n,n}function Xp(e){return!e||typeof e!="object"?!1:!!(Number(e.reviewCount||0)>0||e.lastReviewedAt||e.completedAt||e.completed||e.answers&&typeof e.answers=="object"&&Object.keys(e.answers).length||Array.isArray(e.selectedIndices)&&e.selectedIndices.length||Array.isArray(e.selectedTiles)&&e.selectedTiles.length||String(e.selectedText||"").trim())}function _s(e=""){var a;if(!r.progress)return!1;const t=V(e);(a=r.progress).readingExercises||(a.readingExercises={});const n=new Map(si().filter(o=>!t||V(o.level)===t).map(o=>[String(o.id),o]));let s=!1;return Object.entries(r.progress.readingExercises).forEach(([o,c])=>{const l=n.get(String(o));if(!l)return;const d=Er(c,l),u=Xp(d)?d:xn(l);JSON.stringify(c)!==JSON.stringify(u)&&(r.progress.readingExercises[String(o)]=u,s=!0)}),s}function yS(){const e=Date.now();return si().map(t=>{if(!QS(t.level))return null;const n=r.progress.readingExercises?.[String(t.id)]||null;if(!n)return null;const s=Er(n,t);if(r.progress.readingExercises[String(t.id)]=s,!Xp(s))return null;const a=s.dueAt?new Date(s.dueAt).getTime():0;return!a||a>e?null:{kind:"exercise",source:"reading",key:`reading:${String(t.level||"").toUpperCase()}:${t.id}`,level:String(t.level||"").toUpperCase(),exerciseId:String(t.id||""),lessonId:String(t.sourceId||""),cardId:"",dueAt:a,progress:s,exercise:t,card:null}}).filter(Boolean).sort(dl)}function cl(){const e=bS().map(n=>{if(!n?.id)return null;const s=D(n.id);return{kind:"card",key:`card:${n.id}`,card:n,cardId:String(n.id),dueAt:s.dueAt?new Date(s.dueAt).getTime():0,progress:s}}).filter(Boolean),t=[...kS(),...yS()].sort(dl);return xr(Vf(e,t,ro))}function Qp(e=cl()){const t=Object.freeze(xr(e).map(n=>n.key).filter(Boolean));r.reviewSession={keys:t,initialSize:t.length,startedAt:new Date().toISOString()}}function $S(){const e=cl();if(r.route!=="review")return e;r.reviewSession||Qp(e);const t=new Map(e.map(a=>[a.key,a])),n=Array.isArray(r.reviewSession?.keys)?r.reviewSession.keys:[],s=n.map(a=>t.get(a)).filter(Boolean);return s.length!==n.length||!s.length&&e.length?(Qp(e),e):xr(s)}function jS(){const e=Date.now();return ul().filter(t=>{const n=D(t.id),s=n.dueAt?new Date(n.dueAt).getTime():0;return n.state==="Learning"&&s>e}).length}function SS(){return ul().filter(e=>D(e.id).state!=="New").length}function Be(){if(ra&&aa!==null)return aa;const e=cl().length;return ra&&(aa=e),e}function dl(e,t){if(e.dueAt!==t.dueAt)return e.dueAt-t.dueAt;const n=e.kind==="card"&&e.card?.id?D(e.card.id):e.progress,s=t.kind==="card"&&t.card?.id?D(t.card.id):t.progress,a=ka(n),o=ka(s);return a!==o?o-a:e.kind!==t.kind?e.kind==="card"?-1:1:e.kind==="card"&&t.kind==="card"?Number(e.card?.id||0)-Number(t.card?.id||0):String(e.key||"").localeCompare(String(t.key||""))}function ul(){const e=new Set,t=[];return Ke.forEach(n=>{wg(n).forEach(s=>{const a=String(s?.id||"");!a||e.has(a)||(e.add(a),t.push(s))})}),t.sort(ri)}function pl(){const e=uN();return r.cards.filter(t=>{const n=r.lessons.find(a=>a.id===t.lessonId);if(n&&!Me(n))return!1;const s=D(t.id);return s.state==="New"||s.dueAt&&new Date(s.dueAt)<=e}).sort(ri)}function ri(e,t){const n=D(e.id),s=D(t.id),a=n.dueAt?new Date(n.dueAt).getTime():0,o=s.dueAt?new Date(s.dueAt).getTime():0;if(a!==o)return a-o;if(a>0){const c=ka(n),l=ka(s);if(c!==l)return l-c}return Number(e.id)-Number(t.id)}function NS(){const e=r.filters.query.trim().toLocaleLowerCase(p()==="ru"?"ru-RU":"en-US");return r.cards.filter(t=>{const n=Kr(t.id),s=[t.kanji,R(t),t.meaning_ru,t.hiragana,t.romaji,t.onyomi,t.onyomi_romaji,t.kunyomi,t.kunyomi_romaji,hl(t),t.jlpt,Tl(t.lessonId),Jr(t),n.radical,f(n.radicalMeaning||{}),...t.apps,...t.examples.flatMap(a=>[a.word,a.reading,a.romaji,a.translation,Ie(a)])].join(" ").toLocaleLowerCase(p()==="ru"?"ru-RU":"en-US");return(!e||s.includes(e))&&(r.filters.jlpt==="all"||t.jlpt===r.filters.jlpt)&&(r.filters.radical==="all"||n.radical===r.filters.radical)&&(r.filters.favorites==="all"||!!r.progress.favorites[t.id])&&LS(t.strokes,r.filters.strokes)})}function LS(e,t){if(t==="all")return!0;if(t==="13+")return e>=13;const[n,s]=t.split("-").map(Number);return e>=n&&e<=s}function gl(){const e=r.cards.length,t=r.cards.filter(s=>D(s.id).state!=="New").length,n=r.cards.filter(s=>D(s.id).state==="Mastered").length;return{total:e,learned:t,mastered:n,todayCards:pl().length,completion:E(n,e)}}function ml(){return Object.values(r.progress.cards).reduce((e,t)=>e+(t.reviewCount||0),0)}function xS(){return(r.progress.transactions||[]).reduce((e,t)=>e+Math.max(0,Number(t.coins||0)),0)}function Vp(){const e=r.progress.totalCorrect+r.progress.totalWrong;return e?Math.round(r.progress.totalCorrect/e*100):0}function Yp(){const e={New:0,Learning:0,Review:0,Mastered:0};return r.cards.forEach(t=>{e[D(t.id).state]+=1}),e}function Zp(){const e={};return r.cards.forEach(t=>{var n;e[n=t.jlpt]||(e[n]=0),D(t.id).state==="Mastered"&&(e[t.jlpt]+=1)}),e}function Vt(){const e=re();return r.progress.daily[e]||(r.progress.daily[e]={learned:0,reviews:0,mastered:0,mistakes:0,minutes:0,goalClaimed:!1}),r.progress.daily[e]}function fl(e){return r.cards.filter(t=>t.lessonId===e)}function CS(){return r.cards.filter(e=>{const t=r.lessons.find(n=>n.id===e.lessonId);return(!t||Me(t))&&D(e.id).state==="New"})}function ne(e){const t=String(e||"");return t&&r.cards.find(n=>String(n.id)===t||String(n.kanji||"")===t||$p(n)===t)||null}function AS(e){return ne(e)}function TS(e){const t=String(e||"").trim();return t?/^\d+$/.test(t)||/[\p{Script=Han}\p{Script=Hiragana}\p{Script=Katakana}]/u.test(t)?!0:/^u[0-9a-f]{4,6}(?:-u[0-9a-f]{4,6})*-[a-z0-9]+(?:-[a-z0-9]+)*$/i.test(t):!1}function Kr(e){return r.kanjiMeta[String(e)]||{}}function ai(e){const t=r.kanjiHints[String(e)]||{};return{hint:f(t.hint||{})||Ee("leya","hint"),mnemonic:f(t.mnemonic||{})||""}}function IS(e){e&&(r.progress.favorites[e]?delete r.progress.favorites[e]:r.progress.favorites[e]=new Date().toISOString(),N(),C())}function jt(e=null){r.readingCheck={cardId:e?String(e):null,value:"",status:null,message:""}}function RS(e){const t=String(e||"");r.readingCheck.cardId!==t&&jt(t)}function eg(){const e=ne(r.readingCheck.cardId||r.activeCardId);if(!e)return;nr(e,"reading_check"),ug();const t=MS(r.readingCheck.value),n=_S(e),s=t.some(l=>n.normalized.has(l)),a=t.length>0,o=a&&s?"correct":"wrong",c=a?s?p()==="ru"?"Верно. Это чтение есть у карточки.":"Correct. This reading belongs to the card.":p()==="ru"?"Почти. Попробуй другое онъёми или кунъёми.":"Almost. Try another on'yomi or kun'yomi.":p()==="ru"?"Сначала напиши чтение хираганой или катаканой.":"Type a reading in hiragana or katakana first.";r.readingCheck={cardId:e.id,value:r.readingCheck.value,status:o,message:c},P(o==="correct"?"answer_correct":"answer_wrong"),He(),requestAnimationFrame(()=>{const l=document.getElementById(`readingCheck-${e.id}`);l&&(l.focus(),"setSelectionRange"in l&&l.setSelectionRange(l.value.length,l.value.length))})}function _S(e){const t=Dr(e),n=[...An(t.onyomi.kana),...An(t.kunyomi.kana),...An(e.hiragana)].filter(Boolean),s=n.filter((a,o)=>n.indexOf(a)===o);return{normalized:new Set(s.map(tg).filter(Boolean))}}function MS(e){return String(e||"").split(/[\/,гЂЃпјЊ\s]+/u).map(tg).filter(Boolean)}function tg(e){const t=ng(String(e||"").normalize("NFKC")).replace(/[гѓ»пЅҐ.\-]/gu,"").replace(/\s+/gu,"");return PS(t).trim()}function ng(e){return[...String(e||"")].map(t=>{const n=t.charCodeAt(0);return n>=12449&&n<=12534?String.fromCharCode(n-96):t}).join("")}function PS(e){let t="";for(const n of String(e||"")){if(n==="ー"){t+=ES(t.slice(-1));continue}t+=n}return t}function ES(e){return"あかさたなはまやらわがざだばぱゃぁ".includes(e)?"あ":"いきしちにひみりぎ�?ぢびぴぃ".includes(e)?"い":"うくすつぬふむゆるぐずづぶぷゅぅ".includes(e)?"う":"えけせてねへめれげぜでべぺぇ".includes(e)?"え":"おこそとのほもよろをごぞどぼぽょぉ".includes(e)?"お":""}function sg(e){if(!e)return null;const t=String(e.jlpt||"").toUpperCase();let n=null;return t==="N5"?n=r.n5KanjiCatalog:t==="N4"?n=r.n4KanjiCatalog:t==="N3"?n=r.n3KanjiCatalog:t==="N2"&&(n=r.n2KanjiCatalog),!n||!Array.isArray(n)?null:n.find(s=>s&&s.kanji===e.kanji)||null}const rg={あ:"a",い:"i",う:"u",え:"e",お:"o",か:"ka",き:"ki",く:"ku",け:"ke",こ:"ko",が:"ga",ぎ:"gi",ぐ:"gu",げ:"ge",ご:"go",さ:"sa",し:"shi",す:"su",せ:"se",そ:"so",ざ:"za",じ:"ji",ず:"zu",ぜ:"ze",ぞ:"zo",た:"ta",ち:"chi",つ:"tsu",て:"te",と:"to",だ:"da",ぢ:"ji",づ:"zu",で:"de",ど:"do",な:"na",に:"ni",ぬ:"nu",ね:"ne",の:"no",は:"ha",ひ:"hi",ふ:"fu",へ:"he",ほ:"ho",ば:"ba",び:"bi",ぶ:"bu",べ:"be",ぼ:"bo",ぱ:"pa",ぴ:"pi",ぷ:"pu",ぺ:"pe",ぽ:"po",ま:"ma",み:"mi",む:"mu",め:"me",も:"mo",や:"ya",ゆ:"yu",よ:"yo",ら:"ra",り:"ri",る:"ru",れ:"re",ろ:"ro",わ:"wa",ゐ:"i",ゑ:"e",を:"o",ん:"n",ゔ:"vu"},ag={きゃ:"kya",きゅ:"kyu",きょ:"kyo",ぎゃ:"gya",ぎゅ:"gyu",ぎょ:"gyo",しゃ:"sha",しゅ:"shu",しょ:"sho",じゃ:"ja",じゅ:"ju",じょ:"jo",ちゃ:"cha",ちゅ:"chu",ちょ:"cho",ぢゃ:"ja",ぢゅ:"ju",ぢょ:"jo",にゃ:"nya",にゅ:"nyu",にょ:"nyo",ひゃ:"hya",ひゅ:"hyu",ひょ:"hyo",びゃ:"bya",びゅ:"byu",びょ:"byo",ぴゃ:"pya",ぴゅ:"pyu",ぴょ:"pyo",みゃ:"mya",みゅ:"myu",みょ:"myo",りゃ:"rya",りゅ:"ryu",りょ:"ryo",ふぁ:"fa",ふぃ:"fi",ふぇ:"fe",ふぉ:"fo",しぇ:"she",じぇ:"je",ちぇ:"che",てぃ:"ti",でぃ:"di",とぅ:"tu",どぅ:"du",つぁ:"tsa",つぃ:"tsi",つぇ:"tse",つぉ:"tso",うぃ:"wi",うぇ:"we",うぉ:"wo",ゔぁ:"va",ゔぃ:"vi",ゔぇ:"ve",ゔぉ:"vo"};function Dr(e){const t=sg(e);if(t&&t.readings){const a=t.readings,o=ii(a.onyomi,a.onyomi_romaji||e?.onyomi_romaji,e?.onyomi),c=ii(a.kunyomi,a.kunyomi_romaji||e?.kunyomi_romaji,e?.kunyomi);if(o.kana||c.kana)return{onyomi:o,kunyomi:c}}const n=ii(e?.onyomi,e?.onyomi_romaji),s=ii(e?.kunyomi,e?.kunyomi_romaji);return n.kana||s.kana||n.romaji||s.romaji?{onyomi:n,kunyomi:s}:{onyomi:{kana:"",romaji:""},kunyomi:{kana:"",romaji:""}}}function An(e){return(Array.isArray(e)?e.join(" / "):String(e||"")).split(/[\/пјЏ,пјЊгЂЃгѓ»пЅҐ;пј›]+/u).map(n=>n.trim()).filter(Boolean)}function ii(e,t="",n=""){const s=An(e).length?An(e):An(n),a=An(t),o=s.map((c,l)=>({kana:Q(c),romaji:KS(c,a[l])})).filter(c=>c.kana||c.romaji);return{kana:o.map(c=>c.kana).filter(Boolean).join(" / "),romaji:o.map(c=>c.romaji).filter(Boolean).join(" / ")}}function KS(e,t){const n=ig(e);return n?t&&og(t)===og(n)?t:n:t||""}function ig(e){const t=[...DS(e)];let n="",s=!1;for(let a=0;a<t.length;a+=1){const o=t[a],c=t[a+1]||"";if(o==="っ"){s=!0;continue}if(o==="ー"){const u=FS(n);u&&(n+=u);continue}let l="";const d=o+c;if(ag[d])l=ag[d],a+=1;else if(rg[o])l=rg[o];else if(/[a-zA-Z0-9]/u.test(o))l=o.toLowerCase();else{s=!1;continue}if(s){const u=l.match(/^[bcdfghjklmnpqrstvwxyz]/u)?.[0]||"";u&&u!=="n"&&(n+=u),s=!1}n+=l}return n}function DS(e){return ng(String(e||"").normalize("NFKC")).replace(/[()\[\]{}]/gu,"").replace(/[.\-‐-―\s]/gu,"").trim()}function FS(e){return String(e||"").match(/[aeiou](?!.*[aeiou])/u)?.[0]||""}function og(e){return String(e||"").toLowerCase().normalize("NFKD").replace(/[̀-ͯ]/gu,"").replace(/[^a-z0-9]+/gu,"")}function lg(e){return e==="onyomi"?p()==="ru"?"Онъёми":"On'yomi":p()==="ru"?"Кунъёми":"Kun'yomi"}function oi(e){return e==="onyomi"?p()==="ru"?"Он":"On":p()==="ru"?"Кун":"Kun"}function hl(e){const t=Dr(e);return[`${oi("onyomi")}: ${t.onyomi.kana||"—"} (${t.onyomi.romaji||"—"})`,`${oi("kunyomi")}: ${t.kunyomi.kana||"—"} (${t.kunyomi.romaji||"—"})`].join(" Р'· ")}function vl(e){if(!e)return"";const t=e.audioSrc||e.audio||"";return dg(t)||cg(e)}function cg(e){if(!e?.id||!e?.jlpt||!e?.lessonId)return"";const t=OS(e.romaji);return t?`./audio/kanji/${String(e.jlpt).toLowerCase()}/${e.lessonId}/${e.id}-${t}.mp3`:""}function dg(e){return e?e.startsWith("./")||e.startsWith("http")?e:e.startsWith("/")?`.${e}`:`./${e}`:""}function OS(e){return String(e||"").split("/")[0].trim().toLowerCase().normalize("NFKD").replace(/[̀-ͯ]/g,"").replace(/[^a-z0-9]+/g,"-").replace(/^-+|-+$/g,"")}function BS(e){return!!(vl(e)||wl(e))}function wl(e){if(!e)return"";const t=Dr(e);return t.onyomi.kana||t.kunyomi.kana||e.hiragana||e.kanji||""}function US(e){const t=Dr(e);return{kanji:e?.kanji||"",onyomi:t.onyomi.kana,kunyomi:t.kunyomi.kana,hiragana:e?.hiragana||""}}function Ms(e,t=""){const n=NL(US(e));return!t||t==="cycle"?n:n.filter(s=>s.kind===t)}function GS(e){return Ms(e).length>0}function JS(e){return An(e)[0]||String(e||"").trim()}function bl(){if(r.route!=="learn"&&r.route!=="review")return;const e=560-(Date.now()-Hs);if(e>0){window.setTimeout(bl,e);return}const t=ne(r.activeCardId);if(!t)return;const n=Ms(t).map(o=>`${o.kind}:${o.kana}`).join("|")||wl(t),s=dg(t?.audioSrc||t?.audio||"");if(!n&&!s)return;const a=`${r.route}:${t.id}:${n||s}`;a!==nc&&(nc=a,pg(t,{silent:!0}))}function ug(){kl(),"speechSynthesis"in window&&window.speechSynthesis.cancel()}function kl(){At&&(At.pause(),At.currentTime=0,At=null)}function pg(e,t={}){let n=null;const s=()=>(n||(n=gg(e,t)),n);return mg(e,{kind:"cycle",silent:t.silent,fallback:s})?Promise.resolve(!0):s()}function gg(e,t={}){const n=vl(e);return n?(kl(),At=new Audio(n),At.preload="auto",At.onended=()=>{At=null},At.onerror=()=>{t.silent||console.warn("Kanji audio file could not be loaded.",{id:e?.id,audio:n})},At.play().then(()=>!0).catch(s=>(t.silent||console.warn("Kanji audio playback was blocked or failed.",{id:e?.id,audio:n,error:s}),!1))):Promise.resolve(!1)}function mg(e,t={}){kl();let n=null;const s=typeof t.fallback=="function"?()=>(n||(n=t.fallback()),n):null,a=Q(t.text||""),o=t.kind||"cycle",c=`${e?.id||e?.kanji||"kanji"}:${o}`,l=Ms(e);let d=null;if(!a){const h=LL(l,sc.get(c)??-1,o);d=h.item,sc.set(c,h.cursor)}const u=a||d?.kana||JS(wl(e));if(!xL(u,{onError:h=>{t.silent||console.warn("System kanji TTS failed; trying prepared audio fallback.",{id:e?.id,error:h}),s?.()}}))return s?.(),!s&&!t.silent&&console.warn("Kanji audio is not available for this card.",{id:e?.id,expected:cg(e)}),!1;const v=t.label||(d?tl(d):"TTS");return t.silent||J(`${e?.kanji||""} ${v}: ${u}`.trim()),!0}function zS(e,t){J(e?`${t}: ${e}`:`${t}: ${p()==="ru"?"аудио пока не добавлено":"audio not added yet"}`)}function Me(e){return!!e}function li(e){return r.rewards?.lessonUnlocks?.[e?.id]||1}function fg(e){if(!e||!Me(e))return"locked";const t=fl(e.id);return t.length?!!r.progress.lessonCompletions?.[e.id]||t.every(a=>{const o=D(a.id);return o.state!=="New"||o.reviewCount>0||o.lastReviewedAt})?"completed":t.some(a=>{const o=D(a.id);return o.state!=="New"||o.reviewCount>0||o.lastReviewedAt})?"started":"new":"new"}function yl(e){return e==="completed"?"is-completed":e==="started"?"is-started":""}function $l(e){const t=p()==="ru";return e==="completed"?t?"Урок пройден":"Lesson completed":e==="started"?t?"Урок начат":"Lesson started":t?"Не начат":"Not started"}function HS(e){return e!=="completed"&&e!=="started"?"":`<span class="lesson-status-dot" aria-label="${g($l(e))}"></span>`}function qS(e){return e!=="completed"&&e!=="started"?"":`<span class="pill lesson-status-pill ${yl(e)}">${i($l(e))}</span>`}function Yt(e){const t=String(e||"").toUpperCase();return r.jlptLessons.find(n=>n.jlpt===t)||null}function St(e){const t=String(e||"").toUpperCase();return r.jlptCatalog?.items?.find(n=>n.jlpt===t)||null}function ns(e){const t=String(e||"").toUpperCase();return t==="N5"?Z():t==="N4"?W():t==="N3"?H():t==="N2"?q():t==="N1"?ee():null}function WS(e,t,n="open"){const s=V(e),a=String(t||"");if(!s||!a)return!1;const o=ns(s);return!o||(o.viewedLessons||(o.viewedLessons={}),o.viewedLessons[a])?!1:(o.viewedLessons[a]=new Date().toISOString(),!0)}function XS(e,t){const n=V(e),s=String(t||"");if(!n||!s)return!1;const a=ns(n);return a?!!(a.viewedLessons?.[s]||a.completedLessons?.[s]):!1}function Fr(e,t="open"){var s;const n=V(e);return!n||((s=r.progress).viewedReadingLevels||(s.viewedReadingLevels={}),r.progress.viewedReadingLevels[n])?!1:(r.progress.viewedReadingLevels[n]=new Date().toISOString(),!0)}function QS(e){const t=V(e);return t?!!r.progress.viewedReadingLevels?.[t]:!1}function jl(e){const t=St(e);return Array.isArray(t?.previousLevels)?t.previousLevels.map(n=>String(n||"").toUpperCase()).filter(Boolean):[]}function hg(e){const t=String(e||"").toUpperCase(),n=ns(e);if(!n)return!1;if(n.finalTest?.passed)return!0;const a=St(t)?.lessonCount||(t==="N5"?10:0);let o=0;if(t==="N5"){o=Xn();const c=Object.keys(n.studiedKanji||{}).length;if(o>=10&&c>=80||o>=a)return!0}else if(o=Object.keys(n.completedLessons||{}).length,o>=a)return!0;return!1}function pt(e){const t=String(e||"").toUpperCase();if(Ke.includes(t)||r.progress.unlockedJlptLevels&&r.progress.unlockedJlptLevels.includes(t))return!0;if(!St(t))return t==="N5";const s=jl(t);return s.length?s.every(a=>hg(a)):!0}function vg(e=[]){const t=e.filter(Boolean);if(!t.length)return"";if(t.length===1)return t[0];const n=p()==="ru"?"Рё":"and";return t.length===2?`${t[0]} ${n} ${t[1]}`:`${t.slice(0,-1).join(", ")} ${n} ${t[t.length-1]}`}function Zt(e){const t=jl(e);return t.length?p()==="ru"?`Откроется после завершения ${vg(t)}.`:`Unlocks after completing ${vg(t)}.`:p()==="ru"?"Откроется после учебника N5.":"Unlocks after the N5 textbook."}function Or(e){const t=V(e);if(!t)return[];const n=St(t),s=r.lessons.filter(d=>String(d.jlpt||"").toUpperCase()===t),a=n?(n.lessonIds||[]).map(d=>r.lessons.find(u=>u.id===d)).filter(Boolean):s,o=new Set(a.map(d=>d.id)),c=s.filter(d=>!o.has(d.id)),l=Math.max(n?n.lessonCount||a.length:s.length,a.length);return[...a,...c].slice(0,l||s.length)}function Sl(e){const t=V(e);if(!t)return"";const n=Or(t);if(!n.length)return"";const s=o0(t);if(s?.lessonId&&ui(t,s.lessonId))return s.lessonId;const a=ns(t)?.currentLessonId||"";if(a&&ui(t,a))return a;const o=t==="N5"?Z().completedLessons||{}:t==="N4"?W().completedLessons||{}:t==="N3"?H().completedLessons||{}:t==="N2"?q().completedLessons||{}:r.progress.lessonCompletions||{},c=n.filter(l=>o[l.id]);return c.length?(c.sort((l,d)=>{const u=Date.parse(o[d.id]||"")||0,m=Date.parse(o[l.id]||"")||0;return u!==m?u-m:(d.order||0)-(l.order||0)}),c[0]?.id||n[0]?.id||""):n[0]?.id||""}function ci(e,t=""){const n=V(e);if(!n||!Yt(n))return;if(!pt(n)){r.activeTextbookLevel=n,r.activeJlptLesson=n,ze("textbooks",null,n),J(Zt(n));return}const s=r.route,a=String(t||"")||Sl(n),o=["N5","N4","N3","N2"].includes(n),c=a?`#textbooks/${encodeURIComponent(n)}/${encodeURIComponent(a)}`:`#textbooks/${encodeURIComponent(n)}`;r.route="textbooks",r.activeTextbookLevel=n,r.activeJlptLesson=n,r.activeTextbookSubroute=a||null,r.kanjiPageId=null,r.detailCardId=null,r.revealed=!1,r.navMenu=null,r.finalTestModal=null,r.finalTestBusy=!1,r.contactModal=!1,r.pendingFocus=!o&&a?`#textbook-lesson-${a}`:null,s!=="eva-room"&&(r.evaRoomShopOpen=!1),a&&gt(n,a,"open_jlpt"),jt(),tt(c),ja(),C()}function VS(e){return e?Yt(e.jlpt):null}function Ps(e){const t=String(e||"").toUpperCase();return r.jlptPracticeLessons.find(n=>n.jlpt===t)||null}function ss(){return r.progress.jlptLessonPractice=Uc(us().jlptLessonPractice,r.progress.jlptLessonPractice||{}),r.progress.jlptLessonPractice}function Es(e){if(!e?.drills?.length)return null;const t=ss(),n=t.activeIds[e.jlpt],s=e.drills.find(a=>a.id===n);return s||(t.activeIds[e.jlpt]=e.drills[0].id,e.drills[0])}function YS(e){const t=Ps(r.activeJlptLesson),n=Es(t);if(!n||!n.tiles[e])return;const s=ss(),a=s.selected[n.id]||[],o=n.blanks.flatMap(c=>c.answer||[]).length;a.includes(e)||a.length>=o||(s.selected[n.id]=[...a,e],s.checked[n.id]=!1,s.results[n.id]=null,N(),C())}function ZS(){const e=Es(Ps(r.activeJlptLesson));if(!e)return;const t=ss();t.selected[e.id]=(t.selected[e.id]||[]).slice(0,-1),t.checked[e.id]=!1,t.results[e.id]=null,N(),C()}function e0(){const e=Es(Ps(r.activeJlptLesson));if(!e)return;const t=ss();t.selected[e.id]=[],t.checked[e.id]=!1,t.results[e.id]=null,N(),C()}function t0(){const e=Es(Ps(r.activeJlptLesson));if(!e)return;const t={...Ll(),...Nl()},n=ss(),s=n.selected[e.id]||[],a=e.blanks.flatMap(l=>l.answer||[]),o=a.reduce((l,d,u)=>{const m=e.tiles[s[u]];return(!m||m.kanji!==d)&&l.push(u),l},[]),c=s.length===a.length&&o.length===0;n.checked[e.id]=!0,n.results[e.id]={correct:c,wrongIndexes:o,message:c?t.correct:t.wrong},c&&!n.completed[e.id]?(n.completed[e.id]=new Date().toISOString(),G(8,1,`jlpt_practice:${e.id}`),P("answer_correct")):c||P("answer_wrong"),N(),C()}function n0(){var o,c,l,d,u,m;const e=Ps(r.activeJlptLesson),t=Es(e);if(!e||!t)return;const n=e.drills.findIndex(v=>v.id===t.id),s=e.drills[(n+1)%e.drills.length],a=ss();a.activeIds[e.jlpt]=s.id,(o=a.selected)[c=s.id]||(o[c]=[]),(l=a.checked)[d=s.id]||(l[d]=!1),(u=a.results)[m=s.id]||(u[m]=null),N(),C()}function wg(e){const t=String(e||"").toUpperCase();return t?r.cards.filter(n=>String(n.jlpt||"").toUpperCase()===t):[]}function Nl(){return p()==="ru"?{courseText:"Стратегия уровня, чтения, лексика, приложения и интерактивная практика. Контент хранится в JSON, поэтому урок можно расширять без изменения логики.",apps:"Приложения и интерфейсы",kana:"Хирагана и катакана",hiragana:"Хирагана",katakana:"Катакана",kanjiFocus:"Кандзи с фуриганой",sentenceDrill:"Поставь кандзи в пропуск",fillBlanks:"Заполни пропуск плитками по порядку.",check:"Проверить",undo:"Убрать",clear:"Очистить",next:"Следующее",correct:"Верно. +8 XP и +1 Moon Fragment.",wrong:"Почти. Проверь порядок плиток и попробуй ещё раз."}:{courseText:"Level strategy, readings, vocabulary, apps, and interactive practice. Content lives in JSON, so lessons can grow without changing app logic.",apps:"Apps and interfaces",kana:"Hiragana and katakana",hiragana:"Hiragana",katakana:"Katakana",kanjiFocus:"Kanji with furigana",sentenceDrill:"Place kanji into the blank",fillBlanks:"Fill the blank with tiles in order.",check:"Check",undo:"Undo",clear:"Clear",next:"Next",correct:"Correct. +8 XP and +1 Moon Fragment.",wrong:"Almost. Check the tile order and try again."}}function Ll(){return p()==="ru"?{back:"К учебнику",courseMap:"Полноценный JLPT-модуль",courseText:"Краткая стратегия уровня, чтения, лексика и практика. Данные хранятся в JSON, поэтому урок можно расширять без изменения логики.",available:"кандзи уровня",learned:"изучено",mastered:"освоено",goals:"Цели уровня",practice:"Практика",checkpoint:"Чекпоинт"}:{back:"Back to textbook",courseMap:"Full JLPT module",courseText:"Level strategy, readings, vocabulary, and practice. The content lives in JSON, so lessons can grow without changing app logic.",available:"level kanji",learned:"learned",mastered:"mastered",goals:"Level goals",practice:"Practice",checkpoint:"Checkpoint"}}function di(e){const t=r.rewards?.levelCurve||{baseXp:100,growth:1.35};let n=1,s=e;for(;s>=Br(n,t)&&n<100;)s-=Br(n,t),n+=1;return n}function en(){const e=r.rewards?.levelCurve||{baseXp:100,growth:1.35};let t=1,n=r.progress.xp;for(;n>=Br(t,e)&&t<100;)n-=Br(t,e),t+=1;const s=Br(t,e);return{current:n,next:s,toNext:Math.max(0,s-n),percent:E(n,s)}}function Br(e,t){return Math.round(t.baseXp*Math.pow(t.growth,e-1))}function s0(){const e={app:"Flash Kanji",exportedAt:new Date().toISOString(),progress:r.progress,customization:r.customization},t=new Blob([JSON.stringify(e,null,2)],{type:"application/json"}),n=URL.createObjectURL(t),s=document.createElement("a");s.href=n,s.download=`flash-kanji-progress-${re()}.json`,document.body.append(s),s.click(),s.remove(),URL.revokeObjectURL(n),J(A("export"))}function Tn(e,t={}){try{return typeof window.ym!="function"?!1:(window.ym(xt,"reachGoal",e,t),!0)}catch(n){return console.warn("Metric goal failed.",n),!1}}function r0(e){return{level:e.dataset.shareLevel||e.dataset.level||"",lessonId:e.dataset.shareLessonId||e.dataset.lessonId||e.dataset.lesson||"",toastKey:e.dataset.shareToastKey||"",reward:e.dataset.shareReward&&r.rewardModal||null}}function V(e){const t=String(e||"").toUpperCase();return Ke.includes(t)?t:""}function Ue(e){if(!e||typeof e!="object")return null;const t=V(e.level),n=String(e.lessonId||"");if(!t||!n)return null;const s=typeof e.updatedAt=="string"&&e.updatedAt?e.updatedAt:new Date().toISOString();return{level:t,lessonId:n,updatedAt:s,source:typeof e.source=="string"&&e.source?e.source:"open"}}function a0(e={}){const t={};return Object.entries(e||{}).forEach(([n,s])=>{const a=V(n),o=Ue({...typeof s=="object"&&s?s:{},level:a||n});a&&o&&(t[a]=o)}),t}function rs(e={}){const t={};return Object.entries(e||{}).forEach(([n,s])=>{const a=String(n||"").trim();if(a){if(typeof s=="string"&&s.trim()){t[a]=s.trim();return}if(s&&typeof s=="object"){const o=typeof s.viewedAt=="string"&&s.viewedAt?s.viewedAt:typeof s.updatedAt=="string"&&s.updatedAt?s.updatedAt:new Date().toISOString();t[a]=o;return}s&&(t[a]=new Date().toISOString())}}),t}function ui(e,t){const n=V(e),s=String(t||"");return!n||!s?!1:Or(n).some(a=>a.id===s)}function i0(e,t){const n=V(e),s=String(t||"");if(!n||!s)return!!n;const a=new Set(["review","final","final-test"]),o=new Set(["kanji","grammar","reading","listening"]);return a.has(s)||n!=="N5"&&o.has(s)?!0:Or(n).some(c=>c.id===s)}function bg(e){return Or(e)[0]?.id||""}function o0(e=""){const t=V(e);if(t){const a=Ue(r.progress.lastOpenedJlptLessons?.[t]||null)||(Ue(r.progress.lastOpenedJlptLesson||null)?.level===t?Ue(r.progress.lastOpenedJlptLesson||null):null);return a&&ui(t,a.lessonId)?a:null}const n=[Ue(r.progress.lastOpenedJlptLesson||null),...Object.values(r.progress.lastOpenedJlptLessons||{}).map(a=>Ue(a)).filter(Boolean)].filter(Boolean);return n.sort((a,o)=>(Date.parse(o.updatedAt||"")||0)-(Date.parse(a.updatedAt||"")||0)),n.find(a=>ui(a.level,a.lessonId))||null}function l0(e=""){const t=V(e);if(t)return Ue(r.progress.lastOpenedJlptLessons?.[t]||null)||(Ue(r.progress.lastOpenedJlptLesson||null)?.level===t?Ue(r.progress.lastOpenedJlptLesson||null):null);const n=[Ue(r.progress.lastOpenedJlptLesson||null),...Object.values(r.progress.lastOpenedJlptLessons||{}).map(s=>Ue(s)).filter(Boolean)].filter(Boolean);return n.sort((s,a)=>(Date.parse(a.updatedAt||"")||0)-(Date.parse(s.updatedAt||"")||0)),n[0]||null}function c0(e){const t=V(e);if(!t)return"";const n=Ke.indexOf(t);return n>=0&&n<Ke.length-1?Ke[n+1]:""}function gt(e,t,n="open"){var v;const s=V(e),a=String(t||"");if(!s||!a)return null;const o={level:s,lessonId:a,updatedAt:new Date().toISOString(),source:n},c=Ue(r.progress.lastOpenedJlptLessons?.[s]||null),l=Ue(r.progress.lastOpenedJlptLesson||null);(v=r.progress).lastOpenedJlptLessons||(v.lastOpenedJlptLessons={}),r.progress.lastOpenedJlptLessons[s]=o,r.progress.lastOpenedJlptLesson=o;const d=WS(s,a,n),u=ns(s);return u&&u.currentLessonId!==a&&(u.currentLessonId=a),(!c||c.lessonId!==a||c.level!==s||l?.lessonId!==a||l?.level!==s||d)&&N(),o}function Nt(e,t="btn ghost"){const n=V(e),s=c0(n);if(!n||!s)return"";const a=bg(s);if(!a)return"";const o=p()==="ru"?`Первый урок ${s}`:`${s} lesson 1`;return`<button class="${g(t)}" type="button" data-action="final-test-next-level" data-level="${g(n)}" data-next-level="${g(s)}" data-next-lesson="${g(a)}">${i(o)}</button>`}function tn(){return V(r.activeJlptLesson)||V(r.activeTextbookLevel)||V(r.jlptLessons.find(e=>pt(e.jlpt))?.jlpt)||V(r.jlptLessons[0]?.jlpt)||"N5"}function d0(e,t={}){const n=String(e||r.route||"home").toLowerCase();return n==="textbooks"?"textbooks":n==="textbook"?`textbooks/${encodeURIComponent(V(t.level||r.activeTextbookLevel||tn())||tn())}`:n==="lesson"?`jlpt-lesson/${encodeURIComponent(V(t.level||r.activeJlptLesson||tn())||tn())}`:n==="srs"?"review":n==="stats"?"stats":n==="achievements"?"achievements":n==="achievement"?r.route||"home":n||"home"}function u0(e=r.route,t={}){const n=new URL(location.href);return n.search="",n.hash=d0(e,t),n.href}function p0(e=r.route,t={}){const n=String(e||r.route||"home").toLowerCase(),s=V(t.level||r.activeJlptLesson||r.activeTextbookLevel||""),a=p()==="ru",o={textbooks:a?"Учебники Flash Kanji":"Flash Kanji textbooks",textbook:a?"Учебник Flash Kanji":"Flash Kanji textbook",lesson:a?"Урок Flash Kanji":"Flash Kanji lesson",srs:a?"Повторение Flash Kanji":"Flash Kanji review",stats:a?"Статистика Flash Kanji":"Flash Kanji stats",achievements:a?"Достижения Flash Kanji":"Flash Kanji achievements",achievement:"Flash Kanji"},c=o[n]||o.achievement;return s&&["textbook","lesson"].includes(n)?`${c} ${s}`:c}function g0(e=r.route,t={}){const n=String(e||r.route||"home").toLowerCase(),s=V(t.level||r.activeJlptLesson||r.activeTextbookLevel||""),a=s?St(s):null,o=t.lesson||(s?Yt(s):null),c=p()==="ru";if(n==="textbooks")return c?"Функциональные учебники JLPT N5-N1 внутри Flash Kanji.":"Functional JLPT N5-N1 textbooks inside Flash Kanji.";if(n==="textbook"){const l=f(a?.displayTitle||a?.title||{}),d=Number(a?.lessonCount||0),u=Number(a?.kanjiCount||0);return c?`${l||"Учебник"}: ${d} уроков и ${u} кандзи.`:`${l||"Textbook"}: ${d} lessons and ${u} kanji.`}if(n==="lesson"){const l=f(o?.title||{}),d=f(o?.summary||{});return c?`${s?`${s} · `:""}${l||"Урок"} — ${d||"урок в Flash Kanji"}.`:`${s?`${s} · `:""}${l||"Lesson"} — ${d||"a Flash Kanji lesson"}.`}return n==="srs"?c?"Очередь повторений Flash Kanji.":"Flash Kanji review queue.":n==="stats"?c?"Моя статистика и прогресс во Flash Kanji.":"My Flash Kanji stats and progress.":n==="achievements"?c?"Достижения и секреты Flash Kanji.":"Flash Kanji achievements and secrets.":n==="achievement"?b0(t.reward||r.rewardModal||{}):"Flash Kanji."}function m0(){return p()==="ru"?"Поделиться":"Share"}function Ks(e=r.route,t={}){const n=V(t.level||""),s=String(t.lessonId||t.lesson?.id||""),a=t.label||m0();return`
      <button class="btn ghost share-btn" type="button" data-action="share-page" data-share-section="${g(e)}" ${n?`data-share-level="${g(n)}"`:""} ${s?`data-share-lesson-id="${g(s)}"`:""} ${t.toastKey?`data-share-toast-key="${g(t.toastKey)}"`:""}>
        <span class="btn-icon" aria-hidden="true">${f0()}</span>
        <span>${i(a)}</span>
      </button>
    `}function f0(){return`
    ...
    `}function kg(e){return e==="youtube"?`
        <svg viewBox="0 0 24 24" aria-hidden="true" focusable="false">
    ...
    `}async function h0(e,t={}){const n=t.toastKey||"shareLinkCopied",s={title:e.title,text:e.text,url:e.url};if(e.files?.length&&navigator.canShare?.({files:e.files})&&(s.files=e.files),navigator.share)try{return await navigator.share(s),"share"}catch(o){if(o&&o.name==="AbortError")return"abort"}return await j0(e.text,e.url,n)?"copy":"failed"}async function v0(e=r.route,t={}){const n=String(e||r.route||"home").toLowerCase(),s=t.reward||r.rewardModal||null,a={section:n,title:p0(n,t),text:g0(n,t),url:u0(n,t),files:[]};if(n==="achievement"||s){const o=await k0(s||{});o&&typeof File<"u"&&(a.files=[new File([o],`flash-kanji-achievement-${r.progress.level}.png`,{type:"image/png"})])}return a}async function yg(e=r.route,t={}){const n=String(e||r.route||"home").toLowerCase(),s={...t};s.level||(s.level=t.level||r.activeJlptLesson||r.activeTextbookLevel||""),Tn("share_opened",{section:n,level:V(s.level)||""});const a=await v0(n,s),o=await h0(a,{toastKey:t.toastKey||"shareLinkCopied"});return o==="share"?(Tn("share_completed",{section:n,method:a.files?.length?"file":"web_share"}),!0):o==="copy"?(Tn("share_link_copied",{section:n}),Tn("share_completed",{section:n,method:"copy"}),!0):(o==="abort"||J(p()==="ru"?"Не удалось поделиться":"Share failed"),!1)}async function w0(){await yg("achievement",{reward:r.rewardModal||{},toastKey:"shareCopied"})}function b0(e={}){const t=A("shareFallback"),n=e.level||r.progress.level,s=en(),a=e.type==="level"?`${s.current}/${s.next}`:e.totalXp||r.progress.xp,o=e.type==="level"?r.progress.moonFragments:e.moonFragments||r.progress.moonFragments;return`${t}: ${A("level")} ${n}, ${a} XP, ${o} Moon Fragments.`}async function k0(e={}){const s=document.createElement("canvas");s.width=1200,s.height=630;const a=s.getContext("2d");if(!a)return null;y0(a,1200,630);const o=e.level||r.progress.level,c=en(),l=e.type==="level"?`${c.current}/${c.next}`:e.totalXp||r.progress.xp,d=e.type==="level"?r.progress.moonFragments:e.moonFragments||r.progress.moonFragments,u=e.mascot||(r.progress.level%2===0?"leya":"eva"),m=Va(u,e.mood||"happy",e.dialog||e.type||"achievement"),[v,h]=await Promise.all([$g("assets/logo.webp"),m?$g(m):Promise.resolve(null)]);return v&&jg(a,v,58,48,330,116),h&&jg(a,h,780,95,330,450),a.fillStyle="#f7f4ee",a.font="900 58px system-ui, sans-serif",a.fillText(A("levelUp"),64,230),a.font="900 110px 'Yu Mincho', serif",a.fillStyle="#ffe15a",a.fillText(`${A("level")} ${o}`,64,340),a.font="800 38px system-ui, sans-serif",a.fillStyle="#f7f4ee",a.fillText(`${l} XP`,70,425),a.fillText(`${d} Moon Fragments`,70,482),a.fillStyle="rgba(255,255,255,0.74)",a.font="700 28px system-ui, sans-serif",a.fillText("Flash Kanji | JLPT Japanese learning",70,558),a.strokeStyle="rgba(255, 225, 90, 0.7)",a.lineWidth=3,a.strokeRect(34,30,1132,570),$0(s)}function y0(e,t,n){const s=e.createLinearGradient(0,0,t,n);s.addColorStop(0,"#08080c"),s.addColorStop(.45,"#1c1018"),s.addColorStop(1,"#071a18"),e.fillStyle=s,e.fillRect(0,0,t,n),e.fillStyle="rgba(255, 56, 92, 0.22)",e.beginPath(),e.moveTo(0,70),e.lineTo(720,0),e.lineTo(560,630),e.lineTo(0,630),e.closePath(),e.fill(),e.strokeStyle="rgba(255,255,255,0.08)",e.lineWidth=1;for(let a=-t;a<t*2;a+=38)e.beginPath(),e.moveTo(a,0),e.lineTo(a+t,n),e.stroke()}function $g(e){return new Promise(t=>{const n=new Image;n.onload=()=>t(n),n.onerror=()=>t(null),n.src=new URL(e,location.href).href})}function jg(e,t,n,s,a,o){const c=Math.min(a/t.naturalWidth,o/t.naturalHeight),l=t.naturalWidth*c,d=t.naturalHeight*c;e.drawImage(t,n+(a-l)/2,s+(o-d)/2,l,d)}function $0(e){return new Promise(t=>e.toBlob(t,"image/png",.94))}async function j0(e,t,n="shareLinkCopied"){const s=await Sg(`${e}
${t}`);return J(s?A(n):e),s}async function Sg(e){if(navigator.clipboard?.writeText)try{return await navigator.clipboard.writeText(e),!0}catch{}const t=document.createElement("textarea");t.value=e,t.setAttribute("readonly",""),t.style.position="fixed",t.style.left="-9999px",document.body.append(t),t.focus(),t.select(),t.setSelectionRange(0,t.value.length);try{return document.execCommand("copy")}catch{return!1}finally{t.remove()}}async function S0(e){const t=e.target.files?.[0];if(t)try{const n=JSON.parse(await t.text());r.progress=Tc(us(),n.progress||n),er(),n.customization&&(r.customization={...Bn(),...n.customization,selected:{...Bn().selected,...n.customization.selected||{}}},ds()),da(),Ds(),N(),nn(),J(A("import")),C()}catch(n){console.error(n),J("Invalid JSON")}finally{e.target.value=""}}function N0(){if(!confirm(p()==="ru"?"Сбросить прогресс?":"Reset progress?"))return;const e=r.progress.settings;r.progress=us(),r.progress.settings=e,r.finalTestModal=null,r.finalTestBusy=!1,er(),Ds(),N(),C()}function L0(){r.progress.settings.theme=r.progress.settings.theme==="dark"?"light":"dark",r.progress.settings.themeManuallySelected=!0,nn(),N(),C()}function x0(){r.progress.settings.language=p()==="ru"?"en":"ru",r.progress.settings.languageAutoDetected=!1,r.progress.settings.languageManuallySelected=!0,N(),C()}function Ng(){r.progress.settings.sound=!ln(r.progress.settings.sound,!0),r.progress.settings.uxSound=r.progress.settings.sound,Ds(),xl(),N(),J(r.progress.settings.sound?"в™Є":"Г—")}function C0(){Ng()}function Ur(){return window.FlashKanjiSound||null}function A0(){try{Ur()?.preloadSounds?.()}catch(e){console.warn("UX sounds preload failed.",e)}}function Ds(){const e=Ur();!e||!r.progress?.settings||(e.setSoundEnabled?.(ln(r.progress?.settings?.sound,!0)),e.setSoundVolume?.(gi()))}function pi(){return ln(r.progress?.settings?.sound,!0)}function xl(){const e=xe('[data-action="sound"]');if(!e)return;const t=ln(r.progress?.settings?.sound,!0),n=p()==="ru"?t?"Звук":"Звук выключен":t?"Sound":"Sound off";e.classList.toggle("is-muted",!t),e.setAttribute("aria-pressed",String(t)),e.setAttribute("aria-label",n),e.title=n,e.innerHTML=T0(t)}function T0(e){return e?`
        <svg viewBox="0 0 24 24" aria-hidden="true" focusable="false">
      ...
      `}function R0(){const e=xe('[data-action="notification-center"]');if(!e)return;const t=r.notificationPrompt||Hr(),n=!!(t.docked||r.notificationPromptVisible||wi("header")),s=!!r.notificationPromptVisible,a=s?p()==="ru"?"Скрыть уведомление":"Hide notification":t.docked?p()==="ru"?"Открыть уведомление":"Open notification":p()==="ru"?"Уведомления":"Notifications";e.hidden=!n,e.classList.toggle("is-active",s),e.classList.toggle("has-prompt",!!(t.docked||s)),e.setAttribute("aria-pressed",String(s)),e.setAttribute("aria-label",a),e.title=a,e.innerHTML=I0(s)}function Cl(){const e=xe('[data-action="toggle-header-socials"]');if(!e)return;const t=Al(),n=p()==="ru"?t?"Скрыть соцсети":"Открыть соцсети":t?"Hide social links":"Open social links";e.setAttribute("aria-expanded",String(t)),e.classList.toggle("is-active",t),e.setAttribute("aria-label",n),e.title=n}function Lg(e){const t=document.querySelector(".app-header");t&&(t.classList.toggle("is-social-open",!!e),Cl())}function Al(){return!!document.querySelector(".app-header")?.classList.contains("is-social-open")}function gi(){const e=Number(r.progress?.settings?.uxVolume);return Number.isFinite(e)?de(e,0,1):.75}function _0(e){const t=de(Number(e),0,1);r.progress.settings.uxVolume=t,Ds(),N()}function P(e){if(!pi())return!1;const t=()=>{try{if(!!Ur()?.playSound?.(e)){Hs=Date.now();return}Rl(String(e))}catch(n){console.warn("UX sound failed.",n),Rl(String(e))}};return typeof requestAnimationFrame=="function"?requestAnimationFrame(()=>window.setTimeout(t,0)):window.setTimeout(t,0),!0}function nn(){document.documentElement.dataset.theme=r.progress.settings.theme,document.documentElement.dataset.customTheme=r.customization?.selected?.theme||"theme_default_dark";const e=qt();document.documentElement.dataset.customRoom=e?.id||"bg_study_hub",document.documentElement.style.setProperty("--app-room-bg",M0(e?.file||"assets/bg/bg_study_hub.webp"));const t=Vv();document.documentElement.dataset.customEffect=t||"none",document.querySelector('meta[name="theme-color"]')?.setAttribute("content",r.progress.settings.theme==="light"?"#f8f7f2":"#08080c")}function M0(e){const t=String(e).replace(/["\\\n\r]/g,"");return`url("${t.startsWith("assets/")?`../${t}`:t}")`}function A(e){return r.i18n?.ui?.[e]?.[p()]||r.i18n?.ui?.[e]?.ru||e}function p(){return r.progress?.settings?.language||"ru"}function f(e){return!e||typeof e!="object"?String(e||""):e[p()]||e.ru||e.en||""}function P0(e){if(!e)return"";try{return new Intl.DateTimeFormat(p()==="ru"?"ru-RU":"en-US",{day:"2-digit",month:"short",hour:"2-digit",minute:"2-digit"}).format(new Date(e))}catch{return String(e).slice(0,16)}}function Gr(e){return p()==="en"&&r.lessonTranslations[e.id]?.title_en||e.title}function E0(e){return p()==="en"&&r.lessonTranslations[e.id]?.summary_en||e.summary}function Tl(e){const t=r.lessons.find(n=>n.id===e);return t?Gr(t):""}function R(e){return Pe(e,p())}function Pe(e,t=p()){if(!e)return"";const n=sg(e);return n&&n.meaning?t==="en"?n.meaning.en||n.meaning.ru||e.meaning_en||r.kanjiTranslations[e.id]?.meaning_en||"":n.meaning.ru||e.meaning_ru||r.kanjiTranslations[e.id]?.meaning_en||e.meaning_en||"":t==="en"?r.kanjiTranslations[e.id]?.meaning_en||e.meaning_en||e.meaning_ru||"":e.meaning_ru||r.kanjiTranslations[e.id]?.meaning_en||e.meaning_en||""}function Jr(e){return p()==="en"?r.kanjiTranslations[e.id]?.interface_use_en||e.interface_use_en||e.interface_use||"":e.interface_use||e.interface_use_en||""}function Ie(e){if(p()!=="en")return e.translation_ru||e.translation||"";if(e.translation_en)return e.translation_en;const t=r.vocabulary.find(n=>n.word===e.word||Il(n.romaji)===Il(e.romaji));return t?.translation_en?t.translation_en:lm[Il(e.romaji)]||e.translation||""}function Il(e){return String(e||"").trim().toLowerCase().replace(/[^a-z0-9]+/g,"")}function Fs(e){return r.dialogues?.mascots?.[e]||{name:{ru:e,en:e},sprites:{},dialogs:{}}}function Ee(e,t){const n=e==="eva"?K0(t):"";if(n)return n;const s=Fs(e).dialogs?.[t]||Fs(e).dialogs?.welcome||{},a=s[p()]||s.ru||[""];return Ge(a)}function K0(e="welcome"){const t=String(e||"welcome").toLowerCase();if(!["welcome","progress","hint","lessoncomplete","masterymilestone","achievement"].includes(t))return"";const n=D0(t),s=[...r.evaAutonomyLines||[],...Aa()].filter(c=>{const l=f(c?.text||{});if(!l)return!1;const d=Array.isArray(c.tags)?c.tags:[];if(!(n.includes(c.category)||d.some(v=>n.includes(v))))return!1;const m=xg(l);return m.length>=12&&m.length<=132}),a=s.filter(c=>!_i.includes(c.id)),o=Ge(a.length?a:s);return o?(o.id&&(_i=[o.id,..._i.filter(c=>c!==o.id)].slice(0,18)),xg(f(o.text||{}))):""}function D0(e){return{welcome:["fis_study","fis_focus","fis_observation","fis_short","study","short","mood","room"],progress:["fis_reward","fis_streak","fis_review","reward","streak","review","progress"],hint:["fis_focus","fis_observation","hint","study"],lessoncomplete:["fis_reward","fis_streak","reward","study"],masterymilestone:["fis_reward","fis_streak","reward","progress"],achievement:["fis_reward","reward","achievement"]}[e]||["fis_study","study"]}function xg(e){const t=String(e||"").replace(/\s+/g," ").trim();if(t.length<=132)return t;const n=t.match(/[^.!?гЂ'пјЃпјџ]+[.!?гЂ'пјЃпјџ]?/g)||[t];let s="";for(const a of n){const o=`${s} ${a.trim()}`.trim();if(o.length>132)break;s=o}return s.length>=12?s:`${t.slice(0,124).trimEnd()}...`}function mi(e){const t=Cg(e);return`<span class="pill ${t}">${i(om[t]||"New")}</span>`}function Cg(e){const t=String(e||"new").toLowerCase();return t==="new"||t==="learning"||t==="review"||t==="mastered"?t:t==="New".toLowerCase()?"new":t.includes("master")?"mastered":t.includes("learn")?"learning":t.includes("review")?"review":"new"}function Ag(e){const t=(e.correct||0)+(e.wrong||0);return t?Math.round((e.correct||0)/t*100):0}function F0(){const e=getComputedStyle(document.documentElement);return{text:e.getPropertyValue("--text").trim(),muted:e.getPropertyValue("--muted").trim(),line:e.getPropertyValue("--line").trim(),red:e.getPropertyValue("--accent").trim(),yellow:e.getPropertyValue("--accent-2").trim(),green:e.getPropertyValue("--accent-3").trim(),blue:e.getPropertyValue("--accent-4").trim(),danger:e.getPropertyValue("--danger").trim(),pink:"#ff91d8",blueSoft:"rgba(67, 214, 255, 0.16)",dangerSoft:"rgba(255, 107, 95, 0.16)"}}function O0(e){return{responsive:!0,maintainAspectRatio:!1,plugins:{legend:{labels:{color:e.text}}},scales:{x:{ticks:{color:e.muted},grid:{color:e.line}},y:{beginAtZero:!0,ticks:{color:e.muted,precision:0},grid:{color:e.line}}}}}function fi(){try{return ta||(ta=new(window.AudioContext||window.webkitAudioContext)),ta.state==="suspended"&&ta.resume().catch(()=>null),ta}catch(e){return console.warn("Audio context unavailable.",e),null}}function B0(e){const t=String(e||"").toLowerCase();return t.includes("wrong")||t.includes("failed")?{type:"triangle",frequencies:[180],duration:.22,peak:.12,interval:0}:t.includes("correct")||t.includes("success")?{type:"triangle",frequencies:[440,554.37],duration:.18,peak:.11,interval:.09}:t.includes("level")||t.includes("achievement")||t.includes("reward")||t.includes("xp")||t.includes("moon")||t.includes("unlock")?{type:"sine",frequencies:[523.25,659.25,783.99],duration:.26,peak:.1,interval:.08}:t.includes("close")?{type:"square",frequencies:[260],duration:.12,peak:.08,interval:0}:t.includes("open")||t.includes("button")||t.includes("click")||t.includes("tab")||t.includes("page")?{type:"sine",frequencies:[320],duration:.09,peak:.08,interval:0}:{type:"sine",frequencies:[360],duration:.16,peak:.08,interval:0}}function Rl(e){const t=fi();if(!t)return!1;try{const n=B0(e),s=t.currentTime+.01;return n.frequencies.forEach((a,o)=>{const c=t.createOscillator(),l=t.createGain();c.type=n.type,c.frequency.value=a;const d=s+n.interval*o;l.gain.setValueAtTime(1e-4,d),l.gain.exponentialRampToValueAtTime(n.peak,d+.02),l.gain.exponentialRampToValueAtTime(1e-4,d+n.duration),c.connect(l).connect(t.destination),c.start(d),c.stop(d+n.duration+.02)}),Hs=Date.now(),!0}catch(n){return console.warn("Fallback UX tone failed.",n),!1}}window.FlashKanjiUxToneFallback=Rl;function U0(){const e=()=>{const t=fi();t?.state==="suspended"&&t.resume().catch(()=>null)};["pointerdown","touchstart","keydown","mousedown"].forEach(t=>{document.addEventListener(t,e,{once:!0,passive:!0,capture:!0})})}function hi(e){if(r.progress.settings.sound){if(Ur()){P(e==="again"?"answer_wrong":"answer_correct");return}try{const t=fi();if(!t)return;Hs=Date.now();const n=t.createOscillator(),s=t.createGain(),a=t.currentTime;n.type="triangle",n.frequency.value=e==="again"?180:480,s.gain.setValueAtTime(1e-4,a),s.gain.exponentialRampToValueAtTime(.13,a+.015),s.gain.exponentialRampToValueAtTime(1e-4,a+.18),n.connect(s).connect(t.destination),n.start(a),n.stop(a+.2)}catch(t){console.warn("Audio unavailable.",t)}}}function G0(){if(r.progress.settings.sound)try{const e=fi();if(!e)return;Hs=Date.now();const t=e.currentTime;[523.25,659.25,783.99].forEach((n,s)=>{const a=e.createOscillator(),o=e.createGain();a.type="sine",a.frequency.value=n;const c=t+s*.08;o.gain.setValueAtTime(1e-4,c),o.gain.exponentialRampToValueAtTime(.12,c+.02),o.gain.exponentialRampToValueAtTime(1e-4,c+.24),a.connect(o).connect(e.destination),a.start(c),a.stop(c+.26)})}catch(e){console.warn("Achievement sound unavailable.",e)}}function J0(){const e=document.createElement("div");e.className="confetti",e.innerHTML=Array.from({length:34},(t,n)=>`<i style="--x:${Math.random()*100}vw;--d:${Math.random()*.8+.8}s;--r:${Math.random()*360}deg;--c:${n%4}"></i>`).join(""),document.body.append(e),window.setTimeout(()=>e.remove(),1800)}function J(e){const t=xe("#toast");t.textContent=e,t.hidden=!1,clearTimeout(rc),rc=window.setTimeout(()=>{t.hidden=!0},2400)}function Tg(){return`
      ...
      </section>`}function z0(e){return`<section class="empty-state" style="margin-top:24px"><span class="kanji-char">警</span><h1>Data error</h1><p>${i(e.message)}</p></section>`}function H0(){try{[Lt,Js,ea,"flashKanji.lastForcedBuild"].forEach(t=>{try{localStorage.removeItem(t)}catch(n){console.warn(`Could not remove recovery key ${t}.`,n)}})}catch(e){console.warn("Could not clear Flash Kanji recovery markers during boot recovery.",e)}}async function q0(){if("caches"in window){const e=await caches.keys();await Promise.all(e.map(t=>caches.delete(t)))}if("serviceWorker"in navigator){const e=await navigator.serviceWorker.getRegistrations();await Promise.all(e.map(async t=>{try{await t.unregister()}catch(n){console.warn("Could not unregister service worker during boot recovery.",n)}}))}}async function W0(e){try{const t=Number(sessionStorage.getItem(Zr)||"0");if(t>=2)return!1;const n=t+1;sessionStorage.setItem(Zr,String(n)),console.warn(`[FlashKanji] Boot failed, attempting recovery stage ${n}.`,e),n>=2&&H0(),await q0();try{localStorage.removeItem(Lt),localStorage.removeItem(Js),localStorage.removeItem(ea),localStorage.removeItem("flashKanji.lastForcedBuild")}catch(a){console.warn("Boot recovery marker cleanup failed.",a)}const s=new URL(location.href);return s.searchParams.set("cachebust",Date.now().toString()),s.searchParams.set("bootRecovery",String(n)),location.replace(s.toString()),!0}catch(t){return console.warn("Boot recovery failed.",t),!1}}function X0(){if(!("serviceWorker"in navigator)||location.protocol==="file:")return;let e=!1;navigator.serviceWorker.addEventListener("controllerchange",()=>{e||(e=!0,location.reload())}),navigator.serviceWorker.addEventListener("message",n=>{if(n.data?.type==="FLASH_KANJI_CACHE_RESET_DONE")try{localStorage.setItem(Js,`${_}:done`)}catch(s){console.warn("Cannot save PWA cache reset marker.",s)}});const t=async()=>{try{const n=new URL("service-worker.js",document.baseURI),s=await navigator.serviceWorker.register(n.href);if(!s||typeof s.update!="function")return;Q0(s),await s.update().catch(console.warn)}catch(n){console.warn(n)}};document.readyState==="loading"?window.addEventListener("load",()=>{t()},{once:!0}):t()}function Q0(e){e&&e.addEventListener("updatefound",()=>{const t=e.installing;t&&t.addEventListener("statechange",()=>{(t.state==="installed"||t.state==="activated")&&e.update().catch(()=>null)})})}function vi(){const e={declineCount:0,nextShowAt:0,neverShow:!1,installed:!1};try{const t=localStorage.getItem(j)||localStorage.getItem(S);if(!t)return e;const n=JSON.parse(t),s={...e,...n,declineCount:Number(n.declineCount||0),nextShowAt:Number(n.nextShowAt||0),neverShow:!!n.neverShow,installed:!!n.installed};return localStorage.getItem(j)||localStorage.setItem(j,JSON.stringify(s)),s}catch(t){return console.warn("PWA install prompt state reset.",t),e}}function _l(){try{localStorage.setItem(j,JSON.stringify(r.pwaInstallPrompt))}catch(e){console.warn("Cannot save PWA install prompt state.",e)}}function V0(e){e.preventDefault(),an=e,r.progress&&r.i18n&&Z0()}async function Y0(){if(Tn("pwa_install_clicked",{available:!!an,ios:Os()}),zr()){Pl();return}if(!an){r.pwaInstallHelpVisible=!0,He();return}const e=an;an=null;try{if(await e.prompt(),(await e.userChoice)?.outcome==="accepted"){Pl();return}El()}catch(t){console.warn("PWA install prompt failed.",t),El()}}function zr(){return["standalone","fullscreen","minimal-ui"].some(t=>window.matchMedia?.(`(display-mode: ${t})`)?.matches)||Reflect.get(navigator,"standalone")===!0}function Ml(){const e=r.pwaInstallPrompt||vi();if(zr()||e.installed||e.neverShow||Date.now()<Number(e.nextShowAt||0))return!1;const t=r.progress?.visits?.firstVisitDate;return!t||Rn(t,re())<1?!1:!!an||Os()}function Z0(){Ml()&&(Tn("pwa_prompt_shown",{source:an?"browser":"ios"}),P("notification_soft"),C())}function Pl(){r.pwaInstallPrompt={...vi(),...r.pwaInstallPrompt,installed:!0,neverShow:!0,nextShowAt:0},r.pwaInstallHelpVisible=!1,_l(),Tn("pwa_installed",{platform:Os()?"ios":"browser"}),Mg(),r.progress&&r.i18n&&C()}function El(){const e=r.pwaInstallPrompt||vi(),t=Math.min(Number(e.declineCount||0)+1,5);r.pwaInstallPrompt={...e,declineCount:t,nextShowAt:eN(t),neverShow:t>=5,installed:!1},_l(),C()}function eN(e){const s={1:864e5,2:1728e5,3:6048e5,4:2592e6};return e>=5?0:Date.now()+(s[e]||864e5)}function tN(){!zr()||r.pwaInstallPrompt.installed||(r.pwaInstallPrompt={...r.pwaInstallPrompt,installed:!0,neverShow:!0,nextShowAt:0},_l())}function Os(){const e=navigator.userAgent||"",t=/iphone|ipad|ipod/i.test(e)||navigator.platform==="MacIntel"&&navigator.maxTouchPoints>1,n=/safari/i.test(e)&&!/(crios|fxios|edgios|opios|chrome|android)/i.test(e);return t&&n}function Ig(){return p()==="en"?{badge:"Offline PWA",title:"Install Flash Kanji on your home screen?",description:"Your progress, lessons and reviews will open like a real app.",iosInstruction:"Tap Share -> Add to Home Screen.",install:"Install app",later:"Later"}:{badge:"Offline PWA",title:"Установить Flash Kanji на главный экран?",description:"Так прогресс, уроки и повторения будут открываться как приложение.",iosInstruction:"Нажмите Поделиться → На экран Домой.",install:"установить приложение",later:"Позже"}}function Hr(){const e={declineCount:0,nextShowAt:0,neverShow:!1,permission:typeof Notification>"u"?"unsupported":Notification.permission,enabled:!1,acceptedAt:null,lastAskedAt:0,lastShown:{},periodicSync:!1,docked:!1};try{const t=localStorage.getItem(I);if(!t)return e;const n=JSON.parse(t);return{...e,...n,declineCount:Number(n.declineCount||0),nextShowAt:Number(n.nextShowAt||0),neverShow:!!n.neverShow,enabled:!!n.enabled,lastShown:n.lastShown&&typeof n.lastShown=="object"?n.lastShown:{},docked:!!n.docked}}catch(t){return console.warn("Notification prompt state reset.",t),e}}function In(){try{localStorage.setItem(I,JSON.stringify(r.notificationPrompt))}catch(e){console.warn("Cannot save notification prompt state.",e)}}function qr(){clearTimeout(Ci),Ci=0}function nN(){qr(),r.notificationPromptVisible&&(Ci=window.setTimeout(()=>{r.notificationPromptVisible&&Rg()},5e3))}function Rg(){qr(),!(!r.notificationPromptVisible&&r.notificationPrompt?.docked)&&(r.notificationPromptVisible=!1,r.notificationPrompt={...r.notificationPrompt,docked:!0},In(),C())}function _g(){return zr()||!!r.pwaInstallPrompt?.installed}function wi(e="usage"){const t=r.notificationPrompt||Hr();return!(!("Notification"in window)||t.neverShow||t.enabled||!_g()||Notification.permission==="granted"||Notification.permission==="denied"||Date.now()<Number(t.nextShowAt||0)||e!=="lesson_complete"&&Date.now()-Ei<2*60*1e3)}function bi(e="usage"){return wi(e)?(r.notificationPromptVisible=!0,r.notificationPrompt={...r.notificationPrompt,docked:!1},In(),P("notification_soft"),nN(),C(),!0):("Notification"in window&&Notification.permission==="granted"&&Pg(),!1)}function Mg(){if(clearTimeout(oc),!_g())return;const e=Math.max(0,2*60*1e3-(Date.now()-Ei));oc=window.setTimeout(()=>bi("usage"),e)}async function sN(){if(r.notificationPromptVisible=!1,qr(),!("Notification"in window)){ki();return}try{const e=Notification.permission==="granted"?"granted":await Notification.requestPermission();if(r.notificationPrompt.permission=e,r.notificationPrompt.lastAskedAt=Date.now(),e==="granted"){Pg(),J(Kg().enabled),He();return}ki()}catch(e){console.warn("Notification permission failed.",e),ki()}}function Pg(){!("Notification"in window)||Notification.permission!=="granted"||(qr(),r.notificationPrompt={...Hr(),...r.notificationPrompt,permission:"granted",enabled:!0,neverShow:!0,docked:!1,acceptedAt:r.notificationPrompt.acceptedAt||new Date().toISOString(),nextShowAt:0},In(),Kl())}function ki(){const e=r.notificationPrompt||Hr(),t=Math.min(Number(e.declineCount||0)+1,5);r.notificationPromptVisible=!1,qr(),r.notificationPrompt={...e,permission:"Notification"in window?Notification.permission:"unsupported",declineCount:t,nextShowAt:rN(t),neverShow:t>=5,enabled:!1,docked:!1,lastAskedAt:Date.now()},In(),He()}function rN(e){const s={1:432e5,2:1728e5,3:6048e5,4:2592e6};return e>=5?0:Date.now()+(s[e]||12*36e5)}function Kl(){!("Notification"in window)||Notification.permission!=="granted"||(r.notificationPrompt.permission="granted",r.notificationPrompt.enabled=!0,In(),Mi.forEach(e=>clearTimeout(e)),Mi.clear(),[{type:"daily_bonus",hour:9,minute:0},{type:"lesson",hour:11,minute:30},{type:"review",hour:18,minute:0},{type:"streak",hour:20,minute:30}].forEach(e=>Eg(e.type,aN(e.hour,e.minute))),cN())}function Eg(e,t){const n=Math.max(1e3,Math.min(t.getTime()-Date.now(),2147483647)),s=window.setTimeout(async()=>{await iN(e),Eg(e,dN(t,1))},n);Mi.set(e,s)}function aN(e,t){const n=new Date;return n.setHours(e,t,0,0),n.getTime()<=Date.now()+60*1e3&&n.setDate(n.getDate()+1),n}async function iN(e){if(!oN(e))return!1;const t=lN(e);try{const n=await navigator.serviceWorker?.ready;return n?.showNotification?await n.showNotification(t.title,t.options):"Notification"in window&&Notification.permission==="granted"&&new Notification(t.title,t.options),P(e==="daily_bonus"?"notification_reward":"notification_reminder"),r.notificationPrompt.lastShown[e]=re(),In(),!0}catch(n){return console.warn("Notification show failed.",n),!1}}function oN(e){if(!("Notification"in window)||Notification.permission!=="granted"||r.notificationPrompt.lastShown?.[e]===re())return!1;if(e==="review")return Be()>0;if(e==="daily_bonus"){const t=va(r.progress.dailyBonusPending);return!!r.progress.visits?.firstVisitDate&&!!t&&t.availableOn<=re()&&!r.progress.dailyBonuses[re()]}return e==="lesson"?CS().length>0:e==="streak"?(r.progress.streak.current||r.progress.visits?.streak||0)>0:!0}function lN(e){const t=p()==="ru",n={review:{title:"Flash Kanji",body:t?"Ваши кандзи ждут повторения.":"Your kanji are waiting for review.",url:"./index.html#review"},streak:{title:t?"Лея рядом 🌙":"Leya is nearby рџЊ™",body:t?"Не потеряйте свою серию дней.":"Do not lose your daily streak.",url:"./index.html#home"},daily_bonus:{title:t?"Ежедневный бонус":"Daily Bonus",body:t?"Заберите XP и Moon Fragments.":"Claim XP and Moon Fragments.",url:"./index.html#home"},lesson:{title:t?"Новые знания ждут":"New knowledge awaits",body:t?"Продолжите изучение кандзи.":"Continue learning kanji.",url:"./index.html#textbooks"}},s=n[e]||n.review;return{title:s.title,options:{body:s.body,tag:`flash-kanji-${e}`,renotify:!1,icon:"./assets/icon-192.png",badge:"./assets/icon-192.png",data:{url:s.url,type:e}}}}async function cN(){try{const e=await navigator.serviceWorker?.ready;if(!e?.periodicSync)return;await e.periodicSync.register("flash-kanji-daily",{minInterval:24*60*60*1e3}),r.notificationPrompt.periodicSync=!0,In()}catch{r.notificationPrompt.periodicSync=!1,In()}}function Kg(){return p()==="en"?{badge:"PWA reminders",title:"Allow Flash Kanji notifications?",description:"We will remind you about reviews, streaks and daily bonuses.",allow:"Allow",later:"Later",enabled:"Notifications enabled"}:{badge:"PWA напоминания",title:"Разрешить уведомления Flash Kanji?",description:"Мы напомним о повторениях, серии и ежедневном бонусе.",allow:"Разрешить",later:"Позже",enabled:"Уведомления включены"}}function se(e){return{...e,history:[...e.history||[]]}}function dN(e,t){return new Date(e.getTime()+t*24*60*60*1e3)}function uN(){const e=new Date;return e.setHours(23,59,59,999),e}function re(){return Dl(new Date)}function Dl(e){return`${e.getFullYear()}-${String(e.getMonth()+1).padStart(2,"0")}-${String(e.getDate()).padStart(2,"0")}`}function Fl(e){const[t,n,s]=e.split("-").map(Number);return new Date(t,n-1,s)}function Rn(e,t){return Math.round((Fl(t)-Fl(e))/864e5)}function Dg(e,t){const n=Fl(e);return n.setDate(n.getDate()+t),Dl(n)}function pN(e){return Array.from({length:e},(t,n)=>{const s=new Date;return s.setDate(s.getDate()-(e-1-n)),Dl(s)})}function _n(e){if(!e)return p()==="ru"?"сейчас":"now";const t=new Date(e).getTime()-Date.now();if(t<=0)return p()==="ru"?"сейчас":"now";const n=Math.ceil(t/6e4);if(n<60)return p()==="ru"?`через ${n} мин.`:`in ${n} min`;const s=Math.ceil(n/60);if(s<24)return p()==="ru"?`через ${s} ч.`:`in ${s} h`;const a=Math.ceil(s/24);return p()==="ru"?`через ${a} дн.`:`in ${a} d`}function E(e,t){return t?de(Math.round(e/t*100),0,100):0}function de(e,t,n){return Math.max(t,Math.min(n,e))}function yi(e,t){const n=10**t;return Math.round(e*n)/n}function Ge(e){return e[Math.floor(Math.random()*e.length)]}function Mn(e,t){return Math.floor(Number(e)+Math.random()*(Number(t)-Number(e)))}function Wr(e,t){return String(e)===String(t)?"selected":""}function gN(){let e="/";try{e=decodeURIComponent(location.pathname||"/")}catch{return"/"}if(!Gg(e))return"/";const t=e.replace(/\/textbooks(?:\/[^/?#]*)*\/?$/i,"/")||"/";if(t!==e||/^\/?textbooks(?:\/|$)/i.test(e))return t.endsWith("/")?t:`${t}/`;if(/\/[^/]+\.html$/i.test(e)){const n=e.replace(/[^/]+\.html$/i,"")||"/";return n.endsWith("/")?n:`${n}/`}return e.endsWith("/")?e:`${e}/`}function Fg(e="",t=""){const n=String(e||"").trim().toUpperCase(),s=String(t||"").trim(),a=n?`#textbooks/${encodeURIComponent(n)}`:"#textbooks/";return s?`${a}/${encodeURIComponent(s)}`:a}function tt(e=""){const t=String(e||"").trim(),n=t?t.startsWith("#")?t:`#${t.replace(/^#/,"")}`:"",s=`${gN()}${location.search||""}${n}`;`${location.pathname}${location.search||""}${location.hash||""}`!==s&&history.replaceState(null,"",s)}function $i(){const e=Yg(location.pathname||"/");return e.status==="valid"&&e.kind==="download"&&!location.hash?e:Gg(location.pathname||"/")?En(location.hash):e.status==="not-found"?e:we("pathname","entity-not-found",e.raw,e.segments,e.locale,e.canonicalPath)}function Og(e){return!e||e.status!=="not-found"?"":`${e.source}:${e.reason}:${e.raw}:${e.canonicalPath||""}`}function Xr(e){const t=e.route,n=e.status==="valid"?e.params:{};r.routeMatch=e,r.routeNotFound=e.status==="not-found"?e:null,r.route=t,r.kanjiPageId=t==="kanji"&&n.cardId||null,r.activeTextbookLevel=t==="textbooks"&&n.level||null,r.activeTextbookSubroute=t==="textbooks"&&n.subroute||null,r.activeJlptLesson=t==="jlpt-lesson"?n.level||null:t==="textbooks"&&n.level||r.activeJlptLesson,r.activeLearnView=t==="learn"&&n.view||Ut,r.activeLearnNodeId=t==="learn"&&r.activeLearnView===Ct&&n.targetId||null,r.activeLearnLegacyLessonId=t==="learn"&&r.activeLearnView===Gt&&n.targetId||null}function Ol(e){if(e.status==="not-found"||e.source==="pathname")return e;const t=e.params||{};if(e.route==="kanji"&&!AS(t.cardId))return!r.deferredDataLoaded&&TS(t.cardId)?e:we("hash","entity-not-found",e.raw,e.segments,e.locale);if(e.route==="textbooks"){const n=t.level||"",s=t.subroute||"";if(n&&!St(n)||n&&s&&!i0(n,s))return we("hash","entity-not-found",e.raw,e.segments,e.locale)}return e.route==="jlpt-lesson"&&!Yt(t.level)||e.route==="learn"&&(t.view===Ct&&!Hn(t.targetId)||t.view===Gt&&!r.lessons.some(n=>n.id===t.targetId))?we("hash","entity-not-found",e.raw,e.segments,e.locale):e}function mN(){return En(location.hash).raw}function fN(){const e=En(location.hash);return e.status==="valid"&&e.route==="kanji"&&e.params.cardId||""}function hN(){const e=En(location.hash);return e.status==="valid"&&e.route==="textbooks"&&e.params.level||""}function vN(){const e=En(location.hash);return e.status==="valid"&&e.route==="textbooks"&&e.params.subroute||""}function wN(){const e=En(location.hash);return e.status==="valid"&&e.route==="jlpt-lesson"&&e.params.level||""}function bN(){return Zn().filter(e=>Bs(e.id)).length}function Bs(e){const t=r.progress?.achievements?.[e];return!!(t&&(t===!0||typeof t=="string"||t.unlockedAt||t.rewardXp!==void 0))}function i(e){return String(e??"").replace(/[&<>"']/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#039;"})[t])}function g(e){return i(e)}})();
