...
`)),a.questions=c.map(m=>m.trim()).filter(Boolean),t[s].push(a),a=null,l=[],c=[],o="idle")},u=m=>{const g=String(m||"").trim().toLowerCase();return g==="жанр"||g==="genre"?"genre":g==="опора"||g==="source"||g==="basis"?"source":g==="цель"||g==="goal"?"goal":g};for(const m of n){const g=String(m??""),w=g.trim(),v=w.match(/^#\s*JLPT\s*(N[1-5])\b/i);if(v){d(),s=v[1].toUpperCase();continue}const $=w.match(/^##\s*(N[1-5])\s*(.+)$/i);if($){d(),s=$[1].toUpperCase(),a={id:`${s.toLowerCase()}-reading-${String((t[s]||[]).length+1).padStart(2,"0")}`,level:s,title:Kp($[2]),genre:"",source:"",goal:"",text:"",questions:[]},o="meta";continue}if(/^#{1,2}(?!#)\s+/.test(w)&&!v&&!$){d(),s=null;continue}if(!a)continue;if(/^###\s*Проверочные вопросы/i.test(w)){o="questions";continue}if(o==="code"){/^```/.test(w)?o="body":l.push(g);continue}if(/^```/.test(w)){o="code";continue}if(o==="questions"){const x=w.match(/^[-*]\s+(.*)$/),b=w.match(/^\d+\.\s+(.*)$/);if(x){c.push(x[1]);continue}if(b){c.push(b[1]);continue}if(!w||/^---+$/.test(w))continue;c.push(w);continue}const y=w.match(/^\*\*(Жанр|Опора|Цель|Genre|Source|Goal)\:\*\*\s*(.*)$/i);if(y){const x=u(y[1]);a[x]=y[2].trim()}}return d(),t}function Op(e){return String(e||"").replace(/^\s*\n+/,"").replace(/\n+\s*$/,"")}function Kp(e){return String(e||"").replace(/^[\s\-–—::]+/u,"").trim()}function Bp(e){const t=e&&typeof e=="object"&&!Array.isArray(e)?e.items&&typeof e.items=="object"&&!Array.isArray(e.items)?e.items:e:{},n={};return Object.entries(t||{}).forEach(([s,a])=>{!s||!a||typeof a!="object"||(n[String(s)]={titleRu:String(a.titleRu||a.ruTitle||a.title_ru||"").trim(),titleEn:String(a.titleEn||a.enTitle||a.title_en||"").trim(),ru:String(a.ru||a.translationRu||a.translation_ru||"").trim(),en:String(a.en||a.translationEn||a.translation_en||"").trim()})}),n}function ul(e){const t=String(e||"").trim();if(!t)return[t];if(/^https?:\/\//i.test(t)||t.startsWith("file:"))return[t];const n=t.replace(/^\.\/+/,"").replace(/^\.\.\/+/,"").replace(/^\/+/,""),s=[t,`./${n}`,`../${n}`,`index/${n}`,`/index/${n}`,`/${n}`];return[...new Set(s.filter(Boolean))]}function Fp(e,t){return{...e,id:String(e.id),lessonId:t,examples:Array.isArray(e.examples)?e.examples:[],apps:Array.isArray(e.apps)?e.apps:[],stroke_order:Array.isArray(e.stroke_order)?e.stroke_order:[]}}function zp(e){const t=e?.items&&typeof e.items=="object"?e.items:{};return Object.fromEntries(Object.entries(t).map(([n,s])=>{const a=Array.isArray(s?.strokeOrder)?s.strokeOrder.filter(o=>typeof o?.path=="string"&&o.path.trim()):[];return a.length?[n,{...s,kanji:s.kanji||n,strokes:Number(s.strokes||a.length),viewBox:s.viewBox||"0 0 109 109",strokeOrder:a}]:null}).filter(Boolean))}function dn(){return{owned:[],selected:{background:"bg_study_hub",outfit:"outfit_default_assassin",theme:"theme_default_dark",decoration:null,frame:null,effect:null},seen:[],updatedAt:new Date().toISOString()}}function Jp(){try{const e=localStorage.getItem(we);if(!e)return dn();const t=JSON.parse(e),n=dn();return{owned:Array.isArray(t.owned)?t.owned.map(String):n.owned,selected:{...n.selected,...t&&t.selected||{}},seen:Array.isArray(t.seen)?t.seen.map(String):n.seen,updatedAt:t.updatedAt||n.updatedAt}}catch(e){return console.warn("Customization storage failed.",e),dn()}}function Rn(){if(!r.customization)return!1;if(dr)return!0;dr=!0;const e=()=>{on=0,dr=!1,r.customization.updatedAt=new Date().toISOString();try{localStorage.setItem(we,JSON.stringify(r.customization))}catch(t){console.warn("Customization save failed.",t)}};return"requestIdleCallback"in window?on=window.requestIdleCallback(e,{timeout:1200}):on=window.setTimeout(e,160),!0}function Up(){if(!r.customization)return!1;dr=!1,on&&("cancelIdleCallback"in window?window.cancelIdleCallback(on):window.clearTimeout(on),on=0),r.customization.updatedAt=new Date().toISOString();try{return localStorage.setItem(we,JSON.stringify(r.customization)),!0}catch(e){return console.warn("Customization save failed.",e),!1}}function hr(){const e=Jp(),t=new Set;(e.owned||[]).forEach(s=>{const a=ne(s)||un(s);a&&t.add(a.id)}),Oe().forEach(s=>{(s.defaultOwned||s.price===0)&&t.add(s.id)}),(r.progress.unlockedBackgrounds||[]).forEach(s=>{const a=ne(s)||un(s);a&&t.add(a.id)}),(r.progress.unlockedEvaSprites||[]).forEach(s=>{const a=pn(s);a&&t.add(a.id),r.progress.shop?.owned?.includes(`eva_sprite:${s}`)&&a&&t.add(a.id)}),(r.progress.shop?.owned||[]).forEach(s=>{const a=String(s),o=ne(a)||un(a);if(o&&t.add(o.id),!o&&a.startsWith("eva_sprite:")){const l=pn(a.replace("eva_sprite:",""));l&&t.add(l.id)}});const n=Gp({...dn().selected,...e.selected||{}});r.progress.selectedEvaRoomBackground&&(n.background=ht(r.progress.selectedEvaRoomBackground)),r.progress.selectedEvaSprite&&(n.outfit=pn(r.progress.selectedEvaSprite)?.id||n.outfit),t.has(n.background)||(n.background="bg_study_hub"),t.has(n.outfit)||(n.outfit="outfit_default_assassin"),t.has(n.theme)||(n.theme="theme_default_dark"),n.decoration&&!t.has(n.decoration)&&(n.decoration=null),n.effect&&!t.has(n.effect)&&(n.effect=null),r.customization={owned:[...t],selected:n,seen:[...new Set([...e.seen||[],...t])],updatedAt:e.updatedAt||new Date().toISOString()},gs(),Rn()}function gs(){if(!r.customization||!r.progress)return;Y();const e=r.customization.selected||{};e.background&&(r.progress.selectedEvaRoomBackground=e.background);const t=ne(e.outfit);t?.spriteId&&(r.progress.selectedEvaSprite=t.spriteId),r.progress.unlockedBackgrounds=[...new Set([...r.progress.unlockedBackgrounds||[],...r.customization.owned.filter(n=>ne(n)?.type==="background")])],r.progress.unlockedEvaSprites=[...new Set([...r.progress.unlockedEvaSprites||[],...r.customization.owned.map(n=>ne(n)).filter(n=>n?.type==="outfit"&&n.spriteId).map(n=>n.spriteId)])],r.progress.shop||={owned:[],equipped:{}},r.progress.shop.owned=[...new Set([...r.progress.shop.owned||[],...r.customization.owned,...r.progress.unlockedEvaSprites.map(n=>`eva_sprite:${n}`)])],r.progress.shop.equipped={...r.progress.shop.equipped||{},background:e.background||null,outfit:e.outfit||null,theme:e.theme||null,decoration:e.decoration||e.frame||null,effect:e.effect||null}}function Oe(){return r.customizationCatalog?.items||[]}function ne(e){return Oe().find(t=>t.id===e)||null}function un(e){const t=String(e||"");return t&&Oe().find(n=>Array.isArray(n.legacyIds)&&n.legacyIds.map(String).includes(t))||null}function ht(e){return(ne(e)||un(e))?.id||e||null}function Gp(e={}){return{background:ht(e.background),outfit:ht(e.outfit),theme:ht(e.theme),decoration:ht(e.decoration||e.frame),effect:ht(e.effect)}}function pn(e){const t=String(e||"");if(!t)return null;const n=`eva_sprite:${t}`;return Oe().find(s=>s.type!=="outfit"?!1:s.spriteId===t||s.legacySpriteId===t?!0:Array.isArray(s.legacyIds)&&s.legacyIds.map(String).includes(n))||null}function qp(e){return(Array.isArray(e?.items)?e.items:Array.isArray(e)?e:[]).map(n=>({...n,jlpt:String(n.jlpt||"").toUpperCase(),title:n.title||{ru:n.jlpt||"JLPT",en:n.jlpt||"JLPT"},summary:n.summary||{ru:"",en:""},goals:Array.isArray(n.goals)?n.goals:[],sections:Array.isArray(n.sections)?n.sections:[],practice:Array.isArray(n.practice)?n.practice:[],checkpoint:Array.isArray(n.checkpoint)?n.checkpoint:[]})).filter(n=>n.jlpt)}function Hp(e){const t=Array.isArray(e?.items)?e.items:Array.isArray(e)?e:[];return{version:Number(e?.version||1),generatedAt:e?.generatedAt||null,items:t.map(n=>({...n,jlpt:String(n.jlpt||"").toUpperCase(),slug:String(n.slug||String(n.jlpt||"").toLowerCase()),title:n.title||{ru:n.displayTitle?.ru||n.jlpt||"JLPT",en:n.displayTitle?.en||n.jlpt||"JLPT"},displayTitle:n.displayTitle||n.title||{ru:n.jlpt||"JLPT",en:n.jlpt||"JLPT"},description:n.description||{ru:"",en:""},goal:n.goal||{ru:"",en:""},recommendedCycle:n.recommendedCycle||{ru:"",en:""},previousLevels:Array.isArray(n.previousLevels)?n.previousLevels:[],nextLevels:Array.isArray(n.nextLevels)?n.nextLevels:[],lessonIds:Array.isArray(n.lessonIds)?n.lessonIds:[],files:n.files||{},lessonCount:Number(n.lessonCount||0),kanjiCount:Number(n.kanjiCount||0),cardCount:Number(n.cardCount||0)})).filter(n=>n.jlpt).sort((n,s)=>be.indexOf(n.jlpt)-be.indexOf(s.jlpt))}}function Xp(e){return(Array.isArray(e?.items)?e.items:Array.isArray(e)?e:[]).map(n=>({...n,jlpt:String(n.jlpt||"").toUpperCase(),apps:Array.isArray(n.apps)?n.apps:[],kana:n.kana||{hiragana:[],katakana:[]},kanjiFocus:Array.isArray(n.kanjiFocus)?n.kanjiFocus:[],drills:Array.isArray(n.drills)?n.drills:[],sources:Array.isArray(n.sources)?n.sources:[]})).filter(n=>n.jlpt)}function Qp(e){return{version:Number(e?.version||1),level:"N5",title:e?.title||{ru:"JLPT N5",en:"JLPT N5"},description:e?.description||{ru:"",en:""},principle:e?.principle||{ru:"",en:""},kanjiCount:Number(e?.kanjiCount||80),lessonCount:Number(e?.lessonCount||10),kanjiPerLesson:Number(e?.kanjiPerLesson||8),pdfUrl:e?.pdfUrl||"docs/flashkanji_N5_expanded_textbook.pdf",reviewPlan:Array.isArray(e?.reviewPlan)?e.reviewPlan:[],rewards:{addToSrsXp:4,knowXp:6,hardXp:2,exerciseXp:7,exerciseMoon:1,lessonCompleteXp:45,lessonCompleteMoon:6,finalTestXp:120,finalTestMoon:20,...e?.rewards||{}}}}function pl(e){const t=Array.isArray(e?.items)?e.items:[];return{version:Number(e?.version||1),level:"N5",textbook:e?.textbook||{},items:t.map((n,s)=>({...n,id:String(n.id||`n5-lesson-${s+1}`),order:Number(n.order||s+1),title:n.title||{ru:`Урок ${s+1}`,en:`Lesson ${s+1}`},theme:n.theme||n.title||{ru:"",en:""},kanji:Array.isArray(n.kanji)?n.kanji.map(String).filter(Boolean):[],goal:n.goal||{ru:"",en:""},sentences:Array.isArray(n.sentences)?n.sentences:[],writing:Array.isArray(n.writing)?n.writing.map(String).filter(Boolean):[],reviewAfterDays:Array.isArray(n.reviewAfterDays)?n.reviewAfterDays.map(Number).filter(Boolean):[1,3,7,14,30]})).filter(n=>n.kanji.length)}}function Wp(e){return(Array.isArray(e?.items)?e.items:Array.isArray(e)?e:[]).map(n=>({...n,id:String(n.id||n.courseCardId||n.kanji||""),courseCardId:String(n.courseCardId||n.id||n.kanji||""),lessonId:n.lessonId||n.lesson_id||null,kanji:String(n.kanji||""),meaning:n.meaning||{ru:n.meaning_ru||"",en:n.meaning_en||n.meaning_ru||""},readings:n.readings||{},examples:Array.isArray(n.examples)?n.examples:[],jlpt:"N5"})).filter(n=>n.kanji)}function Vp(){if(!Array.isArray(r.n5KanjiCatalog)||!r.n5KanjiCatalog.length)return;const e=new Map(r.n5KanjiCatalog.map(n=>[n.kanji,n])),t=new Set;r.cards=r.cards.map(n=>{const s=e.get(n.kanji);if(!s)return n;const a=String(n.jlpt||s.jlpt||"").toUpperCase();return a&&a!=="N5"?n:(t.add(s.kanji),vr(n,s))}),r.n5KanjiCatalog.forEach(n=>{t.has(n.kanji)||(r.cards.push(vr({id:n.courseCardId||n.id,kanji:n.kanji,lessonId:n.lessonId||null,jlpt:"N5",examples:[],source:"n5-catalog"},n)),t.add(n.kanji))})}function vr(e,t){const n=t.readings||{},s=c=>Array.isArray(c)?c.filter(Boolean).join(" / "):String(c||""),a=(t.examples||[]).map(c=>({...c,reading:q(c.reading||c.hiragana||c.kana||""),translation:c.translation_ru||c.translation||""})),o=a[0]||{},l=Array.isArray(t.strokeOrder)?t.strokeOrder.map(c=>c.description_ru||c.description_en||"").filter(Boolean):e.stroke_order;return{...e,jlpt:"N5",lessonId:e.lessonId||t.lessonId||null,meaning_ru:t.meaning?.ru||e.meaning_ru||"",meaning_en:t.meaning?.en||e.meaning_en||t.meaning?.ru||e.meaning_ru||"",onyomi:q(s(n.onyomi)||e.onyomi||""),kunyomi:q(s(n.kunyomi)||e.kunyomi||""),hiragana:q((Array.isArray(n.hiragana)?n.hiragana[0]:n.hiragana)||o.reading||e.hiragana||""),romaji:(Array.isArray(n.romaji)?n.romaji[0]:n.romaji)||o.romaji||e.romaji||"",examples:a.length?a:e.examples,apps:Array.isArray(t.apps)&&t.apps.length?t.apps:e.apps,interface_use:t.interfaceUse||e.interface_use||"",interface_use_en:t.interfaceUseEn||t.interfaceUse||e.interface_use_en||e.interface_use||"",strokes:Number(t.strokes||e.strokes||0),stroke_order:l,meta:{...e.meta||{},...t.meta||{}},n5Detail:t}}function Yp(e){return{version:Number(e?.version||1),level:"N5",types:Array.isArray(e?.types)?e.types:[],lessonQuestionCount:Number(e?.lessonQuestionCount||6),reviewModes:Array.isArray(e?.reviewModes)?e.reviewModes:[]}}function Zp(e){return{version:Number(e?.version||1),level:"N5",title:e?.title||{ru:"Финальный тест JLPT N5",en:"JLPT N5 Final Test"},description:e?.description||{ru:"",en:""},questionCount:Number(e?.questionCount||24),passingPercent:Number(e?.passingPercent||80),types:Array.isArray(e?.types)&&e.types.length?e.types:["meaning","reading","sentence","kanji","word","srs"],rewards:{completeXp:120,completeMoon:20,passXp:80,passMoon:12,...e?.rewards||{}}}}function eg(e){return{version:Number(e?.version||1),level:"N4",title:e?.title||{ru:"JLPT N4",en:"JLPT N4"},description:e?.description||{ru:"",en:""},principle:e?.principle||{ru:"",en:""},kanjiCount:Number(e?.kanjiCount||170),lessonCount:Number(e?.lessonCount||17),kanjiPerLesson:Number(e?.kanjiPerLesson||10),grammarCount:Number(e?.grammarCount||48),readingCount:Number(e?.readingCount||0),listeningCount:Number(e?.listeningCount||0),pdfUrl:e?.pdfUrl||"docs/flashkanji_N4_textbook_flashkanji_space.pdf",reviewPlan:Array.isArray(e?.reviewPlan)?e.reviewPlan:[],n5Bridge:Array.isArray(e?.n5Bridge)?e.n5Bridge.map(String).filter(Boolean):[],rewards:{addToSrsXp:5,knowXp:7,hardXp:2,exerciseXp:9,exerciseMoon:1,grammarXp:10,grammarMoon:1,lessonCompleteXp:65,lessonCompleteMoon:8,readingXp:35,readingMoon:4,listeningXp:30,listeningMoon:3,finalTestXp:180,finalTestMoon:35,...e?.rewards||{}}}}function tg(e){const t=Array.isArray(e?.items)?e.items:[];return{version:Number(e?.version||1),level:"N4",textbook:e?.textbook||{},items:t.map((n,s)=>({...n,id:String(n.id||`n4-lesson-${s+1}`),order:Number(n.order||s+1),title:n.title||{ru:`Урок ${s+1}`,en:`Lesson ${s+1}`},theme:n.theme||n.title||{ru:"",en:""},kanji:Array.isArray(n.kanji)?n.kanji.map(String).filter(Boolean):[],goal:n.goal||{ru:"",en:""},durationMinutes:Number(n.durationMinutes||30),grammarFocus:Array.isArray(n.grammarFocus)?n.grammarFocus.map(String).filter(Boolean):[],sentences:Array.isArray(n.sentences)?n.sentences:[],writing:Array.isArray(n.writing)?n.writing.map(String).filter(Boolean):[],reviewAfterDays:Array.isArray(n.reviewAfterDays)?n.reviewAfterDays.map(Number).filter(Boolean):[1,3,7,14,30,45]})).filter(n=>n.kanji.length)}}function ng(e){return(Array.isArray(e?.items)?e.items:Array.isArray(e)?e:[]).map(n=>({...n,id:String(n.id||n.courseCardId||n.kanji||""),courseCardId:String(n.courseCardId||n.id||n.kanji||""),kanji:String(n.kanji||""),meaning:n.meaning||{ru:n.meaning_ru||"",en:n.meaning_en||n.meaning_ru||""},readings:n.readings||{},examples:Array.isArray(n.examples)?n.examples:Array.isArray(n.words)?n.words:[],jlpt:"N4",lessonId:n.lessonId||n.lesson_id||null})).filter(n=>n.kanji)}function sg(){if(!Array.isArray(r.n4KanjiCatalog)||!r.n4KanjiCatalog.length)return;const e=new Map(r.n4KanjiCatalog.map(n=>[n.kanji,n])),t=new Set;r.cards=r.cards.map(n=>{const s=e.get(n.kanji);return!s||!(String(n.jlpt||s.jlpt||"").toUpperCase()==="N4"||String(n.id)===s.courseCardId||String(n.id)===s.id)?n:(t.add(s.kanji),wr(n,s))}),r.n4KanjiCatalog.forEach(n=>{t.has(n.kanji)||(r.cards.push(wr({id:n.courseCardId||n.id,kanji:n.kanji,lessonId:n.lessonId,jlpt:"N4",examples:[],source:"n4-catalog"},n)),t.add(n.kanji))})}function wr(e,t){const n=t.readings||{},s=c=>Array.isArray(c)?c.filter(Boolean).join(" / "):String(c||""),a=(t.examples||[]).map(c=>({...c,reading:q(c.reading||c.hiragana||c.kana||""),translation:c.translation_ru||c.translation||c.translation_en||""})),o=a[0]||{},l=Array.isArray(t.strokeOrder)?t.strokeOrder.map(c=>typeof c=="string"?c:c.description_ru||c.description_en||"").filter(Boolean):e.stroke_order;return{...e,id:String(e.id||t.courseCardId||t.id),jlpt:"N4",lessonId:e.lessonId||t.lessonId||null,meaning_ru:t.meaning?.ru||e.meaning_ru||"",meaning_en:t.meaning?.en||e.meaning_en||t.meaning?.ru||e.meaning_ru||"",onyomi:q(s(n.onyomi)||e.onyomi||""),kunyomi:q(s(n.kunyomi)||e.kunyomi||""),hiragana:q((Array.isArray(n.hiragana)?n.hiragana[0]:n.hiragana)||o.reading||e.hiragana||""),romaji:(Array.isArray(n.romaji)?n.romaji[0]:n.romaji)||o.romaji||e.romaji||"",examples:a.length?a:e.examples,apps:Array.isArray(t.apps)&&t.apps.length?t.apps:e.apps,interface_use:t.interfaceUse||e.interface_use||"",interface_use_en:t.interfaceUseEn||t.interfaceUse||e.interface_use_en||e.interface_use||"",strokes:Number(t.strokes||e.strokes||0),stroke_order:l,meta:{...e.meta||{},...t.meta||{}},n4Detail:t}}function rg(e){return(Array.isArray(e?.items)?e.items:Array.isArray(e)?e:[]).map((n,s)=>({...n,id:String(n.id||`n4-grammar-${String(s+1).padStart(2,"0")}`),level:"N4",order:Number(n.order||s+1),pattern:String(n.pattern||n.id||""),title:n.title||{ru:n.pattern||"",en:n.pattern||""},explanation:n.explanation||{ru:"",en:""},formula:String(n.formula||""),examples:Array.isArray(n.examples)?n.examples:[],question:n.question||{ru:"",en:""},answer:String(n.answer||""),options:Array.isArray(n.options)?n.options.map(String).filter(Boolean):[]})).filter(n=>n.pattern)}function ag(e){return{version:Number(e?.version||1),level:"N4",lessonQuestionCount:Number(e?.lessonQuestionCount||8),types:Array.isArray(e?.types)?e.types:[],reviewModes:Array.isArray(e?.reviewModes)?e.reviewModes:[]}}function gl(e){return(Array.isArray(e?.items)?e.items:Array.isArray(e)?e:[]).map((n,s)=>({...n,id:String(n.id||`n4-item-${s+1}`),title:n.title||{ru:n.id||"",en:n.id||""},questions:Array.isArray(n.questions)?n.questions:n.question?[{prompt:n.question,answer:n.answer,options:Array.isArray(n.options)?n.options:[]}]:[]})).filter(n=>n.id)}function ig(e){return{version:Number(e?.version||1),level:"N4",title:e?.title||{ru:"Финальный тест JLPT N4",en:"JLPT N4 Final Test"},description:e?.description||{ru:"",en:""},questionCount:Number(e?.questionCount||32),passingPercent:Number(e?.passingPercent||80),kanjiPool:Array.isArray(e?.kanjiPool)?e.kanjiPool.map(String).filter(Boolean):[],grammarPool:Array.isArray(e?.grammarPool)?e.grammarPool.map(String).filter(Boolean):[],readingPool:Array.isArray(e?.readingPool)?e.readingPool.map(String).filter(Boolean):[],types:Array.isArray(e?.types)&&e.types.length?e.types:["meaning","reading","sentence","kanji","word","grammar","mini-reading","srs"],rewards:{completeXp:Number(e?.rewards?.xp||e?.rewards?.completeXp||180),completeMoon:Number(e?.rewards?.moon||e?.rewards?.completeMoon||35),passXp:Number(e?.rewards?.passXp||90),passMoon:Number(e?.rewards?.passMoon||15)}}}function og(e){return{version:Number(e?.version||1),level:"N3",title:e?.title||{ru:"JLPT N3",en:"JLPT N3"},description:e?.description||{ru:"",en:""},principle:e?.principle||{ru:"",en:""},kanjiCount:Number(e?.kanjiCount||370),lessonCount:Number(e?.lessonCount||37),kanjiPerLesson:Number(e?.kanjiPerLesson||10),grammarCount:Number(e?.grammarCount||80),readingCount:Number(e?.readingCount||0),listeningCount:Number(e?.listeningCount||0),pdfUrl:e?.pdfUrl||"docs/flashkanji_N3_textbook_flashkanji_space.pdf",reviewPlan:Array.isArray(e?.reviewPlan)?e.reviewPlan:[],n5Bridge:Array.isArray(e?.n5Bridge)?e.n5Bridge.map(String).filter(Boolean):[],rewards:{addToSrsXp:6,knowXp:8,hardXp:2,exerciseXp:10,exerciseMoon:1,grammarXp:11,grammarMoon:1,lessonCompleteXp:75,lessonCompleteMoon:9,readingXp:38,readingMoon:4,listeningXp:34,listeningMoon:4,finalTestXp:220,finalTestMoon:40,...e?.rewards||{}}}}function lg(e){const t=Array.isArray(e?.items)?e.items:[];return{version:Number(e?.version||1),level:"N3",textbook:e?.textbook||{},items:t.map((n,s)=>({...n,id:String(n.id||`n3-lesson-${s+1}`),order:Number(n.order||s+1),title:n.title||{ru:`Урок ${s+1}`,en:`Lesson ${s+1}`},theme:n.theme||n.title||{ru:"",en:""},kanji:Array.isArray(n.kanji)?n.kanji.map(String).filter(Boolean):[],goal:n.goal||{ru:"",en:""},durationMinutes:Number(n.durationMinutes||30),grammarFocus:Array.isArray(n.grammarFocus)?n.grammarFocus.map(String).filter(Boolean):[],sentences:Array.isArray(n.sentences)?n.sentences:[],writing:Array.isArray(n.writing)?n.writing.map(String).filter(Boolean):[],reviewAfterDays:Array.isArray(n.reviewAfterDays)?n.reviewAfterDays.map(Number).filter(Boolean):[1,3,7,14,30,45,60]})).filter(n=>n.kanji.length)}}function cg(e){return(Array.isArray(e?.items)?e.items:Array.isArray(e)?e:[]).map(n=>({...n,id:String(n.id||n.courseCardId||n.kanji||""),courseCardId:String(n.courseCardId||n.id||n.kanji||""),kanji:String(n.kanji||""),meaning:n.meaning||{ru:n.meaning_ru||"",en:n.meaning_en||n.meaning_ru||""},readings:n.readings||{},examples:Array.isArray(n.examples)?n.examples:Array.isArray(n.words)?n.words:[],jlpt:"N3",lessonId:n.lessonId||n.lesson_id||null})).filter(n=>n.kanji)}function dg(){if(!Array.isArray(r.n3KanjiCatalog)||!r.n3KanjiCatalog.length)return;const e=new Map(r.n3KanjiCatalog.map(n=>[n.kanji,n])),t=new Set;r.cards=r.cards.map(n=>{const s=e.get(n.kanji);return!s||!(String(n.jlpt||s.jlpt||"").toUpperCase()==="N3"||String(n.id)===s.courseCardId||String(n.id)===s.id)?n:(t.add(s.kanji),br(n,s))}),r.n3KanjiCatalog.forEach(n=>{t.has(n.kanji)||(r.cards.push(br({id:n.courseCardId||n.id,kanji:n.kanji,lessonId:n.lessonId,jlpt:"N3",examples:[],source:"n3-catalog"},n)),t.add(n.kanji))})}function br(e,t){const n=t.readings||{},s=c=>Array.isArray(c)?c.filter(Boolean).join(" / "):String(c||""),a=(t.examples||[]).map(c=>({...c,reading:q(c.reading||c.hiragana||c.kana||""),translation:c.translation_ru||c.translation||c.translation_en||""})),o=a[0]||{},l=Array.isArray(t.strokeOrder)?t.strokeOrder.map(c=>typeof c=="string"?c:c.description_ru||c.description_en||"").filter(Boolean):e.stroke_order;return{...e,id:String(e.id||t.courseCardId||t.id),jlpt:"N3",lessonId:e.lessonId||t.lessonId||null,meaning_ru:t.meaning?.ru||e.meaning_ru||"",meaning_en:t.meaning?.en||e.meaning_en||t.meaning?.ru||e.meaning_ru||"",onyomi:q(s(n.onyomi)||e.onyomi||""),kunyomi:q(s(n.kunyomi)||e.kunyomi||""),hiragana:q((Array.isArray(n.hiragana)?n.hiragana[0]:n.hiragana)||o.reading||e.hiragana||""),romaji:(Array.isArray(n.romaji)?n.romaji[0]:n.romaji)||o.romaji||e.romaji||"",examples:a.length?a:e.examples,apps:Array.isArray(t.apps)&&t.apps.length?t.apps:e.apps,interface_use:t.interfaceUse||e.interface_use||"",interface_use_en:t.interfaceUseEn||t.interfaceUse||e.interface_use_en||e.interface_use||"",strokes:Number(t.strokes||e.strokes||0),stroke_order:l,meta:{...e.meta||{},...t.meta||{}},n3Detail:t}}function ug(e){return(Array.isArray(e?.items)?e.items:Array.isArray(e)?e:[]).map((n,s)=>({...n,id:String(n.id||`n3-grammar-${String(s+1).padStart(2,"0")}`),level:"N3",order:Number(n.order||s+1),pattern:String(n.pattern||n.id||""),title:n.title||{ru:n.pattern||"",en:n.pattern||""},explanation:n.explanation||{ru:"",en:""},formula:String(n.formula||""),examples:Array.isArray(n.examples)?n.examples:[],question:n.question||{ru:"",en:""},answer:String(n.answer||""),options:Array.isArray(n.options)?n.options.map(String).filter(Boolean):[]})).filter(n=>n.pattern)}function pg(e){return{version:Number(e?.version||1),level:"N3",lessonQuestionCount:Number(e?.lessonQuestionCount||8),types:Array.isArray(e?.types)?e.types:[],reviewModes:Array.isArray(e?.reviewModes)?e.reviewModes:[]}}function ml(e){return(Array.isArray(e?.items)?e.items:Array.isArray(e)?e:[]).map((n,s)=>({...n,id:String(n.id||`n3-item-${s+1}`),title:n.title||{ru:n.id||"",en:n.id||""},questions:Array.isArray(n.questions)?n.questions:n.question?[{prompt:n.question,answer:n.answer,options:Array.isArray(n.options)?n.options:[]}]:[]})).filter(n=>n.id)}function gg(e){return{version:Number(e?.version||1),level:"N3",title:e?.title||{ru:"Финальный тест JLPT N3",en:"JLPT N3 Final Test"},description:e?.description||{ru:"",en:""},questionCount:Number(e?.questionCount||40),passingPercent:Number(e?.passingPercent||80),kanjiPool:Array.isArray(e?.kanjiPool)?e.kanjiPool.map(String).filter(Boolean):[],grammarPool:Array.isArray(e?.grammarPool)?e.grammarPool.map(String).filter(Boolean):[],readingPool:Array.isArray(e?.readingPool)?e.readingPool.map(String).filter(Boolean):[],types:Array.isArray(e?.types)&&e.types.length?e.types:["meaning","reading","sentence","kanji","word","grammar","mini-reading","srs"],rewards:{completeXp:Number(e?.rewards?.xp||e?.rewards?.completeXp||220),completeMoon:Number(e?.rewards?.moon||e?.rewards?.completeMoon||40),passXp:Number(e?.rewards?.passXp||110),passMoon:Number(e?.rewards?.passMoon||18)}}}function mg(e){return{version:Number(e?.version||1),level:"N2",title:e?.title||{ru:"JLPT N2",en:"JLPT N2"},description:e?.description||{ru:"",en:""},principle:e?.principle||{ru:"",en:""},kanjiCount:Number(e?.kanjiCount||380),lessonCount:Number(e?.lessonCount||38),kanjiPerLesson:Number(e?.kanjiPerLesson||10),grammarCount:Number(e?.grammarCount||120),readingCount:Number(e?.readingCount||46),listeningCount:Number(e?.listeningCount||6),pdfUrl:e?.pdfUrl||"docs/flashkanji_N2_textbook_flashkanji_space.pdf",reviewPlan:Array.isArray(e?.reviewPlan)?e.reviewPlan:[],n5Bridge:Array.isArray(e?.n5Bridge)?e.n5Bridge.map(String).filter(Boolean):[],rewards:{addToSrsXp:7,knowXp:9,hardXp:2,exerciseXp:11,exerciseMoon:1,grammarXp:12,grammarMoon:1,lessonCompleteXp:85,lessonCompleteMoon:10,readingXp:42,readingMoon:4,listeningXp:38,listeningMoon:4,finalTestXp:260,finalTestMoon:48,...e?.rewards||{}}}}function fg(e){const t=Array.isArray(e?.items)?e.items:[];return{version:Number(e?.version||1),level:"N2",textbook:e?.textbook||{},items:t.map((n,s)=>({...n,id:String(n.id||`n2-lesson-${s+1}`),order:Number(n.order||s+1),title:n.title||{ru:`Урок ${s+1}`,en:`Lesson ${s+1}`},theme:n.theme||n.title||{ru:"",en:""},kanji:Array.isArray(n.kanji)?n.kanji.map(String).filter(Boolean):[],goal:n.goal||{ru:"",en:""},durationMinutes:Number(n.durationMinutes||30),grammarFocus:Array.isArray(n.grammarFocus)?n.grammarFocus.map(String).filter(Boolean):[],sentences:Array.isArray(n.sentences)?n.sentences:[],writing:Array.isArray(n.writing)?n.writing.map(String).filter(Boolean):[],reviewAfterDays:Array.isArray(n.reviewAfterDays)?n.reviewAfterDays.map(Number).filter(Boolean):[1,3,7,14,30,60,90]})).filter(n=>n.kanji.length)}}function hg(e){return(Array.isArray(e?.items)?e.items:Array.isArray(e)?e:[]).map(n=>({...n,id:String(n.id||n.courseCardId||n.kanji||""),courseCardId:String(n.courseCardId||n.id||n.kanji||""),kanji:String(n.kanji||""),meaning:n.meaning||{ru:n.meaning_ru||"",en:n.meaning_en||n.meaning_ru||""},readings:n.readings||{},examples:Array.isArray(n.examples)?n.examples:Array.isArray(n.words)?n.words:[],jlpt:"N2",lessonId:n.lessonId||n.lesson_id||null})).filter(n=>n.kanji)}function vg(){if(!Array.isArray(r.n2KanjiCatalog)||!r.n2KanjiCatalog.length)return;const e=new Map(r.n2KanjiCatalog.map(n=>[n.kanji,n])),t=new Set;r.cards=r.cards.map(n=>{const s=e.get(n.kanji);return!s||!(String(n.jlpt||s.jlpt||"").toUpperCase()==="N2"||String(n.id)===s.courseCardId||String(n.id)===s.id)?n:(t.add(s.kanji),kr(n,s))}),r.n2KanjiCatalog.forEach(n=>{t.has(n.kanji)||(r.cards.push(kr({id:n.courseCardId||n.id,kanji:n.kanji,lessonId:n.lessonId,jlpt:"N2",examples:[],source:"n2-catalog"},n)),t.add(n.kanji))})}function kr(e,t){const n=t.readings||{},s=c=>Array.isArray(c)?c.filter(Boolean).join(" / "):String(c||""),a=(t.examples||[]).map(c=>({...c,reading:q(c.reading||c.hiragana||c.kana||""),translation:c.translation_ru||c.translation||c.translation_en||""})),o=a[0]||{},l=Array.isArray(t.strokeOrder)?t.strokeOrder.map(c=>typeof c=="string"?c:c.description_ru||c.description_en||"").filter(Boolean):e.stroke_order;return{...e,id:String(e.id||t.courseCardId||t.id),jlpt:"N2",lessonId:e.lessonId||t.lessonId||null,meaning_ru:t.meaning?.ru||e.meaning_ru||"",meaning_en:t.meaning?.en||e.meaning_en||t.meaning?.ru||e.meaning_ru||"",onyomi:q(s(n.onyomi)||e.onyomi||""),kunyomi:q(s(n.kunyomi)||e.kunyomi||""),hiragana:q((Array.isArray(n.hiragana)?n.hiragana[0]:n.hiragana)||o.reading||e.hiragana||""),romaji:(Array.isArray(n.romaji)?n.romaji[0]:n.romaji)||o.romaji||e.romaji||"",examples:a.length?a:e.examples,apps:Array.isArray(t.apps)&&t.apps.length?t.apps:e.apps,interface_use:t.interfaceUse||e.interface_use||"",interface_use_en:t.interfaceUseEn||t.interfaceUse||e.interface_use_en||e.interface_use||"",strokes:Number(t.strokes||e.strokes||0),stroke_order:l,meta:{...e.meta||{},...t.meta||{}},n2Detail:t}}function wg(e){return(Array.isArray(e?.items)?e.items:Array.isArray(e)?e:[]).map((n,s)=>({...n,id:String(n.id||`n2-grammar-${String(s+1).padStart(2,"0")}`),level:"N2",order:Number(n.order||s+1),pattern:String(n.pattern||n.id||""),title:n.title||{ru:n.pattern||"",en:n.pattern||""},explanation:n.explanation||{ru:"",en:""},formula:String(n.formula||""),examples:Array.isArray(n.examples)?n.examples:[],question:n.question||{ru:"",en:""},answer:String(n.answer||""),options:Array.isArray(n.options)?n.options.map(String).filter(Boolean):[]})).filter(n=>n.pattern)}function bg(e){return{version:Number(e?.version||1),level:"N2",lessonQuestionCount:Number(e?.lessonQuestionCount||8),types:Array.isArray(e?.types)?e.types:[],reviewModes:Array.isArray(e?.reviewModes)?e.reviewModes:[]}}function fl(e){return(Array.isArray(e?.items)?e.items:Array.isArray(e)?e:[]).map((n,s)=>({...n,id:String(n.id||`n2-item-${s+1}`),title:n.title||{ru:n.id||"",en:n.id||""},questions:Array.isArray(n.questions)?n.questions:n.question?[{prompt:n.question,answer:n.answer,options:Array.isArray(n.options)?n.options:[]}]:[]})).filter(n=>n.id)}function kg(e){return{version:Number(e?.version||1),level:"N2",title:e?.title||{ru:"Финальный тест JLPT N2",en:"JLPT N2 Final Test"},description:e?.description||{ru:"",en:""},questionCount:Number(e?.questionCount||40),passingPercent:Number(e?.passingPercent||80),kanjiPool:Array.isArray(e?.kanjiPool)?e.kanjiPool.map(String).filter(Boolean):[],grammarPool:Array.isArray(e?.grammarPool)?e.grammarPool.map(String).filter(Boolean):[],readingPool:Array.isArray(e?.readingPool)?e.readingPool.map(String).filter(Boolean):[],types:Array.isArray(e?.types)&&e.types.length?e.types:["meaning","reading","sentence","kanji","word","grammar","mini-reading","srs"],rewards:{completeXp:Number(e?.rewards?.xp||e?.rewards?.completeXp||260),completeMoon:Number(e?.rewards?.moon||e?.rewards?.completeMoon||48),passXp:Number(e?.rewards?.passXp||130),passMoon:Number(e?.rewards?.passMoon||20)}}}function yg(e){return{version:Number(e?.version||1),level:"N1",title:e?.title||{ru:"JLPT N1",en:"JLPT N1"},description:e?.description||{ru:"",en:""},principle:e?.principle||{ru:"",en:""},lessonCount:Number(e?.lessonCount||0),kanjiCount:Number(e?.kanjiCount||0),readingCount:Number(e?.readingCount||0),pdfUrl:e?.pdfUrl||"docs/flashkanji_N1_textbook_flashkanji_space.pdf",rewards:{addToSrsXp:Number(e?.rewards?.addToSrsXp||8),knowXp:Number(e?.rewards?.knowXp||11),hardXp:Number(e?.rewards?.hardXp||2),exerciseXp:Number(e?.rewards?.exerciseXp||13),exerciseMoon:Number(e?.rewards?.exerciseMoon||1),readingXp:Number(e?.rewards?.readingXp||55),readingMoon:Number(e?.rewards?.readingMoon||5),finalTestXp:Number(e?.rewards?.finalTestXp||320),finalTestMoon:Number(e?.rewards?.finalTestMoon||60)}}}function hl(e){return Array.isArray(e)?e.map(t=>({value:String(t?.value||t?.id||""),label:t?.label||t?.title||t?.text||{ru:String(t?.labelRu||t?.ru||t?.value||""),en:String(t?.labelEn||t?.en||t?.value||"")}})).filter(t=>t.value):[]}function $g(e,t,n){return{id:String(e?.id||`${t.id}-q${n+1}`),prompt:e?.prompt||{ru:"",en:""},answer:String(e?.answer||""),options:hl(e?.options)}}function jg(e,t=""){const n=Array.isArray(e?.items)?e.items:Array.isArray(e)?e:[],s=String(t||e?.level||"").toUpperCase();return n.map((a,o)=>{const l=String(a.id||`${s.toLowerCase()||"reading"}-${o+1}`);return{...a,level:String(a.level||s||"").toUpperCase(),id:l,title:a.title||{ru:a.id||"",en:a.id||""},jp:String(a.jp||""),reading:String(a.reading||""),ru:String(a.ru||""),en:String(a.en||""),source:String(a.source||""),questions:Array.isArray(a.questions)?a.questions.map((c,d)=>$g(c,{id:l},d)):[]}}).filter(a=>a.id)}function Sg(e){return Array.isArray(e)?e.map(t=>({answer:Array.isArray(t?.answer)?t.answer.map(String).filter(Boolean):[],reading:Array.isArray(t?.reading)?t.reading.map(n=>q(n)):[]})):[]}function Ng(e,t){const n=Array.isArray(t)?t.flatMap(s=>Array.isArray(s?.answer)?s.answer.map((a,o)=>({kanji:String(a||""),reading:String(s?.reading?.[o]||"")})):[]):[];return[...Array.isArray(e)?e:[],...n].map(s=>({kanji:String(s?.kanji||""),reading:String(s?.reading||"")})).filter(s=>s.kanji).filter((s,a,o)=>o.findIndex(l=>l.kanji===s.kanji&&l.reading===s.reading)===a)}function xg(e){const t=Array.isArray(e?.items)?e.items:Array.isArray(e)?e:[],n=t.find(a=>String(a?.kind||"").toLowerCase()==="sentences")||t[0]||null;return(Array.isArray(n?.items)?n.items:[]).map((a,o)=>({id:String(a.id||`${String(n?.id||"reading-n5-sentence")}-${o+1}`),level:String(a.jlpt||n?.level||"N5").toUpperCase(),kind:"cloze",sourceKind:"sentences",sourceId:String(n?.id||"reading-n5-sentences"),sourceTitle:n?.title||{ru:"Предложения",en:"Sentences"},title:{ru:"Предложение",en:"Sentence"},sentence:String(a.sentence||""),reading:q(a.reading||""),translationRu:String(a.translationRu||a.translation_ru||a.ru||""),translationEn:String(a.translationEn||a.translation_en||a.en||""),blanks:Sg(a.blanks),tiles:Ng(a.tiles,a.blanks),source:"reading"})).filter(a=>a.id)}function vl(e,t=[]){const n=Array.isArray(e?.achievements)&&e.achievements.length?e.achievements:t,s=Array.isArray(e?.categories)?e.categories.map(l=>({id:String(l.id),title:l.title||{ru:l.id,en:l.id},icon:l.icon||"moon"})):[],a=n.map(l=>Xa(l)),o=new Set(s.map(l=>l.id));return a.forEach(l=>{o.has(l.category)||(o.add(l.category),s.push({id:l.category,title:{ru:l.category,en:l.category},icon:l.icon||"moon"}))}),{categories:s,items:a}}function Xa(e){const t=Number(e.rewardXp??e.xp??0),n=Number(e.rewardFragments??e.coins??0);return{...e,id:String(e.id),category:e.category||e.kind||"learning",title:e.title||e.name||{ru:e.id,en:e.id},description:e.description||{ru:"",en:""},icon:e.icon||"moon",kind:e.kind||"learned",target:Number(e.target||1),rewardXp:t,rewardFragments:n,unlocked:!!e.unlocked,secret:!!e.secret}}function wl(){return[navigator.language,...navigator.languages||[]].filter(Boolean).map(t=>String(t).toLowerCase()).some(t=>t==="ru"||t.startsWith("ru-")||t==="be"||t.startsWith("be-"))?"ru":"en"}function ms(){const e=wl();return{version:3,createdAt:new Date().toISOString(),updatedAt:new Date().toISOString(),settings:{theme:"dark",themeManuallySelected:!1,sound:!0,uxSound:!0,uxVolume:.75,language:e,languageAutoDetected:!0,languageManuallySelected:!1,dailyGoal:10},xp:0,level:1,moonFragments:0,totalCorrect:0,totalWrong:0,correctCombo:0,bestCorrectCombo:0,appOpens:0,totalMoonFragmentsEarned:0,cards:{},seenCards:{},seenKanji:{},daily:{},favorites:{},transactions:[],streakHistory:[],streak:{current:0,best:0,lastStudyDate:null,pendingReward:null},visits:{firstVisitDate:null,lastVisitDate:null,lastDailyBonusDate:null,streak:0,bestStreak:0},lessonCompletions:{},achievements:{},dailyBonuses:{},dailyBonusPending:null,lastOpenedJlptLesson:null,lastOpenedJlptLessons:{},viewedReadingLevels:{},writingPractice:{completed:0,cards:{}},secrets:{evaClicks:0,nightVisit:!1},learningPath:Wa(),jlptLessonStudy:Va(),sentencePractice:{activeId:null,selected:[],checked:!1,result:null,tileKeys:[],completed:{},attempts:0,recentIds:[],recentAnswers:[],custom:[],customSentences:[],customEditingId:null,customDraft:{jp:"",hiragana:"",ru:"",en:""},customMessage:"",customStatus:""},jlptLessonPractice:{activeIds:{},selected:{},checked:{},results:{},completed:{}},readingExercises:{},n5Course:Za(),n4Course:ei(),n3Course:ti(),n2Course:ni(),unlockedJlptLevels:be.slice(),unlockedBackgrounds:["bg_study_hub"],selectedEvaRoomBackground:"bg_study_hub",unlockedEvaSprites:["idle","default"],selectedEvaSprite:"idle",evaRoomDialogueProgress:{currentNode:"intro",rewardsClaimed:{},visited:{},lineHistory:[]},evaRoomQuiz:{answered:0,correct:0,wrong:0,streak:0,rewarded:{},history:[]},evaAutonomy:Rl(),evaRelationship:si(),shop:{owned:[],equipped:{}}}}function Cg(){const e=ms();try{const t=localStorage.getItem(xn)||localStorage.getItem(os);if(!t)return e;const n=JSON.parse(t);return bl(e,n.progress||n)}catch(t){return console.warn("Progress reset because stored JSON is invalid.",t),e}}function bl(e,t){return{...e,...t,version:3,settings:Lg(e.settings,t.settings||{}),cards:{...e.cards,...t.cards||{}},seenCards:{...e.seenCards,...t.seenCards||{}},seenKanji:{...e.seenKanji,...t.seenKanji||{}},daily:{...e.daily,...t.daily||{}},favorites:{...e.favorites,...t.favorites||{}},transactions:Array.isArray(t.transactions)?t.transactions:e.transactions,streakHistory:Array.isArray(t.streakHistory)?t.streakHistory:e.streakHistory,streak:Ig(e.streak,t.streak||{}),visits:{...e.visits,...t.visits||{}},lessonCompletions:{...e.lessonCompletions,...t.lessonCompletions||{}},achievements:{...e.achievements,...t.achievements||{}},dailyBonuses:{...e.dailyBonuses,...t.dailyBonuses||{}},dailyBonusPending:yr(t.dailyBonusPending||null),lastOpenedJlptLesson:xe(t.lastOpenedJlptLesson||null),lastOpenedJlptLessons:a$(t.lastOpenedJlptLessons||{}),viewedReadingLevels:es(t.viewedReadingLevels||{}),appOpens:Number(t.appOpens||e.appOpens),totalMoonFragmentsEarned:Number(t.totalMoonFragmentsEarned||e.totalMoonFragmentsEarned),writingPractice:{...e.writingPractice,...t.writingPractice||{}},secrets:{...e.secrets,...t.secrets||{}},learningPath:Nl(e.learningPath,t.learningPath||{}),jlptLessonStudy:Sl(e.jlptLessonStudy,t.jlptLessonStudy||{}),sentencePractice:Il(e.sentencePractice,t.sentencePractice||{}),jlptLessonPractice:Tl(e.jlptLessonPractice,t.jlptLessonPractice||{}),readingExercises:{...e.readingExercises,...t.readingExercises||{}},n5Course:xl(e.n5Course,t.n5Course||{}),n4Course:Cl(e.n4Course,t.n4Course||{}),n3Course:Ll(e.n3Course,t.n3Course||{}),n2Course:Al(e.n2Course,t.n2Course||{}),unlockedJlptLevels:[...new Set([...Array.isArray(e.unlockedJlptLevels)?e.unlockedJlptLevels:[],...Array.isArray(t.unlockedJlptLevels)?t.unlockedJlptLevels:[],...be])],unlockedBackgrounds:[...new Set([...e.unlockedBackgrounds||[],...t.unlockedBackgrounds||[]])],selectedEvaRoomBackground:t.selectedEvaRoomBackground||e.selectedEvaRoomBackground,unlockedEvaSprites:[...new Set([...e.unlockedEvaSprites||[],...t.unlockedEvaSprites||[],...(t.shop&&t.shop.owned||[]).filter(n=>String(n).startsWith("eva_sprite:")).map(n=>String(n).replace("eva_sprite:",""))])],selectedEvaSprite:t.selectedEvaSprite||e.selectedEvaSprite,evaRoomDialogueProgress:{...e.evaRoomDialogueProgress,...t.evaRoomDialogueProgress||{},rewardsClaimed:{...e.evaRoomDialogueProgress.rewardsClaimed,...t.evaRoomDialogueProgress&&t.evaRoomDialogueProgress.rewardsClaimed||{}},visited:{...e.evaRoomDialogueProgress.visited,...t.evaRoomDialogueProgress&&t.evaRoomDialogueProgress.visited||{}},lineHistory:Array.isArray(t.evaRoomDialogueProgress?.lineHistory)?t.evaRoomDialogueProgress.lineHistory:e.evaRoomDialogueProgress.lineHistory||[]},evaRoomQuiz:{...e.evaRoomQuiz,...t.evaRoomQuiz||{},rewarded:{...e.evaRoomQuiz.rewarded,...t.evaRoomQuiz&&t.evaRoomQuiz.rewarded||{}},history:Array.isArray(t.evaRoomQuiz?.history)?t.evaRoomQuiz.history.slice(0,40):e.evaRoomQuiz.history},evaAutonomy:Ml(e.evaAutonomy,t.evaAutonomy||{}),evaRelationship:_l(e.evaRelationship,t.evaRelationship||{}),shop:{owned:[...new Set([...e.shop.owned||[],...t.shop&&t.shop.owned||[]])],equipped:{...e.shop.equipped,...t.shop&&t.shop.equipped||{}}}}}function Lg(e,t){const n={...e,...t||{}};return n.theme=Ag(n.theme,e.theme||"dark"),n.themeManuallySelected=It(n.themeManuallySelected,e.themeManuallySelected===!0),n.themeManuallySelected||(n.theme="dark"),n.sound=It(n.sound,e.sound!==!1),n.uxSound=n.sound!==!1,n.languageAutoDetected=It(n.languageAutoDetected,e.languageAutoDetected!==!1),n.languageManuallySelected=It(n.languageManuallySelected,e.languageManuallySelected===!0),n}function Ag(e,t="dark"){return e==="light"||e==="dark"?e:t}function Ig(e,t){const n={...e,...t||{}};return n.current=Qa(n.current,e.current||0),n.best=Qa(n.best,e.best||0),n.lastStudyDate=n.lastStudyDate||null,n.pendingReward=kl(n.pendingReward),n}function kl(e){if(!e||typeof e!="object")return null;const t=Qa(e.milestone,0),n=typeof e.availableOn=="string"?e.availableOn:"";return!t||!n?null:{milestone:t,availableOn:n}}function yr(e){if(!e||typeof e!="object")return null;const t=typeof e.availableOn=="string"?e.availableOn:"";return t?{availableOn:t}:null}function It(e,t=!0){if(typeof e=="boolean")return e;if(typeof e=="number")return e!==0;if(typeof e=="string"){const n=e.trim().toLowerCase();if(["false","0","off","no","disabled"].includes(n))return!1;if(["true","1","on","yes","enabled"].includes(n))return!0}return t}function Qa(e,t=0){const n=Number(e);return Number.isFinite(n)?n:t}function Wa(){return{version:Yo,currentLevel:Zo,currentNodeId:le,completedNodes:{},unlockedNodes:{[le]:!0},activeSession:null,resultHistory:{},lastUpdatedAt:null}}function Va(){return{activeSessionKey:null,sessions:{},lastUpdatedAt:null}}function yl(){return{level:"",lessonId:"",currentIndex:0,answers:{},phase:"study",startedAt:null,updatedAt:null,completedAt:null,testOpenedAt:null}}function $l(e){const t=String(e||"").toLowerCase();return["study","test","done"].includes(t)?t:"study"}function jl(e,t){const n=yl(),s=t&&typeof t=="object"?t:{},a={...e?.answers||n.answers,...s.answers||{}};return{...n,...e||{},...s,level:String(s.level||e?.level||n.level||"").toUpperCase(),lessonId:String(s.lessonId||e?.lessonId||n.lessonId||""),currentIndex:Math.max(0,Number(s.currentIndex??e?.currentIndex??n.currentIndex??0)),answers:a,phase:$l(s.phase||e?.phase||n.phase),startedAt:s.startedAt||e?.startedAt||n.startedAt||null,updatedAt:s.updatedAt||e?.updatedAt||n.updatedAt||null,completedAt:s.completedAt||e?.completedAt||n.completedAt||null,testOpenedAt:s.testOpenedAt||e?.testOpenedAt||n.testOpenedAt||null}}function Sl(e,t){const n=Va(),s=t&&typeof t=="object"?t:{},a={},o=e?.sessions||{},l=s.sessions||{};return Object.keys(o).forEach(c=>{a[c]=jl(o[c],l[c])}),Object.keys(l).forEach(c=>{a[c]||(a[c]=jl(null,l[c]))}),{...n,...e||{},...s||{},sessions:a,activeSessionKey:s.activeSessionKey||e?.activeSessionKey||n.activeSessionKey||null,lastUpdatedAt:s.lastUpdatedAt||e?.lastUpdatedAt||n.lastUpdatedAt||null}}function Nl(e,t){return{...e,...t||{},version:Yo,currentLevel:String(t?.currentLevel||e.currentLevel||Zo).toUpperCase(),currentNodeId:String(t?.currentNodeId||e.currentNodeId||le),completedNodes:{...e.completedNodes,...t?.completedNodes||{}},unlockedNodes:{...e.unlockedNodes,...t?.unlockedNodes||{}},activeSession:Ya(t?.activeSession||e.activeSession||null),resultHistory:{...e.resultHistory,...t?.resultHistory||{}},lastUpdatedAt:t?.lastUpdatedAt||e.lastUpdatedAt||null}}function Ya(e){return!e||typeof e!="object"?null:{nodeId:String(e.nodeId||""),mode:String(e.mode||Lt),stepIndex:Math.max(0,Number(e.stepIndex||0)),answers:{...e.answers||{}},mistakes:Array.isArray(e.mistakes)?e.mistakes.slice(0,80):[],reviewStepIds:Array.isArray(e.reviewStepIds)?e.reviewStepIds.map(String).filter(Boolean).slice(0,80):[],score:Number(e.score||0),startedAt:e.startedAt||new Date().toISOString(),updatedAt:e.updatedAt||new Date().toISOString()}}function Za(){return{currentLessonId:"n5-lesson-1",completedLessons:{},viewedLessons:{},studiedKanji:{},srsKanji:{},difficultKanji:{},kanjiMistakes:{},wordMistakes:{},completedExercises:{},exerciseResults:{},exerciseSrs:{},writingPractice:{},activeReviewMode:"due",finalTest:{answers:{},completedAt:null,score:0,percent:0,passed:!1,mistakes:[],attempts:0,correctAnswers:0,incorrectAnswers:0,unansweredAnswers:0,totalQuestions:0,mistakeQuestionIds:[],bestScore:0,lastScore:0,passedAt:null,lastRewardXp:0,lastRewardMoon:0},customSentences:[]}}function xl(e,t){return{...e,...t||{},currentLessonId:t?.currentLessonId||e.currentLessonId,completedLessons:{...e.completedLessons,...t?.completedLessons||{}},viewedLessons:es(t?.viewedLessons||{}),studiedKanji:{...e.studiedKanji,...t?.studiedKanji||{}},srsKanji:{...e.srsKanji,...t?.srsKanji||{}},difficultKanji:{...e.difficultKanji,...t?.difficultKanji||{}},kanjiMistakes:{...e.kanjiMistakes,...t?.kanjiMistakes||{}},wordMistakes:{...e.wordMistakes,...t?.wordMistakes||{}},completedExercises:{...e.completedExercises,...t?.completedExercises||{}},exerciseResults:{...e.exerciseResults,...t?.exerciseResults||{}},exerciseSrs:oa(e.exerciseSrs,t?.exerciseSrs||{},"N5"),writingPractice:{...e.writingPractice,...t?.writingPractice||{}},activeReviewMode:t?.activeReviewMode||e.activeReviewMode,finalTest:{...e.finalTest,...t?.finalTest||{},answers:{...e.finalTest.answers,...t?.finalTest&&t.finalTest.answers||{}},mistakes:Array.isArray(t?.finalTest?.mistakes)?t.finalTest.mistakes:e.finalTest.mistakes},customSentences:Array.isArray(t?.customSentences)?t.customSentences:e.customSentences}}function ei(){return{opened:!1,currentLessonId:"n4-lesson-1",completedLessons:{},viewedLessons:{},studiedKanji:{},srsKanji:{},difficultKanji:{},kanjiMistakes:{},wordMistakes:{},completedExercises:{},exerciseResults:{},exerciseSrs:{},completedGrammar:{},grammarResults:{},completedReading:{},readingAnswers:{},completedListening:{},listeningAnswers:{},writingPractice:{},activeReviewMode:"due",finalTest:{answers:{},completedAt:null,score:0,percent:0,passed:!1,mistakes:[],attempts:0},customSentences:[]}}function Cl(e,t){return{...e,...t||{},opened:!!(t?.opened||e.opened),currentLessonId:t?.currentLessonId||e.currentLessonId,completedLessons:{...e.completedLessons,...t?.completedLessons||{}},viewedLessons:es(t?.viewedLessons||{}),studiedKanji:{...e.studiedKanji,...t?.studiedKanji||{}},srsKanji:{...e.srsKanji,...t?.srsKanji||{}},difficultKanji:{...e.difficultKanji,...t?.difficultKanji||{}},kanjiMistakes:{...e.kanjiMistakes,...t?.kanjiMistakes||{}},wordMistakes:{...e.wordMistakes,...t?.wordMistakes||{}},completedExercises:{...e.completedExercises,...t?.completedExercises||{}},exerciseResults:{...e.exerciseResults,...t?.exerciseResults||{}},exerciseSrs:oa(e.exerciseSrs,t?.exerciseSrs||{},"N4"),completedGrammar:{...e.completedGrammar,...t?.completedGrammar||{}},grammarResults:{...e.grammarResults,...t?.grammarResults||{}},completedReading:{...e.completedReading,...t?.completedReading||{}},readingAnswers:{...e.readingAnswers,...t?.readingAnswers||{}},completedListening:{...e.completedListening,...t?.completedListening||{}},listeningAnswers:{...e.listeningAnswers,...t?.listeningAnswers||{}},writingPractice:{...e.writingPractice,...t?.writingPractice||{}},activeReviewMode:t?.activeReviewMode||e.activeReviewMode,finalTest:{...e.finalTest,...t?.finalTest||{},answers:{...e.finalTest.answers,...t?.finalTest&&t.finalTest.answers||{}},mistakes:Array.isArray(t?.finalTest?.mistakes)?t.finalTest.mistakes:e.finalTest.mistakes},customSentences:Array.isArray(t?.customSentences)?t.customSentences:e.customSentences}}function ti(){return{opened:!1,currentLessonId:"n3-lesson-1",completedLessons:{},viewedLessons:{},studiedKanji:{},srsKanji:{},difficultKanji:{},kanjiMistakes:{},wordMistakes:{},completedExercises:{},exerciseResults:{},exerciseSrs:{},completedGrammar:{},grammarResults:{},completedReading:{},readingAnswers:{},completedListening:{},listeningAnswers:{},writingPractice:{},activeReviewMode:"due",finalTest:{answers:{},completedAt:null,score:0,percent:0,passed:!1,mistakes:[],attempts:0},customSentences:[]}}function Ll(e,t){return{...e,...t||{},opened:!!(t?.opened||e.opened),currentLessonId:t?.currentLessonId||e.currentLessonId,completedLessons:{...e.completedLessons,...t?.completedLessons||{}},viewedLessons:es(t?.viewedLessons||{}),studiedKanji:{...e.studiedKanji,...t?.studiedKanji||{}},srsKanji:{...e.srsKanji,...t?.srsKanji||{}},difficultKanji:{...e.difficultKanji,...t?.difficultKanji||{}},kanjiMistakes:{...e.kanjiMistakes,...t?.kanjiMistakes||{}},wordMistakes:{...e.wordMistakes,...t?.wordMistakes||{}},completedExercises:{...e.completedExercises,...t?.completedExercises||{}},exerciseResults:{...e.exerciseResults,...t?.exerciseResults||{}},exerciseSrs:oa(e.exerciseSrs,t?.exerciseSrs||{},"N3"),completedGrammar:{...e.completedGrammar,...t?.completedGrammar||{}},grammarResults:{...e.grammarResults,...t?.grammarResults||{}},completedReading:{...e.completedReading,...t?.completedReading||{}},readingAnswers:{...e.readingAnswers,...t?.readingAnswers||{}},completedListening:{...e.completedListening,...t?.completedListening||{}},listeningAnswers:{...e.listeningAnswers,...t?.listeningAnswers||{}},writingPractice:{...e.writingPractice,...t?.writingPractice||{}},activeReviewMode:t?.activeReviewMode||e.activeReviewMode,finalTest:{...e.finalTest,...t?.finalTest||{},answers:{...e.finalTest.answers,...t?.finalTest&&t.finalTest.answers||{}},mistakes:Array.isArray(t?.finalTest?.mistakes)?t.finalTest.mistakes:e.finalTest.mistakes},customSentences:Array.isArray(t?.customSentences)?t.customSentences:e.customSentences}}function ni(){return{opened:!1,currentLessonId:"n2-lesson-1",completedLessons:{},viewedLessons:{},studiedKanji:{},srsKanji:{},difficultKanji:{},kanjiMistakes:{},wordMistakes:{},completedExercises:{},exerciseResults:{},exerciseSrs:{},completedGrammar:{},grammarResults:{},completedReading:{},readingAnswers:{},completedListening:{},listeningAnswers:{},writingPractice:{},activeReviewMode:"due",finalTest:{answers:{},completedAt:null,score:0,percent:0,passed:!1,mistakes:[],attempts:0},customSentences:[]}}function Al(e,t){return{...e,...t||{},opened:!!(t?.opened||e.opened),currentLessonId:t?.currentLessonId||e.currentLessonId,completedLessons:{...e.completedLessons,...t?.completedLessons||{}},viewedLessons:es(t?.viewedLessons||{}),studiedKanji:{...e.studiedKanji,...t?.studiedKanji||{}},srsKanji:{...e.srsKanji,...t?.srsKanji||{}},difficultKanji:{...e.difficultKanji,...t?.difficultKanji||{}},kanjiMistakes:{...e.kanjiMistakes,...t?.kanjiMistakes||{}},wordMistakes:{...e.wordMistakes,...t?.wordMistakes||{}},completedExercises:{...e.completedExercises,...t?.completedExercises||{}},exerciseResults:{...e.exerciseResults,...t?.exerciseResults||{}},exerciseSrs:oa(e.exerciseSrs,t?.exerciseSrs||{},"N2"),completedGrammar:{...e.completedGrammar,...t?.completedGrammar||{}},grammarResults:{...e.grammarResults,...t?.grammarResults||{}},completedReading:{...e.completedReading,...t?.completedReading||{}},readingAnswers:{...e.readingAnswers,...t?.readingAnswers||{}},completedListening:{...e.completedListening,...t?.completedListening||{}},listeningAnswers:{...e.listeningAnswers,...t?.listeningAnswers||{}},writingPractice:{...e.writingPractice,...t?.writingPractice||{}},activeReviewMode:t?.activeReviewMode||e.activeReviewMode,finalTest:{...e.finalTest,...t?.finalTest||{},answers:{...e.finalTest.answers,...t?.finalTest&&t.finalTest.answers||{}},mistakes:Array.isArray(t?.finalTest?.mistakes)?t.finalTest.mistakes:e.finalTest.mistakes},customSentences:Array.isArray(t?.customSentences)?t.customSentences:e.customSentences}}function Il(e,t){return{...e,...t,selected:Array.isArray(t.selected)?t.selected:e.selected,tileKeys:Array.isArray(t.tileKeys)?t.tileKeys:e.tileKeys,recentIds:Array.isArray(t.recentIds)?t.recentIds:e.recentIds,recentAnswers:Array.isArray(t.recentAnswers)?t.recentAnswers:e.recentAnswers,completed:{...e.completed,...t.completed||{}},custom:Array.isArray(t.custom)?t.custom.slice(0,80):e.custom,customSentences:Tg(t.customSentences,t.custom),customEditingId:typeof t.customEditingId=="string"?t.customEditingId:null,customDraft:$r(t.customDraft||e.customDraft),customMessage:typeof t.customMessage=="string"?t.customMessage:e.customMessage,customStatus:typeof t.customStatus=="string"?t.customStatus:e.customStatus}}function $r(e={}){return{jp:String(e.jp??e.sentence??""),hiragana:String(e.hiragana??e.reading??""),ru:String(e.ru??e.translationRu??""),en:String(e.en??e.translationEn??"")}}function Tg(e,t){const n=[],s=new Set,a=o=>{if(!o)return;const l=qt(o.jp||Dd(o)),c=qn(l);if(!c||s.has(c))return;s.add(c);const d=String(o.id||"").startsWith("custom_")?String(o.id):`custom_${he(c).toString(36)}`;n.push({id:d,jp:l,hiragana:qt(o.hiragana||o.reading||""),ru:qt(o.ru||o.translationRu||""),en:qt(o.en||o.translationEn||""),source:"user"})};return(Array.isArray(e)?e:[]).forEach(a),(Array.isArray(t)?t:[]).forEach(a),n.slice(0,160)}function Tl(e,t){return{...e,...t,activeIds:{...e.activeIds,...t.activeIds||{}},selected:{...e.selected,...t.selected||{}},checked:{...e.checked,...t.checked||{}},results:{...e.results,...t.results||{}},completed:{...e.completed,...t.completed||{}}}}function si(){return{warmth:44,trust:40,discipline:35,curiosity:42,mood:"neutral",conversationCount:0,totalDialogueChoices:0,lastInteractionAt:null,lastInteractionDate:null,lastDecayDate:W(),lastKnown:{learned:0,mastered:0,reviews:0,lessons:0,streak:0,wrong:0,writing:0,sentence:0},history:[]}}function Rl(){return{enabled:!0,frequency:"normal",roomMode:"auto",outfitMode:"auto",currentLine:null,currentQuestion:null,currentDecoration:null,currentEffect:null,mood:"neutral",emotion:"calm",lastSpokeAt:null,nextSpeakAt:null,recentLineIds:[],lastRoomId:null,lastSprite:null}}function _l(e,t){return{...e,...t,warmth:Z(Number(t.warmth??e.warmth),0,100),trust:Z(Number(t.trust??e.trust),0,100),discipline:Z(Number(t.discipline??e.discipline),0,100),curiosity:Z(Number(t.curiosity??e.curiosity),0,100),lastKnown:{...e.lastKnown,...t.lastKnown||{}},history:Array.isArray(t.history)?t.history.slice(0,40):e.history}}function Ml(e,t){return{...e,...t,enabled:!0,frequency:"normal",roomMode:"auto",outfitMode:"auto",recentLineIds:Array.isArray(t.recentLineIds)?t.recentLineIds.slice(0,32):e.recentLineIds,currentLine:t.currentLine&&typeof t.currentLine=="object"?t.currentLine:e.currentLine,currentQuestion:t.currentQuestion&&typeof t.currentQuestion=="object"?t.currentQuestion:e.currentQuestion,currentDecoration:typeof t.currentDecoration=="string"?t.currentDecoration:e.currentDecoration,currentEffect:typeof t.currentEffect=="string"?t.currentEffect:e.currentEffect,mood:typeof t.mood=="string"?t.mood:e.mood,emotion:typeof t.emotion=="string"?t.emotion:e.emotion}}function vt(){return{lastSeenDate:null,lastInteractionDate:null,lastRoute:null,recentLineIds:[],recentTopics:[],daysSinceReturn:0,lastPraiseAt:null,lastWarningAt:null,timesUserChoseTalkOverStudy:0,timesUserReturnedAfterGap:0,lastReturnCountedDate:null,preferredEvaRoomBackground:null,lastKnownMood:"neutral",recentProblemCluster:null}}function gn(e,t={}){return{...e,...t,recentLineIds:Array.isArray(t.recentLineIds)?t.recentLineIds.slice(0,30):e.recentLineIds,recentTopics:Array.isArray(t.recentTopics)?t.recentTopics.slice(0,20):e.recentTopics,daysSinceReturn:Number(t.daysSinceReturn||e.daysSinceReturn||0),timesUserChoseTalkOverStudy:Number(t.timesUserChoseTalkOverStudy||e.timesUserChoseTalkOverStudy||0),timesUserReturnedAfterGap:Number(t.timesUserReturnedAfterGap||e.timesUserReturnedAfterGap||0),lastKnownMood:typeof t.lastKnownMood=="string"?t.lastKnownMood:e.lastKnownMood}}function at(){return{version:3,createdAt:new Date().toISOString(),updatedAt:new Date().toISOString(),presenceState:"idle",mood:"neutral",emotion:"calm",currentPhrase:null,pendingQuestion:null,currentSkin:"idle",currentBackground:"bg_study_hub",currentDecoration:null,currentEffect:"none",activeSkin:"idle",activeBackground:"bg_study_hub",ownedSkins:["idle","default"],ownedBackgrounds:["bg_study_hub"],ownedEffects:[],ownedDecorations:[],lastEvent:null,lastQuestion:null,lastPhraseAt:0,lastEmotionChangeAt:0,lastQuestionAt:0,lastVisualChangeAt:0,lastPlayerActionAt:Date.now(),textRevealSkippedLineId:null,memory:vt(),questionHistory:[],clickCount:0,eventHistory:[],recentEvents:[],cooldowns:{emotion:18e3,phrase:65e3,question:24e4,visual:72e4}}}function Rg(){const e=at();let t=null;try{const n=localStorage.getItem(Ln);t=n?JSON.parse(n):null}catch(n){console.warn("Eva state reset because stored JSON is invalid.",n)}r.evaRuntime=Pg(e,t||Mg()),_g(),mn()}function _g(){if(!r.evaRuntime)return;r.evaRuntime.memory=gn(vt(),r.evaRuntime.memory||{});const e=r.evaRuntime.memory,t=W(),n=e.lastSeenDate||null,s=n?Math.max(0,tn(n,t)):0;e.daysSinceReturn=s,s>0&&e.lastReturnCountedDate!==t&&(e.timesUserReturnedAfterGap=Number(e.timesUserReturnedAfterGap||0)+1,e.lastReturnCountedDate=t),e.lastSeenDate=t,e.lastRoute=r.route,e.preferredEvaRoomBackground=r.progress?.selectedEvaRoomBackground||e.preferredEvaRoomBackground||"bg_study_hub",e.lastKnownMood=r.evaRuntime.mood||e.lastKnownMood||"neutral"}function Mg(){const e=r.progress?.evaAutonomy||{};return{currentSkin:r.progress?.selectedEvaSprite||e.lastSprite||"idle",currentBackground:r.progress?.selectedEvaRoomBackground||e.lastRoomId||"bg_study_hub",currentDecoration:r.customization?.selected?.decoration||r.customization?.selected?.frame||null,currentEffect:r.customization?.selected?.effect||"none",activeSkin:r.progress?.selectedEvaSprite||e.lastSprite||"idle",activeBackground:r.progress?.selectedEvaRoomBackground||e.lastRoomId||"bg_study_hub",lastEvent:e.currentLine?.reason?{type:e.currentLine.reason,at:e.currentLine.at}:null}}function Pg(e,t={}){return{...e,...t,version:3,updatedAt:new Date().toISOString(),presenceState:typeof t.presenceState=="string"?t.presenceState:e.presenceState,mood:typeof t.mood=="string"?t.mood:e.mood,emotion:typeof t.emotion=="string"?t.emotion:e.emotion,currentPhrase:t.currentPhrase&&typeof t.currentPhrase=="object"?t.currentPhrase:e.currentPhrase,pendingQuestion:t.pendingQuestion&&typeof t.pendingQuestion=="object"?t.pendingQuestion:e.pendingQuestion,currentSkin:typeof t.currentSkin=="string"?t.currentSkin:e.currentSkin,currentBackground:typeof t.currentBackground=="string"?t.currentBackground:e.currentBackground,currentDecoration:typeof t.currentDecoration=="string"?t.currentDecoration:null,currentEffect:typeof t.currentEffect=="string"?t.currentEffect:e.currentEffect,activeSkin:typeof t.activeSkin=="string"?t.activeSkin:t.currentSkin||e.activeSkin,activeBackground:typeof t.activeBackground=="string"?t.activeBackground:t.currentBackground||e.activeBackground,ownedSkins:Array.isArray(t.ownedSkins)?t.ownedSkins:e.ownedSkins,ownedBackgrounds:Array.isArray(t.ownedBackgrounds)?t.ownedBackgrounds:e.ownedBackgrounds,ownedEffects:Array.isArray(t.ownedEffects)?t.ownedEffects:e.ownedEffects,ownedDecorations:Array.isArray(t.ownedDecorations)?t.ownedDecorations:e.ownedDecorations,lastPhraseAt:Number(t.lastPhraseAt||e.lastPhraseAt||0),lastEmotionChangeAt:Number(t.lastEmotionChangeAt||e.lastEmotionChangeAt||0),lastQuestionAt:Number(t.lastQuestionAt||e.lastQuestionAt||0),lastVisualChangeAt:Number(t.lastVisualChangeAt||e.lastVisualChangeAt||0),lastPlayerActionAt:Number(t.lastPlayerActionAt||e.lastPlayerActionAt||Date.now()),textRevealSkippedLineId:typeof t.textRevealSkippedLineId=="string"?t.textRevealSkippedLineId:null,memory:gn(e.memory||vt(),t.memory||{}),questionHistory:Array.isArray(t.questionHistory)?t.questionHistory.slice(0,40):e.questionHistory,eventHistory:Array.isArray(t.eventHistory)?t.eventHistory.slice(0,80):e.eventHistory,recentEvents:Array.isArray(t.recentEvents)?t.recentEvents.slice(0,80):e.recentEvents,cooldowns:{...e.cooldowns,...t.cooldowns||{}},clickCount:Number(t.clickCount||e.clickCount||0)}}function ri(){if(!r.evaRuntime)return!1;Pl(),r.evaRuntime.updatedAt=new Date().toISOString(),Ea=!1,an&&("cancelIdleCallback"in window?window.cancelIdleCallback(an):window.clearTimeout(an),an=0);try{return localStorage.setItem(Ln,JSON.stringify(r.evaRuntime)),!0}catch(e){return console.warn("Eva state could not be saved.",e),!1}}function mn(e={}){if(!r.evaRuntime)return!1;if(e?.immediate)return ri();if(Ea)return!0;Ea=!0;const t=()=>{an=0,ri()};return"requestIdleCallback"in window?an=window.requestIdleCallback(t,{timeout:1200}):an=window.setTimeout(t,160),!0}function ai(){ii(),ri(),Up()}function Pl(){if(!r.evaRuntime||!r.progress)return;const e=r.progress.selectedEvaRoomBackground||r.customization?.selected?.background||"bg_study_hub",t=Oe().filter(n=>ot(n.id));r.evaRuntime.ownedSkins=[...new Set(["idle","default",...r.progress.unlockedEvaSprites||[],...t.filter(n=>n.type==="outfit").map(n=>n.spriteId||n.id)].filter(Boolean))],r.evaRuntime.ownedBackgrounds=[...new Set(["bg_study_hub",...r.progress.unlockedBackgrounds||[],...t.filter(n=>n.type==="background").map(n=>n.id)].filter(Boolean))],r.evaRuntime.ownedEffects=[...new Set(t.filter(n=>n.type==="effect").map(n=>n.id))],r.evaRuntime.ownedDecorations=[...new Set(t.filter(n=>n.type==="decoration").map(n=>n.id))],r.evaRuntime.currentBackground=e,r.evaRuntime.activeSkin=r.evaRuntime.currentSkin||r.progress.selectedEvaSprite||"idle",r.evaRuntime.activeBackground=e}function ii(){if(!r.progress)return!1;r.progress.level=ya(r.progress.xp),r.progress.updatedAt=new Date().toISOString(),Pa=!1,rn&&("cancelIdleCallback"in window?window.cancelIdleCallback(rn):window.clearTimeout(rn),rn=0);try{return localStorage.setItem(xn,JSON.stringify(r.progress)),!0}catch(e){return console.warn("Progress could not be saved.",e),!1}}function N(e={}){if(!r.progress)return!1;if(e?.immediate)return ii();if(Pa)return!0;Pa=!0;const t=()=>{rn=0,ii()};return"requestIdleCallback"in window?rn=window.requestIdleCallback(t,{timeout:1200}):rn=window.setTimeout(t,120),!0}function jr(){r.cards.forEach(s=>A(s.id)),r.progress.level=ya(r.progress.xp),r.progress.totalMoonFragmentsEarned=Math.max(Number(r.progress.totalMoonFragmentsEarned||0),Number(r.progress.moonFragments||0),_y()),Y(),ys(),Cs(),_i(),Di(),Fi(),typeof ensureN1CourseProgress=="function"&&ensureN1CourseProgress();const e=Hs(),t=[ca(J(),"N5"),ca(P(),"N4"),ca(_(),"N3"),ca(M(),"N2"),da(J(),"N5"),da(P(),"N4"),da(_(),"N3"),da(M(),"N2")].some(Boolean);[J(),P(),_(),M(),typeof n1Course=="function"?n1Course():null].filter(Boolean).forEach(s=>Eg(s)),(t||e)&&N(),Sr();const n=r.lessons.find(s=>ke(s));r.activeLessonId||(r.activeLessonId=n?.id||r.lessons[0]?.id||null)}function Eg(e){e&&(e.studiedKanji||={},e.srsKanji||={},e.viewedLessons=es(e.viewedLessons||{}),Object.entries(e.srsKanji).forEach(([t,n])=>{e.studiedKanji[t]||(e.studiedKanji[t]=n)}),Object.entries(e.studiedKanji).forEach(([t,n])=>{e.srsKanji[t]||(e.srsKanji[t]=n)}))}function fs(e,t,n=new Date().toISOString()){if(!e||!t)return"";e.studiedKanji||={},e.srsKanji||={};const s=e.studiedKanji[t],a=e.srsKanji[t],o=s||a||n;return e.studiedKanji[t]=o,e.srsKanji[t]=a||o,o}function Sr(){r.progress.learningPath=Nl(Wa(),r.progress.learningPath||{});const e=r.progress.learningPath,t=e.completedNodes,n=e.unlockedNodes;n[le]=!0,(Object.keys(r.progress.seenKanji||{}).length>0||Object.keys(J().studiedKanji||{}).length>0||Object.keys(J().completedLessons||{}).length>0||Object.keys(r.progress.lessonCompletions||{}).length>0)&&!t[le]&&(t[le]=r.progress.visits?.firstVisitDate||new Date().toISOString()),oi().forEach((o,l)=>{J().completedLessons?.[o]&&!t[o]&&(t[o]=J().completedLessons[o]),n[o]=!0});const a=El();e.currentNodeId=a,n[a]=!0,e.activeSession?.nodeId&&t[e.activeSession.nodeId]&&(e.activeSession=null),e.lastUpdatedAt=new Date().toISOString()}function oi(){const e=(r.n5Textbook?.items||[]).map(t=>String(t.id||"")).filter(Boolean);return e.length?e:bp.filter(t=>/^n5-lesson-\d+$/i.test(t))}function El(){const e=r.progress?.learningPath||Wa(),t=[le,...oi(),In];return t.find(n=>!e.completedNodes?.[n])||t[t.length-1]||le}function li(){return r.n5Textbook?.items?.length?Promise.resolve(r.n5Textbook):ps||(ps=Qe(K.n5Lessons).then(e=>(r.n5Textbook=pl(e),Sr(),(r.route==="learn"||r.route==="home")&&j(),r.n5Textbook)).catch(e=>{throw ps=null,e}),ps)}function Dg(e){const t=String(e||"");if(!t)return Promise.resolve(null);if(r.learningPathLessonPayloads[t])return Promise.resolve(r.learningPathLessonPayloads[t]);const n=kp[t];if(!n){const a=js(t);return a&&(r.learningPathLessonPayloads[t]=a),Promise.resolve(a)}if(mr.has(t))return mr.get(t);const s=Qe(n).then(a=>(r.learningPathLessonPayloads[t]=a||js(t),r.route==="learn"&&r.activeLearnNodeId===t&&j(),r.learningPathLessonPayloads[t])).catch(a=>{const o=js(t);if(o)return r.learningPathLessonPayloads[t]=o,r.route==="learn"&&r.activeLearnNodeId===t&&j(),o;throw a}).finally(()=>{mr.delete(t)});return mr.set(t,s),s}function Tt(){return Sr(),r.progress.learningPath}function ci(){const e=Tt().activeSession;return!e?.nodeId||Tt().completedNodes?.[e.nodeId]?null:e}function _n(){const e=ci();return e?.nodeId?e.nodeId:Tt().currentNodeId||El()||le}function Dl(e){const t=Mn(e);return t?h(t.title):Og(e)}function Og(e){const t=String(e||"");if(t===le)return p()==="ru"?"Введение в маршрут":"Route introduction";if(t===In)return p()==="ru"?"Контрольная точка N5":"N5 checkpoint";const n=Ze(t);if(n)return h(n.title);const s=t.match(/n5-lesson-(\d+)/i);return s?p()==="ru"?`N5 · Урок ${s[1]}`:`N5 · Lesson ${s[1]}`:t}function Kg(e){const t=Mn(e);return t?h(t.summary):""}function V(){return p()==="ru"?{route:"Маршрут обучения",intro:"Введение",checkpoint:"Контрольная точка",review:"Повторение",available:"доступно",current:"сейчас",completed:"завершено",locked:"закрыто",due:"нужно повторить",minutes:"мин",lessons:"уроки",start:"Начать учиться",resume:"Продолжить урок",next:"Следующий урок",reviewAction:"Повторить",reviewOld:"Повторить старое",continue:"Дальше",finish:"Завершить",backToMap:"К маршруту",openTextbook:"Открыть учебник",openCheckpoint:"К тесту",score:"Результат",mistakes:"Ошибки",retryMistakes:"Повторить ошибки",continuePath:"Продолжить путь",ready:"Готово",introTitle:"Как тут учиться",introSummary:"Кандзи идут по цепочке: знак -> смысл -> чтение -> пример -> повторение.",introBody:"Сначала берём один маленький блок, потом отправляем его в повторение. Не нужно держать всё в голове за раз.",introBridge:"Если что-то тяжело, это не провал. Значит, карточка просто раньше вернётся в повторение.",introQuestion:"Куда отправляются карточки после урока?",introQuestionHint:"Выбери правильный путь.",loading:"Подгружаю маршрут...",empty:"Маршрут скоро появится.",nextLesson:"Следующий шаг",lessonTrack:"Текущий уровень",reviewQueue:"К повторению",streak:"Стрик",level:"Уровень",xp:"XP",mapHint:"Сначала идём по текущему уровню. Остальные уровни остаются в учебниках.",step:"Шаг",finishHint:"После урока карточки попадут в повторение.",scoreHint:"Вернёмся к ошибкам или двинемся дальше."}:{route:"Learning path",intro:"Intro",checkpoint:"Checkpoint",review:"Review",available:"available",current:"current",completed:"done",locked:"locked",due:"review due",minutes:"min",lessons:"lessons",start:"Start learning",resume:"Resume lesson",next:"Next lesson",reviewAction:"Review",reviewOld:"Review old material",continue:"Next",finish:"Finish",backToMap:"Back to path",openTextbook:"Open textbook",openCheckpoint:"Open test",score:"Score",mistakes:"Ошибки",retryMistakes:"Retry mistakes",continuePath:"Continue path",ready:"Done",introTitle:"How this route works",introSummary:"Kanji move through a chain: sign -> meaning -> reading -> example -> review.",introBody:"Take one small block first, then send it into review. You do not need to hold everything at once.",introBridge:"If something feels hard, that is not failure. It only means the card should return sooner.",introQuestion:"Where do cards go after the lesson?",introQuestionHint:"Choose the correct path.",loading:"Loading the path...",empty:"The path will appear soon.",nextLesson:"Next step",lessonTrack:"Current level",reviewQueue:"Due now",streak:"Streak",level:"Level",xp:"XP",mapHint:"Stay on the current level here. The rest remains in textbooks.",step:"Шаг",finishHint:"After the lesson the cards move to review.",scoreHint:"Retry mistakes or keep moving."}}function Bg(){const e=V();return{id:le,type:"lesson",level:"INTRO",title:{ru:e.introTitle,en:e.introTitle},summary:{ru:e.introSummary,en:e.introSummary},durationMinutes:3}}function Fg(){const e=Ne();return V(),{id:An,type:"review",level:"SRS",title:{ru:`Повторение: ${e}`,en:`Review: ${e}`},summary:{ru:e>0?"Карточки, которые уже нужно вернуть в память.":"Очередь пуста, можно идти дальше.",en:e>0?"Cards that should return now.":"Queue is empty, move on."},durationMinutes:Math.max(2,Math.min(12,e))}}function zg(){return{id:In,type:"checkpoint",level:"N5",title:{ru:"Контрольная точка N5",en:"N5 checkpoint"},summary:{ru:"Повторение блока и переход к финальному тесту уровня.",en:"Review the block and move into the level final test."},durationMinutes:12}}function Jg(){return oi().map((e,t)=>({id:e,type:"lesson",level:"N5",title:{ru:`N5 · Урок ${t+1}`,en:`N5 · Lesson ${t+1}`},summary:t===0?{ru:"Первый интерактивный урок: 4 знака, чтения, примеры и мини-практика.",en:"First interactive lesson: 4 signs, readings, examples, and mini practice."}:{ru:"Откроем карточки урока прямо из учебника.",en:"Open this lesson directly from the textbook."},durationMinutes:t===0?12:10}))}function Ol(){const e=Bg(),t=Fg(),n=zg(),s=r.n5Textbook?.items?.length?r.n5Textbook.items.map((o,l)=>({id:o.id,type:"lesson",level:"N5",title:o.title,summary:o.goal||o.theme||{ru:"",en:""},durationMinutes:Number(o.durationMinutes||o.estimatedMinutes||10)})):Jg(),a=[e];return Ne()>0&&a.push(t),[...a,...s,n]}function Mn(e){const t=String(e||"");return t&&Ol().find(n=>n.id===t)||null}function Kl(e){if(!e)return"locked";if(e.id===An)return Ne()>0?"review":"available";const t=Tt();return t.completedNodes?.[e.id]?"completed":_n()===e.id?"current":t.unlockedNodes?.[e.id]?e.type==="checkpoint"?"checkpoint":"available":"locked"}function Ug(e){const t=V();return e==="completed"?t.completed:e==="current"?t.current:e==="available"?t.available:e==="review"?t.due:e==="checkpoint"?t.checkpoint:t.locked}function Bl(){const e=Tt(),t=Ne(),n=ci(),s=_n(),a=Mn(s),o=Number(yt().reviews||0)>=Number(r.progress.settings.dailyGoal||0);return!e.completedNodes?.[le]&&!n?{kind:"node",label:V().start,nodeId:le}:n?.nodeId?{kind:"node",label:V().resume,nodeId:n.nodeId}:t>0?{kind:"review",label:`${V().reviewAction}: ${t}`,nodeId:An}:o&&a?{kind:"node",label:V().next,nodeId:a.id}:a?{kind:"node",label:e.completedNodes?.[le]?V().resume:V().start,nodeId:a.id}:{kind:"review",label:V().reviewOld,nodeId:An}}function Gg(){const e=V(),t=o$(),n=t?.level||Nt(),s=t?.lessonId||bo(n),a=jn(n),o=Ju(n);return{label:!!(t?.lessonId||a&&(Object.keys(a.completedLessons||{}).length>0||a.currentLessonId&&a.currentLessonId!==o))?e.resume:e.start,level:n,lessonId:s}}function qg(){const e=jt(),t=Ne(),n=V();return[{label:n.streak,value:r.progress.streak.current},{label:n.level,value:r.progress.level},{label:n.xp,value:`${e.current}/${e.next}`},{label:n.reviewQueue,value:t}]}function Hg(e){return`
    ...
    `}function Fl(){const e=_n();return{title:Dl(e),summary:Kg(e)}}function A(e){const t=String(e);r.progress.cards[t]||(r.progress.cards[t]={state:"New",intervalDays:0,srsStep:-1,easeFactor:2.5,dueAt:null,lastReviewedAt:null,lastRating:null,reviews:0,lapses:0,correct:0,wrong:0,stage:"new",lastReview:null,nextReview:null,reviewCount:0,successRate:0,history:[]});const n=r.progress.cards[t];return n.stage||=Zs(n.state),n.lastReview||=n.lastReviewedAt||null,n.nextReview||=n.dueAt||null,n.reviewCount||=n.reviews||0,n.successRate=Lo(n),n.state=Yu(n.stage),n.dueAt=n.nextReview,n.lastReviewedAt=n.lastReview,Number.isFinite(Number(n.srsStep))?n.srsStep=Z(Math.trunc(Number(n.srsStep)),-1,63):n.srsStep=Nr(n),r.progress.cards[t]}function hs(e,t="seen"){if(!r.progress||!e?.id)return!1;Y();const n=new Date().toISOString();let s=!1;const a=String(e.id);return r.progress.seenCards[a]||(r.progress.seenCards[a]=n,s=!0),e.kanji&&!r.progress.seenKanji[e.kanji]&&(r.progress.seenKanji[e.kanji]={at:n,cardId:a,source:t,jlpt:e.jlpt||""},s=!0),s}function vs(e,t="seen"){hs(e,t)&&N()}const We=[5/1440,1/24,12/24,1,2,4],di=1;function Nr(e){const t=Number(e?.intervalDays||0);if(!(t>0))return-1;for(let s=0;s<We.length;s+=1)if(t<=We[s]*1.08)return s;const n=We[We.length-1];return We.length-1+Math.max(1,Math.round(Math.log2(t/n)))}function ws(e){const t=Math.trunc(e);return t<0?0:t<We.length?We[t]||We[0]:We[We.length-1]*2**(t-(We.length-1))}function Vg(e,t,n=di){const s=Array.isArray(e)?e.slice():[],a=Array.isArray(t)?t.slice():[],o=[],l=Math.max(1,Math.trunc(Number(n)||di));let c=0,d=0,u=0;for(;c<s.length||d<a.length;){if(u>=l&&d<a.length){o.push(a[d++]),u=0;continue}if(c<s.length){o.push(s[c++]),u+=1;continue}if(d<a.length){o.push(a[d++]),u=0;continue}break}return o}function Yg(e,t){const n=Nr(e);return t==="again"?0:t==="hard"?n<1?1:n:t==="easy"?n<0?2:n+2:n<0?0:n+1}function Zg(e){const t=Math.max(1,Math.round(e*24*60));if(t<60)return p()==="ru"?`${t} мин.`:`${t} min`;const n=Math.round(t/60);if(n<24)return p()==="ru"?`${n} ?.`:`${n} h`;const s=Math.round(n/24);return p()==="ru"?`${s} ??.`:`${s} d`}function xr(e){const t=e.state==="Learning"?3:e.state==="Review"?2:e.state==="Mastered"?1:0,n=Number(e.lapses||0),s=Number(e.wrong||0),a=Number(e.correct||0);return t+n*4+s*2-a*.05}function Rt(e,t,n="jlpt_lesson"){if(!t)return!1;const a=zl(e,t).reduce((o,l)=>hs(l,n)||o,!1);return a&&N(),a}function zl(e,t){const n=String(e||"").toUpperCase();return n==="N5"?Ot(t):n==="N4"?Ts(t):n==="N3"?_s(t):n==="N2"?Ps(t):(t?.kanji||[]).map(s=>r.cards.find(a=>a.kanji===s&&String(a.jlpt||"").toUpperCase()===n)).filter(Boolean)}function em(e){const t=r.progress?.cards?.[String(e?.id||"")];return t?t.state&&t.state!=="New"?!0:!!(t.lastReviewedAt||t.lastReview||Number(t.reviews||0)>0||Number(t.reviewCount||0)>0||Number(t.correct||0)>0||Number(t.wrong||0)>0||Number(t.lapses||0)>0):!1}function Jl(){return Y(),r.progress.evaRoomQuiz}function Ul(){const e=[r.cards||[],typeof lt=="function"?lt():[],typeof Re=="function"?Re():[],typeof Me=="function"?Me():[],typeof Ee=="function"?Ee():[]];return Gl(e.flat().filter(Boolean))}function tm(){if(!r.progress)return[];Y();const e=new Set(Object.keys(r.progress.seenCards||{})),t=new Set(Object.keys(r.progress.seenKanji||{})),n=new Set(Object.keys(r.progress.lessonCompletions||{})),s=nm(),a=Ul().filter(o=>{if(!o?.id||!o.kanji||!ye(o,"ru")||!ye(o,"en"))return!1;const l=String(o.jlpt||"").toUpperCase();return e.has(String(o.id))||t.has(o.kanji)||em(o)||n.has(o.lessonId)||s.has(`${l}:${o.kanji}`)||s.has(o.kanji)});return Gl(a)}function nm(){const e=new Set,t=(n,s)=>{if(!s)return;const a=String(n||"").toUpperCase();e.add(String(s)),a&&e.add(`${a}:${s}`)};return ui().forEach(n=>{const s=n.course();Object.keys(s.studiedKanji||{}).forEach(a=>t(n.level,a)),Object.keys(s.completedLessons||{}).forEach(a=>{(n.lessonById(a)?.kanji||[]).forEach(l=>t(n.level,l))})}),e}function ui(){return[{level:"N5",course:J,lessonById:Ze,markStudied:Fn,markDifficult:As},{level:"N4",course:P,lessonById:Kt,markStudied:zn,markDifficult:Rs},{level:"N3",course:_,lessonById:Ft,markStudied:Jn,markDifficult:Ms},{level:"N2",course:M,lessonById:Jt,markStudied:Un,markDifficult:Es}]}function Gl(e){const t=new Set;return e.filter(n=>{const s=`${n.kanji}:${ye(n,"ru")}:${ye(n,"en")}`;return t.has(s)?!1:(t.add(s),!0)})}function sm(e){if(e.target.classList?.contains("detail-backdrop")){C("menu_close"),r.detailCardId=null,Q();return}if(e.target.classList?.contains("final-test-backdrop")){r.finalTestModal=null,r.finalTestBusy=!1,Q();return}const t=e.target.closest(".nav-popover, .bottom-nav");if(r.navMenu&&!t&&!e.target.closest("[data-action]")){r.navMenu=null,Q();return}const n=e.target.closest("[data-action]");if(!n)return;const s=n.dataset.action,a=n.dataset.id;if(!(["eva-click","eva-autonomy-next","eva-question-answer"].includes(s)&&Date.now()-al<280)){if(s&&s.endsWith("-complete-lesson")){const l=`${s.split("-")[0]}:${a||""}`;if(ee.has(l)){n&&(n.disabled=!0,n.textContent=p()==="ru"?"Урок завершён":"Lesson completed");return}}if(pi(s),requestAnimationFrame(()=>window.setTimeout(()=>im(s,n),0)),s==="route"){const o=n.dataset.route;if(n.closest(".bottom-nav")&&Ir(o)){Im(o);return}r.navMenu=null,o==="writing"&&r.detailCardId&&(r.activeCardId=r.detailCardId),Te(o,n.dataset.focus||null,n.dataset.subroute||null)}if(s==="nav-menu-route"){const o=n.dataset.route;r.navMenu=null,o==="writing"&&r.detailCardId&&(r.activeCardId=r.detailCardId),Te(o,n.dataset.focus||null,n.dataset.subroute||null)}if(s==="share-page"&&Gu(n.dataset.shareSection||r.route,r$(n)).catch(()=>E(p()==="ru"?"Не удалось поделиться":"Share failed")),s==="toggle-header-socials"&&Wu(!No()),s==="notification-center"){if(r.notificationPromptVisible){ep();return}(r.notificationPrompt?.docked||La("header"))&&Aa("header");return}if(s==="repeat-onboarding"){hi({force:!0});return}if(s==="onboarding-next"){nc();return}if(s==="onboarding-prev"){sc();return}if(s==="onboarding-continue"){Cm();return}if(s==="onboarding-close"||s==="onboarding-skip"){ks({completed:s==="onboarding-close"});return}if(s==="dismiss-mascot-speech"){Zd(n.dataset.speechKey||"");return}if(s==="contact-email"&&(r.navMenu=null,r.contactModal=!0,Q()),s==="copy-contact-email"&&Xu(_a).then(o=>{E(o?p()==="ru"?"Email скопирован":"Email copied":p()==="ru"?"Не удалось скопировать email":"Could not copy email")}),s==="close-contact-modal"&&(r.contactModal=!1,Q()),s==="close-pwa-install-help"&&(r.pwaInstallHelpVisible=!1,Q()),s==="close-nav-menu"&&(r.navMenu=null,Q()),s==="close-final-test-modal"&&(r.finalTestModal=null,r.finalTestBusy=!1,r.pendingFocus=null,Q()),s==="final-test-focus-missing"){const o=n.dataset.focus||r.finalTestModal?.focusSelector||null;r.finalTestModal=null,r.finalTestBusy=!1,r.pendingFocus=o,Q()}if(s==="final-test-force-submit"){const o=String(n.dataset.level||r.finalTestModal?.level||"N5").toUpperCase();o==="N4"?id(!0):o==="N3"?wd(!0):o==="N2"?Id(!0):o==="N1"?submitN1FinalTest(!0):Xc(!0)}if(s==="final-test-next-level"){const o=F(n.dataset.nextLevel||""),l=String(n.dataset.nextLesson||"");if(!o||!l)return;r.finalTestModal=null,r.finalTestBusy=!1,r.pendingFocus=null,ka(o,l);return}if(s==="scroll-page-edge"&&((n.dataset.direction||vi())==="up"?Ar():Lm()),s==="theme"&&N$(),s==="language"&&x$(),s==="sound"&&Qu(),s==="toggle-ux-sound"&&C$(),s==="export"&&s$(),s==="import"&&il.click(),s==="reset"&&S$(),s==="share-achievement"&&v$().catch(()=>E(S("shareFallback"))),s==="pwa-install"&&Y$(),s==="pwa-later"&&_o(),s==="notification-allow"&&sj(),s==="notification-later"&&Ia(),s==="mascot-click"&&ey(n.dataset.character),s==="eva-click"&&ru(),s==="eva-dialogue-skip"&&am(n),s==="dictionary-favorites-tab"&&(r.filters.favorites=n.dataset.favorites||"all",r.dictionaryVisibleCount=ls,Q()),s==="set-learn-jlpt"){r.activeLearnJlpt=String(n.dataset.jlpt||"all").toUpperCase();const o=Li();Ic(o),r.activeCardId=null,Q()}if(s==="dictionary-load-more"&&(r.dictionaryVisibleCount+=wp,Q()),s==="toggle-favorite"&&Py(a),s==="eva-room-choice"&&Kf(n),s==="eva-question-answer"&&If(n),s==="eva-room-reset"&&Ff(),s==="toggle-eva-autonomy"&&Wf(),s==="cycle-eva-autonomy"&&Vf(),s==="eva-autonomy-room-mode"&&Yf(),s==="eva-autonomy-outfit-mode"&&Zf(),s==="eva-autonomy-next"&&Lc(),s==="eva-autonomy-clear"&&eh(),s==="eva-room-shop-open"&&(r.evaRoomShopOpen=!0,de("shop_opened"),Q()),s==="eva-room-shop-close"&&(r.evaRoomShopOpen=!1,Q()),s==="eva-bg-buy"&&zf(a),s==="eva-bg-select"&&Jf(a),s==="eva-sprite-buy"&&Uf(a),s==="eva-sprite-select"&&Gf(a),s==="shop-category"&&(r.shopFilters.category=n.dataset.category||"all",Q()),s==="shop-filter"&&(r.shopFilters.view=n.dataset.filter||"all",Q()),s==="shop-sort"&&(r.shopFilters.sort=n.dataset.sort||"featured",Q()),s==="shop-buy"&&Br(a),s==="shop-select"&&Fr(a),s==="shop-clear-effect"&&Cc(a),s==="shop-clear-item"&&Xf(a),s==="clear-writing"&&uy(),s==="undo-writing"&&py(),s==="check-writing"&&gy(!0),s==="replay-writing"&&cu(),s==="play-writing-step"&&du(),s==="writing-step-prev"&&uu(-1),s==="writing-step-next"&&uu(1),s==="select-writing-step"&&pu(Number(n.dataset.index||0),!0),s==="insert-sentence-tile"&&Kb(Number(n.dataset.index)),s==="undo-sentence-tile"&&Bb(),s==="clear-sentence"&&Fb(),s==="check-sentence"&&zb(),s==="next-sentence"&&Ub(),s==="reading-review-tile"&&qh(Number(n.dataset.index)),s==="reading-review-undo"&&Hh(),s==="reading-review-clear"&&Xh(),s==="reading-review-check"&&Uc(),s==="reading-review-answer"&&Gh(n),s==="toggle-reading-translation"&&Qh(),s==="add-custom-sentence"&&Sb(),s==="edit-custom-sentence"&&xb(n.dataset.id),s==="delete-custom-sentence"&&Cb(n.dataset.id),s==="cancel-custom-sentence-edit"&&Lb(),s==="insert-jlpt-tile"&&Yy(Number(n.dataset.index)),s==="undo-jlpt-tile"&&Zy(),s==="clear-jlpt-practice"&&e$(),s==="check-jlpt-practice"&&t$(),s==="next-jlpt-practice"&&n$(),s==="n5-open-lesson"&&tv(a),s==="n5-overview"&&nv(),s==="n5-review"&&sv(n.dataset.mode||null),s==="n5-answer"&&Wh(n),s==="n5-check-input"&&Vh(a),s==="n5-srs"&&qc(a,n.dataset.rating||"good",n.dataset.source||"review"),s==="n5-writing-done"&&Zh(a),s==="n5-complete-lesson"&&ev(a),s==="jlpt-lesson-answer"&&Yh(n.dataset.level||"",n.dataset.lesson||n.dataset.lessonId||"",n.dataset.card||a,String(n.dataset.value||"")==="remember"),s==="n5-final-answer"&&iv(n),s==="n5-final-submit"&&Xc(),s==="n5-final-reset"&&ov(),s==="n4-open-lesson"&&Rv(a),s==="n4-overview"&&_v(),s==="n4-review"&&Mv(n.dataset.mode||null),s==="n4-kanji"&&Pv(),s==="n4-grammar"&&Ev(),s==="n4-reading"&&Dv(),s==="n4-listening"&&Ov(),s==="n4-final"&&Kv(),s==="n4-answer"&&Nv(n),s==="n4-check-input"&&xv(a),s==="n4-srs"&&sd(a,n.dataset.rating||"good",n.dataset.source||"review"),s==="n4-writing-done"&&Cv(a),s==="n4-complete-lesson"&&Lv(a),s==="n4-grammar-complete"&&Av(a,n.dataset.value||""),s==="n4-reading-complete"&&Iv(a,n.dataset.question||"",n.dataset.value||""),s==="n4-listening-complete"&&Tv(a,n.dataset.question||"",n.dataset.value||""),s==="n4-final-answer"&&zv(n),s==="n4-final-submit"&&id(),s==="n4-final-reset"&&Jv(),s==="n3-open-lesson"&&fw(a),s==="n3-overview"&&hw(),s==="n3-review"&&vw(n.dataset.mode||null),s==="n3-kanji"&&ww(),s==="n3-grammar"&&bw(),s==="n3-reading"&&kw(),s==="n3-listening"&&yw(),s==="n3-final"&&$w(),s==="n3-answer"&&lw(n),s==="n3-check-input"&&cw(a),s==="n3-srs"&&fd(a,n.dataset.rating||"good",n.dataset.source||"review"),s==="n3-writing-done"&&dw(a),s==="n3-complete-lesson"&&uw(a),s==="n3-grammar-complete"&&pw(a,n.dataset.value||""),s==="n3-reading-complete"&&gw(a,n.dataset.question||"",n.dataset.value||""),s==="n3-listening-complete"&&mw(a,n.dataset.question||"",n.dataset.value||""),s==="n3-final-answer"&&Nw(n),s==="n3-final-submit"&&wd(),s==="n3-final-reset"&&xw(),s==="n2-open-lesson"&&Yw(a),s==="n2-overview"&&Zw(),s==="n2-review"&&eb(n.dataset.mode||null),s==="n2-kanji"&&tb(),s==="n2-grammar"&&nb(),s==="n2-reading"&&sb(),s==="n2-listening"&&rb(),s==="n2-final"&&ab(),s==="n2-answer"&&Gw(n),s==="n2-check-input"&&qw(a),s==="n2-srs"&&Cd(a,n.dataset.rating||"good",n.dataset.source||"review"),s==="n2-writing-done"&&Hw(a),s==="n2-complete-lesson"&&Xw(a),s==="n2-grammar-complete"&&Qw(a,n.dataset.value||""),s==="n2-reading-complete"&&Ww(a,n.dataset.question||"",n.dataset.value||""),s==="n2-listening-complete"&&Vw(a,n.dataset.question||"",n.dataset.value||""),s==="n2-final-answer"&&lb(n),s==="n2-final-submit"&&Id(),s==="n2-final-reset"&&cb(),s==="review-exercise-next"){sa(),r.pendingFocus="__scroll-top__",j();return}if(s==="play-kanji-audio"){const o=X(a)||X(r.activeCardId);o&&Eu(o)}if(s==="open-jlpt-lesson"){const o=String(n.dataset.jlpt||"").toUpperCase();if(Yt(o)){if(!qe(o)){r.activeTextbookLevel=o,r.activeJlptLesson=o,Te("textbooks",null,o),E($t(o));return}r.activeJlptLesson=o,Te("jlpt-lesson",null,o)}}if(s==="open-jlpt-lesson-start"&&ka(n.dataset.jlpt||Nt()),s==="social-link"&&Zt(`social_${String(n.dataset.network||"").toLowerCase()}_opened`,{network:n.dataset.network||"",section:r.route}),s==="play-audio"&&Hy(n.dataset.audio,n.dataset.label),s==="close-reward"&&(r.rewardModal=r.rewardQueue.shift()||null,r.rewardModal&&iu(r.rewardModal),j()),s==="set-goal"&&(r.progress.settings.dailyGoal=Number(n.dataset.goal),N(),E(`${S("dailyGoal")}: ${r.progress.settings.dailyGoal}`),j()),s==="buy-shop"&&Br(a),s==="start-due"&&(Te("textbooks"),Ne()||E($e("eva","welcome"))),s==="home-lesson"){const o=F(n.dataset.level||"")||Nt(),l=String(n.dataset.lessonId||"");ka(o,l)}if(s==="home-review"&&(Ne()?Te("review"):E(p()==="ru"?"Пока нет повторений.":"No reviews are due right now.")),s==="home-primary"&&lh(),s==="learning-path-node"&&Tc(n.dataset.node||a),s==="learning-path-back"&&fn(),s==="learning-path-choice"){const o=String(n.dataset.node||""),l=String(n.dataset.step||""),c=String(n.dataset.value||""),d=Ss(o),u=d.steps.find(m=>m.id===l);if(!u||u.kind!=="quiz"||d.session.answers?.[l])return;d.session.answers[l]={selected:c,correct:c===u.answer,at:new Date().toISOString()},c===u.answer?d.session.score=Number(d.session.score||0)+1:d.session.mistakes=[...new Set([...d.session.mistakes||[],l])],d.session.updatedAt=new Date().toISOString(),N(),j()}if(s==="learning-path-step-next"){const o=String(n.dataset.node||r.activeLearnNodeId||""),l=Ss(o);if(!l.steps.length)return;const c=l.steps[l.session.stepIndex];if(c?.kind==="quiz"&&!l.session.answers?.[c.id])return;l.session.stepIndex=Math.min(l.session.stepIndex+1,l.steps.length),l.session.updatedAt=new Date().toISOString(),N(),j()}if(s==="learning-path-retry"){const o=String(n.dataset.node||r.activeLearnNodeId||""),c=(Ss(o).session.mistakes||[]).slice();Tt().activeSession=Ya({nodeId:o,mode:"mistakes",stepIndex:0,answers:{},mistakes:[],reviewStepIds:c,score:0,startedAt:new Date().toISOString(),updatedAt:new Date().toISOString()}),N(),j()}if(s==="learning-path-continue"){const o=String(n.dataset.node||r.activeLearnNodeId||""),l=Ss(o);gh(o,l.session,l.steps),fn();return}if(s==="start-lesson"||s==="select-lesson"){const o=r.lessons.find(l=>l.id===a);if(!o||!ke(o)){E(`${S("unlockedAt")} ${va(o)}`);return}if(r.activeLessonId=a,r.activeCardId=null,r.revealed=!1,gt(),s==="start-lesson"){de("lesson_start",{lessonId:a,jlpt:o.jlpt});const l=String(o.jlpt||"").toUpperCase();/^n[2-5]-lesson-\d+$/i.test(o.id)&&["N5","N4","N3","N2"].includes(l)?(Te("textbooks",null,l),r.activeTextbookSubroute=o.id,history.replaceState(null,"",`#textbooks/${encodeURIComponent(l)}/${encodeURIComponent(o.id)}`),j()):fn(sn,o.id)}else j()}if(s==="show-answer"&&(vs(X(r.activeCardId),"show_answer"),r.revealed=!0,gt(),j()),s==="check-reading"){const o=document.getElementById(`readingCheck-${a||r.activeCardId}`);o&&(r.readingCheck.value=o.value,r.readingCheck.cardId=a||r.activeCardId),ju()}if(s==="rate"&&Xk(n.dataset.rating),s==="open-card"&&(vs(X(a),"card_details"),r.detailCardId=a,j()),s==="open-kanji-page"&&dm(a),s==="close-detail"&&(r.detailCardId=null,Q()),s==="study-card"){const o=X(a);if(!o)return;vs(o,"study_card"),r.activeLessonId=o.lessonId,r.activeCardId=o.id,r.revealed=!1,gt(o.id),r.detailCardId=null,fn(sn,o.lessonId)}}}function rm(e){const t=e.target.closest?.('[data-action="eva-click"], [data-action="eva-autonomy-next"]');if(!t||t.disabled)return;const n=t.dataset.action;al=Date.now(),e.preventDefault(),pi(n),n==="eva-click"&&ru(),n==="eva-autonomy-next"&&Lc()}function pi(e="activity"){r.evaRuntime&&(r.evaRuntime.lastPlayerActionAt=Date.now(),r.evaRuntime.memory=gn(vt(),r.evaRuntime.memory||{}),r.evaRuntime.memory.lastRoute=r.route,e.startsWith("eva")&&(r.evaRuntime.memory.lastInteractionDate=W()),["eva-autonomy-next","eva-question-answer"].includes(e)&&(r.evaRuntime.lastPlayerActionAt=Date.now()))}function am(e){if(!r.evaRuntime)return;const t=e?.dataset?.lineId||G().currentLine?.id||"";!t||r.evaRuntime.textRevealSkippedLineId===t||(r.evaRuntime.textRevealSkippedLineId=t,mn(),j())}function im(e,t){if(!(!e||t?.disabled)&&!om(e,t)&&!["eva-room-choice","eva-bg-buy","eva-bg-select"].includes(e)){if(e==="eva-room-shop-open"){C("menu_open");return}if(e==="eva-room-shop-close"){C("menu_close");return}if(e==="route"){if(t?.closest(".bottom-nav")&&Ir(t.dataset.route)){C(r.navMenu===t.dataset.route?"menu_close":"menu_open");return}C("tab_switch");return}if(e==="nav-menu-route"){C("tab_switch");return}if(e==="close-nav-menu"){C("menu_close");return}if(e==="toggle-header-socials"){C(No()?"menu_close":"menu_open");return}if(e==="show-answer"||e==="open-card"){C("card_flip");return}if(["close-reward","close-detail","close-pwa-install-help","pwa-later","notification-later","dismiss-mascot-speech"].includes(e)){C("menu_close");return}if(e==="notification-center"){C("notification_soft");return}if(["start-lesson","select-lesson","next-sentence","study-card","rate","open-jlpt-lesson","n5-open-lesson","n5-overview","n5-review","n4-open-lesson","n4-overview","n4-review","n4-kanji","n4-grammar","n4-reading","n4-listening","n4-final","n3-open-lesson","n3-overview","n3-review","n3-kanji","n3-grammar","n3-reading","n3-listening","n3-final","n2-open-lesson","n2-overview","n2-review","n2-kanji","n2-grammar","n2-reading","n2-listening","n2-final"].includes(e)){C("page_turn");return}if(["n5-answer","n5-check-input","n5-srs","n5-writing-done","n5-complete-lesson","n5-final-answer","n5-final-submit","n4-answer","n4-check-input","n4-srs","n4-writing-done","n4-complete-lesson","n4-grammar-complete","n4-reading-complete","n4-listening-complete","n4-final-answer","n4-final-submit","n3-answer","n3-check-input","n3-srs","n3-writing-done","n3-complete-lesson","n3-grammar-complete","n3-reading-complete","n3-listening-complete","n3-final-answer","n3-final-submit","n2-answer","n2-check-input","n2-srs","n2-writing-done","n2-complete-lesson","n2-grammar-complete","n2-reading-complete","n2-listening-complete","n2-final-answer","n2-final-submit","n1-answer","n1-check-input","n1-srs","n1-writing-done","n1-complete-lesson","n1-grammar-complete","n1-reading-complete","n1-listening-complete","n1-final-answer","n1-final-submit","jlpt-lesson-answer"].includes(e)){C("button_click");return}if(["pwa-install","notification-allow","notification-center","set-goal"].includes(e)){C("notification_soft");return}t?.matches("button, .btn, [role='button']")&&C("button_click"),e!=="toggle-header-socials"&&Wu(!1)}}function om(e,t){return["learn","review"].includes(r.route)?new Set(["show-answer","rate","check-reading","play-kanji-audio","start-lesson","select-lesson","study-card"]).has(e)||!!t?.closest(".study-card, .study-layout"):!1}function ql(e){pi("input");const t=e.target.closest("[data-ux-volume]");if(t){R$(Number(t.value)/100);const c=document.querySelector("[data-ux-volume-label]");c&&(c.textContent=`${Math.round(Sa()*100)}%`);return}const n=e.target.closest("[data-reading-input]");if(n){r.readingCheck={cardId:n.dataset.id||r.activeCardId,value:n.value,status:null,message:""};return}const s=e.target.closest("[data-sentence-draft]");if(s){const c=fe(),d=s.dataset.sentenceDraft;c.customDraft=$r(c.customDraft||{}),d&&Object.prototype.hasOwnProperty.call(c.customDraft,d)&&(c.customDraft[d]=s.value,c.customMessage="",c.customStatus="",N());return}const a=e.target.closest("[data-filter]");if(!a)return;const o=a.dataset.filter,l=a.selectionStart;r.filters[o]=a.value,r.dictionaryVisibleCount=ls,j(),requestAnimationFrame(()=>{const c=document.getElementById(a.id);c&&(c.focus(),typeof l=="number"&&"setSelectionRange"in c&&c.setSelectionRange(l,l))})}function lm(e){if(Nm(e)||cm(e))return;if(e.key==="Escape"&&(r.detailCardId||r.rewardModal||r.finalTestModal||r.contactModal||r.pwaInstallHelpVisible||r.navMenu)){r.detailCardId=null,r.rewardModal=null,r.finalTestModal=null,r.contactModal=!1,r.pwaInstallHelpVisible=!1,r.navMenu=null,j();return}const t=e.target.closest?.("[data-reading-input]");!t||e.key!=="Enter"||(e.preventDefault(),r.readingCheck.value=t.value,r.readingCheck.cardId=t.dataset.id||r.activeCardId,ju())}function cm(e){return e.target?.closest?.("input, textarea, select, [contenteditable='true']")||e.ctrlKey||e.metaKey||e.altKey||e.key.length!==1||(fr=`${fr}${e.key.toLowerCase()}`.slice(-Uo.length),fr!==Uo)?!1:(fr="",Hl(5e3),!0)}function Hl(e=5e3){const t=Math.max(1,Math.min(999999,Math.floor(Number(e)||5e3)));return r.progress?(O(0,t,"cheat:moon_farm"),U(),N(),C("moon_fragment_gain"),E(p()==="ru"?`Чит активирован: +${t} Moon`:`Cheat activated: +${t} Moon`),j(),r.progress.moonFragments):0}function fn(e=cs,t=null,n=null){r.route="learn",r.activeLearnView=e,r.activeLearnNodeId=e===Lt&&String(t||"")||null,r.activeLearnLegacyLessonId=e===sn&&String(t||"")||null;const s=e===Lt&&t?`#learn/lesson/${encodeURIComponent(String(t))}`:e===sn&&t?`#learn/legacy/${encodeURIComponent(String(t))}`:"#learn";location.hash!==s&&history.replaceState(null,"",s),r.activeTextbookLevel=null,r.activeTextbookSubroute=null,r.kanjiPageId=null,r.detailCardId=null,r.revealed=!1,r.navMenu=null,r.finalTestModal=null,r.finalTestBusy=!1,r.contactModal=!1,r.pendingFocus=n,r.evaRoomShopOpen=!1,gt(),Mt(),Q()}function Te(e,t=null,n=null){if(e==="learn"){fn(cs,null,t);return}if(r.route=Vo.includes(e)?e:"home",r.route==="textbooks"?(r.activeTextbookLevel=n?String(n).toUpperCase():null,r.activeTextbookSubroute=null):r.route==="jlpt-lesson"?r.activeJlptLesson=n?String(n).toUpperCase():r.activeJlptLesson||zo()||null:(r.activeTextbookLevel=null,r.activeTextbookSubroute=null),r.route!=="review"&&sa(),r.route==="textbooks"){const s=lp(r.activeTextbookLevel||"",r.activeTextbookSubroute||"");`${location.pathname}${location.search||""}`!==s&&history.replaceState(null,"",s)}else{const s=r.route==="learn"?"#learn":r.route==="jlpt-lesson"&&r.activeJlptLesson?`#jlpt-lesson/${encodeURIComponent(r.activeJlptLesson)}`:`#${r.route}`;location.hash!==s&&history.replaceState(null,"",s)}r.route!=="kanji"&&(r.kanjiPageId=null),r.detailCardId=null,r.revealed=!1,r.navMenu=null,r.finalTestModal=null,r.finalTestBusy=!1,r.contactModal=!1,r.pendingFocus=t,r.route!=="eva-room"&&(r.evaRoomShopOpen=!1),gt(),Mt(),Q(),r.route==="eva-room"&&de("room_opened")}function dm(e){const t=X(e);if(!t)return;r.route="kanji",r.kanjiPageId=t.id,r.detailCardId=null,r.revealed=!1,r.navMenu=null,r.pendingFocus=null,r.finalTestModal=null,r.finalTestBusy=!1,r.contactModal=!1,r.evaRoomShopOpen=!1,gt();const n=`#kanji/${encodeURIComponent(t.id)}`;location.hash!==n&&history.replaceState(null,"",n),Mt(),Q()}function um(){ur=!0,pr=null,Sy();try{Km();let e="";r.route==="home"&&(e=Fm()),r.route==="about"&&(e=Em()),r.route==="learn"&&(e=oh(),r.pendingFocus!=="lesson-tabs"&&requestAnimationFrame(fo)),r.route==="review"&&(e=hb(),r.pendingFocus!=="sentence-practice"&&requestAnimationFrame(fo)),r.route==="dictionary"&&(e=ok()),r.route==="kanji"&&(e=pk()),r.route==="writing"&&(e=Ik(),requestAnimationFrame(oy)),r.route==="stats"&&(e=_k(),requestAnimationFrame(ou)),r.route==="achievements"&&(e=Ek()),r.route==="eva-room"&&(e=qm()),r.route==="jlpt-lesson"&&(e=hh()),r.route==="textbooks"&&(e=vh()),cn.innerHTML=`${e}${Mm()}${pm()}`,document.body.classList.toggle("modal-open",!!(r.detailCardId||r.rewardModal||r.finalTestModal||r.contactModal||r.pwaInstallHelpVisible)),qk(),requestAnimationFrame(()=>{Om(),wi(),$m()})}finally{ur=!1}}function Q(){Ma||(Ma=requestAnimationFrame(()=>{Ma=0,um()}))}function j(){Q()}function pm(){const e=`${Dm()}${Rk()}${Kk()}${Xb()}${Bk()}${Fk()}${zk()}${Jk()}${Am()}`;return e?`<div class="modal-layer">${e}</div>`:""}function Xl(){return te?.isConnected?te:document.body?(te||(te=document.createElement("div"),te.className="flash-kanji-onboarding-root",te.setAttribute("role","presentation"),te.setAttribute("aria-hidden","false")),te.isConnected||document.body.appendChild(te),te):null}const gi=[{target:null,title:{ru:"Добро пожаловать",en:"Welcome"},text:{ru:"Привет! Я Ева. Быстро покажу, где что находится и как пользоваться Flash Kanji.",en:"Hi! I am Eva. I will quickly show you where everything is and how Flash Kanji works."}},{target:"[data-tour='home-lesson']",title:{ru:"Учебники",en:"Textbooks"},text:{ru:"Это главный вход в Flash Kanji. Здесь открываются учебники N5-N1 и путь к урокам каждого уровня.",en:"This is the main entrance to Flash Kanji. Open N5-N1 textbooks here and continue into each level's lessons."}},{target:"[data-tour='srs-review']",title:{ru:"Повторение",en:"Review"},text:{ru:"Изученные карточки возвращаются в повторение, чтобы закрепляться в памяти.",en:"Learned cards come back here for spaced repetition so they stay in memory."}},{target:"[data-tour='dictionary']",title:{ru:"Словарь",en:"Dictionary"},text:{ru:"В словаре можно посмотреть значения, чтения, примеры и подробности по каждому кандзи.",en:"The dictionary lets you check meanings, readings, examples, and kanji details."}},{target:["[data-tour='eva-room']","[data-tour='profile-progress']","[data-tour='profile-progress-nav']"],title:{ru:"Комната Евы",en:"Eva room"},text:e=>e?.dataset?.tour==="eva-room"?{ru:"Это моя комната. Здесь можно поговорить со мной, менять облик и тратить Moon Fragments.",en:"This is my room. You can talk to me here, change the look, and spend Moon Fragments."}:{ru:"Если комнаты Евы на этой странице нет, посмотри на стрик и статистику.",en:"If Eva Room is not on this page, check the streak and progress stats instead."}}],Cr={title:{ru:"Готово!",en:"All set!"},text:{ru:"Открой учебники и начни с N5. Я рядом.",en:"Open the textbooks and start with N5. I will be right here."},start:{ru:"Открыть учебники",en:"Open textbooks"},close:{ru:"Закрыть",en:"Close"}};function Ql(){try{return localStorage.getItem(Ho)==="true"}catch{return!1}}function gm(){try{return localStorage.getItem(Qo)||""}catch{return""}}function Lr(e){try{localStorage.setItem(Qo,e)}catch{}}function mm(e=r.progress){return e?Number(e.appOpens||0)>0||Object.keys(e.lessonCompletions||{}).length>0||Object.keys(e.cards||{}).length>0||Object.keys(e.seenKanji||{}).length>0||Object.keys(e.daily||{}).length>0||Object.keys(e.favorites||{}).length>0||Object.keys(e.transactions||{}).length>0||Number(e.totalMoonFragmentsEarned||0)>0||Number(e.secrets?.evaClicks||0)>0||(e.secrets?.nightVisit?1:0)>0||Number(e.visits?.streak||0)>0||Number(e.visits?.bestStreak||0)>0:!1}function fm(e=!1){const t=gm();return t==="returning"||t==="completed"?t:Ql()?(Lr("completed"),"completed"):e?(Lr("returning"),"returning"):(Lr("new"),"new")}function Wl(){return!Ql()}function hm(){try{localStorage.getItem(Xo)==="true"&&localStorage.removeItem(Xo)}catch{}}function vm(){try{localStorage.setItem(Ho,"true"),Lr("completed")}catch{}}function Vl(){return Xe}function bs(){return gi.length}function mi(){return gi[Z(st,0,bs()-1)]||gi[0]}function wm(e=mi()){return e?.target?Array.isArray(e.target)?e.target:[e.target]:[]}function bm(e){if(!(e instanceof HTMLElement))return!1;const t=window.getComputedStyle(e);return t.display==="none"||t.visibility==="hidden"||Number(t.opacity||"1")<=0?!1:e.getClientRects().length>0}function Yl(e=mi()){for(const t of wm(e)){const s=Array.from(document.querySelectorAll(t)).find(a=>bm(a));if(s)return s}return null}function Zl(e,t=null){return typeof e=="function"?Zl(e(t),t):h(e||{ru:"",en:""})}function km(){return typeof window.matchMedia=="function"&&window.matchMedia("(prefers-reduced-motion: reduce)").matches}function ym(){return!(Xe||!r.progress||!r.i18n||!r.lessons.length||!document.body||document.visibilityState!=="visible"||r.detailCardId||r.rewardModal||r.finalTestModal||r.contactModal||r.navMenu)}function fi(e=!1,t=hp){clearTimeout(Tn),!(!e&&!Wl())&&(Tn=window.setTimeout(()=>{Tn=0,hi({force:e})},t))}function hi(e={}){const t=!!e.force;let n=!1;if(Xe){if(!t)return!0;ks({completed:!1,silent:!0})}if(!t&&!Wl())return!1;if(!ym())return fi(t,Wo),!1;clearTimeout(Tn);try{Oa=document.activeElement instanceof HTMLElement?document.activeElement:null,Xe=!0,ae="step",st=0,document.body.classList.add("onboarding-open");const s=document.querySelector(".app-shell");if(s){s.setAttribute("aria-hidden","true");try{s.inert=!0}catch{}}return Xl(),Pn(),ec(),n=!0,window.addEventListener("scroll",_t,{passive:!0}),window.addEventListener("resize",_t),window.addEventListener("orientationchange",_t),_t(),tc(),!0}catch(s){return console.error("Flash Kanji onboarding failed to start.",s),ks({completed:!1,silent:!0}),n||fi(t,Wo),!1}}function ks(e={}){const{completed:t=!0,silent:n=!1,routeTo:s=null}=e;clearTimeout(Tn),Tn=0,cancelAnimationFrame(us),us=0,window.removeEventListener("scroll",_t),window.removeEventListener("resize",_t),window.removeEventListener("orientationchange",_t),rt&&rt.classList.remove("is-onboarding-target"),rt=null,Xe=!1,ae="step",st=0,te&&(te.remove(),te=null,Ie=null,pe=null),document.body.classList.remove("onboarding-open");const a=document.querySelector(".app-shell");if(a){a.removeAttribute("aria-hidden");try{a.inert=!1}catch{}}t&&vm(),n||(s?Te(s):j()),Oa?.focus&&requestAnimationFrame(()=>{try{Oa.focus()}catch{}})}function Pn(){if(!Xl())return;const e=ae==="final"?null:mi(),t=ae==="final"?null:Yl(e),n=ae==="final"?Cr.title:e.title,s=ae==="final"?Cr.text:Zl(e.text,t),a=ae==="final"?p()==="ru"?"Готово":"Done":`${st+1} ${p()==="ru"?"из":"of"} ${bs()}`,o=h(n),l=h(s),c=aa("eva","calm","welcome"),d=bs();te.classList.toggle("is-final",ae==="final"),te.classList.toggle("has-target",!!t),te.dataset.view=ae;const u=ae==="final"?`
    ...
    `,Ie=ge("[data-onboarding-spotlight]",te),pe=ge(".flash-kanji-onboarding-dialog",te),rt&&rt!==t&&rt.classList.remove("is-onboarding-target"),rt=t||null,rt&&rt.classList.add("is-onboarding-target"),pe&&(pe.dataset.totalSteps=String(d)),_t()}function _t(){Xe&&(us||(us=requestAnimationFrame(()=>{us=0,ec()})))}function ec(){if(!Xe||!te||!pe)return;const e=ae==="final"?null:rt||Yl();km();const t=window.innerWidth,n=window.innerHeight;if(pe.style.maxWidth=`${Math.min(vp,Math.max(280,t-16))}px`,pe.style.maxHeight=`${Math.max(180,n-24)}px`,pe.style.left="50%",pe.style.top="50%",pe.style.transform="translate(-50%, -50%)",pe.dataset.placement="center",e){const s=e.isConnected?e.getBoundingClientRect():null;!!s&&s.top>=8&&s.bottom<=n-8&&s.left>=8&&s.right<=t-8&&Ie?(Ie.hidden=!1,Ie.style.left=`${Math.round(s.left-12)}px`,Ie.style.top=`${Math.round(s.top-12)}px`,Ie.style.width=`${Math.round(s.width+12*2)}px`,Ie.style.height=`${Math.round(s.height+12*2)}px`,Ie.style.borderRadius=`${Math.max(6,Math.round(parseFloat(getComputedStyle(e).borderRadius||"8")||8))}px`):Ie&&(Ie.hidden=!0)}else Ie&&(Ie.hidden=!0);te.style.visibility="visible",tc()}function $m(){Xe&&Pn()}function tc(){if(!pe)return;const e=pe.querySelector('[data-action="onboarding-next"], [data-action="onboarding-continue"], [data-action="onboarding-start"], [data-action="onboarding-prev"]'),t=pe.querySelectorAll("button"),n=e||t[0]||pe;try{n.focus?.()}catch{}}function jm(){return pe?Array.from(pe.querySelectorAll('button:not([disabled]), [href], [tabindex]:not([tabindex="-1"])')).filter(e=>e instanceof HTMLElement):[]}function Sm(e=1){const t=jm();if(!t.length)return;const n=document.activeElement,s=t.indexOf(n),a=s===-1?e>0?0:t.length-1:(s+e+t.length)%t.length;t[a]?.focus?.()}function Nm(e){return Xe?e.key==="Tab"?(e.preventDefault(),Sm(e.shiftKey?-1:1),!0):e.key==="Escape"?(e.preventDefault(),ks({completed:ae==="final"}),!0):e.key==="ArrowRight"?(e.preventDefault(),nc(),!0):e.key==="ArrowLeft"?(e.preventDefault(),sc(),!0):!1:!1}function nc(){if(!Xe)return;const e=bs()-1;if(ae!=="final"){if(st<e){st+=1,Pn();return}ae="final",Pn()}}function sc(){if(Xe){if(ae==="final"){ae="step",st=bs()-1,Pn();return}st>0&&(st-=1,Pn())}}function xm(e=null){ks({completed:!0,routeTo:e})}function Cm(){xm("textbooks")}function Ar(){if(typeof window>"u")return;const e=document.scrollingElement||document.documentElement;e&&(e.scrollTop=0),document.body&&(document.body.scrollTop=0),window.scrollTo({top:0,left:0,behavior:"auto"})}function Mt(){typeof window>"u"||requestAnimationFrame(()=>requestAnimationFrame(()=>Ar()))}function Lm(){if(typeof window>"u")return;const e=Math.max(0,document.documentElement.scrollHeight-window.innerHeight);window.scrollTo({top:e,behavior:"auto"})}function rc(){return typeof window>"u"||!document.documentElement?!1:document.documentElement.scrollHeight>window.innerHeight+24}function vi(){return rc()?window.scrollY>32?"up":"down":null}function Am(){const e=vi()||"down",t=rc()?"":" hidden",n=p()==="ru",s=e==="up"?n?"Наверх":"Scroll to top":n?"Вниз":"Scroll to bottom",a=e==="up"?"↑":"↓";return`
          ...
          <div class="site-footer-columns">
            ...
            <section class="site-footer-section">
              ...
              <div class="site-footer-socials" aria-label="${f(e?"Социальные ссылки":"Social links")}">
                <a class="btn ghost footer-social-link" href="${f(Go.youtube)}" target="_blank" rel="noopener noreferrer">
                  <span class="btn-icon" aria-hidden="true">${Uu("youtube")}</span>
                  <span>YouTube</span>
                </a>
                <a class="btn ghost footer-social-link" href="${f(Go.instagram)}" target="_blank" rel="noopener noreferrer">
                  <span class="btn-icon" aria-hidden="true">${Uu("instagram")}</span>
                  <span>Instagram</span>
                </a>
              </div>
            </section>
    ...
    `}function Dm(){const e=ac(r.navMenu);if(!e.length)return"";const t=r.navMenu,n=t?bi(t):"";return`
    ...
    `}function Om(){if(!r.pendingFocus)return;const e=r.pendingFocus;if(r.pendingFocus=null,e==="__scroll-top__"){Mt();return}const t={"lesson-card":".study-card, .daily-lesson-card","lesson-tabs":".lesson-tabs","review-card":"[data-section='review-card']","sentence-practice":"[data-section='sentence-practice']","writing-demo":"[data-section='writing-demo']","writing-canvas":"[data-section='writing-canvas']","eva-room":".eva-room-entry, .eva-room-page, .eva-room-shell",about:".about-page","stats-top":".metric-grid","achievements-top":".achievements-page .metric-grid","shop-panel":"[data-section='shop-panel']"},n=document.querySelector(t[e]||e);n&&(n.scrollIntoView({behavior:"smooth",block:"start"}),n.classList.add("is-focus-pulse"),window.setTimeout(()=>n.classList.remove("is-focus-pulse"),900))}function Km(){Ga(".nav-btn").forEach(t=>{const n=t.dataset.route,s=n===r.route||n==="learn"&&r.route==="textbooks"||n==="stats"&&r.route==="achievements"||n==="dictionary"&&r.route==="kanji";t.classList.toggle("is-active",s),t.classList.toggle("has-menu",!!t.closest(".bottom-nav")&&Ir(n)),t.setAttribute("aria-expanded",r.navMenu===n?"true":"false"),s?t.setAttribute("aria-current","page"):t.removeAttribute("aria-current");const a=t.querySelector("small");a&&n&&(a.textContent=bi(n))});const e=ge('[data-action="language"]');e&&(e.textContent=p().toUpperCase()),jo(),T$(),So(),Bm()}function Bm(){const e=ge("#sidebarProgressBar"),t=ge("#sidebarProgressLabel"),n=ge("#sidebarProgressPercent"),s=ge("#sidebarProgressNote"),a=ge("#sidebarUserAvatar"),o=ge("#sidebarUserTitle"),l=ge("#sidebarUserSubtitle"),c=jt(),d=Fl(),u=Ne(),m=Math.max(1,Number(r.progress?.level||1)),g=Math.max(0,Math.min(100,Math.round(c.percent||0)));e&&(e.max=100,e.value=g),t&&(t.textContent=`${p()==="ru"?"Уровень":"Level"} ${m}`),n&&(n.textContent=`${g}%`),s&&(s.textContent=u>0?`${u} ${V().reviewQueue} · ${d.title||V().mapHint}`:`${d.title||V().mapHint}${d.summary?` · ${d.summary}`:""}`),a&&(a.textContent=`N${m}`),o&&(o.textContent=(p()==="ru","Flash Kanji")),l&&(l.textContent=`${V().level} ${m} · ${r.progress?.streak?.current||0} ${V().streak}`)}function Fm(){r.n5Textbook?.items?.length||li();const e=zm(),t=Gg(),n=Ne(),s=Fl(),a=qg(),o=V(),l=jt(),c=Math.max(0,Math.min(100,Math.round(l.percent||0))),d=p()==="ru",u=d?[{action:"home-review",icon:"↻",title:"Повторение",detail:n>0?`${n} карточек ждут тебя.`:"Очередь пуста, но тренировка всегда под рукой.",count:n},{action:"home-lesson",icon:"文",title:t.label,detail:s.title||o.mapHint,count:r.progress.level,level:t.level,lessonId:t.lessonId||""},{action:"route",route:"eva-room",icon:"☾",title:"Комната Евы",detail:"Диалоги, фон и Moon Fragments.",count:r.progress.moonFragments}]:[{action:"home-review",icon:"↻",title:"Review",detail:n>0?`${n} cards are waiting.`:"The queue is empty, but practice is always ready.",count:n},{action:"home-lesson",icon:"文",title:t.label,detail:s.title||o.mapHint,count:r.progress.level,level:t.level,lessonId:t.lessonId||""},{action:"route",route:"eva-room",icon:"☾",title:"Eva Room",detail:"Dialogue, backgrounds, and Moon Fragments.",count:r.progress.moonFragments}],m=Zu();return`
    ...
    `}function zm(){Jm();const e=G(),t=e.currentLine||r.evaRuntime?.currentPhrase||null,n=Kr(),s=h(ss("eva").name||{ru:"Ева",en:"Eva"}),a=r.evaRuntime?.mood||e.mood||it().mood,o=r.evaRuntime?.emotion||e.emotion||t?.emotion||"calm",l=t?.state||r.evaRuntime?.presenceState||(n?"wait_choice":"speak"),c=Kn(t?.sprite||r.evaRuntime?.currentSkin||ki());return{line:t,question:n,speaker:s,mood:a,emotion:o,presenceState:l,sprite:c}}function Jm(){Y();const e=G();return e.currentLine?.text||r.evaRuntime?.currentPhrase?.text?e.currentLine||r.evaRuntime.currentPhrase:(Ac("manual"),G().currentLine||r.evaRuntime?.currentPhrase||null)}function Um(e){const t=Et(),n=Pt(),s=e.question?p()==="ru"?"Вопрос":"Question":p()==="ru"?"Диалог":"Dialogue",a=e.line||{text:{ru:"Я здесь.",en:"I'm here."}},o=a.id||"home_eva_line";return`
      <section class="home-eva-vn" role="region" aria-label="${f(p()==="ru"?"Диалог Евы":"Eva dialogue")}" data-home-eva-mode="${f(e.question?"question":"dialogue")}" data-eva-state="${f(e.presenceState)}" data-eva-mood="${f(e.mood)}" data-eva-emotion="${f(e.emotion)}">
        <div class="home-eva-copy">
          ...
          ${lc(h(a.text||{ru:"Я здесь.",en:"I'm here."}),o)}
          ${e.question?`
        ...
        <button class="home-eva-avatar" type="button" data-action="eva-click" data-character="eva" aria-label="${f(e.speaker)}">
          <img class="${f(oc({line:e.line,isAutonomy:!0}))}" src="${f(e.sprite)}" alt="${f(e.speaker)}" loading="eager" decoding="async" onerror="this.src='assets/mascots/eva_normal.webp'" />
        </button>
      </section>
    `}function ic(e){return e.line?.state||r.evaRuntime?.presenceState||(e.isAutonomy?"speak":"wait_choice")}function oc(e){const t=["eva-vn-sprite"],n=ic(e);return["speak","soften","warning"].includes(n)&&t.push("is-speaking"),(["react","warning"].includes(n)||Date.now()-Number(r.evaRuntime?.lastVisualChangeAt||0)<1400)&&t.push("is-reacting"),n==="quiet"&&t.push("is-quiet"),t.join(" ")}function Gm(e){const t=String(e||"").trim();return t?(t.match(/[^.!?гЂ'пјЃпјџ]+[.!?гЂ'пјЃпјџ]?/g)||[t]).map(s=>s.trim()).filter(Boolean):[]}function lc(e,t=""){const n=Gm(e),a=`eva-dialogue-text ${r.evaRuntime?.textRevealSkippedLineId===t?"is-skipped":""}`,o=n.length?n.map((l,c)=>`<span class="eva-line-piece" style="--i:${c}">${i(l)}</span>`).join(" "):i(e);return`<p class="${a}" data-action="eva-dialogue-skip" data-line-id="${f(t)}">${o}</p>`}function qm(){Y(),ys(),Cs(),U();const e=Of(),t=e.node,n=wt()||e.bg||Dn(t.background),s=e.sprite||e.spriteSrc||Kn(e.spriteId||Dt(t.sprite)),a=Et(),o=Pt(),l=Array.isArray(t.choices)?t.choices:[],c=ic(e),d=e.line?.id||t.id||"eva_dialogue";return`
      <section class="page eva-room-page">
        ...
        <article class="eva-vn-scene ${e.isAutonomy?"is-autonomous":""} is-${f(c)}" data-eva-state="${f(c)}" data-eva-mood="${f(e.mood||it().mood)}" data-eva-emotion="${f(e.emotion||"calm")}" style="--eva-bg:url('${f(n.file)}')">
          ...
          <button class="eva-sprite-button" type="button" data-action="eva-click" aria-label="${f(h(t.speaker||{ru:"Ева",en:"Eva"}))}">
            <img class="${f(oc(e))}" src="${f(s)}" alt="${f(h(t.speaker||{ru:"Ева",en:"Eva"}))}" onerror="this.src='assets/mascots/eva_normal.webp'" />
          </button>
          ${Xm(e)}
        ...
        ${r.evaRoomShopOpen?Hm():""}
      </section>
    `}function Hm(){const e=Et();return`
      <aside class="eva-shop-panel customization-shop-panel" role="dialog" aria-label="${f(e.shop)}">
        ${cc({closable:!0})}
      </aside>
    `}function Xm(e={}){const t=Qm(e);return t?`
      <div class="eva-room-decoration deco-${f(t.id)}" aria-label="${f(Ve(t))}">
        <img src="${f(t.asset||t.preview)}" alt="" loading="lazy" />
      </div>
    `:""}function Qm(e={}){const t=e.decoration||G().currentDecoration||r.customization?.selected?.decoration||r.customization?.selected?.frame,n=ne(t);return!n||n.type!=="decoration"||!ot(n.id)?null:n}function cc(e={}){const t=En(),n=Zm(),s=Oe().filter(a=>ot(a.id)).length;return`
      <div class="custom-shop">
        ...
        <div class="custom-shop-grid">
          ${n.map(ef).join("")||`<article class="empty-state"><h3>${i(t.empty)}</h3></article>`}
        </div>
        <div class="custom-shop-history">
          ${Wd({limit:6})}
        </div>
      </div>
    `}function Wm(){return r.customizationCatalog?.categories?.length?r.customizationCatalog.categories:[{id:"all",title_ru:"Все",title_en:"All"},{id:"background",title_ru:"Фоны",title_en:"Backgrounds"},{id:"outfit",title_ru:"Образы",title_en:"Outfits"},{id:"decoration",title_ru:"Декор",title_en:"Decorations"},{id:"theme",title_ru:"Темы",title_en:"Themes"},{id:"effect",title_ru:"Эффекты",title_en:"Effects"}]}function Vm(){const e=p()==="ru";return[{id:"all",title:e?"Все":"All"},{id:"available",title:e?"Доступные":"Available"},{id:"owned",title:e?"Купленные":"Owned"},{id:"new",title:e?"Новые":"New"}]}function Ym(){const e=p()==="ru";return[{id:"featured",title:e?"Рекомендовано":"Featured"},{id:"price",title:e?"По цене":"By price"},{id:"rarity",title:e?"По редкости":"By rarity"}]}function Zm(){const e=r.shopFilters.category||"all",t=r.shopFilters.view||"all",n={common:1,rare:2,epic:3,legendary:4,mythic:5};let s=Oe().filter(a=>e==="all"||a.type===e);return t==="available"&&(s=s.filter(a=>xc(a)==="available")),t==="owned"&&(s=s.filter(a=>ot(a.id))),t==="new"&&(s=s.filter(a=>!r.customization?.seen?.includes(a.id))),r.shopFilters.sort==="price"&&(s=[...s].sort((a,o)=>a.price-o.price)),r.shopFilters.sort==="rarity"&&(s=[...s].sort((a,o)=>(n[o.rarity]||0)-(n[a.rarity]||0)||a.price-o.price)),s}function ef(e){const t=xc(e),n=En(),s=n.status[t]||t,a=Qf(e),o=t==="available"?`<button class="btn primary" type="button" data-action="shop-buy" data-id="${f(e.id)}">${i(n.buy)}</button>`:t==="owned"?`<button class="btn" type="button" data-action="shop-select" data-id="${f(e.id)}">${i(n.select)}</button>`:t==="selected"?`<button class="btn warning" type="button" data-action="shop-clear-item" data-id="${f(e.id)}">${i(n.remove)}</button>`:`<button class="btn" type="button" disabled>${i(n.unavailable)}</button>`;return`
      <article class="custom-shop-card type-${f(e.type)} is-${f(t)} rarity-${f(e.rarity)}">
        <div class="custom-shop-preview">
          ...
          <span class="rarity-badge">${i(nf(e.rarity))}</span>
        </div>
    ...
    `}function af(e){const t=Pt(),n=Kr();return n?.id?`
    ...
    `}function th(e){const t=uo(e.id),n=t.filter(d=>A(d.id).state!=="New").length,s=t.filter(d=>A(d.id).state==="Mastered").length,a=!ke(e),o=Ou(e),l=a?"鎖":t[0]?.kanji||"文",c=I(s,t.length);return`
    ...
    `}function nh(e){const t=Ou(e),n=e.id===r.activeLessonId,s=!ke(e);return`
      <button class="btn ${n?"primary":"ghost"} ${s?"is-disabled":""} ${ho(t)}" type="button" data-action="select-lesson" data-id="${f(e.id)}" title="${f(vo(t))}">
        <span>${i(e.jlpt)}</span>
        ${Xy(t)}
      </button>
    `}function Li(){const e=String(r.activeLearnJlpt||"all").toUpperCase();return r.lessons.filter(t=>e==="ALL"||String(t.jlpt||"").toUpperCase()===e)}function sh(){const e=Li();return e.find(t=>t.id===r.activeLessonId)||e.find(t=>ke(t))||e[0]||r.lessons.find(t=>t.id===r.activeLessonId)||r.lessons.find(t=>ke(t))||r.lessons[0]||null}function Ai(){return F(sh()?.jlpt)||Nt()}function Ic(e){if(!e.length)return r.activeLessonId=null,null;const t=e.find(a=>a.id===r.activeLessonId);if(t&&ke(t))return t;const s=e.find(a=>ke(a))||e[0];return r.activeLessonId=s?.id||null,s||null}function rh(e){const t=e.length,n=e.filter(a=>ke(a)).length,s=["all",...be];return`
    ...
    `}function ah(e){if(!e)return"";const t=e.textbook||e;return`
    ...
    `}function ih(e){const t=mt(e?.jlpt);return`
    ...
    `}function oh(){return r.activeLearnView===sn?fh():r.activeLearnView===Lt?mh():_c()}function lh(){const e=Bl();if(e.kind==="review"){Te("review");return}if(r.route==="home"){ka(Ai());return}Tc(e.nodeId)}function Tc(e){const t=Mn(e);if(!t){fn();return}if(Kl(t)==="locked"){E(p()==="ru"?"Сначала закончи предыдущий шаг.":"Finish the previous step first.");return}if(t.id===An){Te("review");return}if(t.id===In){Is("final-test");return}if(t.type==="textbook"){Is(t.id);return}fn(Lt,t.id)}function Rc(e){const t=String(e||"");return t&&(X(t)||r.cards.find(n=>String(n.id)===t))||null}function ch(){const e=V();return[{id:"intro-1",kind:"info",eyebrow:e.intro,title:e.introTitle,text:e.introBody,note:e.finishHint},{id:"intro-2",kind:"info",eyebrow:e.route,title:e.nextLesson,text:e.introBridge,note:e.mapHint},{id:"intro-3",kind:"quiz",eyebrow:e.ready,title:e.introQuestion,text:e.introQuestionHint,answer:"review",options:[{value:"review",label:{ru:"В повторение",en:"Into review"}},{value:"memory",label:{ru:"В архив навсегда",en:"Into permanent archive"}},{value:"skip",label:{ru:"Никуда, пока не забудешь",en:"Nowhere, until you forget"}}]}]}function js(e){const t=Ze(e);if(!t)return null;const n=Ot(t);if(!n.length)return null;const s=Array.isArray(t.sentences)?t.sentences:[],a=n.map((o,l)=>{const c=et(o)[0]||null,d=s[l%Math.max(s.length,1)]||s[0]||null,u=c?{jp:c.word||o.kanji,hiragana:c.reading||o.hiragana||"",translation:c.translation||(d?{ru:d.ru||"",en:d.en||""}:"")}:d?{jp:d.jp||o.kanji,hiragana:q(d.reading||d.hiragana||o.hiragana||""),translation:{ru:d.ru||"",en:d.en||""}}:{jp:o.kanji,hiragana:o.hiragana||"",translation:{ru:L(o),en:L(o)}};return{cardId:o.id,sentence:u}});return{id:t.id,title:t.title,summary:t.goal||t.theme||t.title,objectives:[t.goal,t.theme].filter(Boolean),kanjiIds:n.map(o=>o.id),kanjiBlocks:a,exercises:Ls(t),source:"learning_path"}}function dh(e){if(e===le)return ch();const t=r.learningPathLessonPayloads[e]||js(e);if(!t)return[];const n=V(),s=[],a=(t.objectives||[]).map(h).filter(Boolean).slice(0,3).join(" • ");return s.push({id:`${e}-overview`,kind:"info",eyebrow:"N5",title:h(t.title),text:h(t.summary),note:a||n.finishHint}),(t.kanjiBlocks||[]).forEach((o,l)=>{const c=Rc(o.cardId);if(!c)return;const d=o.sentence||null;s.push({id:`${e}-kanji-${l+1}`,kind:"kanji",eyebrow:c.jlpt||"N5",title:`${c.kanji} · ${L(c)}`,text:Bh(c,{word:d?.jp||c.kanji,reading:d?.hiragana||c.hiragana||""}),note:d?.translation?h(d.translation):"",cardId:c.id,card:c,sentence:d})}),(t.exercises||[]).forEach(o=>{const l=(o.options||[]).map(c=>({value:String(c.value??c.id??c.label??c),label:h(c.label||c.text||c)}));s.push({id:String(o.id||`${e}-quiz-${s.length}`),kind:"quiz",eyebrow:"N5",title:h(o.prompt),text:h(o.promptHint||{ru:"",en:""}),answer:String(o.answer??""),options:l})}),s}function uh(e,t=null){const n=dh(e);if(!t||t.mode!=="mistakes"||!t.reviewStepIds?.length)return n;const s=new Set(t.reviewStepIds),a=n.filter(o=>o.kind==="quiz"&&s.has(o.id));return a.length?a:n.filter(o=>o.kind==="quiz")}function ph(e,t=Lt,n=[]){const s=Tt(),a=s.activeSession,o=n.map(String).filter(Boolean);return a?.nodeId===e&&a.mode===t&&JSON.stringify(a.reviewStepIds||[])===JSON.stringify(o)?a:(s.activeSession=Ya({nodeId:e,mode:t,stepIndex:0,answers:{},mistakes:[],reviewStepIds:o,score:0,startedAt:new Date().toISOString(),updatedAt:new Date().toISOString()}),s.lastUpdatedAt=s.activeSession.updatedAt,N(),s.activeSession)}function Ss(e){const t=ci(),n=t?.nodeId===e?t:ph(e),s=uh(e,n),a=s.filter(c=>c.kind==="quiz"),o=Object.keys(n.answers||{}).length,l=Math.max(0,Number(n.stepIndex||0));return{session:n,steps:s,quizSteps:a,answeredCount:o,stepIndex:l,currentStep:s[l]||null,isResult:l>=s.length&&s.length>0}}function gh(e,t,n){const s=Tt(),a=new Date().toISOString(),o=n.filter(c=>c.kind==="quiz"),l=Array.isArray(t.mistakes)&&t.mistakes.length>0;if(s.completedNodes[e]||=a,s.resultHistory[e]={completedAt:a,score:Number(t.score||0),totalQuestions:o.length,mistakes:(t.mistakes||[]).slice(0,24)},s.activeSession=null,e===le&&O(12,0,"learning_path:intro"),/^n5-lesson-\d+$/i.test(e)){const c=Ze(e),d=r.learningPathLessonPayloads[e]||js(e),u=[...new Set([...d?.kanjiIds||[],...(d?.kanjiBlocks||[]).map(g=>g.cardId),...Ot(c).map(g=>g.id)].map(String).filter(Boolean))],m=J();if(u.forEach(g=>{const w=Rc(g);if(!w)return;hs(w,"learning_path"),fs(m,w.kanji);const v=H(A(w.id));v.state==="New"&&(r.progress.cards[w.id]=ue(v,l?"hard":"good"))}),c){ee.add(`n5:${c.id}`),m.completedLessons[c.id]=a,m.currentLessonId=Se().find(v=>v.order===c.order+1)?.id||c.id;try{const v=xn,$=localStorage.getItem(v),y=$?JSON.parse($):{};y.n5Course||(y.n5Course={}),y.n5Course.completedLessons||(y.n5Course.completedLessons={}),y.n5Course.completedLessons[c.id]=a,localStorage.setItem(v,JSON.stringify(y)),r.progress.n5Course=r.progress.n5Course||{},r.progress.n5Course.completedLessons=r.progress.n5Course.completedLessons||{},r.progress.n5Course.completedLessons[c.id]=a}catch(v){console.warn("N5 learning path persist failed",v)}hn()>=10&&Object.keys(m.studiedKanji||{}).length>=80&&(r.progress.unlockedJlptLevels=r.progress.unlockedJlptLevels||[],r.progress.unlockedJlptLevels.includes("N5")||r.progress.unlockedJlptLevels.push("N5"),r.progress.unlockedJlptLevels.includes("N4")||r.progress.unlockedJlptLevels.push("N4"));const g=r.n5Meta?.rewards?.lessonCompleteXp||45,w=r.n5Meta?.rewards?.lessonCompleteMoon||6;O(g,w,`learning_path:${e}`),Ge({title:`${je().lessonComplete}: ${h(c.title)}`,message:je().lessonCompleteText,xp:g,coins:w,mascot:"eva",mood:"happy",dialog:"lessonComplete"}),C("lesson_complete"),de("lesson_complete",{lessonId:e,jlpt:"N5"})}}Sr(),ve(),U(),N()}function _c(){r.n5Textbook?.items?.length||li();const e=V(),t=Ol(),n=Bl(),s=Mn(_n()),a=jt();return`
      <section class="page learning-path-page">
        ...
        <div class="learning-path-timeline">
          ${t.length?t.map((o,l)=>{const c=Kl(o),d=c==="locked",u=h(o.summary)||"",m=o.id===An?e.reviewAction:o.id===In?e.openCheckpoint:o.type==="textbook"?e.openTextbook:c==="current"?e.resume:e.continue;return`
    ...
    `}function mh(){const e=r.activeLearnNodeId||_n(),t=Mn(e),n=V();if(!t)return _c();if(t.id!==le&&t.type==="lesson"&&!r.n5Textbook?.items?.length)return li(),`
        <section class="page learning-path-page">
      ...
      `;t.type==="lesson"&&Dg(e);const s=Ss(e),{session:a,steps:o,quizSteps:l,currentStep:c,isResult:d}=s;if(!o.length)return`
        <section class="page learning-path-page">
          <article class="study-card lesson-player">
            <div class="section-head">
              <div>
    ...
    `}function fh(){const e=Li(),t=Ic(e),n=!!(t&&ke(t)),s=n?Ny(t.id):[];(!r.activeCardId||!s.some(l=>l.id===r.activeCardId))&&(r.activeCardId=s[0]?.id||null);const a=n&&r.activeCardId?X(r.activeCardId):null,o=r.activeLearnJlpt!=="all"?mt(r.activeLearnJlpt):null;return`
      <section class="page">
        <div class="section-head">
          <div>
            <h1>${i(S("learn"))}</h1>
    ...
    `}function hh(){const e=Yt(r.activeJlptLesson)||Yt(X(r.activeCardId)?.jlpt)||r.jlptLessons[0];if(!e)return`
        <section class="page">
      ...
      `;r.activeJlptLesson=e.jlpt;const t=mt(e.jlpt);if(!qe(e.jlpt))return Mc(t||e);const n=ko(e.jlpt),s=n.filter(l=>A(l.id).state==="Mastered").length,a=n.filter(l=>A(l.id).state!=="New").length,o={...$o(),...yo()};return`
    ...
    `}function wh(e){const t=String(e?.jlpt||"").toUpperCase();if(!qe(t))return Mc(e);if(String(e?.jlpt||"").toUpperCase()==="N5"&&r.n5Textbook?.items?.length)return bh(e);if(String(e?.jlpt||"").toUpperCase()==="N4"&&r.n4Textbook?.items?.length)return lv(e);if(String(e?.jlpt||"").toUpperCase()==="N3"&&r.n3Textbook?.items?.length)return Uv(e);if(String(e?.jlpt||"").toUpperCase()==="N2"&&r.n2Textbook?.items?.length)return Cw(e);r.activeTextbookLevel=e.jlpt,r.activeJlptLesson=e.jlpt;const n=(e.lessonIds||[]).map(w=>r.lessons.find(v=>v.id===w)).filter(Boolean),s=r.lessons.filter(w=>String(w.jlpt||"").toUpperCase()===String(e.jlpt||"").toUpperCase()&&!n.includes(w)),a=[...n,...s].slice(0,Math.max(e.lessonCount||n.length,n.length)),o=r.activeTextbookSubroute?a.find(w=>w.id===r.activeTextbookSubroute)||Yt(e.jlpt)||r.jlptLessons[0]:Yt(e.jlpt)||r.jlptLessons[0];r.activeTextbookSubroute&&o?.id&&ft(t,o.id,"textbook_page");const l=p()==="ru"?{title:"Страница учебника",back:"Все учебники",pdf:"Скачать PDF",lessonPage:"Страница урока",openLesson:"Открыть урок",outline:"Что внутри",practice:"Практика",lessons:"Уроки учебника",previous:"Предыдущие уровни",next:"Следующие уровни"}:{title:"Textbook page",back:"All textbooks",pdf:"Download PDF",lessonPage:"Lesson page",openLesson:"Open lesson",outline:"Inside the textbook",practice:"Practice",lessons:"Textbook lessons",previous:"Previous levels",next:"Next levels"},c=bo(e.jlpt)||e.lessonIds?.[0]||a[0]?.id||"",d=h(e.recommendedCycle||{}),u=h(e.goal||{}),m=(e.previousLevels||[]).map(w=>`<a class="pill" href="#textbooks/${f(w)}">${i(w)}</a>`).join(""),g=(e.nextLevels||[]).map(w=>`<a class="pill" href="#textbooks/${f(w)}">${i(w)}</a>`).join("");return`
      <section class="page textbooks-page textbook-detail-page">
        ...
        <div class="lesson-grid">
          ${a.map(w=>th(w)).join("")||`<article class="empty-state"><h3>${i(p()==="ru"?"Уроки скоро появятся":"Lessons will appear soon")}</h3></article>`}
        </div>
      </section>
    `}function bh(e){r.activeTextbookLevel="N5",r.activeJlptLesson="N5",Cs();const t=String(r.activeTextbookSubroute||"");if(t==="final-test")return Rh();if(t==="review")return Ih();const n=Ze(t);return n?(J().currentLessonId=n.id,ft("N5",n.id,"n5_lesson_page"),Rt("N5",n,"n5_lesson_page"),Lh(e,n)):kh(e)}function kh(e){const t=Fh(),n=je(),s=Se(),a=Oh(),o=r.n5Meta||{},l=h(o.principle||{});return`
    ...
    `}function yh(e){const t=Ti(e.id),n=je();let s=e.kanji.filter(a=>J().studiedKanji[a]).length;return t==="completed"&&(s=e.kanji.length),`
      <a class="n5-lesson-tile ${t}" href="#textbooks/N5/${f(e.id)}" data-action="n5-open-lesson" data-id="${f(e.id)}">
        ...
        <small>${i(s)}/${i(e.kanji.length)} · ${i(zh(t))}</small>
      </a>
    `}function Ns(){return r.progress.jlptLessonStudy=Sl(Va(),r.progress.jlptLessonStudy||{}),r.progress.jlptLessonStudy}function $h(e,t){return`${String(e||"").toUpperCase()}:${String(t||"")}`}function Ye(e,t,n="player"){return`jlpt-${String(e||"").toLowerCase()}-${n}-${String(t||"").replace(/[^a-z0-9_-]+/gi,"-")}`}function Bn(e,t,n){const s=Ns(),a=$h(e,t?.id),o=yl();let l=s.sessions[a];l||(l={...o,level:String(e||"").toUpperCase(),lessonId:String(t?.id||""),startedAt:new Date().toISOString(),updatedAt:new Date().toISOString()},s.sessions[a]=l),l.level=String(e||l.level||"").toUpperCase(),l.lessonId=String(t?.id||l.lessonId||""),l.answers||={},l.phase=$l(l.phase),l.startedAt||=new Date().toISOString(),l.updatedAt||=new Date().toISOString();const c=Array.isArray(n)?n.length:0,d=c?n.findIndex(m=>!l.answers[m.id]):-1,u=Object.keys(l.answers||{}).length;return l.completedAt?(l.phase="done",l.currentIndex=c):d<0?(l.currentIndex=c,l.phase="test",l.testOpenedAt||=l.updatedAt||new Date().toISOString()):(l.currentIndex=d,l.phase!=="test"&&(l.phase="study")),s.activeSessionKey=a,s.lastUpdatedAt=new Date().toISOString(),{session:l,key:a,answeredCount:u,currentIndex:l.currentIndex,total:c}}function jh(e,t){return!e||!Array.isArray(t)||!t.length||e.session?.phase!=="study"?null:t[Math.min(Math.max(Number(e.currentIndex||0),0),t.length-1)]||null}function Sh(e){const t=Array.isArray(e)?e:[];return t.length?`
      <ul class="example-list lesson-study-example-list">
        ${t.slice(0,2).map(na).join("")}
      </ul>
    `:""}function Nh(e){const t=Us(e),n=t.length>0;return`
    ...
    `}function xh(e,t,n,s,a,o,l={}){if(!n)return"";const c=typeof l.examples=="function"?l.examples(n,t)||[]:[],d=typeof l.sentence=="function"?l.sentence(n,t):"",u=typeof l.extra=="function"?l.extra(n,t):"",m=l.answerAction||"jlpt-lesson-answer",g=String(e||n.jlpt||"").toUpperCase(),w=Number(s||0),v=A(n.id),$=t?.id||"";return`
    ...
    `}function zr(e,t,n,s,a={}){const o=Bn(e,t,n),l=jh(o,n),c=Number(o.answeredCount||0),d=Number(o.total||0),u=a.playerId||Ye(e,t?.id,"player"),m=d?I(c,d):0,g=l?`${p()==="ru"?"Кандзи":"Kanji"} ${Math.min(c+1,d)}/${d}`:o.session?.phase==="done"?p()==="ru"?"Урок завершён":"Lesson complete":p()==="ru"?"Тест открыт":"Test open",w=l?L(l):s.lessonComplete;return`
      <article class="study-card lesson-player lesson-study-player" id="${f(u)}">
        ...
        ${l?xh(e,t,l,o.currentIndex,d,s,a):Ch(e,t,s,d,c)}
      </article>
    `}function Lh(e,t){const n=je(),s=Ot(t),a=Ls(t),o=Ti(t.id),l=Bn("N5",t,s);let c=o==="completed";const d=`n5:${t.id}`;ee.has(d)&&(c=!0);const u=c,m=a.filter(R=>Ri(R.id)?.correct).length,g=a.length>0&&m===a.length,w=s.filter(R=>J().studiedKanji[R.kanji]).length,v=t.kanji.length,$=w>=v,y=!c&&g&&$,x=t.kanji.filter(R=>J().difficultKanji[R]).join(" · "),b=Se().find(R=>R.order===t.order+1),k=Ye("N5",t.id,"player"),D=Ye("N5",t.id,"test");return`
      <section class="page textbooks-page n5-course-page n5-lesson-page">
        ...
        ${zr("N5",t,s,n,{playerId:k,answerAction:"jlpt-lesson-answer",examples:R=>et(R),sentence:R=>Ah(R,t)})}
    ...
    `}function Ah(e,t){const n=t.sentences.find(s=>s.jp.includes(e.kanji))||t.sentences[0];return n?`
      <div class="n5-card-sentence">
        <strong>${i(n.jp)}</strong>
        <span>${i(q(n.reading||""))}</span>
        <small>${i(h({ru:n.ru,en:n.en}))}</small>
      </div>
    `:""}function Pc(e){const t=je(),n=Ri(e.id),s=n?n.correct?"is-correct":"is-wrong":"",a=r.route==="review"&&vn("N5",e.id)&&!!n;return e.type==="active-recall"?`
        <article class="n5-exercise-card ${s}">
          <span class="pill">${i(h(e.title))}</span>
          <h3>${i(e.prompt)}</h3>
          <div class="n5-input-row">
            <input id="${f(Qc(e.id))}" type="text" maxlength="2" autocomplete="off" value="${f(n?.selected||"")}" aria-label="${f(h(e.title))}" ${a?"disabled":""} />
    ...
    `}function Ec(e,t){if(!t)return"";const n=je(),s=t.correct?n.correctAnswer:`${n.wrongAnswer}: ${e.answerLabel||e.answer}`;return`<p class="n5-feedback">${i(s)}</p>`}function Ih(e){const t=je(),n=J().activeReviewMode||"due",s=rv(n);return`
      <section class="page textbooks-page n5-course-page">
        <div class="section-head">
          <div>
        ...
        <div class="n5-kanji-grid">
          ${s.map((a,o)=>Th(a,o)).join("")||`<article class="empty-state"><h3>${i(t.noReviewCards)}</h3></article>`}
        </div>
      </section>
    `}function Th(e,t){const n=je(),s=A(e.id);return`
    ...
    `}function Rh(e){const t=je(),n=r.n5FinalTest||{},s=Hc(),a=J().finalTest,o=Ht(a,s),l=o.answered,c=o.ready,d=r.finalTestBusy;if(a&&typeof a.score=="number"&&a.score>0&&a.totalQuestions>0){const g=Math.round(a.score/a.totalQuestions*100);(!a.percent||a.percent===0||a.percent!==g)&&(a.percent=g),a.completedAt||(a.completedAt=new Date().toISOString()),N()}const u=!!a.completedAt||typeof a.percent=="number"&&a.percent>0||typeof a.score=="number"&&a.score>0,m=typeof a.percent=="number"&&a.percent>0?a.percent:Number(a.score||0)&&a.totalQuestions?Math.round(a.score/a.totalQuestions*100):0;return`
    ...
    `}function _h(e,t){const n=J().finalTest.answers?.[e.id],s=!!J().finalTest.completedAt,a=r.finalTestModal&&r.finalTestModal.level==="N5"&&r.finalTestModal.kind==="warning"?r.finalTestModal:null,o=!!(a&&Array.isArray(a.missingIds)&&a.missingIds.includes(e.id));return`
    ...
    `}function xs(e){const t=Kc(e);if(!t.length)return"";const n=Dc(),s=Oc(e),a=wa(s,"textbook_reading_block"),o=Hs(s);return(a||o)&&N(),`
      <section class="n5-panel jlpt-reading-panel">
        ...
        <div class="jlpt-reading-grid">
          ${t.map((l,c)=>Dh(l,s,c)).join("")}
        </div>
      </section>
    `}function Dh(e,t,n){const s=Dc(),a=Ii(e),o=Array.isArray(e?.questions)?e.questions:[];return`
    ...
    `}function dv(e){const t=ed(e.id),n=ie();let s=e.kanji.filter(a=>P().studiedKanji[a]).length;return t==="completed"&&(s=e.kanji.length),`
    ...
    `}function uv(e,t){const n=ie(),s=Ts(t),a=qr(t),o=ed(t.id),l=Bn("N4",t,s);let c=o==="completed";const d=`n4:${t.id}`;ee.has(d)&&(c=!0);const u=c,m=a.filter(R=>Pi(R.id)?.correct).length,g=a.length>0&&m===a.length,w=s.filter(R=>P().studiedKanji[R.kanji]).length,v=t.kanji.length,$=w>=v,y=!c&&g&&$,x=t.kanji.filter(R=>P().difficultKanji[R]).join(" · "),b=Ke().find(R=>R.order===t.order+1),k=Ye("N4",t.id,"player"),D=Ye("N4",t.id,"test");return`
      <section class="page textbooks-page n5-course-page n4-course-page n5-lesson-page">
        ...
        ${zr("N4",t,s,n,{playerId:k,answerAction:"jlpt-lesson-answer",examples:R=>Be(R),sentence:R=>pv(R,t)})}
    ...
    `}function pv(e,t){const n=t.sentences.find(a=>a.jp.includes(e.kanji))||t.sentences[0];if(!n)return"";const s=(t.grammarFocus||[]).find(a=>n.jp.includes(String(a).replace(/[гЂњ~].*/,"")))||t.grammarFocus?.[0]||"";return`
      <div class="n5-card-sentence">
        <strong>${i(n.jp)}</strong>
        <span>${i(q(n.reading||""))}</span>
        <small>${i(h({ru:n.ru,en:n.en}))}</small>
    ...
    `}function gv(e){const t=ie(),n=(e.grammarFocus||[]).map(s=>Mi(s)).filter(Boolean).slice(0,3);return n.length?`
    ...
    `:""}function Wc(e){const t=ie(),n=Pi(e.id),s=n?n.correct?"is-correct":"is-wrong":"",a=r.route==="review"&&vn("N4",e.id)&&!!n;return e.type==="active-recall"?`
        <article class="n5-exercise-card ${s}">
          <span class="pill">${i(h(e.title))}</span>
          <h3>${i(e.prompt)}</h3>
          <div class="n5-input-row">
            <input id="${f(od(e.id))}" type="text" maxlength="3" autocomplete="off" value="${f(n?.selected||"")}" aria-label="${f(h(e.title))}" ${a?"disabled":""} />
    ...
    `}function Vc(e,t){if(!t)return"";const n=ie(),s=t.correct?n.correctAnswer:`${n.wrongAnswer}: ${e.answerLabel||e.answer}`;return`<p class="n5-feedback">${i(s)}</p>`}function mv(e){const t=ie(),n=P().activeReviewMode||"due",s=Bv(n);return`
      <section class="page textbooks-page n5-course-page n4-course-page">
        <div class="section-head">
          <div>
        ...
        <div class="n5-kanji-grid">
          ${s.map((a,o)=>fv(a,o)).join("")||`<article class="empty-state"><h3>${i(t.noReviewCards)}</h3></article>`}
        </div>
      </section>
    `}function fv(e,t){const n=ie(),s=A(e.id);return`
      <article class="n5-kanji-card n5-review-card">
        <div class="n5-kanji-topline">
          <span class="pill">${t+1}</span>
          <span class="pill">${i(s.state)} · ${i(Nn(s.dueAt))}</span>
    ...
    `}function hv(e){const t=ie(),n=Re();return`
      <section class="page textbooks-page n5-course-page n4-course-page">
        <div class="section-head">
          <div>
    ...
    `}function wv(e){const t=ie(),n=wa("N4","n4_reading_page"),s=Hs("N4");return(n||s)&&N(),`
      <section class="page textbooks-page n5-course-page n4-course-page">
        <div class="section-head">
          <div>
        ...
        <div class="n4-section-grid">
          ${r.n4Reading.map(a=>Yc(a,"reading")).join("")}
        </div>
      </section>
    `}function bv(e){const t=ie();return`
      <section class="page textbooks-page n5-course-page n4-course-page">
        ...
        <div class="n4-section-grid">
          ${r.n4Listening.map(n=>Yc(n,"listening")).join("")}
        </div>
      </section>
    `}function Yc(e,t){const n=ie(),s=t==="reading"?P().completedReading[e.id]:P().completedListening[e.id],a=t==="reading"?P().readingAnswers:P().listeningAnswers,o=t==="reading"?"n4-reading-complete":"n4-listening-complete";return`
    ...
    `}function kv(e){const t=ie(),n=r.n4FinalTest||{},s=ad(),a=P().finalTest,o=Ht(a,s),l=o.answered,c=o.ready;if(a&&typeof a.score=="number"&&a.score>0&&a.totalQuestions>0){const m=Math.round(a.score/a.totalQuestions*100);(!a.percent||a.percent===0||a.percent!==m)&&(a.percent=m),a.completedAt||(a.completedAt=new Date().toISOString()),N()}const d=!!a.completedAt||typeof a.percent=="number"&&a.percent>0||typeof a.score=="number"&&a.score>0,u=typeof a.percent=="number"&&a.percent>0?a.percent:Number(a.score||0)&&a.totalQuestions?Math.round(a.score/a.totalQuestions*100):0;return`
    ...
    `}function yv(e,t){const n=P().finalTest.answers?.[e.id],s=!!P().finalTest.completedAt;return`
    ...
    `}function qv(e){const t=pd(e.id),n=se();let s=e.kanji.filter(a=>_().studiedKanji[a]).length;return t==="completed"&&(s=e.kanji.length),`
      <a class="n5-lesson-tile ${t}" href="#jlpt/n3/${f(e.id)}" data-action="n3-open-lesson" data-id="${f(e.id)}">
        ...
        <div class="achievement-progress" aria-label="${f(`${s}/${e.kanji.length}`)}"><i style="width:${I(s,e.kanji.length)}%"></i></div>
        <small>${i(s)}/${i(e.kanji.length)} · ${i(ow(t))}</small>
      </a>
    `}function Hv(e,t){const n=se(),s=_s(t),a=Hr(t),o=pd(t.id),l=Bn("N3",t,s);let c=o==="completed";const d=`n3:${t.id}`;ee.has(d)&&(c=!0);const u=c,m=a.filter(z=>Ki(z.id)?.correct).length,g=a.length>0&&m===a.length,w=s.filter(z=>_().studiedKanji[z.kanji]).length,v=t.kanji.length,$=w>=v,y=!c&&g&&$,x=t.kanji.filter(z=>_().difficultKanji[z]).join(" · "),b=Fe().find(z=>z.order===t.order+1),k=ld(t),D=k?!!_().completedReading[k.id]:!1,R=Ye("N3",t.id,"player"),ar=Ye("N3",t.id,"test");return`
      <section class="page textbooks-page n5-course-page n3-course-page n5-lesson-page">
        ...
        ${zr("N3",t,s,n,{playerId:R,answerAction:"jlpt-lesson-answer",examples:z=>ze(z),sentence:z=>Qv(z,t)})}
    ...
    `}function ld(e){return e?.miniReadingId&&r.n3Reading.find(t=>t.id===e.miniReadingId)||null}function Xv(e){const t=se(),n=ld(e);return n?`
      <section class="n5-panel">
        <div>
    ...
    `}function Wv(e){const t=se(),n=(e.grammarFocus||[]).map(s=>Oi(s)).filter(Boolean).slice(0,3);return n.length?`
    ...
    `:""}function cd(e){const t=se(),n=Ki(e.id),s=n?n.correct?"is-correct":"is-wrong":"",a=r.route==="review"&&vn("N3",e.id)&&!!n;return e.type==="active-recall"?`
        <article class="n5-exercise-card ${s}">
          <span class="pill">${i(h(e.title))}</span>
          <h3>${i(e.prompt)}</h3>
          <div class="n5-input-row">
            <input id="${f(bd(e.id))}" type="text" maxlength="3" autocomplete="off" value="${f(n?.selected||"")}" aria-label="${f(h(e.title))}" ${a?"disabled":""} />
    ...
    `}function dd(e,t){if(!t)return"";const n=se(),s=t.correct?n.correctAnswer:`${n.wrongAnswer}: ${e.answerLabel||e.answer}`;return`<p class="n5-feedback">${i(s)}</p>`}function Vv(e){const t=se(),n=_().activeReviewMode||"due",s=jw(n);return`
      <section class="page textbooks-page n5-course-page n3-course-page">
        <div class="section-head">
          <div>
    ...
    `}function Yv(e,t){const n=se(),s=A(e.id);return`
      <article class="n5-kanji-card n5-review-card">
        <div class="n5-kanji-topline">
          <span class="pill">${t+1}</span>
          <span class="pill">${i(s.state)} · ${i(Nn(s.dueAt))}</span>
    ...
    `}function Zv(e){const t=se(),n=Me();return`
      <section class="page textbooks-page n5-course-page n3-course-page">
        <div class="section-head">
          <div>
    ...
    `}function tw(e){const t=se(),n=wa("N3","n3_reading_page"),s=Hs("N3");return(n||s)&&N(),`
      <section class="page textbooks-page n5-course-page n3-course-page">
        <div class="section-head">
          <div>
    ...
    `}function sw(e){const t=se(),n=r.n3FinalTest||{},s=vd(),a=_().finalTest,o=Ht(a,s),l=o.answered,c=o.ready;if(a&&typeof a.score=="number"&&a.score>0&&a.totalQuestions>0){const m=Math.round(a.score/a.totalQuestions*100);(!a.percent||a.percent===0||a.percent!==m)&&(a.percent=m),a.completedAt||(a.completedAt=new Date().toISOString()),N()}const d=!!a.completedAt||typeof a.percent=="number"&&a.percent>0||typeof a.score=="number"&&a.score>0,u=typeof a.percent=="number"&&a.percent>0?a.percent:Number(a.score||0)&&a.totalQuestions?Math.round(a.score/a.totalQuestions*100):0;return`
    ...
    `}function rw(e,t){const n=_().finalTest.answers?.[e.id],s=!!_().finalTest.completedAt;return`
      <article class="n5-exercise-card ${s?n===e.answer?"is-correct":"is-wrong":""}">
        <span class="pill">${t+1} · ${i(e.type)}</span>
        <h3>${i(e.prompt)}</h3>
        <div class="n5-option-grid">
    ...
    `}function Aw(e){const t=Sd(e.id),n=re();let s=e.kanji.filter(a=>M().studiedKanji[a]).length;return t==="completed"&&(s=e.kanji.length),`
    ...
    `}function Iw(e,t){const n=re(),s=Ps(t),a=Xr(t),o=Sd(t.id),l=Bn("N2",t,s);let c=o==="completed";const d=`n2:${t.id}`;ee.has(d)&&(c=!0);const u=c,m=a.filter(z=>Ji(z.id)?.correct).length,g=a.length>0&&m===a.length,w=s.filter(z=>M().studiedKanji[z.kanji]).length,v=t.kanji.length,$=w>=v,y=!c&&g&&$,x=t.kanji.filter(z=>M().difficultKanji[z]).join(" · "),b=Je().find(z=>z.order===t.order+1),k=kd(t),D=k?!!M().completedReading[k.id]:!1,R=Ye("N2",t.id,"player"),ar=Ye("N2",t.id,"test");return`
      <section class="page textbooks-page n5-course-page n2-course-page n5-lesson-page">
        ...
        ${zr("N2",t,s,n,{playerId:R,answerAction:"jlpt-lesson-answer",examples:z=>Ue(z),sentence:z=>Rw(z,t)})}
    ...
    `}function kd(e){return e?.miniReadingId&&r.n2Reading.find(t=>t.id===e.miniReadingId)||null}function Tw(e){const t=re(),n=kd(e);return n?`
      <section class="n5-panel">
        <div>
          <h2>${i(t.miniReadingTitle)}</h2>
          <p>${i(t.miniReadingText)}</p>
    ...
    `:""}function Rw(e,t){const n=t.sentences.find(a=>a.jp.includes(e.kanji))||t.sentences[0];if(!n)return"";const s=(t.grammarFocus||[]).find(a=>n.jp.includes(String(a).replace(/[гЂњ~].*/,"")))||t.grammarFocus?.[0]||"";return`
      <div class="n5-card-sentence">
        <strong>${i(n.jp)}</strong>
        <span>${i(q(n.reading||""))}</span>
        <small>${i(h({ru:n.ru,en:n.en}))}</small>
    ...
    `}function _w(e){const t=re(),n=(e.grammarFocus||[]).map(s=>zi(s)).filter(Boolean).slice(0,3);return n.length?`
    ...
    `:""}function yd(e){const t=re(),n=Ji(e.id),s=n?n.correct?"is-correct":"is-wrong":"",a=r.route==="review"&&vn("N2",e.id)&&!!n;return e.type==="active-recall"?`
        <article class="n5-exercise-card ${s}">
          <span class="pill">${i(h(e.title))}</span>
          <h3>${i(e.prompt)}</h3>
          <div class="n5-input-row">
            <input id="${f(Td(e.id))}" type="text" maxlength="3" autocomplete="off" value="${f(n?.selected||"")}" aria-label="${f(h(e.title))}" ${a?"disabled":""} />
    ...
    `}function $d(e,t){if(!t)return"";const n=re(),s=t.correct?n.correctAnswer:`${n.wrongAnswer}: ${e.answerLabel||e.answer}`;return`<p class="n5-feedback">${i(s)}</p>`}function Mw(e){const t=re(),n=M().activeReviewMode||"due",s=ib(n);return`
      <section class="page textbooks-page n5-course-page n2-course-page">
        <div class="section-head">
          <div>
        ...
        <div class="n5-kanji-grid">
          ${s.map((a,o)=>Pw(a,o)).join("")||`<article class="empty-state"><h3>${i(t.noReviewCards)}</h3></article>`}
        </div>
      </section>
    `}function Pw(e,t){const n=re(),s=A(e.id);return`
      <article class="n5-kanji-card n5-review-card">
        <div class="n5-kanji-topline">
          <span class="pill">${t+1}</span>
          <span class="pill">${i(s.state)} · ${i(Nn(s.dueAt))}</span>
    ...
    `}function Ew(e){const t=re(),n=Ee();return`
      <section class="page textbooks-page n5-course-page n2-course-page">
        <div class="section-head">
          <div>
    ...
    `}function Ow(e){const t=re(),n=wa("N2","n2_reading_page"),s=Hs("N2");return(n||s)&&N(),`
      <section class="page textbooks-page n5-course-page n2-course-page">
        <div class="section-head">
          <div>
    ...
    `}function Bw(e){const t=re(),n=r.n2FinalTest||{},s=Ad(),a=M().finalTest,o=Ht(a,s),l=o.answered,c=o.ready;if(a&&typeof a.score=="number"&&a.score>0&&a.totalQuestions>0){const m=Math.round(a.score/a.totalQuestions*100);(!a.percent||a.percent===0||a.percent!==m)&&(a.percent=m),a.completedAt||(a.completedAt=new Date().toISOString()),N()}const d=!!a.completedAt||typeof a.percent=="number"&&a.percent>0||typeof a.score=="number"&&a.score>0,u=typeof a.percent=="number"&&a.percent>0?a.percent:Number(a.score||0)&&a.totalQuestions?Math.round(a.score/a.totalQuestions*100):0;return`
    ...
    `}function Fw(e,t){const n=M().finalTest.answers?.[e.id],s=!!M().finalTest.completedAt;return`
      <article class="n5-exercise-card ${s?n===e.answer?"is-correct":"is-wrong":""}">
        <span class="pill">${t+1} · ${i(e.type)}</span>
        <h3>${i(e.prompt)}</h3>
        <div class="n5-option-grid">
    ...
    `}function db(e,t){return e.apps.length?`
    ...
    `:""}function ub(e,t){const n=Array.isArray(e.kana?.hiragana)?e.kana.hiragana:[],s=Array.isArray(e.kana?.katakana)?e.kana.katakana:[];return!n.length&&!s.length?"":`
      <article class="jlpt-practice-card">
        <h3>${i(t.kana)}</h3>
    ...
    `}function _d(e,t){return t.length?`
    ...
    `:""}function pb(e,t){return e.kanjiFocus.length?`
    ...
    `:""}function gb(e){const t=Array.isArray(e.furigana)?e.furigana:[];return t.length?t.map(n=>n.rt?`<ruby>${i(n.text)}<rt>${i(n.rt)}</rt></ruby>`:i(n.text)).join(""):i(e.word||e.kanji||"")}function mb(e,t){const n=Zn(e);if(!n)return"";const s=Sn(),a=s.selected[n.id]||[],o=!!s.checked[n.id],l=s.results[n.id]||null,c=a.map(m=>n.tiles[m]).filter(Boolean),d=o&&l?.correct,u=o&&l?l.wrongIndexes||[]:[];return`
      <article class="jlpt-practice-card jlpt-drill-card">
        ...
        <div class="jlpt-sentence-line">${fb(n,c,u)}</div>
    ...
    `}function fb(e,t,n){let s=0;return String(e.sentence||"").split("___").map((a,o,l)=>{if(o===l.length-1)return i(a);const d=(e.blanks[o]||{answer:[]}).answer.length||1,u=t.slice(s,s+d),m=u.some((w,v)=>n.includes(s+v));s+=d;const g=u.length?u.map(w=>`<span>${i(w.kanji)}</span>`).join(""):`<span>${i("в–Ў".repeat(d))}</span>`;return`${i(a)}<span class="sentence-blank ${m?"is-wrong":""}">${g}</span>`}).join("")}function hb(){const e=Ay(),t=Yb(e),n=e.length,s=t?.kind==="card"?t.card:t?.kind==="exercise"?t.card||X(t.cardId)||X(t.progress?.cardId||""):null;Vb(t);const a=t?t.kind==="card"?s?zd(s):ra():ak(t):ra();return`
      <section class="page">
        <div class="section-head">
          <div>
            <h1>${i(S("review"))}</h1>
    ...
    `}function vb(){const e=dt(),t=Wr(e),n={...Gn(),...Ui()},s=wb(e,n);if(!e.length)return`
      ...
      <article class="sentence-practice${r.progress.sentencePractice.checked?m?" is-success":" is-error":""}" data-section="sentence-practice" aria-live="polite">
        <div class="section-head sentence-head">
          ...
          <div class="tag-row">
            ...
            ${o.source?`<span class="pill">${i(kb(o.source,n))}</span>`:""}
        ...
        <div class="sentence-card">
          <div class="sentence-line">${Pd(o,c,u)}</div>
          <p class="sentence-reading">${i(o.reading||"")}</p>
          <p class="sentence-translation">${i(yb(o))}</p>
        </div>
    ...
    `}function wb(e,t){const n=fe(),s=$r(n.customDraft||{}),a=Array.isArray(n.customSentences)?n.customSentences:[],o=a.length,l=!!n.customEditingId,c=n.customStatus?` is-${n.customStatus}`:"";return`
    ...
    `}function bb(e,t,n){return e.length?`
    ...
    `:""}function ea(e){const t=fa(e);return`
      <div class="reading-row reading-split">
        ${Fd(Tu("onyomi"),t.onyomi.kana,t.onyomi.romaji)}
        ${Fd(Tu("kunyomi"),t.kunyomi.kana,t.kunyomi.romaji)}
      </div>
    ...
    `}function ta(e,t="btn ghost"){const n=Vy(e);if(!n)return"";const s=qe(n.jlpt),a=p()==="ru"?"JLPT урок":"JLPT lesson";return s?`<button class="${t}" type="button" data-action="open-jlpt-lesson" data-jlpt="${f(n.jlpt)}">${i(n.jlpt)} · ${i(a)}</button>`:`<button class="${t} is-disabled" type="button" disabled aria-disabled="true" title="${f($t(n.jlpt))}">🔒 ${i(n.jlpt)}</button>`}function zd(e){vs(e,"study_card");const t=A(e.id),n=r.revealed;Ey(e.id);const s=e.lessonTitle||xo(e.lessonId)||e.jlpt||"";return`
    ...
    `}function Qb(e){const t=r.readingCheck.cardId===e.id?r.readingCheck:{value:"",status:null,message:""},n=t.status?` is-${t.status}`:"",s=t.message||(p()==="ru"?"Напиши любое чтение этого кандзи хираганой или катаканой.":"Type any reading for this kanji in hiragana or katakana.");return`
    ...
    `}function Wb(e){return`
      <div class="answer-section">
        ...
        <div class="rating-grid srs-binary-grid">
          ...
          <button class="btn success" type="button" data-action="rate" data-rating="remember">${i(ia().remember)} <small>${i(Qk(e))}</small></button>
        </div>
      </div>
    ...
    `}function sa(){r.reviewExerciseResults={},r.activeExerciseReviewId=null,r.activeExerciseReviewLevel="",r.activeExerciseReviewSource="",r.activeExerciseReviewSelection=[],r.activeExerciseReviewChoice="",r.activeExerciseReviewTranslationOpen=!1}function Vb(e){if(!e){r.activeCardId=null,sa();return}if(r.reviewQueueLastKind=e.kind,e.kind==="card"){r.activeCardId!==e.card.id&&(r.activeCardId=e.card.id,sa());return}if(e.kind==="exercise"){const t=r.activeExerciseReviewId===e.exerciseId&&r.activeExerciseReviewLevel===e.level&&r.activeExerciseReviewSource===String(e.source||"textbook");r.activeCardId=null,r.activeExerciseReviewId=e.exerciseId,r.activeExerciseReviewLevel=e.level,r.activeExerciseReviewSource=String(e.source||"textbook"),t||(r.reviewExerciseResults={}),t||(r.activeExerciseReviewSelection=[],r.activeExerciseReviewChoice="",r.activeExerciseReviewTranslationOpen=!1)}}function Wi(e,t,n="",s=null,a=null,o="textbook"){const l=F(e);if(!l||!t)return null;if(String(o||"textbook")==="reading"){const w=a||wu(t,l);if(!w)return null;const v=yn(s||{},w);return{kind:"exercise",source:"reading",key:`reading:${String(l)}:${t}`,level:l,exerciseId:t,lessonId:String(w.sourceId||n||v.lessonId||""),cardId:"",dueAt:v.dueAt?new Date(v.dueAt).getTime():0,progress:v,exercise:w,card:null}}const d=Xt(s||{},{level:l,lessonId:n,exerciseId:t,cardId:s?.cardId||"",kanji:s?.kanji||"",type:s?.type||"",title:s?.title||null,prompt:s?.prompt||"",answer:s?.answer||"",answerLabel:s?.answerLabel||""}),u=a||la(l,t,n||d.lessonId||"");if(!u)return null;const m=String(u.lessonId||d.lessonId||n||""),g=String(u.cardId||d.cardId||"");return{kind:"exercise",source:"textbook",key:`exercise:${l}:${t}`,level:l,exerciseId:t,lessonId:m,cardId:g,dueAt:d.dueAt?new Date(d.dueAt).getTime():0,progress:d,exercise:u,card:X(g)||X(d.cardId||"")}}function Hn(){if(!r.activeExerciseReviewId||!r.activeExerciseReviewLevel)return null;const e=r.activeExerciseReviewLevel,t=r.activeExerciseReviewId;if(String(r.activeExerciseReviewSource||"textbook")==="reading"){const o=wu(t,e),l=o?pt(o):r.progress.readingExercises?.[t]||null;return Wi(e,t,l?.lessonId||o?.sourceId||"",l,o,"reading")}const a=Wk(e)?.exerciseSrs?.[t]||null;return Wi(e,t,a?.lessonId||"",a,null,"textbook")}function Jd(e){return!e||e.kind!=="exercise"?null:Wi(e.level,e.exerciseId,e.lessonId||e.progress?.lessonId||"",e.progress,e.exercise||null,e.source||"textbook")}function Yb(e){const t=Hn();if(t&&r.reviewExerciseResults?.[t.exerciseId]||t&&!e.some(a=>a.kind==="exercise"&&a.exerciseId===t.exerciseId&&a.level===t.level))return t;const n=r.activeCardId?e.find(a=>a.kind==="card"&&a.card.id===r.activeCardId):null;if(n)return n;const s=r.reviewQueueLastKind==="card"?"exercise":r.reviewQueueLastKind==="exercise"?"card":"";if(s){const a=e.find(o=>o.kind===s);if(a)return a}return e[0]||t||null}function Zb(e,t){const n=F(e);return n==="N5"?Pc(t):n==="N4"?Wc(t):n==="N3"?cd(t):n==="N2"?yd(t):""}function ek(e){return p()==="ru"?e?.kind==="cloze"?"Предложение":"Вопрос":e?.kind==="cloze"?"Sentence":"Question"}function Vi(){return p()==="ru"?"Перевод":"Translation"}function Ud(e){const t=String(e||"").trim();return t?t.split(/([гЂ'пјЃпјџгЂЃ\n]+)/u).map(n=>{if(!n)return"";if(/^[гЂ'пјЃпјџгЂЃ\n]+$/u.test(n))return n===`
`?`
`:`${n} `;const s=Au(n);return s?`${s} `:""}).join("").replace(/\s+\n/gu,`
`).replace(/[ \t]+/gu," ").replace(/\s+([гЂ'пјЃпјџгЂЃ])/gu,"$1 ").replace(/([гЂ'пјЃпјџгЂЃ])\s*$/gu,"$1").trim():""}function tk(e){const t=!!r.activeExerciseReviewTranslationOpen,n=e?.reading?q(e.reading):"",s=e?.reading?Ud(e.reading):"",a=h({ru:e?.translationRu||e?.ru||"",en:e?.translationEn||e?.en||""});return`
    ...
    `}function nk(e){return r.reviewExerciseResults?.[e.exerciseId]||pt(e.exercise)||null}function sk(e,t){const n=(e?.options||[]).find(s=>String(s.value||"")===String(t||""));return n?h(n.label||n):String(t||"")}function rk(e){const t=Jd(e);if(!t||!t.exercise)return ra();const n=nk(t),s=!!n?.completed,a=t.progress||pt(t.exercise),o=ek(t.exercise),l=h(t.exercise.sourceTitle||t.exercise.title||{}),c=t.exercise.kind==="question"?Object.keys(n?.answers||{}).length:s?1:Array.isArray(a?.selectedIndices)?a.selectedIndices.length:0,d=t.exercise.kind==="question"?1:Math.max(1,tt(t.exercise).length),u=Array.isArray(a?.selectedIndices)?a.selectedIndices:Array.isArray(r.activeExerciseReviewSelection)?r.activeExerciseReviewSelection:[],m=u.map(v=>t.exercise.tiles?.[v]).filter(Boolean),g=Array.isArray(a?.wrongIndexes)?a.wrongIndexes:[],w=tk(t.exercise);return`
      <article class="study-card textbook-review-card reading-review-card ${s?n?.correct===!1?"is-wrong":"is-correct":""}" data-review-exercise-id="${f(t.exerciseId)}">
        ...
        ${t.exercise.kind==="cloze"?`
          <div class="sentence-card reading-cloze-card">
            <div class="sentence-line">${Pd(t.exercise,m,g)}</div>
        ...
        `:`
          <article class="n4-question-block reading-passage-block">
            ...
            ${n?.answers?.[t.exercise.question.id]?`<p class="n5-feedback">${i(n.answers[t.exercise.question.id].correct?p()==="ru"?"Верно.":"Correct.":`${p()==="ru"?"Неверно":"Wrong"} · ${sk(t.exercise.question,t.exercise.question.answer)}`)}</p>`:""}
          </article>
        `}
    ...
    `}function ak(e){const t=Jd(e);if(!t||!t.exercise)return ra();if(t.source==="reading")return rk(t);const n=!!r.reviewExerciseResults?.[t.exerciseId];return`
    ...
    `}function ok(){const e=Ty(),t=Math.max(ls,Number(r.dictionaryVisibleCount||ls)),n=e.slice(0,t),s=n.length<e.length,a=r.cards.filter(u=>!!r.progress.favorites[u.id]).length,o=["all",...new Set(r.cards.map(u=>u.jlpt))],l=["all",...new Set(r.cards.map(u=>Xs(u.id).radical).filter(Boolean))],c=p()==="ru"?`Показано ${n.length} из ${e.length}`:`Showing ${n.length} of ${e.length}`,d=p()==="ru"?"Показать ещё":"Show more";return`
      <section class="page">
        <div class="section-head">
          <div>
        ...
        <div class="dictionary-grid" style="margin-top:12px">${n.map(ck).join("")||uk()}</div>
        ${s?`
    ...
    `}function lk(e){const t=r.filters.favorites==="yes",n=p()==="ru"?"Все кандзи":"All kanji",s=p()==="ru"?"Избранные":"Favorites";return`
    ...
    `}function ck(e){const t=A(e.id),n=Xs(e.id),s=!!r.progress.favorites[e.id];return`
    ...
    `}function uk(){const e=r.filters.favorites==="yes",t=e?p()==="ru"?"В избранном пока пусто":"No favorites yet":p()==="ru"?"Ничего не найдено":"Nothing found",n=e?p()==="ru"?"Открой кандзи и нажми звездочку, чтобы он появился здесь.":"Open a kanji and tap the star to keep it here.":"";return`<article class="empty-state"><span class="kanji-char">無</span><h2>${i(t)}</h2>${n?`<p>${i(n)}</p>`:""}</article>`}function pk(){const e=X(r.kanjiPageId||Ko());if(!e)return`
        <section class="page">
          <article class="empty-state">
      ...
      `;const t=A(e.id),n=Xs(e.id),s=!!r.progress.favorites[e.id],a=Lk(e,p()),o=gk(e),l=ro(e);return`
      <section class="page kanji-page">
        <div class="section-head kanji-page-head">
          <div>
            ...
            <h1>${i(o?`${e.kanji} — ${mk(o)}`:e.kanji)}</h1>
            <p>${i(o?fk(o):L(e))}</p>
          </div>
          <div class="actions">
    ...
    `}function gk(e){return r.kanjiPageSources?.[e?.kanji]||null}function mk(e){return Gd(e.meanings)[0]||e.literal}function Gd(e){return e?e[p()]||e.ru||e.en||[]:[]}function Xn(e){return!e||typeof e!="object"?String(e||""):e[p()]||e.ru||e.en||""}function fk(e){const t=e.editorial?.[p()]||e.editorial?.ru||e.editorial?.en||{};return[t.why,t.firstSeen].filter(Boolean).join(" ")}function hk(e){const t=e.kanjidic2||{},n=t.codepoints?.unicode||`U+${t.codepoints?.ucs||""}`;return`
      <article class="kanji-profile-card kanji-facts-card">
        <h2>${i(p()==="ru"?"Факты KANJIDIC2":"KANJIDIC2 facts")}</h2>
        <dl class="kanji-fact-grid">
          <div><dt>${i(p()==="ru"?"Значения":"Meanings")}</dt><dd>${i(Gd(e.meanings).join(", "))}</dd></div>
    ...
    `}function bk(e){const t=new Set,n=new Set((e.commonWords||[]).map(s=>s.surface));return(e.sentences||[]).filter(s=>{const a=s.japanese||"";if(!a.includes(e.literal)||t.has(a))return!1;t.add(a);const o=a.replace(/[\sгЂ'гЂЃпјЃпјџ!?гЂЊгЂЌгЂЋгЂЏпј€пј‰()гѓ»гЂњгѓј]/g,"").length;return!(o<3||o>44)}).sort((s,a)=>Number(qd(a.japanese,n))-Number(qd(s.japanese,n))).slice(0,8)}function qd(e,t){return[...t].some(n=>e.includes(n))}function kk(e){return`
    ...
    `}function yk(e){const t=e.editorial?.[p()]||e.editorial?.ru||e.editorial?.en||{},n=p()==="ru"?["Почему этот кандзи важен","Частая путаница","Где встретишь раньше всего","На что обратить внимание"]:["Why this kanji matters","Common confusion","Where you will meet it first","What to watch"],s=[t.why,t.confusion,t.firstSeen,t.focus];return`
    ...
    `}function $k(e){return`../word/${encodeURIComponent(e.surface||"")}/`}function Yi(e,t){const n=String(t||""),s=String(e||"");return n?s.split(n).map(i).join(`<mark class="kanji-hit" data-kanji="${f(n)}">${i(n)}</mark>`):i(s)}function jk(e){const t=Sk(e);return t.length?`
      <ul class="kanji-sentence-list">
        ${t.map(n=>`
          <li>
            <strong>${Ck(n)}</strong>
    ...
    `:`<p class="label">${i(p()==="ru"?"Подходящие предложения появятся, когда база практики содержит этот кандзи.":"Matching sentences will appear when the practice database contains this kanji.")}</p>`}function Sk(e){const t=e?.kanji||"";return t?(r.sentenceExercises||[]).filter(n=>{const s=Hd(n),a=(n.blanks||[]).flatMap(o=>o.answer||[]).join("");return s.includes(t)||a.includes(t)}).slice(0,6):[]}function Hd(e){return e?.sentence||e?.jp||""}function Nk(e){return e?.reading||e?.hiragana||""}function xk(e){return p()==="en"?e?.translationEn||e?.en||e?.translationRu||e?.ru||"":e?.translationRu||e?.ru||e?.translationEn||e?.en||""}function Ck(e){let t=i(Hd(e));return(e?.blanks||[]).map(s=>(s.answer||[]).join("")).forEach(s=>{t=t.replace("___",`<mark>${i(s)}</mark>`)}),t}function Lk(e,t="ru"){return`../${t==="en"?"en":"ru"}/kanji/${Ak(e)}/`}function Ak(e){const t=String(e?.kanji||""),n=Array.from(t).map(o=>`u${o.codePointAt(0).toString(16).padStart(4,"0")}`).join("-"),a=(String(e?.romaji||e?.onyomi_romaji||e?.kunyomi_romaji||"kanji").toLowerCase().split(/[\/,;|()\s]+/).find(o=>/[a-z]/.test(o))||"kanji").replace(/[^a-z0-9]+/g,"-").replace(/^-+|-+$/g,"")||"kanji";return`${n||"kanji"}-${a}`}function Ik(){const e=X(r.activeCardId)||oo()[0]||r.cards[0];e&&(r.activeCardId=e.id,r.activeLessonId=e.lessonId,r.writingStep=Z(r.writingStep,0,Math.max(0,nt(e)-1)));const t=ro(e),n=nt(e),s=p()==="ru"?"Шаг":"Step",a=p()==="ru"?"Получилось":"Got it",o=p()==="ru"?"Показать образец":"Show sample",l=t?p()==="ru"?"Точные SVG-штрихи KanjiVG":"Precise KanjiVG SVG strokes":p()==="ru"?"Fallback: шаблон без фейковых штрихов":"Fallback: template without fake strokes";return`
      <section class="page">
        <div class="section-head">
          <div>
    ...
    `}function Rk(){if(!r.detailCardId)return"";const e=X(r.detailCardId);if(!e)return"";const t=A(e.id),n=Xs(e.id),s=!!r.progress.favorites[e.id];return`
    ...
    `}function _k(){const e=lo(),t=yt(),n=jt();return`
      <section class="page">
        <div class="section-head">
          <div>
            <h1>${i(S("stats"))}</h1>
        ...
        <div class="metric-grid">
          ...
          ${T(S("successRate"),`${ku()}%`,`${co()} reviews`,ku())}
        ...
        <div class="stats-grid" style="margin-top:12px">
          ...
          <article class="tool-panel">${Pk()}</article>
          <article class="tool-panel" data-section="shop-panel">${Dk()}</article>
          <article class="tool-panel">${Wd()}</article>
    ...
    `}function bn(){return r.achievements?.length?r.achievements:r.rewards?.achievements||[]}function Mk(){return r.achievementCategories?.length?r.achievementCategories:[...new Set(bn().map(t=>t.category||"learning"))].map(t=>({id:t,title:{ru:t,en:t},icon:"moon"}))}function eo(e){return h(e.title||e.name||{ru:e.id,en:e.id})}function Xd(e){return h(e.description||{})}function to(e){return{moon:"月",book:"ж›ё",memory:"記",flame:"зЃ«",star:"星",brush:"з­†",text:"文",lock:"йЌµ",eye:"眼"}[e]||"в—†"}function Pk(){return`<h3>${i(S("achievements"))}</h3><div class="achievement-grid compact">${bn().slice(0,8).map(Qd).join("")}</div>`}function Ek(){const e=bn(),t=gj(),n=e.reduce((s,a)=>({xp:s.xp+(a.rewardXp||0),coins:s.coins+(a.rewardFragments||0)}),{xp:0,coins:0});return`
      <section class="page achievements-page">
        ...
        <div class="achievement-category-list">
          ${Mk().map(s=>{const a=e.filter(l=>l.category===s.id);if(!a.length)return"";const o=a.filter(l=>is(l.id)).length;return`
              <section class="achievement-category">
                ...
                <div class="achievement-grid expanded">${a.map(l=>Qd(l,!0)).join("")}</div>
              </section>
            `}).join("")}
        </div>
      </section>
    `}function Qd(e,t=!1){const n=is(e.id),s=au(e),a=Math.max(1,Number(e.target||1)),o=I(s,a),l=Math.min(s,a),c=e.secret&&!n&&!t?p()==="ru"?"Секретное достижение":"Secret achievement":eo(e),d=e.secret&&!n&&!t?p()==="ru"?"Откроется при необычном действии.":"Unlocked by an unusual action.":Xd(e);return`
    ...
    `}function Dk(){return cc({closable:!1})}function Wd(e={}){const t=e.limit||10,n=(r.progress.transactions||[]).slice(0,t);return`
      <h3>${i(S("transactions"))}</h3>
      <div class="transaction-list">
        ${n.map(s=>`
          <div class="transaction-row">
            <div>
              <strong>${i(Ok(s))}</strong>
              <small>${i(M$(s.at))}</small>
            </div>
    ...
    `}function Bk(){if(!r.contactModal)return"";const e=p()==="ru"?"Сообщить об ошибке":"Report a bug",t=p()==="ru"?"Если почтовое приложение не открывается, скопируй адрес и отправь сообщение вручную.":"If your mail app does not open, copy the address and send the message manually.",n=p()==="ru"?"Скопировать email":"Copy email",s=p()==="ru"?"Открыть почту":"Open email",a=p()==="ru"?"Закрыть":"Close",o=encodeURIComponent(gp),l=encodeURIComponent(p()==="ru"?`Привет! Я нашел ошибку в Flash Kanji:
...
`),c=`mailto:${_a}?subject=${o}&body=${l}`;return`
    ...
    `}function zk(){if(Vl()||r.pwaInstallHelpVisible||!To()||r.detailCardId||r.rewardModal||r.finalTestModal||r.contactModal)return"";const e=Zu(),t=!At&&rs();return`
    ...
    `}function Jk(){if(Vl()||!r.notificationPromptVisible||!La("visible")||r.detailCardId||r.rewardModal||r.finalTestModal||r.contactModal||r.pwaInstallHelpVisible||To())return"";const e=ap();return`
    ...
    `}function Uk(e,t,n){const s=ss(e),a=aa(e,t,n),o=eu($e(e,n));return`
    ...
    `}function Qn(e,t,n,s){const a=ss(e),o=aa(e,t,n),l=eu($e(e,n)),c=`${s||"mascot"}:${e}:${n}:${r.route}:${r.activeTextbookLevel||r.activeJlptLesson||""}`.toLowerCase();return Yd(c)?`
    ...
    `}function Vd(){try{const e=sessionStorage.getItem(Jo);return e?JSON.parse(e)||{}:{}}catch{return{}}}function Gk(e){try{sessionStorage.setItem(Jo,JSON.stringify(e||{}))}catch{}}function Yd(e){return e?!!Vd()[e]:!1}function Zd(e){if(!e)return;const t=Vd();t[e]=Date.now(),Gk(t);const n=ln.get(e);n&&(clearTimeout(n),ln.delete(e)),j()}function qk(){const e=new Set;Ga("[data-mascot-speech-key][data-autohide-ms]").forEach(t=>{const n=String(t.dataset.mascotSpeechKey||"");if(!n||Yd(n)||(e.add(n),ln.has(n)))return;const s=Number(t.dataset.autohideMs||0);if(!s)return;const a=window.setTimeout(()=>{ln.delete(n),Zd(n)},s);ln.set(n,a)});for(const[t,n]of ln)e.has(t)||(clearTimeout(n),ln.delete(t))}function aa(e,t="normal",n="welcome"){if(e==="eva")return Kn(Dt(null,Hk(t,n)));const s=ss(e);return s.sprites?.[t]||Object.values(s.sprites||{})[0]||""}function Hk(e="normal",t="welcome"){const n=String(t||"").toLowerCase(),s=String(e||"").toLowerCase(),a={welcome:"welcome",correct:"approve",wrong:"sad",progress:"observe",streakloss:"sad",lessoncomplete:"proud",masterymilestone:"proud",achievement:"achievement",goal:"reward",combo:"proud",hint:"think",dailybonus:"reward"},o={normal:"welcome",calm:"neutral",happy:"happy",proud:"proud",thinking:"think",focus:"think",sad:"sad",angry:"strict",shy:"shy"},l=o[s]&&!["normal","calm"].includes(s)?o[s]:null;return l&&(!n||n==="welcome")?l:a[n]||o[s]||s||"neutral"}function eu(e){if(p()!=="ru")return e;const t="[А-Яа-яЁё]";return String(e||"").replace(new RegExp(`(^|\\s)(${t})\\s+(?=${t}{4,})`,"gu"),"$1$2 ")}function Xk(e){const t=X(r.activeCardId);if(!t||!He[e])return;hs(t,"srs_rating"),Pu();const n=H(A(t.id)),s=ue(n,e);r.progress.cards[t.id]=s,Qt(n,s,e),ve();const a=Number(r.progress.correctCombo||0);kn(e)?(r.progress.totalWrong+=1,r.progress.correctCombo=0,ce({discipline:-.8,trust:-.2},"answer_again"),de("answer_wrong",{cardId:t.id,kanji:t.kanji,rating:e,comboLost:a>0}),er("again"),E($e("eva","wrong"))):(O(r.rewards.rewards.correctXp,r.rewards.rewards.correctCoins,"review_success"),r.progress.totalCorrect+=1,r.progress.correctCombo+=1,r.progress.bestCorrectCombo=Math.max(r.progress.bestCorrectCombo,r.progress.correctCombo),ce({trust:.35,discipline:.25,curiosity:s.lastDecision==="Easy"?.2:0},`answer_${e}`),de("answer_correct",{cardId:t.id,kanji:t.kanji,rating:e,combo:r.progress.correctCombo}),er("ok"),E($e("eva","correct")),r.progress.correctCombo>0&&r.progress.correctCombo%5===0&&(O(r.rewards.rewards.comboXp,0,"combo_bonus"),Ge({title:"Combo",message:$e("leya","combo"),xp:r.rewards.rewards.comboXp,coins:0,mascot:"leya",mood:"proud",dialog:"combo"}))),ys(),Yk(t.lessonId),so(),U(),r.reviewQueueLastKind="card",N(),r.revealed=!1,r.activeCardId=null,gt(),r.pendingFocus="__scroll-top__",j()}function ia(){return p()==="ru"?{forgot:"Не помню",remember:"Помню",forgotHint:"вернём быстро",rememberHint:"Повторение выберет срок"}:{forgot:"Forgot",remember:"Remember",forgotHint:"review soon",rememberHint:"review decides"}}function Qk(e){const t=ia(),n=A(e.id),s=tu(n,"remember"),a=Yg(n,s);return`${t.rememberHint}: ${Zg(ws(a))}`}function tu(e,t){if(kn(t))return"again";if(t!=="remember")return t;const n=e.state||"New",s=Number(e.reviews||e.reviewCount||0),a=Number(e.correct||0),o=Number(e.wrong||0),l=Number(e.lapses||0),c=Number(e.successRate||(s?a/Math.max(a+o,1)*100:0));return n==="New"?"good":n==="Learning"?c>=70||a>=2?"good":"hard":c>=88&&a>=5&&l<=1?"easy":c<70||l>Math.max(1,Math.floor(a/3))?"hard":"good"}function kn(e){return e==="forgot"||e==="again"}function ue(e,t,n=t){const s=new Date,a=H(e),o=n,l=tu(e,t);t=l;const c=e.state||"New";let d=Number(e.easeFactor||2.5),u=Number(e.intervalDays||0),m=Nr(e),g=c;return t==="again"?(d=Math.max(1.3,d-.2),m=0,u=ws(m),g="Learning",a.lapses+=c==="New"?0:1,a.wrong+=1):t==="hard"?(d=Math.max(1.3,d-.15),m=m<1?1:m,u=ws(m),g=u<1?"Learning":"Review",a.correct+=1):t==="good"?(m=m<0?0:m+1,u=ws(m),g=u<1?"Learning":"Review",a.correct+=1):t==="easy"&&(d=Math.min(3.2,d+.15),m=m<0?2:m+2,u=ws(m),g=u<1?"Learning":"Review",a.correct+=1),a.correct>=8&&u>=30&&(g="Mastered"),a.state=g,a.stage=Zs(g),a.easeFactor=as(d,2),a.intervalDays=as(u,6),a.srsStep=m,a.dueAt=ip(s,u).toISOString(),a.nextReview=a.dueAt,a.lastReviewedAt=s.toISOString(),a.lastReview=a.lastReviewedAt,a.lastRating=He[o]||He[t],a.lastDecision=He[l]||He[t],a.reviews+=1,a.reviewCount=a.reviews,a.history=[...e.history||[],{at:s.toISOString(),rating:He[o]||He[t],inputRating:He[o]||He[t],decision:He[l]||He[t],from:c,to:g,intervalDays:a.intervalDays,srsStep:m}].slice(-120),a.successRate=Lo(a),a}function Wn(e="",t="",n="",s={}){return{level:String(e||"").toUpperCase(),lessonId:String(s.lessonId||t||""),exerciseId:String(s.exerciseId||n||""),cardId:String(s.cardId||""),kanji:String(s.kanji||""),type:String(s.type||""),title:s.title||null,prompt:String(s.prompt||""),answer:String(s.answer||""),answerLabel:String(s.answerLabel||""),state:"New",intervalDays:0,srsStep:-1,easeFactor:2.5,dueAt:null,lastReviewedAt:null,lastRating:null,reviews:0,lapses:0,correct:0,wrong:0,stage:"new",lastReview:null,nextReview:null,reviewCount:0,successRate:0,history:[]}}function Xt(e,t={}){const s={...Wn(t.level||"",t.lessonId||"",t.exerciseId||"",t),...e||{}};if(s.level=String(t.level||s.level||"").toUpperCase(),s.lessonId=String(t.lessonId||s.lessonId||""),s.exerciseId=String(t.exerciseId||s.exerciseId||""),s.cardId=String(t.cardId||s.cardId||""),s.kanji=String(t.kanji||s.kanji||""),s.type=String(t.type||s.type||""),s.title=t.title||s.title||null,s.prompt=String(t.prompt||s.prompt||""),s.answer=String(t.answer||s.answer||""),s.answerLabel=String(t.answerLabel||s.answerLabel||""),s.stage||=Zs(s.state),s.lastReview||=s.lastReviewedAt||null,s.nextReview||=s.dueAt||null,s.reviewCount||=s.reviews||0,s.successRate=Lo(s),s.state=Yu(s.stage),s.dueAt=s.nextReview,s.lastReviewedAt=s.lastReview,Number.isFinite(Number(s.srsStep))?s.srsStep=Z(Math.trunc(Number(s.srsStep)),-1,63):s.srsStep=Nr(s),Number(s.reviews||0)===0&&!s.lastReview&&!s.lastReviewedAt&&(s.dueAt?new Date(s.dueAt).getTime():0)>Date.now()){const l=new Date().toISOString();s.state="Learning",s.stage="learning",s.intervalDays=0,s.srsStep=Math.max(0,Number.isFinite(Number(s.srsStep))?Math.trunc(Number(s.srsStep)):0),s.dueAt=l,s.nextReview=l}return s}function oa(e,t,n){const s={...e||{}};return Object.entries(t||{}).forEach(([a,o])=>{s[a]=Xt(o,{level:n,exerciseId:a,lessonId:o?.lessonId||"",cardId:o?.cardId||"",kanji:o?.kanji||"",type:o?.type||"",title:o?.title||null,prompt:o?.prompt||"",answer:o?.answer||"",answerLabel:o?.answerLabel||""})}),s}function Wk(e){const t=F(e);return t==="N5"?J():t==="N4"?P():t==="N3"?_():t==="N2"?M():null}function no(e){const t=F(e);return t==="N5"?Se():t==="N4"?Ke():t==="N3"?Fe():t==="N2"?Je():[]}function Vk(e,t){const n=F(e),s=String(t||"");return!n||!s?null:no(n).find(a=>a.id===s||a.id===`${n.toLowerCase()}-${s}`||a.id.endsWith(`-${s}`))||null}function nu(e){const t=F(e);return t==="N5"?Ls:t==="N4"?qr:t==="N3"?Hr:t==="N2"?Xr:null}function la(e,t,n=""){const s=nu(e),a=F(e),o=String(t||"");if(!s||!a||!o)return null;const l=Vk(a,n);if(l){const c=s(l).find(d=>String(d.id)===o);if(c)return c}for(const c of no(a)){const d=s(c).find(u=>String(u.id)===o);if(d)return d}return null}function ca(e,t){const n=F(t);if(!e||!n)return!1;e.exerciseSrs||={};const s=new Set([...Object.keys(e.viewedLessons||{}),...Object.keys(e.completedLessons||{})]),a=new Set([...Object.keys(e.completedExercises||{}),...Object.keys(e.exerciseResults||{})]);let o=!1;return a.forEach(l=>{if(e.exerciseSrs[l])return;const c=la(n,l);if(!c||!s.has(String(c.lessonId||"")))return;const d=Wn(n,c.lessonId||"",c.id,c),u=e.exerciseResults?.[l]||null,m=!!e.completedExercises?.[l],g=ue(H(d),m||u?.correct?"good":"again");g.level=n,g.lessonId=String(c.lessonId||g.lessonId||""),g.exerciseId=String(c.id||l||""),g.cardId=String(c.cardId||g.cardId||""),g.kanji=String(c.kanji||g.kanji||""),g.type=String(c.type||g.type||""),g.title=c.title||g.title||null,g.prompt=String(c.prompt||g.prompt||""),g.answer=String(c.answer||g.answer||""),g.answerLabel=String(c.answerLabel||g.answerLabel||""),e.exerciseSrs[l]=g,o=!0}),o}function da(e,t){const n=F(t);if(!e||!n)return!1;const s=no(n),a=nu(n);if(!a?.length&&!a)return!1;e.exerciseSrs||={};const o=new Set(Object.keys(e.completedLessons||{})),l=new Set([...Object.keys(e.viewedLessons||{}),...o]);let c=!1;return s.forEach(d=>{if(!l.has(d.id))return;(a(d)||[]).forEach(m=>{if(!m?.id||e.exerciseSrs[m.id])return;const g=Wn(n,d.id,m.id,{...m,lessonId:d.id}),w=new Date().toISOString();e.exerciseSrs[m.id]=Xt({...g,state:"Learning",stage:"learning",intervalDays:0,srsStep:0,dueAt:w,nextReview:w,lastReviewedAt:null,lastRating:null,reviews:0,lapses:0,correct:0,wrong:0,lastReview:null,reviewCount:0,history:[]},{level:n,lessonId:d.id,exerciseId:m.id,cardId:m.cardId||"",kanji:m.kanji||"",type:m.type||"",title:m.title||null,prompt:m.prompt||"",answer:m.answer||"",answerLabel:m.answerLabel||""}),c=!0})}),c}function Yk(e){if(r.progress.lessonCompletions[e])return;const t=uo(e);if(!(t.length>0&&t.every(o=>A(o.id).state!=="New")))return;const s=r.rewards.rewards.lessonCompleteXp,a=r.rewards.rewards.lessonCompleteCoins;r.progress.lessonCompletions[e]=new Date().toISOString(),C("lesson_complete"),O(s,a,"lesson_completion"),ce({warmth:2.4,trust:2,discipline:2.2,curiosity:.8},"lesson_completion"),de("lesson_complete",{lessonId:e,xp:s,coins:a}),Ge({title:h({ru:"Урок завершён",en:"Lesson complete"}),message:$e("eva","lessonComplete"),xp:s,coins:a,mascot:"eva",mood:"happy",dialog:"lessonComplete"}),Aa("lesson_complete")}function so(){const e=W(),t=yt();if(t.goalClaimed||t.reviews<r.progress.settings.dailyGoal)return;t.goalClaimed=!0;const n=r.rewards.rewards.comboXp,s=r.rewards.rewards.streakCoins;O(n,s,"daily_goal"),Ge({title:S("dailyGoal"),message:$e("leya","goal"),xp:n,coins:s,mascot:"leya",mood:"happy",dialog:"goal"}),r.progress.daily[e]=t}function Zk(){const e=ua(),t=W();e.firstVisitDate||(e.firstVisitDate=t),e.lastVisitDate=t,r.progress.appOpens=Number(r.progress.appOpens||0)+1;const n=new Date().getHours();(n>=22||n<5)&&(r.progress.secrets.nightVisit=!0),su()}function su(){const e=r.progress.streak,t=kl(e.pendingReward);if(!t||W()<t.availableOn)return!1;e.pendingReward=null;const n=r.rewards.rewards.streakCoins;return C("streak_reward"),O(0,n,`streak:${t.milestone}:claim`),Ge({title:p()==="ru"?"Награда за стрик":"Streak reward",message:p()==="ru"?`Бонус за серию ${t.milestone} дней готов.`:`Your ${t.milestone}-day streak bonus is ready.`,xp:0,coins:n,mascot:"eva",mood:"achievement",dialog:"achievement"}),U(),N(),!0}function ey(e){if(e==="eva"){r.progress.secrets.evaClicks=Number(r.progress.secrets.evaClicks||0)+1,ce({warmth:.2,curiosity:.1},"eva_click"),E($e("eva","welcome")),U(),N(),j();return}e==="leya"&&E($e("leya","combo"))}function ru(){Y(),r.progress.secrets.evaClicks=Number(r.progress.secrets.evaClicks||0)+1,r.evaRuntime||=at(),r.evaRuntime.clickCount=Number(r.evaRuntime.clickCount||0)+1,de("user_clicked_eva",{clickCount:r.evaRuntime.clickCount}),U(),C("notification_soft"),N(),j()}function ty(){if(B.completed)return;B.completed=!0,r.progress.writingPractice.completed=Number(r.progress.writingPractice.completed||0)+1,B.cardId&&(r.progress.writingPractice.cards[B.cardId]=(r.progress.writingPractice.cards[B.cardId]||0)+1),ce({curiosity:1,discipline:.8,trust:.4},"writing_complete"),de("writing_complete",{cardId:B.cardId});const e=U();N(),e&&j()}function ny(){const e=W();ua();const t=sy(),n=yr(r.progress.dailyBonusPending);n&&n.availableOn>e||(n&&n.availableOn<=e&&!t&&(r.progress.dailyBonusPending=null),r.progress.dailyBonusPending={availableOn:op(e,1)},N())}function sy(){const e=W(),t=ua(),n=yr(r.progress.dailyBonusPending);if(!n||W()<n.availableOn||r.progress.dailyBonuses[e]||t.lastDailyBonusDate===e)return!1;r.progress.dailyBonusPending=null;const s=t.lastDailyBonusDate||t.firstVisitDate||t.lastVisitDate;return ry(s,e),t.lastVisitDate=e,t.lastDailyBonusDate=e,r.progress.dailyBonuses[e]=new Date().toISOString(),C("daily_bonus"),O(r.rewards.rewards.dailyBonusXp,r.rewards.rewards.dailyBonusCoins,"daily_bonus"),ce({warmth:1,discipline:.8},"daily_bonus"),Ge({title:S("dailyBonus"),message:$e("leya","welcome"),xp:r.rewards.rewards.dailyBonusXp,coins:r.rewards.rewards.dailyBonusCoins,mascot:"leya",mood:"calm",dialog:"welcome"}),U(),Mo(),!0}function ua(){r.progress.visits||={};const e=r.progress.visits;return e.firstVisitDate||=null,e.lastVisitDate||=null,e.lastDailyBonusDate||=null,e.streak=Number(e.streak||0),e.bestStreak=Number(e.bestStreak||0),e}function ry(e,t){const n=ua();n.streak=e&&tn(e,t)===1?n.streak+1:1,n.bestStreak=Math.max(n.bestStreak||0,n.streak);const s=r.progress.streak.lastStudyDate;s!==t&&(r.progress.streak.current=s&&tn(s,t)===1?r.progress.streak.current+1:1,r.progress.streak.lastStudyDate=t,r.progress.streak.best=Math.max(r.progress.streak.best||0,r.progress.streak.current),r.progress.streakHistory.push({date:t,value:r.progress.streak.current}),r.progress.streakHistory=r.progress.streakHistory.slice(-120))}function U(){if(!bn().length)return 0;let e=0;return bn().forEach(t=>{if(is(t.id)||!ay(t))return;e+=1;const n=t.rewardXp||0,s=t.rewardFragments||0;r.progress.achievements[t.id]={unlockedAt:new Date().toISOString(),rewardXp:n,rewardFragments:s},Ge({type:"achievement",title:eo(t),message:Xd(t),xp:n,coins:s,icon:t.icon,mascot:"eva",mood:"happy",dialog:"achievement"}),O(n,s,`achievement:${t.id}`)}),e}function ay(e){return au(e)>=Number(e.target||1)}function au(e){if(e.kind==="lessonComplete")return Object.keys(r.progress.lessonCompletions).length;if(e.kind==="correct")return r.progress.totalCorrect;if(e.kind==="learned")return lo().learned;if(e.kind==="reviews")return co();if(e.kind==="streak")return Math.max(r.progress.streak.current||0,r.progress.streak.best||0);if(e.kind==="level")return r.progress.level||1;if(e.kind==="moonFragments")return r.progress.totalMoonFragmentsEarned||0;if(e.kind==="writing")return r.progress.writingPractice?.completed||0;if(e.kind==="sentence")return Object.keys(r.progress.sentencePractice?.completed||{}).length;if(e.kind==="evaClicks")return r.progress.secrets?.evaClicks||0;if(e.kind==="nightVisit")return r.progress.secrets?.nightVisit?1:0;if(e.kind==="appOpens")return r.progress.appOpens||0;if(e.kind==="n5KanjiStudied")return Object.keys(J().studiedKanji||{}).length;if(e.kind==="n5LessonComplete"||e.kind==="n5LessonsComplete")return hn();if(e.kind==="n5Writing")return Object.keys(J().writingPractice||{}).length;if(e.kind==="n5SrsAll")return Object.keys(J().srsKanji||{}).length;if(e.kind==="n5FinalPass")return J().finalTest?.passed?1:0;if(e.kind==="n4Opened")return P().opened?1:0;if(e.kind==="n4LessonComplete")return Object.keys(P().completedLessons||{}).length;if(e.kind==="n4LessonsComplete")return Object.keys(P().completedLessons||{}).length;if(e.kind==="n4SrsAll")return Object.keys(P().srsKanji||{}).length;if(e.kind==="n4GrammarComplete")return Object.keys(P().completedGrammar||{}).length;if(e.kind==="n4ReadingComplete")return Object.keys(P().completedReading||{}).length;if(e.kind==="n4ListeningComplete")return Object.keys(P().completedListening||{}).length;if(e.kind==="n4Writing")return Object.keys(P().writingPractice||{}).length;if(e.kind==="n4FinalPass")return P().finalTest?.passed?1:0;if(e.kind==="n3Opened")return _().opened?1:0;if(e.kind==="n3LessonComplete")return Object.keys(_().completedLessons||{}).length;if(e.kind==="n3LessonsComplete")return Object.keys(_().completedLessons||{}).length;if(e.kind==="n3SrsAll")return Object.keys(_().srsKanji||{}).length;if(e.kind==="n3GrammarComplete")return Object.keys(_().completedGrammar||{}).length;if(e.kind==="n3ReadingComplete")return Object.keys(_().completedReading||{}).length;if(e.kind==="n3ListeningComplete")return Object.keys(_().completedListening||{}).length;if(e.kind==="n3Writing")return Object.keys(_().writingPractice||{}).length;if(e.kind==="n3ComprehensionAnswers")return Object.values(_().readingAnswers||{}).filter(t=>t&&t.correct).length;if(e.kind==="n3FinalPass")return _().finalTest?.passed?1:0;if(e.kind==="n2Opened")return M().opened?1:0;if(e.kind==="n2LessonComplete")return Object.keys(M().completedLessons||{}).length;if(e.kind==="n2LessonsComplete")return Object.keys(M().completedLessons||{}).length;if(e.kind==="n2SrsAll")return Object.keys(M().srsKanji||{}).length;if(e.kind==="n2GrammarComplete")return Object.keys(M().completedGrammar||{}).length;if(e.kind==="n2ReadingComplete")return Object.keys(M().completedReading||{}).length;if(e.kind==="n2ListeningComplete")return Object.keys(M().completedListening||{}).length;if(e.kind==="n2Writing")return Object.keys(M().writingPractice||{}).length;if(e.kind==="n2ComprehensionAnswers")return Object.values(M().readingAnswers||{}).filter(t=>t&&t.correct).length;if(e.kind==="n2FinalPass")return M().finalTest?.passed?1:0;if(e.kind==="shopComplete"){const t=Oe().filter(n=>!n.defaultOwned&&n.price>0);return t.length&&t.every(n=>ot(n.id))?1:0}if(e.kind==="jlpt"){const t=r.cards.filter(n=>n.jlpt===e.jlpt);return t.length>0&&t.every(n=>A(n.id).state==="Mastered")?1:0}return 0}function Ge(e){if(!r.rewardModal){r.rewardModal=e,iu(e);return}if(e.type==="level"){r.rewardQueue.unshift(e);return}r.rewardQueue.push(e)}function iu(e){if(J$(),e?.type==="achievement"){Ws()?C("achievement_unlock"):ja()&&z$();return}if(e?.type==="level"){C("level_up");return}((e?.xp||0)>0||(e?.coins||0)>0)&&C("notification_reward")}function O(e,t,n="reward"){const s=r.progress.level||ya(r.progress.xp);r.progress.xp+=e,r.progress.moonFragments+=t;const a=iy(n);if(!a&&e>0&&C("xp_gain"),!a&&t>0&&C("moon_fragment_gain"),t>0&&(r.progress.totalMoonFragmentsEarned=Number(r.progress.totalMoonFragmentsEarned||0)+t),r.progress.level=ya(r.progress.xp),(e||t)&&(r.progress.transactions.unshift({at:new Date().toISOString(),reason:n,xp:e,coins:t,balance:r.progress.moonFragments}),r.progress.transactions=r.progress.transactions.slice(0,80)),r.progress.level>s){C("level_up"),de("level_up",{level:r.progress.level,xp:r.progress.xp,moonFragments:r.progress.moonFragments});const o=jt();Ge({type:"level",title:S("levelUp"),message:`${S("level")} ${r.progress.level} - ${o.current}/${o.next} XP - ${r.progress.moonFragments} ${S("coins")}`,xp:0,coins:0,mascot:r.progress.level%2===0?"leya":"eva",mood:"happy",dialog:"achievement",level:r.progress.level,totalXp:r.progress.xp,moonFragments:r.progress.moonFragments})}}function iy(e){return["learn","review"].includes(r.route)&&["review_success","combo_bonus"].includes(e)}function Qt(e,t,n){const s=yt();s.reviews+=1,e.state==="New"&&t.state!=="New"&&(s.learned+=1),e.state!=="Mastered"&&t.state==="Mastered"&&(s.mastered+=1),kn(n)&&(s.mistakes+=1),s.minutes=as(s.reviews*.75+s.learned*1.25,1),r.progress.daily[W()]=s}function ve(){su();const e=W(),t=r.progress.streak.lastStudyDate;if(t===e)return;const n=!!(t&&tn(t,e)>1&&r.progress.streak.current>0);r.progress.streak.current=t&&tn(t,e)===1?r.progress.streak.current+1:1,r.progress.streak.lastStudyDate=e,r.progress.streak.best=Math.max(r.progress.streak.best,r.progress.streak.current),r.progress.streakHistory.push({date:e,value:r.progress.streak.current}),r.progress.streakHistory=r.progress.streakHistory.slice(-120),ce(n?{discipline:-3.5,trust:-1.4,warmth:-.8}:{discipline:1.4,trust:.8,warmth:.4},n?"streak_lost":"study_streak"),n&&E($e("eva","streakLoss")),[1,7,30,100].includes(r.progress.streak.current)&&(r.progress.streak.pendingReward={milestone:r.progress.streak.current,availableOn:op(e,1)}),de("streak_up",{streak:r.progress.streak.current,lost:n}),N()}function ou(){if(r.route!=="stats")return;if(!window.Chart){Lp().then(()=>{r.route==="stats"&&ou()}).catch(a=>console.warn("Chart.js failed to load.",a));return}const e=uj(10),t=e.map(a=>a.slice(5)),n=O$(),s=K$(n);Ks("activityChart",{type:"bar",data:{labels:t,datasets:[{label:S("learned"),data:e.map(a=>r.progress.daily[a]?.learned||0),backgroundColor:n.green},{label:S("review"),data:e.map(a=>r.progress.daily[a]?.reviews||0),backgroundColor:n.red}]},options:s}),Ks("jlptChart",{type:"bar",data:{labels:Object.keys($u()),datasets:[{label:S("mastered"),data:Object.values($u()),backgroundColor:n.yellow}]},options:s}),Ks("streakChart",{type:"line",data:{labels:t,datasets:[{label:S("streak"),data:e.map(a=>r.progress.streakHistory.find(o=>o.date===a)?.value||(r.progress.daily[a]?.reviews?1:0)),borderColor:n.blue,backgroundColor:n.blueSoft,fill:!0,tension:.35}]},options:s}),Ks("stateChart",{type:"doughnut",data:{labels:Object.keys(yu()),datasets:[{data:Object.values(yu()),backgroundColor:[n.blue,n.yellow,n.green,n.pink],borderColor:n.line}]},options:{responsive:!0,maintainAspectRatio:!1,plugins:{legend:{labels:{color:n.text}}}}}),Ks("mistakeChart",{type:"line",data:{labels:t,datasets:[{label:S("errors"),data:e.map(a=>r.progress.daily[a]?.mistakes||0),borderColor:n.danger,backgroundColor:n.dangerSoft,fill:!0,tension:.35}]},options:s})}function Ks(e,t){const n=document.getElementById(e);n&&r.charts.push(new Chart(n,t))}function oy(){const e=Wt();e&&(r.activeCardId=e.id,r.activeLessonId=e.lessonId,r.writingStep=Z(r.writingStep,0,Math.max(0,nt(e)-1)),B.cardId!==String(e.id)&&ly(e)),cy(),Fs(),pa(),Gs(Bs(!1)),window.setTimeout(cu,120)}function Wt(){return X(r.activeCardId)||oo()[0]||r.cards[0]||null}function ly(e){B.cardId=String(e?.id||""),B.strokes=[],B.currentStroke=[],B.drawing=!1,B.activePointerId=null,B.completed=!1}function cy(){const e=document.getElementById("practiceCanvas");if(!e)return;Vn();const t=a=>{a.pointerType==="mouse"&&a.button!==0||(a.preventDefault(),e.setPointerCapture?.(a.pointerId),B.drawing=!0,B.activePointerId=a.pointerId,B.currentStroke=[lu(e,a)],B.completed=!1,Vn())},n=a=>{if(!B.drawing||a.pointerId!==B.activePointerId)return;a.preventDefault();const o=lu(e,a),l=B.currentStroke[B.currentStroke.length-1];(!l||vu(l,o)>1.4)&&(B.currentStroke.push(o),Vn())},s=a=>{if(!B.drawing||a.pointerId!==B.activePointerId)return;a.preventDefault();const o=dy(B.currentStroke);o.length&&B.strokes.push(o),B.currentStroke=[],B.drawing=!1,B.activePointerId=null,Vn(),Gs(Bs(!1))};e.onpointerdown=t,e.onpointermove=n,e.onpointerup=s,e.onpointercancel=s,e.onpointerleave=s,e.oncontextmenu=a=>a.preventDefault()}function lu(e,t){const n=e.getBoundingClientRect();return{x:Z((t.clientX-n.left)*(e.width/n.width),0,e.width),y:Z((t.clientY-n.top)*(e.height/n.height),0,e.height),pressure:t.pressure||.5,time:performance.now()}}function dy(e){if(!e.length)return[];const t=[e[0]];return e.slice(1).forEach(n=>{vu(t[t.length-1],n)>=2.6&&t.push(n)}),t.length===1?[t[0],{...t[0],x:t[0].x+.1,y:t[0].y+.1}]:t}function Vn(){const e=document.getElementById("practiceCanvas");if(!e)return;const t=e.getContext("2d"),n=Wt();hu(t,e),n&&my(t,e,n),B.strokes.forEach((s,a)=>fu(t,s,{color:getComputedStyle(document.documentElement).getPropertyValue("--text").trim(),width:13,shadow:a===B.strokes.length-1})),B.currentStroke.length&&fu(t,B.currentStroke,{color:getComputedStyle(document.documentElement).getPropertyValue("--accent-2").trim(),width:13,shadow:!0})}function uy(){B.strokes=[],B.currentStroke=[],B.drawing=!1,B.completed=!1,Vn(),Gs(Bs(!1))}function py(){B.strokes.pop(),B.currentStroke=[],B.completed=!1,Vn(),Gs(Bs(!1))}function gy(e=!1){const t=Bs(!0);Gs(t),e&&(er(t.success?"good":"again"),E(t.message),t.success&&ty())}function Bs(e){const t=document.getElementById("practiceCanvas"),n=Wt(),s=nt(n);if(!t||!n)return{score:0,success:!1,expectedCount:s,message:""};const a=B.strokes;if(!a.length)return{score:0,success:!1,expectedCount:s,message:p()==="ru"?"Начни с первой черты.":"Start with the first stroke."};const o=Z(Math.round(Math.min(a.length,s)/s*100),0,100),l=e?100:o,c=!!(e&&a.length);let d=p()==="ru"?`Черты: ${a.length}/${s}. Самопроверка без распознавания.`:`Strokes: ${a.length}/${s}. Self-check without recognition.`;return!e&&a.length<s?d=p()==="ru"?`Черта ${a.length+1}/${s}: продолжай по образцу.`:`Stroke ${a.length+1}/${s}: keep following the guide.`:!e&&a.length>s?d=p()==="ru"?`Черты: ${a.length}/${s}. Если лишняя линия случайная, нажми «Отменить черту».`:`Strokes: ${a.length}/${s}. If one was accidental, tap "Undo stroke".`:e&&(d=ro(n)?p()==="ru"?"Записано. Сравни с жёлтым порядком KanjiVG и двигайся дальше.":"Saved. Compare it with the yellow KanjiVG order and move on.":p()==="ru"?"Записано. Для этого кандзи пока есть только шаблон, без точной схемы штрихов.":"Saved. This kanji currently has a template only, without exact stroke paths."),{score:l,success:c,expectedCount:s,message:d}}function cu(){const e=document.getElementById("strokeCanvas"),t=Wt();if(!e||!t)return;cancelAnimationFrame(B.demoAnimationId);const n=nt(t),s=460,a=performance.now(),o=l=>{const c=l-a,d=Z(Math.floor(c/s),0,n-1),u=Z((c-d*s)/s,0,1);r.writingStep=d,Fs(d,u),pa(),c<n*s?B.demoAnimationId=requestAnimationFrame(o):(r.writingStep=n-1,Fs(r.writingStep,1),pa())};B.demoAnimationId=requestAnimationFrame(o)}function du(){const e=document.getElementById("strokeCanvas"),t=Wt();if(!e||!t)return;cancelAnimationFrame(B.demoAnimationId);const n=performance.now(),s=520,a=Z(r.writingStep,0,Math.max(0,nt(t)-1)),o=l=>{const c=Z((l-n)/s,0,1);Fs(a,c),c<1&&(B.demoAnimationId=requestAnimationFrame(o))};B.demoAnimationId=requestAnimationFrame(o)}function uu(e){pu(r.writingStep+e,!1)}function pu(e,t){const n=Wt();n&&(r.writingStep=Z(e,0,Math.max(0,nt(n)-1)),pa(),t?du():Fs(r.writingStep,1))}function pa(){const e=Wt();if(!e)return;const t=Us(e),n=p()==="ru"?"Шаг":"Step",s=document.getElementById("writingStepCounter");s&&(s.textContent=`${n} ${r.writingStep+1}/${nt(e)}`);const a=document.querySelector(".writing-step-head .label");a&&(a.textContent=t[r.writingStep]||""),Ga(".writing-guide-list li").forEach((o,l)=>o.classList.toggle("is-active",l===r.writingStep))}function Fs(e=r.writingStep,t=1){const n=document.getElementById("strokeCanvas"),s=Wt();if(!n||!s)return;const a=n.getContext("2d");hu(a,n);const o=zs(s);if(!o){mu(a,n,s,e);return}gu(a,n,o,{activeIndex:e,progress:t,showFuture:!0,guideAlpha:1,showNumbers:!0})}function my(e,t,n){const s=zs(n);if(!s){mu(e,t,n,r.writingStep);return}gu(e,t,s,{activeIndex:r.writingStep,progress:1,showFuture:!0,guideAlpha:.24,showNumbers:!1})}function zs(e){if(!e?.kanji)return null;const t=r.kanjiStrokes?.[e.kanji];return t?.strokeOrder?.length?t:null}function ro(e){return!!zs(e)}function nt(e){const t=zs(e);return Math.max(1,t?.strokeOrder?.length||Number(e?.strokes||1))}function Js(){const e=getComputedStyle(document.documentElement),t=n=>e.getPropertyValue(n).trim();return{paper:t("--writing-paper")||t("--surface")||"#ffffff",border:t("--writing-paper-border")||t("--line")||"#d0d5dd",grid:t("--writing-grid")||t("--line")||"#d0d5dd",gridStrong:t("--writing-grid-strong")||t("--line-strong")||"#98a2b3",ink:t("--writing-ink")||t("--text")||"#111014",guide:t("--writing-guide")||t("--muted")||"#5f6670",templateOpacity:Number(t("--writing-template-opacity")||"0.16")||.16}}function gu(e,t,n,s={}){const a=Z(Number(s.activeIndex||0),0,Math.max(0,n.strokeOrder.length-1)),o=fy(n,t,s.padding||22),l=Js(),c=getComputedStyle(document.documentElement).getPropertyValue("--accent").trim(),d=getComputedStyle(document.documentElement).getPropertyValue("--accent-2").trim(),u=l.guide;n.strokeOrder.forEach((m,g)=>{const w=g<a,v=g===a;g>a&&!s.showFuture||(e.save(),e.translate(o.x,o.y),e.scale(o.scale,o.scale),e.lineCap="round",e.lineJoin="round",e.strokeStyle=v?d:w?c:u,e.lineWidth=(v?8:5.5)/o.scale,e.globalAlpha=Number(s.guideAlpha??1)*(v?1:w?.86:.24),v&&s.progress<1&&(e.globalAlpha*=.45+Z(s.progress,0,1)*.55),v&&(e.shadowColor="rgba(248, 216, 74, 0.34)",e.shadowBlur=13/o.scale),e.stroke(new Path2D(m.path)),e.restore(),s.showNumbers&&vy(e,m,o,g+1,v))})}function fy(e,t,n=22){const s=hy(e.viewBox),a=Math.min((t.width-n*2)/s.width,(t.height-n*2)/s.height),o=(t.width-s.width*a)/2-s.x*a,l=(t.height-s.height*a)/2-s.y*a;return{...s,scale:a,x:o,y:l}}function hy(e){const t=String(e||"0 0 109 109").trim().split(/\s+/).map(Number),[n=0,s=0,a=109,o=109]=t;return{x:n,y:s,width:Math.max(1,a),height:Math.max(1,o)}}function vy(e,t,n,s,a){const o=wy(t.path);if(!o)return;const l=n.x+o.x*n.scale,c=n.y+o.y*n.scale;by(e,l,c,s,a)}function wy(e){const t=String(e||"").match(/M\s*(-?\d+(?:\.\d+)?)[,\s]+(-?\d+(?:\.\d+)?)/i);return t?{x:Number(t[1]),y:Number(t[2])}:null}function by(e,t,n,s,a){e.save(),e.fillStyle=a?getComputedStyle(document.documentElement).getPropertyValue("--accent-2").trim():getComputedStyle(document.documentElement).getPropertyValue("--surface-2").trim(),e.strokeStyle=getComputedStyle(document.documentElement).getPropertyValue("--line-strong").trim(),e.lineWidth=1,e.beginPath(),e.arc(t,n,a?13:10,0,Math.PI*2),e.fill(),e.stroke(),e.fillStyle=a?"#111014":getComputedStyle(document.documentElement).getPropertyValue("--text").trim(),e.font="800 12px system-ui",e.textAlign="center",e.textBaseline="middle",e.fillText(String(s),t,n+.5),e.restore()}function mu(e,t,n,s=0){const a=Js(),o=getComputedStyle(document.documentElement).getPropertyValue("--accent-2").trim();e.save(),e.globalAlpha=a.templateOpacity,e.fillStyle=a.ink,e.font=`900 ${Math.floor(t.height*.7)}px "Noto Sans JP", "Yu Gothic", serif`,e.textAlign="center",e.textBaseline="middle",e.fillText(n?.kanji||"文",t.width/2,t.height/2+t.height*.04),e.globalAlpha=1,e.fillStyle=o,e.font="800 15px system-ui",e.textAlign="left",e.textBaseline="top";const l=p()==="ru"?`Шаг ${s+1}/${nt(n)} · точной схемы пока нет`:`Step ${s+1}/${nt(n)} · exact paths not available yet`;e.fillText(l,18,16),e.restore()}function fu(e,t,n={}){const s=t.map($y).filter(Boolean);if(!e||!s.length)return;const a=Js();if(e.save(),e.strokeStyle=n.color||a.ink,e.lineWidth=n.width||12,e.lineCap="round",e.lineJoin="round",e.imageSmoothingEnabled=!0,n.shadow&&(e.shadowColor="rgba(255, 48, 92, 0.36)",e.shadowBlur=12),e.beginPath(),e.moveTo(s[0].x,s[0].y),s.length===1){e.arc(s[0].x,s[0].y,e.lineWidth/2,0,Math.PI*2),e.fillStyle=e.strokeStyle,e.fill(),e.restore();return}if(s.length===2)e.lineTo(s[1].x,s[1].y);else{for(let l=1;l<s.length-1;l+=1){const c=jy(s[l],s[l+1]);e.quadraticCurveTo(s[l].x,s[l].y,c.x,c.y)}const o=s[s.length-1];e.lineTo(o.x,o.y)}e.stroke(),e.restore()}function hu(e,t){if(!e||!t)return;const n=Js();e.clearRect(0,0,t.width,t.height),e.fillStyle=n.paper,e.fillRect(0,0,t.width,t.height),ky(e,t)}function ky(e,t){const n=Js();e.save(),e.strokeStyle=n.grid,e.lineWidth=1,e.setLineDash([8,8]),e.beginPath(),e.moveTo(t.width/2,0),e.lineTo(t.width/2,t.height),e.moveTo(0,t.height/2),e.lineTo(t.width,t.height/2),e.moveTo(0,0),e.lineTo(t.width,t.height),e.moveTo(t.width,0),e.lineTo(0,t.height),e.stroke(),e.setLineDash([]),e.strokeStyle=n.gridStrong,e.strokeRect(.5,.5,t.width-1,t.height-1),e.restore()}function Us(e){const t=zs(e);if(t?.strokeOrder?.length)return t.strokeOrder.map((s,a)=>p()==="ru"?s.description_ru||`Штрих ${a+1} по данным KanjiVG`:s.description_en||`Stroke ${a+1} from KanjiVG data`);const n=Array.isArray(e?.stroke_order)?e.stroke_order:[];return Array.from({length:nt(e)},(s,a)=>n[a]||yy(e,a))}function yy(e,t){return p()!=="ru"?`Step ${t+1}: exact stroke paths are not available yet. Use the translucent ${e?.kanji||"kanji"} template.`:`Шаг ${t+1}: для этого кандзи пока нет точной схемы штрихов. Обводи полупрозрачный шаблон ${e?.kanji||""}.`}function Gs(e){const t=document.getElementById("writingStrokeCounter");t&&(t.textContent=`${B.strokes.length}/${e.expectedCount}`);const n=document.getElementById("writingScore");n&&(n.querySelector("span").textContent=`${e.score}%`,n.querySelector("i").style.width=`${e.score}%`);const s=document.getElementById("writingFeedback");s&&(s.textContent=e.message,s.classList.toggle("is-good",e.success),s.classList.toggle("is-warning",!e.success&&e.score>0))}function $y(e){return e?Array.isArray(e)?{x:e[0],y:e[1]}:{x:e.x,y:e.y}:null}function jy(e,t){return{x:(e.x+t.x)/2,y:(e.y+t.y)/2}}function vu(e,t){return Math.hypot((e?.x||0)-(t?.x||0),(e?.y||0)-(t?.y||0))}function Sy(){r.charts.forEach(e=>e.destroy()),r.charts=[]}function Ny(e,t){const n=new Date;return r.cards.filter(s=>!e||s.lessonId===e).filter(s=>{const a=r.lessons.find(l=>l.id===s.lessonId);if(a&&!ke(a))return!1;const o=A(s.id);return o.state==="New"?!0:o.dueAt&&new Date(o.dueAt)<=n}).sort(ga)}function xy(){const e=new Date;return Iy().filter(t=>{const n=A(t.id);return n.state==="New"?!1:n.dueAt&&new Date(n.dueAt)<=e}).sort(ga)}function Cy(){const e=Date.now(),t=[];return[["N5",J()],["N4",P()],["N3",_()],["N2",M()]].forEach(([n,s])=>{Object.entries(s?.exerciseSrs||{}).forEach(([a,o])=>{const l=Xt(o,{level:n,exerciseId:a,lessonId:o?.lessonId||"",cardId:o?.cardId||"",kanji:o?.kanji||"",type:o?.type||"",title:o?.title||null,prompt:o?.prompt||"",answer:o?.answer||"",answerLabel:o?.answerLabel||""});if(!l.dueAt)return;const c=la(n,a,l.lessonId||""),d=String(c?.lessonId||l.lessonId||"");if(!Ku(n,d))return;const u=new Date(l.dueAt).getTime();!u||u>e||t.push({kind:"exercise",source:"textbook",key:`exercise:${String(n).toUpperCase()}:${a}`,level:String(n||"").toUpperCase(),exerciseId:a,lessonId:d,cardId:String(l.cardId||""),dueAt:u,progress:l})})}),t.sort(io)}function qs(){const e=[];return r.n5Reading.forEach(t=>{t?.id&&e.push(t)}),[["N4",r.n4Reading],["N3",r.n3Reading],["N2",r.n2Reading],["N1",r.n1Reading]].forEach(([t,n])=>{(Array.isArray(n)?n:[]).forEach(s=>{(s.questions||[]).forEach((a,o)=>{const l={id:String(a.id||`${s.id}:${o}`),prompt:a.prompt||{ru:"",en:""},answer:String(a.answer||""),options:hl(a.options)};e.push({id:String(a.id||`${s.id}:${o}`),level:String(s.level||t||"").toUpperCase(),kind:"question",sourceKind:String(s.kind||"reading"),sourceId:String(s.id||""),sourceTitle:s.title||{ru:s.id||"",en:s.id||""},title:s.title||{ru:s.id||"",en:s.id||""},jp:String(s.jp||""),reading:String(s.reading||""),translationRu:String(s.ru||""),translationEn:String(s.en||""),passageSource:String(s.source||""),questionIndex:o,question:l,questions:[l]})})})}),[...e,...Ph()]}function wu(e,t=""){const n=String(e||""),s=String(t||"").toUpperCase();return qs().find(a=>String(a.id||"")===n&&(!s||String(a.level||"").toUpperCase()===s))||qs().find(a=>String(a.id||"")===n)||null}function bu(e){const t=Array.isArray(e?.questions)?e.questions[0]||null:e?.question||null;return{level:String(e?.level||"").toUpperCase(),lessonId:String(e?.sourceId||""),exerciseId:String(e?.id||""),type:String(e?.kind||""),title:e?.sourceTitle||e?.title||null,prompt:String(e?.kind==="question"?h(t?.prompt||{}):e?.sentence||e?.jp||""),answer:String(e?.kind==="question"?t?.answer||"":tt(e).map(n=>n.kanji).join("")),answerLabel:String(e?.kind==="question"?t?.answer||"":tt(e).map(n=>n.kanji).join(""))}}function ao(e){return 1}function ut(e){const t=bu(e);return{...Wn(t.level,t.lessonId,t.exerciseId,t),sourceId:String(e?.sourceId||""),sourceKind:String(e?.sourceKind||""),sourceTitle:e?.sourceTitle||null,exerciseKind:String(e?.kind||""),questionCount:ao(),answers:{},selectedIndices:[],selectedTiles:[],selectedText:"",wrongIndexes:[],wrongQuestions:[],completed:!1,completedAt:null}}function yn(e,t){const n=ut(t),s=Xt({...n,...e||{}},bu(t));return s.sourceId=String(t?.sourceId||s.sourceId||""),s.sourceKind=String(t?.sourceKind||s.sourceKind||""),s.sourceTitle=t?.sourceTitle||s.sourceTitle||null,s.exerciseKind=String(t?.kind||s.exerciseKind||""),s.questionCount=ao(),s.answers=s.answers&&typeof s.answers=="object"&&!Array.isArray(s.answers)?{...s.answers}:{},s.selectedIndices=Array.isArray(s.selectedIndices)?s.selectedIndices.map(a=>Number(a)).filter(a=>Number.isInteger(a)&&a>=0):[],s.selectedTiles=Array.isArray(s.selectedTiles)?s.selectedTiles.map(a=>({kanji:String(a?.kanji||""),reading:String(a?.reading||"")})).filter(a=>a.kanji):[],s.selectedText=String(s.selectedText||""),s.wrongIndexes=Array.isArray(s.wrongIndexes)?s.wrongIndexes.map(a=>Number(a)).filter(a=>Number.isInteger(a)&&a>=0):[],s.wrongQuestions=Array.isArray(s.wrongQuestions)?s.wrongQuestions.map(a=>String(a)).filter(Boolean):[],s.completed=!!s.completed,s.completedAt=s.completedAt||null,s}function pt(e){if(!e?.id)return null;r.progress.readingExercises||={};const t=r.progress.readingExercises[String(e.id)]||null;if(t){const s=yn(t,e);return r.progress.readingExercises[String(e.id)]=s,s}const n=ut(e);return r.progress.readingExercises[String(e.id)]=n,n}function $n(e,t){if(!e?.id)return null;r.progress.readingExercises||={};const n=yn(t||{},e);return r.progress.readingExercises[String(e.id)]=n,n}function Hs(e=""){if(!r.progress)return!1;const t=new Set([...Object.entries(r.progress.viewedReadingLevels||{}).filter(([,l])=>!!l).map(([l])=>F(l)).filter(Boolean)]),n=F(e);if(n&&t.add(n),!t.size)return!1;const s=qs().filter(l=>t.has(F(l.level)));if(!s.length)return!1;r.progress.readingExercises||={};const a=new Date().toISOString();let o=!1;return s.forEach(l=>{const c=String(l.id),d=r.progress.readingExercises[c];if(d){r.progress.readingExercises[c]=yn(d,l);return}r.progress.readingExercises[c]=yn({...ut(l),state:"Learning",stage:"learning",intervalDays:0,srsStep:0,dueAt:a,nextReview:a},l),o=!0}),o}function Ly(){const e=Date.now();return qs().map(t=>{if(!Bu(t.level))return null;const n=pt(t),s=yn(n||ut(t),t),a=s.dueAt?new Date(s.dueAt).getTime():0;return!a||a>e?null:{kind:"exercise",source:"reading",key:`reading:${String(t.level||"").toUpperCase()}:${t.id}`,level:String(t.level||"").toUpperCase(),exerciseId:String(t.id||""),lessonId:String(t.sourceId||""),cardId:"",dueAt:a,progress:s,exercise:t,card:null}}).filter(Boolean).sort(io)}function Ay(){const e=xy().map(n=>({kind:"card",key:`card:${n.id}`,card:n,dueAt:n.dueAt?new Date(n.dueAt).getTime():0,progress:A(n.id)})),t=[...Cy(),...Ly()].sort(io);return Vg(e,t,di)}function Ne(){if(ur&&pr!==null)return pr;let e=0;const t=Date.now(),n=new Set;return be.forEach(s=>{ko(s).forEach(a=>{const o=String(a?.id||"");if(!o||n.has(o))return;n.add(o);const l=A(o);l.state!=="New"&&l.dueAt&&new Date(l.dueAt).getTime()<=t&&(e+=1)})}),[["N5",J()],["N4",P()],["N3",_()],["N2",M()]].forEach(([s,a])=>{Object.entries(a?.exerciseSrs||{}).forEach(([o,l])=>{const c=Xt(l,{level:s,exerciseId:o,lessonId:l?.lessonId||"",cardId:l?.cardId||"",kanji:l?.kanji||"",type:l?.type||"",title:l?.title||null,prompt:l?.prompt||"",answer:l?.answer||"",answerLabel:l?.answerLabel||""});if(!c.dueAt)return;const d=la(s,o,c.lessonId||""),u=String(d?.lessonId||c.lessonId||"");if(!Ku(s,u))return;const m=new Date(c.dueAt).getTime();m&&m<=t&&(e+=1)})}),qs().forEach(s=>{if(!Bu(s.level))return;const a=pt(s),o=yn(a||ut(s),s),l=o.dueAt?new Date(o.dueAt).getTime():0;l&&l<=t&&(e+=1)}),ur&&(pr=e),e}function io(e,t){if(e.dueAt!==t.dueAt)return e.dueAt-t.dueAt;const n=e.kind==="card"?A(e.card.id):e.progress,s=t.kind==="card"?A(t.card.id):t.progress,a=xr(n),o=xr(s);return a!==o?o-a:e.kind!==t.kind?e.kind==="card"?-1:1:e.kind==="card"&&t.kind==="card"?Number(e.card.id)-Number(t.card.id):String(e.key||"").localeCompare(String(t.key||""))}function Iy(){const e=new Set,t=[];return be.forEach(n=>{ko(n).forEach(s=>{const a=String(s?.id||"");!a||e.has(a)||(e.add(a),t.push(s))})}),t.sort(ga)}function oo(){const e=dj();return r.cards.filter(t=>{const n=r.lessons.find(a=>a.id===t.lessonId);if(n&&!ke(n))return!1;const s=A(t.id);return s.state==="New"||s.dueAt&&new Date(s.dueAt)<=e}).sort(ga)}function ga(e,t){const n=A(e.id),s=A(t.id),a=n.dueAt?new Date(n.dueAt).getTime():0,o=s.dueAt?new Date(s.dueAt).getTime():0;if(a!==o)return a-o;if(a>0){const l=xr(n),c=xr(s);if(l!==c)return c-l}return Number(e.id)-Number(t.id)}function Ty(){const e=r.filters.query.trim().toLocaleLowerCase(p()==="ru"?"ru-RU":"en-US");return r.cards.filter(t=>{const n=Xs(t.id),s=[t.kanji,L(t),t.meaning_ru,t.hiragana,t.romaji,t.onyomi,t.onyomi_romaji,t.kunyomi,t.kunyomi_romaji,po(t),t.jlpt,xo(t.lessonId),Ys(t),n.radical,h(n.radicalMeaning||{}),...t.apps,...t.examples.flatMap(a=>[a.word,a.reading,a.romaji,a.translation,Ce(a)])].join(" ").toLocaleLowerCase(p()==="ru"?"ru-RU":"en-US");return(!e||s.includes(e))&&(r.filters.jlpt==="all"||t.jlpt===r.filters.jlpt)&&(r.filters.radical==="all"||n.radical===r.filters.radical)&&(r.filters.favorites==="all"||!!r.progress.favorites[t.id])&&Ry(t.strokes,r.filters.strokes)})}function Ry(e,t){if(t==="all")return!0;if(t==="13+")return e>=13;const[n,s]=t.split("-").map(Number);return e>=n&&e<=s}function lo(){const e=r.cards.length,t=r.cards.filter(s=>A(s.id).state!=="New").length,n=r.cards.filter(s=>A(s.id).state==="Mastered").length;return{total:e,learned:t,mastered:n,todayCards:oo().length,completion:I(n,e)}}function co(){return Object.values(r.progress.cards).reduce((e,t)=>e+(t.reviewCount||t.reviews||0),0)}function _y(){return(r.progress.transactions||[]).reduce((e,t)=>e+Math.max(0,Number(t.coins||0)),0)}function ku(){const e=r.progress.totalCorrect+r.progress.totalWrong;return e?Math.round(r.progress.totalCorrect/e*100):0}function yu(){const e={New:0,Learning:0,Review:0,Mastered:0};return r.cards.forEach(t=>{e[A(t.id).state]+=1}),e}function $u(){const e={};return r.cards.forEach(t=>{e[t.jlpt]||=0,A(t.id).state==="Mastered"&&(e[t.jlpt]+=1)}),e}function yt(){const e=W();return r.progress.daily[e]||(r.progress.daily[e]={learned:0,reviews:0,mastered:0,mistakes:0,minutes:0,goalClaimed:!1}),r.progress.daily[e]}function uo(e){return r.cards.filter(t=>t.lessonId===e)}function My(){return r.cards.filter(e=>{const t=r.lessons.find(n=>n.id===e.lessonId);return(!t||ke(t))&&A(e.id).stage==="new"})}function X(e){return r.cards.find(t=>String(t.id)===String(e))}function Xs(e){return r.kanjiMeta[String(e)]||{}}function ma(e){const t=r.kanjiHints[String(e)]||{};return{hint:h(t.hint||{})||$e("leya","hint"),mnemonic:h(t.mnemonic||{})||""}}function Py(e){e&&(r.progress.favorites[e]?delete r.progress.favorites[e]:r.progress.favorites[e]=new Date().toISOString(),N(),j())}function gt(e=null){r.readingCheck={cardId:e?String(e):null,value:"",status:null,message:""}}function Ey(e){const t=String(e||"");r.readingCheck.cardId!==t&&gt(t)}function ju(){const e=X(r.readingCheck.cardId||r.activeCardId);if(!e)return;vs(e,"reading_check"),Pu();const t=Oy(r.readingCheck.value),n=Dy(e),s=t.some(c=>n.normalized.has(c)),a=t.length>0,o=a&&s?"correct":"wrong",l=a?s?p()==="ru"?"Верно. Это чтение есть у карточки.":"Correct. This reading belongs to the card.":p()==="ru"?"Почти. Попробуй другое онъёми или кунъёми.":"Almost. Try another on'yomi or kun'yomi.":p()==="ru"?"Сначала напиши чтение хираганой или катаканой.":"Type a reading in hiragana or katakana first.";r.readingCheck={cardId:e.id,value:r.readingCheck.value,status:o,message:l},C(o==="correct"?"answer_correct":"answer_wrong"),j(),requestAnimationFrame(()=>{const c=document.getElementById(`readingCheck-${e.id}`);c&&(c.focus(),"setSelectionRange"in c&&c.setSelectionRange(c.value.length,c.value.length))})}function Dy(e){const t=fa(e),n=[...Vt(t.onyomi.kana),...Vt(t.kunyomi.kana),...Vt(e.hiragana)].filter(Boolean),s=n.filter((a,o)=>n.indexOf(a)===o);return{normalized:new Set(s.map(Su).filter(Boolean))}}function Oy(e){return String(e||"").split(/[\/,гЂЃпјЊ\s]+/u).map(Su).filter(Boolean)}function Su(e){const t=Nu(String(e||"").normalize("NFKC")).replace(/[гѓ»пЅҐ.\-]/gu,"").replace(/\s+/gu,"");return Ky(t).trim()}function Nu(e){return[...String(e||"")].map(t=>{const n=t.charCodeAt(0);return n>=12449&&n<=12534?String.fromCharCode(n-96):t}).join("")}function Ky(e){let t="";for(const n of String(e||"")){if(n==="ー"){t+=By(t.slice(-1));continue}t+=n}return t}function By(e){return"あかさたなはまやらわがざだばぱゃぁ".includes(e)?"あ":"いきしちにひみりぎ�?ぢびぴぃ".includes(e)?"い":"うくすつぬふむゆるぐずづぶぷゅぅ".includes(e)?"う":"えけせてねへめれげぜでべぺぇ".includes(e)?"え":"おこそとのほもよろをごぞどぼぽょぉ".includes(e)?"お":""}function xu(e){if(!e)return null;const t=String(e.jlpt||"").toUpperCase();let n=null;return t==="N5"?n=r.n5KanjiCatalog:t==="N4"?n=r.n4KanjiCatalog:t==="N3"?n=r.n3KanjiCatalog:t==="N2"&&(n=r.n2KanjiCatalog),!n||!Array.isArray(n)?null:n.find(s=>s&&s.kanji===e.kanji)||null}const Cu={あ:"a",い:"i",う:"u",え:"e",お:"o",か:"ka",き:"ki",く:"ku",け:"ke",こ:"ko",が:"ga",ぎ:"gi",ぐ:"gu",げ:"ge",ご:"go",さ:"sa",し:"shi",す:"su",せ:"se",そ:"so",ざ:"za",じ:"ji",ず:"zu",ぜ:"ze",ぞ:"zo",た:"ta",ち:"chi",つ:"tsu",て:"te",と:"to",だ:"da",ぢ:"ji",づ:"zu",で:"de",ど:"do",な:"na",に:"ni",ぬ:"nu",ね:"ne",の:"no",は:"ha",ひ:"hi",ふ:"fu",へ:"he",ほ:"ho",ば:"ba",び:"bi",ぶ:"bu",べ:"be",ぼ:"bo",ぱ:"pa",ぴ:"pi",ぷ:"pu",ぺ:"pe",ぽ:"po",ま:"ma",み:"mi",む:"mu",め:"me",も:"mo",や:"ya",ゆ:"yu",よ:"yo",ら:"ra",り:"ri",る:"ru",れ:"re",ろ:"ro",わ:"wa",ゐ:"i",ゑ:"e",を:"o",ん:"n",ゔ:"vu"},Lu={きゃ:"kya",きゅ:"kyu",きょ:"kyo",ぎゃ:"gya",ぎゅ:"gyu",ぎょ:"gyo",しゃ:"sha",しゅ:"shu",しょ:"sho",じゃ:"ja",じゅ:"ju",じょ:"jo",ちゃ:"cha",ちゅ:"chu",ちょ:"cho",ぢゃ:"ja",ぢゅ:"ju",ぢょ:"jo",にゃ:"nya",にゅ:"nyu",にょ:"nyo",ひゃ:"hya",ひゅ:"hyu",ひょ:"hyo",びゃ:"bya",びゅ:"byu",びょ:"byo",ぴゃ:"pya",ぴゅ:"pyu",ぴょ:"pyo",みゃ:"mya",みゅ:"myu",みょ:"myo",りゃ:"rya",りゅ:"ryu",りょ:"ryo",ふぁ:"fa",ふぃ:"fi",ふぇ:"fe",ふぉ:"fo",しぇ:"she",じぇ:"je",ちぇ:"che",てぃ:"ti",でぃ:"di",とぅ:"tu",どぅ:"du",つぁ:"tsa",つぃ:"tsi",つぇ:"tse",つぉ:"tso",うぃ:"wi",うぇ:"we",うぉ:"wo",ゔぁ:"va",ゔぃ:"vi",ゔぇ:"ve",ゔぉ:"vo"};function fa(e){const t=xu(e);if(t&&t.readings){const a=t.readings,o=ha(a.onyomi,a.onyomi_romaji||e?.onyomi_romaji,e?.onyomi),l=ha(a.kunyomi,a.kunyomi_romaji||e?.kunyomi_romaji,e?.kunyomi);if(o.kana||l.kana)return{onyomi:o,kunyomi:l}}const n=ha(e?.onyomi,e?.onyomi_romaji),s=ha(e?.kunyomi,e?.kunyomi_romaji);return n.kana||s.kana||n.romaji||s.romaji?{onyomi:n,kunyomi:s}:{onyomi:{kana:"",romaji:""},kunyomi:{kana:"",romaji:""}}}function Vt(e){return(Array.isArray(e)?e.join(" / "):String(e||"")).split(/[\/пјЏ,пјЊгЂЃгѓ»пЅҐ;пј›]+/u).map(n=>n.trim()).filter(Boolean)}function ha(e,t="",n=""){const s=Vt(e).length?Vt(e):Vt(n),a=Vt(t),o=s.map((l,c)=>({kana:q(l),romaji:Fy(l,a[c])})).filter(l=>l.kana||l.romaji);return{kana:o.map(l=>l.kana).filter(Boolean).join(" / "),romaji:o.map(l=>l.romaji).filter(Boolean).join(" / ")}}function Fy(e,t){const n=Au(e);return n?t&&Iu(t)===Iu(n)?t:n:t||""}function Au(e){const t=[...zy(e)];let n="",s=!1;for(let a=0;a<t.length;a+=1){const o=t[a],l=t[a+1]||"";if(o==="っ"){s=!0;continue}if(o==="ー"){const u=Jy(n);u&&(n+=u);continue}let c="";const d=o+l;if(Lu[d])c=Lu[d],a+=1;else if(Cu[o])c=Cu[o];else if(/[a-zA-Z0-9]/u.test(o))c=o.toLowerCase();else{s=!1;continue}if(s){const u=c.match(/^[bcdfghjklmnpqrstvwxyz]/u)?.[0]||"";u&&u!=="n"&&(n+=u),s=!1}n+=c}return n}function zy(e){return Nu(String(e||"").normalize("NFKC")).replace(/[()\[\]{}]/gu,"").replace(/[.\-‐-―\s]/gu,"").trim()}function Jy(e){return String(e||"").match(/[aeiou](?!.*[aeiou])/u)?.[0]||""}function Iu(e){return String(e||"").toLowerCase().normalize("NFKD").replace(/[̀-ͯ]/gu,"").replace(/[^a-z0-9]+/gu,"")}function Tu(e){return e==="onyomi"?p()==="ru"?"Онъёми":"On'yomi":p()==="ru"?"Кунъёми":"Kun'yomi"}function Ru(e){return e==="onyomi"?p()==="ru"?"Он":"On":p()==="ru"?"Кун":"Kun"}function po(e){const t=fa(e);return[`${Ru("onyomi")}: ${t.onyomi.kana||"—"} (${t.onyomi.romaji||"—"})`,`${Ru("kunyomi")}: ${t.kunyomi.kana||"—"} (${t.kunyomi.romaji||"—"})`].join(" Р'· ")}function go(e){if(!e)return"";const t=e.audioSrc||e.audio||"";return Mu(t)||_u(e)}function _u(e){if(!e?.id||!e?.jlpt||!e?.lessonId)return"";const t=Uy(e.romaji);return t?`./audio/kanji/${String(e.jlpt).toLowerCase()}/${e.lessonId}/${e.id}-${t}.mp3`:""}function Mu(e){return e?e.startsWith("./")||e.startsWith("http")?e:e.startsWith("/")?`.${e}`:`./${e}`:""}function Uy(e){return String(e||"").split("/")[0].trim().toLowerCase().normalize("NFKD").replace(/[̀-ͯ]/g,"").replace(/[^a-z0-9]+/g,"-").replace(/^-+|-+$/g,"")}function Gy(e){return!!(go(e)||mo(e))}function mo(e){if(!e)return"";const t=fa(e);return t.onyomi.kana||t.kunyomi.kana||e.hiragana||e.kanji||""}function qy(e){return Vt(e)[0]||String(e||"").trim()}function fo(){if(r.route!=="learn"&&r.route!=="review")return;const e=560-(Date.now()-ds);if(e>0){window.setTimeout(fo,e);return}const t=X(r.activeCardId),n=Mu(t?.audioSrc||t?.audio||"");if(!t||!n)return;const s=`${r.route}:${t.id}:${n}`;s!==tl&&(tl=s,Eu(t,{silent:!0}))}function Pu(){Ae&&(Ae.pause(),Ae.currentTime=0,Ae=null),"speechSynthesis"in window&&window.speechSynthesis.cancel()}function Eu(e,t={}){const n=go(e);return n?(Ae&&(Ae.pause(),Ae.currentTime=0),Ae=new Audio(n),Ae.preload="auto",Ae.onended=()=>{Ae=null},Ae.onerror=()=>{t.silent||console.warn("Kanji audio file could not be loaded.",{id:e?.id,audio:n})},Ae.play().then(()=>!0).catch(s=>!t.silent&&Du(e)?!0:(t.silent||console.warn("Kanji audio playback was blocked or failed.",{id:e?.id,audio:n,error:s}),!1))):Promise.resolve(t.silent?!1:Du(e))}function Du(e){const t=qy(mo(e));if(!t||!("speechSynthesis"in window)||!("SpeechSynthesisUtterance"in window))return console.warn("Kanji audio is not available for this card.",{id:e?.id,expected:_u(e)}),!1;window.speechSynthesis.cancel();const n=new SpeechSynthesisUtterance(t);return n.lang="ja-JP",n.rate=.92,window.speechSynthesis.speak(n),!0}function Hy(e,t){E(e?`${t}: ${e}`:`${t}: ${p()==="ru"?"аудио пока не добавлено":"audio not added yet"}`)}function ke(e){return!!e}function va(e){return r.rewards?.lessonUnlocks?.[e?.id]||1}function Ou(e){if(!e||!ke(e))return"locked";const t=uo(e.id);return t.length?!!r.progress.lessonCompletions?.[e.id]||t.every(a=>{const o=A(a.id);return o.state!=="New"||o.reviewCount>0||o.lastReview})?"completed":t.some(a=>{const o=A(a.id);return o.state!=="New"||o.reviewCount>0||o.lastReview})?"started":"new":"new"}function ho(e){return e==="completed"?"is-completed":e==="started"?"is-started":""}function vo(e){const t=p()==="ru";return e==="completed"?t?"Урок пройден":"Lesson completed":e==="started"?t?"Урок начат":"Lesson started":t?"Не начат":"Not started"}function Xy(e){return e!=="completed"&&e!=="started"?"":`<span class="lesson-status-dot" aria-label="${f(vo(e))}"></span>`}function Qy(e){return e!=="completed"&&e!=="started"?"":`<span class="pill lesson-status-pill ${ho(e)}">${i(vo(e))}</span>`}function Yt(e){const t=String(e||"").toUpperCase();return r.jlptLessons.find(n=>n.jlpt===t)||null}function mt(e){const t=String(e||"").toUpperCase();return r.jlptCatalog?.items?.find(n=>n.jlpt===t)||null}function jn(e){const t=String(e||"").toUpperCase();return t==="N5"?J():t==="N4"?P():t==="N3"?_():t==="N2"?M():null}function Wy(e,t,n="open"){const s=F(e),a=String(t||"");if(!s||!a)return!1;const o=jn(s);return!o||(o.viewedLessons||={},o.viewedLessons[a])?!1:(o.viewedLessons[a]=new Date().toISOString(),!0)}function Ku(e,t){const n=F(e),s=String(t||"");if(!n||!s)return!1;const a=jn(n);return a?!!(a.viewedLessons?.[s]||a.completedLessons?.[s]):!1}function wa(e,t="open"){const n=F(e);return!n||(r.progress.viewedReadingLevels||={},r.progress.viewedReadingLevels[n])?!1:(r.progress.viewedReadingLevels[n]=new Date().toISOString(),!0)}function Bu(e){const t=F(e);return t?!!r.progress.viewedReadingLevels?.[t]:!1}function wo(e){const t=mt(e);return Array.isArray(t?.previousLevels)?t.previousLevels.map(n=>String(n||"").toUpperCase()).filter(Boolean):[]}function Fu(e){const t=String(e||"").toUpperCase(),n=jn(e);if(!n)return!1;if(n.finalTest?.passed)return!0;const a=mt(t)?.lessonCount||(t==="N5"?10:0);let o=0;if(t==="N5"){o=hn();const l=Object.keys(n.studiedKanji||{}).length;if(o>=10&&l>=80||o>=a)return!0}else if(o=Object.keys(n.completedLessons||{}).length,o>=a)return!0;return!1}function qe(e){const t=String(e||"").toUpperCase();if(be.includes(t)||r.progress.unlockedJlptLevels&&r.progress.unlockedJlptLevels.includes(t))return!0;if(!mt(t))return t==="N5";const s=wo(t);return s.length?s.every(a=>Fu(a)):!0}function zu(e=[]){const t=e.filter(Boolean);if(!t.length)return"";if(t.length===1)return t[0];const n=p()==="ru"?"Рё":"and";return t.length===2?`${t[0]} ${n} ${t[1]}`:`${t.slice(0,-1).join(", ")} ${n} ${t[t.length-1]}`}function $t(e){const t=wo(e);return t.length?p()==="ru"?`Откроется после завершения ${zu(t)}.`:`Unlocks after completing ${zu(t)}.`:p()==="ru"?"Откроется после учебника N5.":"Unlocks after the N5 textbook."}function ba(e){const t=F(e);if(!t)return[];const n=mt(t),s=r.lessons.filter(d=>String(d.jlpt||"").toUpperCase()===t),a=n?(n.lessonIds||[]).map(d=>r.lessons.find(u=>u.id===d)).filter(Boolean):s,o=new Set(a.map(d=>d.id)),l=s.filter(d=>!o.has(d.id)),c=Math.max(n?n.lessonCount||a.length:s.length,a.length);return[...a,...l].slice(0,c||s.length)}function bo(e){const t=F(e);if(!t)return"";const n=ba(t);if(!n.length)return"";const s=i$(t);if(s?.lessonId&&$a(t,s.lessonId))return s.lessonId;const a=jn(t)?.currentLessonId||"";if(a&&$a(t,a))return a;const o=t==="N5"?J().completedLessons||{}:t==="N4"?P().completedLessons||{}:t==="N3"?_().completedLessons||{}:t==="N2"?M().completedLessons||{}:r.progress.lessonCompletions||{},l=n.filter(c=>o[c.id]);return l.length?(l.sort((c,d)=>{const u=Date.parse(o[d.id]||"")||0,m=Date.parse(o[c.id]||"")||0;return u!==m?u-m:(d.order||0)-(c.order||0)}),l[0]?.id||n[0]?.id||""):n[0]?.id||""}function ka(e,t=""){const n=F(e);if(!n||!Yt(n))return;if(!qe(n)){r.activeTextbookLevel=n,r.activeJlptLesson=n,Te("textbooks",null,n),E($t(n));return}const s=r.route,a=String(t||"")||bo(n),o=["N5","N4","N3","N2"].includes(n),l=a?`#textbooks/${encodeURIComponent(n)}/${encodeURIComponent(a)}`:`#textbooks/${encodeURIComponent(n)}`;r.route="textbooks",r.activeTextbookLevel=n,r.activeJlptLesson=n,r.activeTextbookSubroute=a||null,r.kanjiPageId=null,r.detailCardId=null,r.revealed=!1,r.navMenu=null,r.finalTestModal=null,r.finalTestBusy=!1,r.contactModal=!1,r.pendingFocus=!o&&a?`#textbook-lesson-${a}`:null,s!=="eva-room"&&(r.evaRoomShopOpen=!1),a&&ft(n,a,"open_jlpt"),gt(),location.hash!==l&&history.replaceState(null,"",l),Ar(),j()}function Vy(e){return e?Yt(e.jlpt):null}function Yn(e){const t=String(e||"").toUpperCase();return r.jlptPracticeLessons.find(n=>n.jlpt===t)||null}function Sn(){return r.progress.jlptLessonPractice=Tl(ms().jlptLessonPractice,r.progress.jlptLessonPractice||{}),r.progress.jlptLessonPractice}function Zn(e){if(!e?.drills?.length)return null;const t=Sn(),n=t.activeIds[e.jlpt],s=e.drills.find(a=>a.id===n);return s||(t.activeIds[e.jlpt]=e.drills[0].id,e.drills[0])}function Yy(e){const t=Yn(r.activeJlptLesson),n=Zn(t);if(!n||!n.tiles[e])return;const s=Sn(),a=s.selected[n.id]||[],o=n.blanks.flatMap(l=>l.answer||[]).length;a.includes(e)||a.length>=o||(s.selected[n.id]=[...a,e],s.checked[n.id]=!1,s.results[n.id]=null,N(),j())}function Zy(){const e=Zn(Yn(r.activeJlptLesson));if(!e)return;const t=Sn();t.selected[e.id]=(t.selected[e.id]||[]).slice(0,-1),t.checked[e.id]=!1,t.results[e.id]=null,N(),j()}function e$(){const e=Zn(Yn(r.activeJlptLesson));if(!e)return;const t=Sn();t.selected[e.id]=[],t.checked[e.id]=!1,t.results[e.id]=null,N(),j()}function t$(){const e=Zn(Yn(r.activeJlptLesson));if(!e)return;const t={...$o(),...yo()},n=Sn(),s=n.selected[e.id]||[],a=e.blanks.flatMap(c=>c.answer||[]),o=a.reduce((c,d,u)=>{const m=e.tiles[s[u]];return(!m||m.kanji!==d)&&c.push(u),c},[]),l=s.length===a.length&&o.length===0;n.checked[e.id]=!0,n.results[e.id]={correct:l,wrongIndexes:o,message:l?t.correct:t.wrong},l&&!n.completed[e.id]?(n.completed[e.id]=new Date().toISOString(),O(8,1,`jlpt_practice:${e.id}`),C("answer_correct")):l||C("answer_wrong"),N(),j()}function n$(){const e=Yn(r.activeJlptLesson),t=Zn(e);if(!e||!t)return;const n=e.drills.findIndex(o=>o.id===t.id),s=e.drills[(n+1)%e.drills.length],a=Sn();a.activeIds[e.jlpt]=s.id,a.selected[s.id]||=[],a.checked[s.id]||=!1,a.results[s.id]||=null,N(),j()}function ko(e){const t=String(e||"").toUpperCase();return t?r.cards.filter(n=>String(n.jlpt||"").toUpperCase()===t):[]}function yo(){return p()==="ru"?{courseText:"Стратегия уровня, чтения, лексика, приложения и интерактивная практика. Контент хранится в JSON, поэтому урок можно расширять без изменения логики.",apps:"Приложения и интерфейсы",kana:"Хирагана и катакана",hiragana:"Хирагана",katakana:"Катакана",kanjiFocus:"Кандзи с фуриганой",sentenceDrill:"Поставь кандзи в пропуск",fillBlanks:"Заполни пропуск плитками по порядку.",check:"Проверить",undo:"Убрать",clear:"Очистить",next:"Следующее",correct:"Верно. +8 XP и +1 Moon Fragment.",wrong:"Почти. Проверь порядок плиток и попробуй ещё раз."}:{courseText:"Level strategy, readings, vocabulary, apps, and interactive practice. Content lives in JSON, so lessons can grow without changing app logic.",apps:"Apps and interfaces",kana:"Hiragana and katakana",hiragana:"Hiragana",katakana:"Katakana",kanjiFocus:"Kanji with furigana",sentenceDrill:"Place kanji into the blank",fillBlanks:"Fill the blank with tiles in order.",check:"Check",undo:"Undo",clear:"Clear",next:"Next",correct:"Correct. +8 XP and +1 Moon Fragment.",wrong:"Almost. Check the tile order and try again."}}function $o(){return p()==="ru"?{back:"К учебнику",courseMap:"Полноценный JLPT-модуль",courseText:"Краткая стратегия уровня, чтения, лексика и практика. Данные хранятся в JSON, поэтому урок можно расширять без изменения логики.",available:"кандзи уровня",learned:"изучено",mastered:"освоено",goals:"Цели уровня",practice:"Практика",checkpoint:"Чекпоинт"}:{back:"Back to textbook",courseMap:"Full JLPT module",courseText:"Level strategy, readings, vocabulary, and practice. The content lives in JSON, so lessons can grow without changing app logic.",available:"level kanji",learned:"learned",mastered:"mastered",goals:"Level goals",practice:"Practice",checkpoint:"Checkpoint"}}function ya(e){const t=r.rewards?.levelCurve||{baseXp:100,growth:1.35};let n=1,s=e;for(;s>=Qs(n,t)&&n<100;)s-=Qs(n,t),n+=1;return n}function jt(){const e=r.rewards?.levelCurve||{baseXp:100,growth:1.35};let t=1,n=r.progress.xp;for(;n>=Qs(t,e)&&t<100;)n-=Qs(t,e),t+=1;const s=Qs(t,e);return{current:n,next:s,toNext:Math.max(0,s-n),percent:I(n,s)}}function Qs(e,t){return Math.round(t.baseXp*Math.pow(t.growth,e-1))}function s$(){const e={app:"Flash Kanji",exportedAt:new Date().toISOString(),progress:r.progress,customization:r.customization},t=new Blob([JSON.stringify(e,null,2)],{type:"application/json"}),n=URL.createObjectURL(t),s=document.createElement("a");s.href=n,s.download=`flash-kanji-progress-${W()}.json`,document.body.append(s),s.click(),s.remove(),URL.revokeObjectURL(n),E(S("export"))}function Zt(e,t={}){try{return typeof window.ym!="function"?!1:(window.ym(pp,"reachGoal",e,t),!0)}catch(n){return console.warn("Metric goal failed.",n),!1}}function r$(e){return{level:e.dataset.shareLevel||e.dataset.level||"",lessonId:e.dataset.shareLessonId||e.dataset.lessonId||e.dataset.lesson||"",toastKey:e.dataset.shareToastKey||"",reward:e.dataset.shareReward&&r.rewardModal||null}}function F(e){const t=String(e||"").toUpperCase();return be.includes(t)?t:""}function xe(e){if(!e||typeof e!="object")return null;const t=F(e.level),n=String(e.lessonId||"");if(!t||!n)return null;const s=typeof e.updatedAt=="string"&&e.updatedAt?e.updatedAt:new Date().toISOString();return{level:t,lessonId:n,updatedAt:s,source:typeof e.source=="string"&&e.source?e.source:"open"}}function a$(e={}){const t={};return Object.entries(e||{}).forEach(([n,s])=>{const a=F(n),o=xe({...typeof s=="object"&&s?s:{},level:a||n});a&&o&&(t[a]=o)}),t}function es(e={}){const t={};return Object.entries(e||{}).forEach(([n,s])=>{const a=String(n||"").trim();if(a){if(typeof s=="string"&&s.trim()){t[a]=s.trim();return}if(s&&typeof s=="object"){const o=typeof s.viewedAt=="string"&&s.viewedAt?s.viewedAt:typeof s.updatedAt=="string"&&s.updatedAt?s.updatedAt:new Date().toISOString();t[a]=o;return}s&&(t[a]=new Date().toISOString())}}),t}function $a(e,t){const n=F(e),s=String(t||"");return!n||!s?!1:ba(n).some(a=>a.id===s)}function Ju(e){return ba(e)[0]?.id||""}function i$(e=""){const t=F(e);if(t){const a=xe(r.progress.lastOpenedJlptLessons?.[t]||null)||(xe(r.progress.lastOpenedJlptLesson||null)?.level===t?xe(r.progress.lastOpenedJlptLesson||null):null);return a&&$a(t,a.lessonId)?a:null}const n=[xe(r.progress.lastOpenedJlptLesson||null),...Object.values(r.progress.lastOpenedJlptLessons||{}).map(a=>xe(a)).filter(Boolean)].filter(Boolean);return n.sort((a,o)=>(Date.parse(o.updatedAt||"")||0)-(Date.parse(a.updatedAt||"")||0)),n.find(a=>$a(a.level,a.lessonId))||null}function o$(e=""){const t=F(e);if(t)return xe(r.progress.lastOpenedJlptLessons?.[t]||null)||(xe(r.progress.lastOpenedJlptLesson||null)?.level===t?xe(r.progress.lastOpenedJlptLesson||null):null);const n=[xe(r.progress.lastOpenedJlptLesson||null),...Object.values(r.progress.lastOpenedJlptLessons||{}).map(s=>xe(s)).filter(Boolean)].filter(Boolean);return n.sort((s,a)=>(Date.parse(a.updatedAt||"")||0)-(Date.parse(s.updatedAt||"")||0)),n[0]||null}function l$(e){const t=F(e);if(!t)return"";const n=be.indexOf(t);return n>=0&&n<be.length-1?be[n+1]:""}function ft(e,t,n="open"){const s=F(e),a=String(t||"");if(!s||!a)return null;const o={level:s,lessonId:a,updatedAt:new Date().toISOString(),source:n},l=xe(r.progress.lastOpenedJlptLessons?.[s]||null),c=xe(r.progress.lastOpenedJlptLesson||null);r.progress.lastOpenedJlptLessons||={},r.progress.lastOpenedJlptLessons[s]=o,r.progress.lastOpenedJlptLesson=o;const d=Wy(s,a,n),u=jn(s);return u&&u.currentLessonId!==a&&(u.currentLessonId=a),(!l||l.lessonId!==a||l.level!==s||c?.lessonId!==a||c?.level!==s||d)&&N(),o}function St(e,t="btn ghost"){const n=F(e),s=l$(n);if(!n||!s)return"";const a=Ju(s);if(!a)return"";const o=p()==="ru"?`Первый урок ${s}`:`${s} lesson 1`;return`<button class="${f(t)}" type="button" data-action="final-test-next-level" data-level="${f(n)}" data-next-level="${f(s)}" data-next-lesson="${f(a)}">${i(o)}</button>`}function Nt(){return F(r.activeJlptLesson)||F(r.activeTextbookLevel)||F(r.jlptLessons.find(e=>qe(e.jlpt))?.jlpt)||F(r.jlptLessons[0]?.jlpt)||"N5"}function c$(e,t={}){const n=String(e||r.route||"home").toLowerCase();return n==="textbooks"?"textbooks":n==="textbook"?`textbooks/${encodeURIComponent(F(t.level||r.activeTextbookLevel||Nt())||Nt())}`:n==="lesson"?`jlpt-lesson/${encodeURIComponent(F(t.level||r.activeJlptLesson||Nt())||Nt())}`:n==="srs"?"review":n==="stats"?"stats":n==="achievements"?"achievements":n==="achievement"?r.route||"home":n||"home"}function d$(e=r.route,t={}){const n=new URL(location.href);return n.search="",n.hash=c$(e,t),n.href}function u$(e=r.route,t={}){const n=String(e||r.route||"home").toLowerCase(),s=F(t.level||r.activeJlptLesson||r.activeTextbookLevel||""),a=p()==="ru",o={textbooks:a?"Учебники Flash Kanji":"Flash Kanji textbooks",textbook:a?"Учебник Flash Kanji":"Flash Kanji textbook",lesson:a?"Урок Flash Kanji":"Flash Kanji lesson",srs:a?"Повторение Flash Kanji":"Flash Kanji review",stats:a?"Статистика Flash Kanji":"Flash Kanji stats",achievements:a?"Достижения Flash Kanji":"Flash Kanji achievements",achievement:"Flash Kanji"},l=o[n]||o.achievement;return s&&["textbook","lesson"].includes(n)?`${l} ${s}`:l}function p$(e=r.route,t={}){const n=String(e||r.route||"home").toLowerCase(),s=F(t.level||r.activeJlptLesson||r.activeTextbookLevel||""),a=s?mt(s):null,o=t.lesson||(s?Yt(s):null),l=p()==="ru";if(n==="textbooks")return l?"Функциональные учебники JLPT N5-N1 внутри Flash Kanji.":"Functional JLPT N5-N1 textbooks inside Flash Kanji.";if(n==="textbook"){const c=h(a?.displayTitle||a?.title||{}),d=Number(a?.lessonCount||0),u=Number(a?.kanjiCount||0);return l?`${c||"Учебник"}: ${d} уроков и ${u} кандзи.`:`${c||"Textbook"}: ${d} lessons and ${u} kanji.`}if(n==="lesson"){const c=h(o?.title||{}),d=h(o?.summary||{});return l?`${s?`${s} · `:""}${c||"Урок"} — ${d||"урок в Flash Kanji"}.`:`${s?`${s} · `:""}${c||"Lesson"} — ${d||"a Flash Kanji lesson"}.`}return n==="srs"?l?"Очередь повторений Flash Kanji.":"Flash Kanji review queue.":n==="stats"?l?"Моя статистика и прогресс во Flash Kanji.":"My Flash Kanji stats and progress.":n==="achievements"?l?"Достижения и секреты Flash Kanji.":"Flash Kanji achievements and secrets.":n==="achievement"?w$(t.reward||r.rewardModal||{}):"Flash Kanji."}function g$(){return p()==="ru"?"Поделиться":"Share"}function ts(e=r.route,t={}){const n=F(t.level||""),s=String(t.lessonId||t.lesson?.id||""),a=t.label||g$();return`
    ...
    `}function Uu(e){return e==="youtube"?`
        <svg viewBox="0 0 24 24" aria-hidden="true" focusable="false">
    ...
    `}async function f$(e,t={}){const n=t.toastKey||"shareLinkCopied",s={title:e.title,text:e.text,url:e.url};if(e.files?.length&&navigator.canShare?.({files:e.files})&&(s.files=e.files),navigator.share)try{return await navigator.share(s),"share"}catch(o){if(o&&o.name==="AbortError")return"abort"}return await $$(e.text,e.url,n)?"copy":"failed"}async function h$(e=r.route,t={}){const n=String(e||r.route||"home").toLowerCase(),s=t.reward||r.rewardModal||null,a={section:n,title:u$(n,t),text:p$(n,t),url:d$(n,t),files:[]};if(n==="achievement"||s){const o=await b$(s||{});o&&typeof File<"u"&&(a.files=[new File([o],`flash-kanji-achievement-${r.progress.level}.png`,{type:"image/png"})])}return a}async function Gu(e=r.route,t={}){const n=String(e||r.route||"home").toLowerCase(),s={...t};s.level||(s.level=t.level||r.activeJlptLesson||r.activeTextbookLevel||""),Zt("share_opened",{section:n,level:F(s.level)||""});const a=await h$(n,s),o=await f$(a,{toastKey:t.toastKey||"shareLinkCopied"});return o==="share"?(Zt("share_completed",{section:n,method:a.files?.length?"file":"web_share"}),!0):o==="copy"?(Zt("share_link_copied",{section:n}),Zt("share_completed",{section:n,method:"copy"}),!0):(o==="abort"||E(p()==="ru"?"Не удалось поделиться":"Share failed"),!1)}async function v$(){await Gu("achievement",{reward:r.rewardModal||{},toastKey:"shareCopied"})}function w$(e={}){const t=S("shareFallback"),n=e.level||r.progress.level,s=jt(),a=e.type==="level"?`${s.current}/${s.next}`:e.totalXp||r.progress.xp,o=e.type==="level"?r.progress.moonFragments:e.moonFragments||r.progress.moonFragments;return`${t}: ${S("level")} ${n}, ${a} XP, ${o} Moon Fragments.`}async function b$(e={}){const s=document.createElement("canvas");s.width=1200,s.height=630;const a=s.getContext("2d");if(!a)return null;k$(a,1200,630);const o=e.level||r.progress.level,l=jt(),c=e.type==="level"?`${l.current}/${l.next}`:e.totalXp||r.progress.xp,d=e.type==="level"?r.progress.moonFragments:e.moonFragments||r.progress.moonFragments,u=e.mascot||(r.progress.level%2===0?"leya":"eva"),m=aa(u,e.mood||"happy",e.dialog||e.type||"achievement"),[g,w]=await Promise.all([qu("assets/logo.webp"),m?qu(m):Promise.resolve(null)]);return g&&Hu(a,g,58,48,330,116),w&&Hu(a,w,780,95,330,450),a.fillStyle="#f7f4ee",a.font="900 58px system-ui, sans-serif",a.fillText(S("levelUp"),64,230),a.font="900 110px 'Yu Mincho', serif",a.fillStyle="#ffe15a",a.fillText(`${S("level")} ${o}`,64,340),a.font="800 38px system-ui, sans-serif",a.fillStyle="#f7f4ee",a.fillText(`${c} XP`,70,425),a.fillText(`${d} Moon Fragments`,70,482),a.fillStyle="rgba(255,255,255,0.74)",a.font="700 28px system-ui, sans-serif",a.fillText("Flash Kanji | JLPT Japanese learning",70,558),a.strokeStyle="rgba(255, 225, 90, 0.7)",a.lineWidth=3,a.strokeRect(34,30,1132,570),y$(s)}function k$(e,t,n){const s=e.createLinearGradient(0,0,t,n);s.addColorStop(0,"#08080c"),s.addColorStop(.45,"#1c1018"),s.addColorStop(1,"#071a18"),e.fillStyle=s,e.fillRect(0,0,t,n),e.fillStyle="rgba(255, 56, 92, 0.22)",e.beginPath(),e.moveTo(0,70),e.lineTo(720,0),e.lineTo(560,630),e.lineTo(0,630),e.closePath(),e.fill(),e.strokeStyle="rgba(255,255,255,0.08)",e.lineWidth=1;for(let a=-t;a<t*2;a+=38)e.beginPath(),e.moveTo(a,0),e.lineTo(a+t,n),e.stroke()}function qu(e){return new Promise(t=>{const n=new Image;n.onload=()=>t(n),n.onerror=()=>t(null),n.src=new URL(e,location.href).href})}function Hu(e,t,n,s,a,o){const l=Math.min(a/t.naturalWidth,o/t.naturalHeight),c=t.naturalWidth*l,d=t.naturalHeight*l;e.drawImage(t,n+(a-c)/2,s+(o-d)/2,c,d)}function y$(e){return new Promise(t=>e.toBlob(t,"image/png",.94))}async function $$(e,t,n="shareLinkCopied"){const s=await Xu(`${e}
${t}`);return E(s?S(n):e),s}async function Xu(e){if(navigator.clipboard?.writeText)try{return await navigator.clipboard.writeText(e),!0}catch{}const t=document.createElement("textarea");t.value=e,t.setAttribute("readonly",""),t.style.position="fixed",t.style.left="-9999px",document.body.append(t),t.focus(),t.select(),t.setSelectionRange(0,t.value.length);try{return document.execCommand("copy")}catch{return!1}finally{t.remove()}}async function j$(e){const t=e.target.files?.[0];if(t)try{const n=JSON.parse(await t.text());r.progress=bl(ms(),n.progress||n),jr(),n.customization&&(r.customization={...dn(),...n.customization,selected:{...dn().selected,...n.customization.selected||{}}},Rn()),hr(),ns(),N(),xt(),E(S("import")),j()}catch(n){console.error(n),E("Invalid JSON")}finally{e.target.value=""}}function S$(){if(!confirm(p()==="ru"?"Сбросить прогресс?":"Reset progress?"))return;const e=r.progress.settings;r.progress=ms(),r.progress.settings=e,r.finalTestModal=null,r.finalTestBusy=!1,jr(),ns(),N(),j()}function N$(){r.progress.settings.theme=r.progress.settings.theme==="dark"?"light":"dark",r.progress.settings.themeManuallySelected=!0,xt(),N(),j()}function x$(){r.progress.settings.language=p()==="ru"?"en":"ru",r.progress.settings.languageAutoDetected=!1,r.progress.settings.languageManuallySelected=!0,N(),j()}function Qu(){r.progress.settings.sound=!It(r.progress.settings.sound,!0),r.progress.settings.uxSound=r.progress.settings.sound,ns(),jo(),N(),E(r.progress.settings.sound?"в™Є":"Г—")}function C$(){Qu()}function Ws(){return window.FlashKanjiSound||null}function L$(){try{Ws()?.preloadSounds?.()}catch(e){console.warn("UX sounds preload failed.",e)}}function ns(){const e=Ws();!e||!r.progress?.settings||(e.setSoundEnabled?.(It(r.progress?.settings?.sound,!0)),e.setSoundVolume?.(Sa()))}function ja(){return It(r.progress?.settings?.sound,!0)}function jo(){const e=ge('[data-action="sound"]');if(!e)return;const t=It(r.progress?.settings?.sound,!0),n=p()==="ru"?t?"Звук":"Звук выключен":t?"Sound":"Sound off";e.classList.toggle("is-muted",!t),e.setAttribute("aria-pressed",String(t)),e.setAttribute("aria-label",n),e.title=n,e.innerHTML=A$(t)}function A$(e){return e?`
        <svg viewBox="0 0 24 24" aria-hidden="true" focusable="false">
      ...
      `}function T$(){const e=ge('[data-action="notification-center"]');if(!e)return;const t=r.notificationPrompt||nr(),n=!!(t.docked||r.notificationPromptVisible||La("header")),s=!!r.notificationPromptVisible,a=s?p()==="ru"?"Скрыть уведомление":"Hide notification":t.docked?p()==="ru"?"Открыть уведомление":"Open notification":p()==="ru"?"Уведомления":"Notifications";e.hidden=!n,e.classList.toggle("is-active",s),e.classList.toggle("has-prompt",!!(t.docked||s)),e.setAttribute("aria-pressed",String(s)),e.setAttribute("aria-label",a),e.title=a,e.innerHTML=I$(s)}function So(){const e=ge('[data-action="toggle-header-socials"]');if(!e)return;const t=No(),n=p()==="ru"?t?"Скрыть соцсети":"Открыть соцсети":t?"Hide social links":"Open social links";e.setAttribute("aria-expanded",String(t)),e.classList.toggle("is-active",t),e.setAttribute("aria-label",n),e.title=n}function Wu(e){const t=document.querySelector(".app-header");t&&(t.classList.toggle("is-social-open",!!e),So())}function No(){return!!document.querySelector(".app-header")?.classList.contains("is-social-open")}function Sa(){const e=Number(r.progress?.settings?.uxVolume);return Number.isFinite(e)?Z(e,0,1):.75}function R$(e){const t=Z(Number(e),0,1);r.progress.settings.uxVolume=t,ns(),N()}function C(e){if(!ja())return!1;const t=()=>{try{if(!!Ws()?.playSound?.(e)){ds=Date.now();return}Ao(String(e))}catch(n){console.warn("UX sound failed.",n),Ao(String(e))}};return typeof requestAnimationFrame=="function"?requestAnimationFrame(()=>window.setTimeout(t,0)):window.setTimeout(t,0),!0}function xt(){document.documentElement.dataset.theme=r.progress.settings.theme,document.documentElement.dataset.customTheme=r.customization?.selected?.theme||"theme_default_dark";const e=wt();document.documentElement.dataset.customRoom=e?.id||"bg_study_hub",document.documentElement.style.setProperty("--app-room-bg",_$(e?.file||"assets/bg/bg_study_hub.webp"));const t=Hf();document.documentElement.dataset.customEffect=t||"none",document.querySelector('meta[name="theme-color"]')?.setAttribute("content",r.progress.settings.theme==="light"?"#f8f7f2":"#08080c")}function _$(e){return`url("${String(e).replace(/["\\\n\r]/g,"")||"assets/bg/bg_study_hub.webp"}")`}function S(e){return r.i18n?.ui?.[e]?.[p()]||r.i18n?.ui?.[e]?.ru||e}function p(){return r.progress?.settings?.language||"ru"}function h(e){return!e||typeof e!="object"?String(e||""):e[p()]||e.ru||e.en||""}function M$(e){if(!e)return"";try{return new Intl.DateTimeFormat(p()==="ru"?"ru-RU":"en-US",{day:"2-digit",month:"short",hour:"2-digit",minute:"2-digit"}).format(new Date(e))}catch{return String(e).slice(0,16)}}function Vs(e){return p()==="en"&&r.lessonTranslations[e.id]?.title_en||e.title}function P$(e){return p()==="en"&&r.lessonTranslations[e.id]?.summary_en||e.summary}function xo(e){const t=r.lessons.find(n=>n.id===e);return t?Vs(t):""}function L(e){return ye(e,p())}function ye(e,t=p()){if(!e)return"";const n=xu(e);return n&&n.meaning?t==="en"?n.meaning.en||n.meaning.ru||e.meaning_en||r.kanjiTranslations[e.id]?.meaning_en||"":n.meaning.ru||e.meaning_ru||r.kanjiTranslations[e.id]?.meaning_en||e.meaning_en||"":t==="en"?r.kanjiTranslations[e.id]?.meaning_en||e.meaning_en||e.meaning_ru||"":e.meaning_ru||r.kanjiTranslations[e.id]?.meaning_en||e.meaning_en||""}function Ys(e){return p()==="en"?r.kanjiTranslations[e.id]?.interface_use_en||e.interface_use_en||e.interface_use||"":e.interface_use||e.interface_use_en||""}function Ce(e){if(p()!=="en")return e.translation_ru||e.translation||"";if(e.translation_en)return e.translation_en;const t=r.vocabulary.find(n=>n.word===e.word||Co(n.romaji)===Co(e.romaji));return t?.translation_en?t.translation_en:fp[Co(e.romaji)]||e.translation||""}function Co(e){return String(e||"").trim().toLowerCase().replace(/[^a-z0-9]+/g,"")}function ss(e){return r.dialogues?.mascots?.[e]||{name:{ru:e,en:e},sprites:{},dialogs:{}}}function $e(e,t){const n=e==="eva"?E$(t):"";if(n)return n;const s=ss(e).dialogs?.[t]||ss(e).dialogs?.welcome||{},a=s[p()]||s.ru||[""];return Le(a)}function E$(e="welcome"){const t=String(e||"welcome").toLowerCase();if(!["welcome","progress","hint","lessoncomplete","masterymilestone","achievement"].includes(t))return"";const n=D$(t),s=[...r.evaAutonomyLines||[],...Pr()].filter(l=>{const c=h(l?.text||{});if(!c)return!1;const d=Array.isArray(l.tags)?l.tags:[];if(!(n.includes(l.category)||d.some(g=>n.includes(g))))return!1;const m=Vu(c);return m.length>=12&&m.length<=132}),a=s.filter(l=>!za.includes(l.id)),o=Le(a.length?a:s);return o?(o.id&&(za=[o.id,...za.filter(l=>l!==o.id)].slice(0,18)),Vu(h(o.text||{}))):""}function D$(e){return{welcome:["fis_study","fis_focus","fis_observation","fis_short","study","short","mood","room"],progress:["fis_reward","fis_streak","fis_review","reward","streak","review","progress"],hint:["fis_focus","fis_observation","hint","study"],lessoncomplete:["fis_reward","fis_streak","reward","study"],masterymilestone:["fis_reward","fis_streak","reward","progress"],achievement:["fis_reward","reward","achievement"]}[e]||["fis_study","study"]}function Vu(e){const t=String(e||"").replace(/\s+/g," ").trim();if(t.length<=132)return t;const n=t.match(/[^.!?гЂ'пјЃпјџ]+[.!?гЂ'пјЃпјџ]?/g)||[t];let s="";for(const a of n){const o=`${s} ${a.trim()}`.trim();if(o.length>132)break;s=o}return s.length>=12?s:`${t.slice(0,124).trimEnd()}...`}function Na(e){const t=Zs(e);return`<span class="pill ${t}">${i(mp[t]||"New")}</span>`}function Zs(e){const t=String(e||"new").toLowerCase();return t==="new"||t==="learning"||t==="review"||t==="mastered"?t:t==="New".toLowerCase()?"new":t.includes("master")?"mastered":t.includes("learn")?"learning":t.includes("review")?"review":"new"}function Yu(e){return{new:"New",learning:"Learning",review:"Review",mastered:"Mastered"}[Zs(e)]}function Lo(e){const t=(e.correct||0)+(e.wrong||0);return t?Math.round((e.correct||0)/t*100):0}function O$(){const e=getComputedStyle(document.documentElement);return{text:e.getPropertyValue("--text").trim(),muted:e.getPropertyValue("--muted").trim(),line:e.getPropertyValue("--line").trim(),red:e.getPropertyValue("--accent").trim(),yellow:e.getPropertyValue("--accent-2").trim(),green:e.getPropertyValue("--accent-3").trim(),blue:e.getPropertyValue("--accent-4").trim(),danger:e.getPropertyValue("--danger").trim(),pink:"#ff91d8",blueSoft:"rgba(67, 214, 255, 0.16)",dangerSoft:"rgba(255, 107, 95, 0.16)"}}function K$(e){return{responsive:!0,maintainAspectRatio:!1,plugins:{legend:{labels:{color:e.text}}},scales:{x:{ticks:{color:e.muted},grid:{color:e.line}},y:{beginAtZero:!0,ticks:{color:e.muted,precision:0},grid:{color:e.line}}}}}function xa(){try{return cr||=new(window.AudioContext||window.webkitAudioContext),cr.state==="suspended"&&cr.resume().catch(()=>null),cr}catch(e){return console.warn("Audio context unavailable.",e),null}}function B$(e){const t=String(e||"").toLowerCase();return t.includes("wrong")||t.includes("failed")?{type:"triangle",frequencies:[180],duration:.22,peak:.12,interval:0}:t.includes("correct")||t.includes("success")?{type:"triangle",frequencies:[440,554.37],duration:.18,peak:.11,interval:.09}:t.includes("level")||t.includes("achievement")||t.includes("reward")||t.includes("xp")||t.includes("moon")||t.includes("unlock")?{type:"sine",frequencies:[523.25,659.25,783.99],duration:.26,peak:.1,interval:.08}:t.includes("close")?{type:"square",frequencies:[260],duration:.12,peak:.08,interval:0}:t.includes("open")||t.includes("button")||t.includes("click")||t.includes("tab")||t.includes("page")?{type:"sine",frequencies:[320],duration:.09,peak:.08,interval:0}:{type:"sine",frequencies:[360],duration:.16,peak:.08,interval:0}}function Ao(e){const t=xa();if(!t)return!1;try{const n=B$(e),s=t.currentTime+.01;return n.frequencies.forEach((a,o)=>{const l=t.createOscillator(),c=t.createGain();l.type=n.type,l.frequency.value=a;const d=s+n.interval*o;c.gain.setValueAtTime(1e-4,d),c.gain.exponentialRampToValueAtTime(n.peak,d+.02),c.gain.exponentialRampToValueAtTime(1e-4,d+n.duration),l.connect(c).connect(t.destination),l.start(d),l.stop(d+n.duration+.02)}),ds=Date.now(),!0}catch(n){return console.warn("Fallback UX tone failed.",n),!1}}window.FlashKanjiUxToneFallback=Ao;function F$(){const e=()=>{const t=xa();t?.state==="suspended"&&t.resume().catch(()=>null)};["pointerdown","touchstart","keydown","mousedown"].forEach(t=>{document.addEventListener(t,e,{once:!0,passive:!0,capture:!0})})}function er(e){if(r.progress.settings.sound){if(Ws()){C(e==="again"?"answer_wrong":"answer_correct");return}try{const t=xa();if(!t)return;ds=Date.now();const n=t.createOscillator(),s=t.createGain(),a=t.currentTime;n.type="triangle",n.frequency.value=e==="again"?180:480,s.gain.setValueAtTime(1e-4,a),s.gain.exponentialRampToValueAtTime(.13,a+.015),s.gain.exponentialRampToValueAtTime(1e-4,a+.18),n.connect(s).connect(t.destination),n.start(a),n.stop(a+.2)}catch(t){console.warn("Audio unavailable.",t)}}}function z$(){if(r.progress.settings.sound)try{const e=xa();if(!e)return;ds=Date.now();const t=e.currentTime;[523.25,659.25,783.99].forEach((n,s)=>{const a=e.createOscillator(),o=e.createGain();a.type="sine",a.frequency.value=n;const l=t+s*.08;o.gain.setValueAtTime(1e-4,l),o.gain.exponentialRampToValueAtTime(.12,l+.02),o.gain.exponentialRampToValueAtTime(1e-4,l+.24),a.connect(o).connect(e.destination),a.start(l),a.stop(l+.26)})}catch(e){console.warn("Achievement sound unavailable.",e)}}function J$(){const e=document.createElement("div");e.className="confetti",e.innerHTML=Array.from({length:34},(t,n)=>`<i style="--x:${Math.random()*100}vw;--d:${Math.random()*.8+.8}s;--r:${Math.random()*360}deg;--c:${n%4}"></i>`).join(""),document.body.append(e),window.setTimeout(()=>e.remove(),1800)}function E(e){const t=ge("#toast");t.textContent=e,t.hidden=!1,clearTimeout(nl),nl=window.setTimeout(()=>{t.hidden=!0},2400)}function U$(){return`
      ...
      </section>`}function G$(e){return`<section class="empty-state" style="margin-top:24px"><span class="kanji-char">警</span><h1>Data error</h1><p>${i(e.message)}</p></section>`}function q$(){try{[or,Ta,lr,"flashKanji.lastForcedBuild"].forEach(t=>{try{localStorage.removeItem(t)}catch(n){console.warn(`Could not remove recovery key ${t}.`,n)}})}catch(e){console.warn("Could not clear Flash Kanji recovery markers during boot recovery.",e)}}async function H$(){if("caches"in window){const e=await caches.keys();await Promise.all(e.map(t=>caches.delete(t)))}if("serviceWorker"in navigator){const e=await navigator.serviceWorker.getRegistrations();await Promise.all(e.map(async t=>{try{await t.unregister()}catch(n){console.warn("Could not unregister service worker during boot recovery.",n)}}))}}async function X$(e){try{const t=Number(sessionStorage.getItem(Ra)||"0");if(t>=2)return!1;const n=t+1;sessionStorage.setItem(Ra,String(n)),console.warn(`[FlashKanji] Boot failed, attempting recovery stage ${n}.`,e),n>=2&&q$(),await H$();try{localStorage.removeItem(or),localStorage.removeItem(Ta),localStorage.removeItem(lr),localStorage.removeItem("flashKanji.lastForcedBuild")}catch(a){console.warn("Boot recovery marker cleanup failed.",a)}const s=new URL(location.href);return s.searchParams.set("cachebust",Date.now().toString()),s.searchParams.set("bootRecovery",String(n)),location.replace(s.toString()),!0}catch(t){return console.warn("Boot recovery failed.",t),!1}}function Q$(){if(!("serviceWorker"in navigator)||location.protocol==="file:")return;let e=!1;navigator.serviceWorker.addEventListener("controllerchange",()=>{e||(e=!0,location.reload())}),navigator.serviceWorker.addEventListener("message",n=>{if(n.data?.type==="FLASH_KANJI_CACHE_RESET_DONE")try{localStorage.setItem(Ta,`${Ct}:done`)}catch(s){console.warn("Cannot save PWA cache reset marker.",s)}});const t=async()=>{try{const n=new URL("../service-worker.js",document.baseURI);n.searchParams.set("v",Ct);const s=await navigator.serviceWorker.register(n.href);W$(s),await s.update().catch(console.warn)}catch(n){console.warn(n)}};document.readyState==="loading"?window.addEventListener("load",()=>{t()},{once:!0}):t()}function W$(e){e&&e.addEventListener("updatefound",()=>{const t=e.installing;t&&t.addEventListener("statechange",()=>{(t.state==="installed"||t.state==="activated")&&e.update().catch(()=>null)})})}function Ca(){const e={declineCount:0,nextShowAt:0,neverShow:!1,installed:!1};try{const t=localStorage.getItem(Cn)||localStorage.getItem(ir);if(!t)return e;const n=JSON.parse(t),s={...e,...n,declineCount:Number(n.declineCount||0),nextShowAt:Number(n.nextShowAt||0),neverShow:!!n.neverShow,installed:!!n.installed};return localStorage.getItem(Cn)||localStorage.setItem(Cn,JSON.stringify(s)),s}catch(t){return console.warn("PWA install prompt state reset.",t),e}}function Io(){try{localStorage.setItem(Cn,JSON.stringify(r.pwaInstallPrompt))}catch(e){console.warn("Cannot save PWA install prompt state.",e)}}function V$(e){e.preventDefault(),At=e,r.progress&&r.i18n&&Z$()}async function Y$(){if(Zt("pwa_install_clicked",{available:!!At,ios:rs()}),tr()){Ro();return}if(!At){r.pwaInstallHelpVisible=!0,j();return}const e=At;At=null;try{if(await e.prompt(),(await e.userChoice)?.outcome==="accepted"){Ro();return}_o()}catch(t){console.warn("PWA install prompt failed.",t),_o()}}function tr(){return["standalone","fullscreen","minimal-ui"].some(t=>window.matchMedia?.(`(display-mode: ${t})`)?.matches)||Reflect.get(navigator,"standalone")===!0}function To(){const e=r.pwaInstallPrompt||Ca();if(tr()||e.installed||e.neverShow||Date.now()<Number(e.nextShowAt||0))return!1;const t=r.progress?.visits?.firstVisitDate;return!t||tn(t,W())<1?!1:!!At||rs()}function Z$(){To()&&(Zt("pwa_prompt_shown",{source:At?"browser":"ios"}),C("notification_soft"),j())}function Ro(){r.pwaInstallPrompt={...Ca(),...r.pwaInstallPrompt,installed:!0,neverShow:!0,nextShowAt:0},r.pwaInstallHelpVisible=!1,Io(),Zt("pwa_installed",{platform:rs()?"ios":"browser"}),np(),r.progress&&r.i18n&&j()}function _o(){const e=r.pwaInstallPrompt||Ca(),t=Math.min(Number(e.declineCount||0)+1,5);r.pwaInstallPrompt={...e,declineCount:t,nextShowAt:ej(t),neverShow:t>=5,installed:!1},Io(),j()}function ej(e){const s={1:864e5,2:1728e5,3:6048e5,4:2592e6};return e>=5?0:Date.now()+(s[e]||864e5)}function tj(){!tr()||r.pwaInstallPrompt.installed||(r.pwaInstallPrompt={...r.pwaInstallPrompt,installed:!0,neverShow:!0,nextShowAt:0},Io())}function rs(){const e=navigator.userAgent||"",t=/iphone|ipad|ipod/i.test(e)||navigator.platform==="MacIntel"&&navigator.maxTouchPoints>1,n=/safari/i.test(e)&&!/(crios|fxios|edgios|opios|chrome|android)/i.test(e);return t&&n}function Zu(){return p()==="en"?{badge:"Offline PWA",title:"Install Flash Kanji on your home screen?",description:"Your progress, lessons and reviews will open like a real app.",iosInstruction:"Tap Share -> Add to Home Screen.",install:"Install app",later:"Later"}:{badge:"Offline PWA",title:"Установить Flash Kanji на главный экран?",description:"Так прогресс, уроки и повторения будут открываться как приложение.",iosInstruction:"Нажмите Поделиться → На экран Домой.",install:"установить приложение",later:"Позже"}}function nr(){const e={declineCount:0,nextShowAt:0,neverShow:!1,permission:typeof Notification>"u"?"unsupported":Notification.permission,enabled:!1,acceptedAt:null,lastAskedAt:0,lastShown:{},periodicSync:!1,docked:!1};try{const t=localStorage.getItem(oe);if(!t)return e;const n=JSON.parse(t);return{...e,...n,declineCount:Number(n.declineCount||0),nextShowAt:Number(n.nextShowAt||0),neverShow:!!n.neverShow,enabled:!!n.enabled,lastShown:n.lastShown&&typeof n.lastShown=="object"?n.lastShown:{},docked:!!n.docked}}catch(t){return console.warn("Notification prompt state reset.",t),e}}function en(){try{localStorage.setItem(oe,JSON.stringify(r.notificationPrompt))}catch(e){console.warn("Cannot save notification prompt state.",e)}}function sr(){clearTimeout(Da),Da=0}function nj(){sr(),r.notificationPromptVisible&&(Da=window.setTimeout(()=>{r.notificationPromptVisible&&ep()},5e3))}function ep(){sr(),!(!r.notificationPromptVisible&&r.notificationPrompt?.docked)&&(r.notificationPromptVisible=!1,r.notificationPrompt={...r.notificationPrompt,docked:!0},en(),j())}function tp(){return tr()||!!r.pwaInstallPrompt?.installed}function La(e="usage"){const t=r.notificationPrompt||nr();return!(!("Notification"in window)||t.neverShow||t.enabled||!tp()||Notification.permission==="granted"||Notification.permission==="denied"||Date.now()<Number(t.nextShowAt||0)||e!=="lesson_complete"&&Date.now()-Ua<2*60*1e3)}function Aa(e="usage"){return La(e)?(r.notificationPromptVisible=!0,r.notificationPrompt={...r.notificationPrompt,docked:!1},en(),C("notification_soft"),nj(),j(),!0):("Notification"in window&&Notification.permission==="granted"&&sp(),!1)}function np(){if(clearTimeout(sl),!tp())return;const e=Math.max(0,2*60*1e3-(Date.now()-Ua));sl=window.setTimeout(()=>Aa("usage"),e)}async function sj(){if(r.notificationPromptVisible=!1,sr(),!("Notification"in window)){Ia();return}try{const e=Notification.permission==="granted"?"granted":await Notification.requestPermission();if(r.notificationPrompt.permission=e,r.notificationPrompt.lastAskedAt=Date.now(),e==="granted"){sp(),E(ap().enabled),j();return}Ia()}catch(e){console.warn("Notification permission failed.",e),Ia()}}function sp(){!("Notification"in window)||Notification.permission!=="granted"||(sr(),r.notificationPrompt={...nr(),...r.notificationPrompt,permission:"granted",enabled:!0,neverShow:!0,docked:!1,acceptedAt:r.notificationPrompt.acceptedAt||new Date().toISOString(),nextShowAt:0},en(),Mo())}function Ia(){const e=r.notificationPrompt||nr(),t=Math.min(Number(e.declineCount||0)+1,5);r.notificationPromptVisible=!1,sr(),r.notificationPrompt={...e,permission:"Notification"in window?Notification.permission:"unsupported",declineCount:t,nextShowAt:rj(t),neverShow:t>=5,enabled:!1,docked:!1,lastAskedAt:Date.now()},en(),j()}function rj(e){const s={1:432e5,2:1728e5,3:6048e5,4:2592e6};return e>=5?0:Date.now()+(s[e]||12*36e5)}function Mo(){!("Notification"in window)||Notification.permission!=="granted"||(r.notificationPrompt.permission="granted",r.notificationPrompt.enabled=!0,en(),Ja.forEach(e=>clearTimeout(e)),Ja.clear(),[{type:"daily_bonus",hour:9,minute:0},{type:"lesson",hour:11,minute:30},{type:"review",hour:18,minute:0},{type:"streak",hour:20,minute:30}].forEach(e=>rp(e.type,aj(e.hour,e.minute))),cj())}function rp(e,t){const n=Math.max(1e3,Math.min(t.getTime()-Date.now(),2147483647)),s=window.setTimeout(async()=>{await ij(e),rp(e,ip(t,1))},n);Ja.set(e,s)}function aj(e,t){const n=new Date;return n.setHours(e,t,0,0),n.getTime()<=Date.now()+60*1e3&&n.setDate(n.getDate()+1),n}async function ij(e){if(!oj(e))return!1;const t=lj(e);try{const n=await navigator.serviceWorker?.ready;return n?.showNotification?await n.showNotification(t.title,t.options):"Notification"in window&&Notification.permission==="granted"&&new Notification(t.title,t.options),C(e==="daily_bonus"?"notification_reward":"notification_reminder"),r.notificationPrompt.lastShown[e]=W(),en(),!0}catch(n){return console.warn("Notification show failed.",n),!1}}function oj(e){if(!("Notification"in window)||Notification.permission!=="granted"||r.notificationPrompt.lastShown?.[e]===W())return!1;if(e==="review")return Ne()>0;if(e==="daily_bonus"){const t=yr(r.progress.dailyBonusPending);return!!r.progress.visits?.firstVisitDate&&!!t&&t.availableOn<=W()&&!r.progress.dailyBonuses[W()]}return e==="lesson"?My().length>0:e==="streak"?(r.progress.streak.current||r.progress.visits?.streak||0)>0:!0}function lj(e){const t=p()==="ru",n={review:{title:"Flash Kanji",body:t?"Ваши кандзи ждут повторения.":"Your kanji are waiting for review.",url:"./index.html#review"},streak:{title:t?"Лея рядом 🌙":"Leya is nearby рџЊ™",body:t?"Не потеряйте свою серию дней.":"Do not lose your daily streak.",url:"./index.html#home"},daily_bonus:{title:t?"Ежедневный бонус":"Daily Bonus",body:t?"Заберите XP и Moon Fragments.":"Claim XP and Moon Fragments.",url:"./index.html#home"},lesson:{title:t?"Новые знания ждут":"New knowledge awaits",body:t?"Продолжите изучение кандзи.":"Continue learning kanji.",url:"./index.html#textbooks"}},s=n[e]||n.review;return{title:s.title,options:{body:s.body,tag:`flash-kanji-${e}`,renotify:!1,icon:"./assets/icon-192.png",badge:"./assets/icon-192.png",data:{url:s.url,type:e}}}}async function cj(){try{const e=await navigator.serviceWorker?.ready;if(!e?.periodicSync)return;await e.periodicSync.register("flash-kanji-daily",{minInterval:24*60*60*1e3}),r.notificationPrompt.periodicSync=!0,en()}catch{r.notificationPrompt.periodicSync=!1,en()}}function ap(){return p()==="en"?{badge:"PWA reminders",title:"Allow Flash Kanji notifications?",description:"We will remind you about reviews, streaks and daily bonuses.",allow:"Allow",later:"Later",enabled:"Notifications enabled"}:{badge:"PWA напоминания",title:"Разрешить уведомления Flash Kanji?",description:"Мы напомним о повторениях, серии и ежедневном бонусе.",allow:"Разрешить",later:"Позже",enabled:"Уведомления включены"}}function H(e){return{...e,history:[...e.history||[]]}}function ip(e,t){return new Date(e.getTime()+t*24*60*60*1e3)}function dj(){const e=new Date;return e.setHours(23,59,59,999),e}function W(){return Po(new Date)}function Po(e){return`${e.getFullYear()}-${String(e.getMonth()+1).padStart(2,"0")}-${String(e.getDate()).padStart(2,"0")}`}function Eo(e){const[t,n,s]=e.split("-").map(Number);return new Date(t,n-1,s)}function tn(e,t){return Math.round((Eo(t)-Eo(e))/864e5)}function op(e,t){const n=Eo(e);return n.setDate(n.getDate()+t),Po(n)}function uj(e){return Array.from({length:e},(t,n)=>{const s=new Date;return s.setDate(s.getDate()-(e-1-n)),Po(s)})}function Nn(e){if(!e)return p()==="ru"?"сейчас":"now";const t=new Date(e).getTime()-Date.now();if(t<=0)return p()==="ru"?"сейчас":"now";const n=Math.ceil(t/6e4);if(n<60)return p()==="ru"?`через ${n} мин.`:`in ${n} min`;const s=Math.ceil(n/60);if(s<24)return p()==="ru"?`через ${s} ч.`:`in ${s} h`;const a=Math.ceil(s/24);return p()==="ru"?`через ${a} дн.`:`in ${a} d`}function I(e,t){return t?Z(Math.round(e/t*100),0,100):0}function Z(e,t,n){return Math.max(t,Math.min(n,e))}function as(e,t){const n=10**t;return Math.round(e*n)/n}function Le(e){return e[Math.floor(Math.random()*e.length)]}function nn(e,t){return Math.floor(Number(e)+Math.random()*(Number(t)-Number(e)))}function rr(e,t){return String(e)===String(t)?"selected":""}function pj(e="",t=""){const n=String(e||"").trim().toUpperCase(),s=String(t||"").trim(),a=n?`/textbooks/${encodeURIComponent(n)}`:"/textbooks/";return s?`${a}/${encodeURIComponent(s)}`:a}function lp(e="",t=""){return`${pj(e,t)}${location.search||""}`}function Do(){const t=decodeURIComponent(location.pathname||"").replace(/^\/+|\/+$/g,"");return t&&!/^index(?:\.html)?$/i.test(t)?t:decodeURIComponent(location.hash.replace("#",""))}function Oo(){const e=Do();if(/^jlpt\/n[1-5](?:\/|$)/i.test(e))return"textbooks";const t=e.split("/")[0];return Vo.includes(t)?t:"home"}function Ko(){const t=decodeURIComponent(location.hash.replace("#","")).match(/^kanji\/([^/?]+)/);return t?t[1]:""}function Bo(){const e=Do(),t=e.match(/^textbooks\/([^/?#]+)/i)||e.match(/^jlpt\/([^/?#]+)/i);return t?String(t[1]||"").toUpperCase():""}function Fo(){const e=Do(),t=e.match(/^textbooks\/[^/?#]+\/([^?#]+)/i)||e.match(/^jlpt\/[^/?#]+\/([^?#]+)/i);return t?String(t[1]||""):""}function cp(){const t=decodeURIComponent(location.hash.replace("#","")).match(/^learn(?:\/([^/?#]+))?/i),n=String(t?.[1]||"").toLowerCase();return n===Lt?Lt:n===sn?sn:cs}function dp(){const t=decodeURIComponent(location.hash.replace("#","")).match(/^learn\/lesson\/([^/?#]+)/i);return t?String(t[1]||""):""}function up(){const t=decodeURIComponent(location.hash.replace("#","")).match(/^learn\/legacy\/([^/?#]+)/i);return t?String(t[1]||""):""}function zo(){const t=decodeURIComponent(location.hash.replace("#","")).match(/^jlpt-lesson\/([^/?#]+)/i);return t?String(t[1]||"").toUpperCase():""}function gj(){return bn().filter(e=>is(e.id)).length}function is(e){const t=r.progress?.achievements?.[e];return!!(t&&(t===!0||typeof t=="string"||t.unlockedAt||t.rewardXp!==void 0))}function i(e){return String(e??"").replace(/[&<>"']/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#039;"})[t])}function f(e){return i(e)}})();
