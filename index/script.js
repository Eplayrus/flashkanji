(() => {
  ...
  const APP_VERSION = 3;
  const BUILD_VERSION = "2026-06-15-jlpt-eva-v8";
...
if (await refreshStaleAppCache()) return;
  ...
  function handleClick(event) {
    ...
    if (action === "eva-jlpt-toggle") handleJlptModuleToggle(target);
    if (action === "eva-jlpt-next") handleJlptModuleNext(target);
    if (action === "eva-jlpt-answer") handleJlptModuleAnswer(target);
  ...
  function renderGlobalOverlays() {
    const overlays = `${renderBottomNavMenu()}${renderDetailModal()}${renderRewardModal()}${renderFinalTestModal()}${renderPwaInstallBanner()}${renderNotificationPermissionBanner()}${renderScrollToggleButton()}`;
  ...
  function renderJlptEvaPanel(level, pageContext = {}) {
    ...
    const sprite = evaSpritePath(state.evaRuntime?.currentSkin || selectedEvaSkinId());
    ...
    if (moduleState.collapsed) {
      return `
        <section class="home-eva-vn jlpt-eva-vn is-collapsed" role="region" aria-label="${escapeAttr(lang() === "ru" ? `Панель Евы ${spec.level}` : `Eva panel ${spec.level}`)}" data-jlpt-level="${escapeAttr(spec.level)}" data-jlpt-view="${escapeAttr(view)}" data-jlpt-phase="${escapeAttr(moduleState.phase)}">
          <button class="jlpt-eva-collapsed" type="button" data-action="eva-jlpt-toggle" data-level="${escapeAttr(spec.level)}" aria-label="${escapeAttr(collapseLabel)}" title="${escapeAttr(collapseLabel)}">
            <img class="jlpt-eva-collapsed-avatar" src="${escapeAttr(sprite)}" alt="${escapeAttr(speaker)}" loading="eager" decoding="async" onerror="this.src='assets/mascots/eva_normal.png'" />
            <span class="jlpt-eva-collapsed-copy">
              <strong>${escapeHtml(speaker)} · ${escapeHtml(spec.level)}</strong>
              <small>${escapeHtml(`${summary.completedLessons}/${summary.totalLessons || 0} ${lang() === "ru" ? "уроков" : "lessons"} · ${summary.studied}/${summary.totalCards || 0} ${lang() === "ru" ? "кандзи" : "kanji"}`)}</small>
              ${lastLesson ? `<small>${escapeHtml(lang() === "ru" ? "Последний урок" : "Last lesson")}: ${escapeHtml(localized(lastLesson.title || {}))}</small>` : ""}
            </span>
            <span class="pill">${escapeHtml(lang() === "ru" ? "Открыть" : "Open")}</span>
          </button>
        </section>
      `;
    }
    ...
    return `
      <section class="home-eva-vn jlpt-eva-vn" role="region" aria-label="${escapeAttr(lang() === "ru" ? `Диалог Евы ${spec.level}` : `Eva dialogue ${spec.level}`)}" data-jlpt-level="${escapeAttr(spec.level)}" data-jlpt-view="${escapeAttr(view)}" data-jlpt-phase="${escapeAttr(moduleState.phase)}" data-eva-state="${escapeAttr(presenceState)}" data-eva-mood="${escapeAttr(mood)}" data-eva-emotion="${escapeAttr(emotion)}">
    ...
    return `
      <section class="page">
        ...
        <div class="study-layout">
          ${lessonUnlocked ? (card ? renderStudyCard(card) : renderLessonDone(lesson)) : renderLessonLocked(lesson)}
  ...
  function renderJlptLessonPage() {
    ...
    return `
      <section class="page jlpt-lesson-page">
        ...
        ${renderJlptEvaPanel(lesson.jlpt, { view: "lesson", lesson, textbook })}
      </section>
    `;
  }
  ...
  function renderN5OverviewPage(textbook) {
    ...
    return `
      <section class="page textbooks-page n5-course-page">
        ...
        ${renderJlptEvaPanel("N5", { view: "overview", lesson: current, textbook })}
      </section>
    `;
  }
  ...
  function renderN5LessonPage(textbook, lesson) {
    ...
    return `
      <section class="page textbooks-page n5-course-page n5-lesson-page">
        ...
        ${renderJlptEvaPanel("N5", { view: "lesson", lesson, textbook })}
      </section>
    `;
  }
  ...
  function renderN5ReviewPage(textbook) {
    ...
    return `
      <section class="page textbooks-page n5-course-page">
        ...
        ${renderJlptEvaPanel("N5", { view: "review", lesson: n5CurrentLesson(), textbook })}
      </section>
    `;
  }
  ...
  function renderN5FinalTestPage(textbook) {
    ...
    return `
      <section class="page textbooks-page n5-course-page n5-final-page">
        ...
        ${renderJlptEvaPanel("N5", { view: "final", lesson: n5CurrentLesson(), textbook })}
      </section>
    `;
  }
  ...
  function renderN4OverviewPage(textbook) {
    ...
    return `
      <section class="page textbooks-page n5-course-page n4-course-page">
        ...
        ${renderJlptEvaPanel("N4", { view: "overview", lesson: current, textbook })}
      </section>
    `;
  }
  ...
  function renderN4LessonPage(textbook, lesson) {
    ...
    return `
      <section class="page textbooks-page n5-course-page n4-course-page n5-lesson-page">
        ...
        ${renderJlptEvaPanel("N4", { view: "lesson", lesson, textbook })}
      </section>
    `;
  }
  ...
  function renderN4ReviewPage(textbook) {
    ...
    return `
      <section class="page textbooks-page n5-course-page n4-course-page">
        ...
        ${renderJlptEvaPanel("N4", { view: "review", lesson: n4CurrentLesson(), textbook })}
      </section>
    `;
  }
  ...
  function renderN4KanjiListPage(textbook) {
    ...
    return `
      <section class="page textbooks-page n5-course-page n4-course-page">
        ...
        ${renderJlptEvaPanel("N4", { view: "kanji", lesson: n4CurrentLesson(), textbook })}
      </section>
    `;
  }
  ...
  function renderN4ReadingPage(textbook) {
    ...
    return `
      <section class="page textbooks-page n5-course-page n4-course-page">
        ...
        ${renderJlptEvaPanel("N4", { view: "reading", lesson: n4CurrentLesson(), textbook })}
      </section>
    `;
  }
  ...
  function renderN4ListeningPage(textbook) {
    ...
    return `
      <section class="page textbooks-page n5-course-page n4-course-page">
        ...
        ${renderJlptEvaPanel("N4", { view: "listening", lesson: n4CurrentLesson(), textbook })}
      </section>
    `;
  }
  ...
  function renderN4FinalTestPage(textbook) {
    ...
    return `
      <section class="page textbooks-page n5-course-page n4-course-page n5-final-page">
        ...
        ${renderJlptEvaPanel("N4", { view: "final", lesson: n4CurrentLesson(), textbook })}
      </section>
    `;
  }
  ...
  function renderN3OverviewPage(textbook) {
    ...
    return `
      <section class="page textbooks-page n5-course-page n3-course-page">
        ...
        ${renderJlptEvaPanel("N3", { view: "overview", lesson: current, textbook })}
      </section>
    `;
  }
  ...
  function renderN3LessonPage(textbook, lesson) {
    ...
    return `
      <section class="page textbooks-page n5-course-page n3-course-page n5-lesson-page">
        ...
        ${renderJlptEvaPanel("N3", { view: "lesson", lesson, textbook })}
      </section>
    `;
  }
  ...
  function renderN3ReviewPage(textbook) {
    ...
    return `
      <section class="page textbooks-page n5-course-page n3-course-page">
        ...
        ${renderJlptEvaPanel("N3", { view: "review", lesson: n3CurrentLesson(), textbook })}
      </section>
    `;
  }
  ...
  function renderN3KanjiListPage(textbook) {
    ...
    return `
      <section class="page textbooks-page n5-course-page n3-course-page">
        ...
        ${renderJlptEvaPanel("N3", { view: "kanji", lesson: n3CurrentLesson(), textbook })}
      </section>
    `;
  }
  ...
  function renderN3GrammarPage(textbook) {
    ...
    return `
      <section class="page textbooks-page n5-course-page n3-course-page">
        ...
        ${renderJlptEvaPanel("N3", { view: "grammar", lesson: n3CurrentLesson(), textbook })}
      </section>
    `;
  }
  ...
  function renderN3ReadingPage(textbook) {
    ...
    return `
      <section class="page textbooks-page n5-course-page n3-course-page">
        ...
        ${renderJlptEvaPanel("N3", { view: "reading", lesson: n3CurrentLesson(), textbook })}
      </section>
    `;
  }
  ...
  function renderN3ListeningPage(textbook) {
    ...
    return `
      <section class="page textbooks-page n5-course-page n3-course-page">
        ...
        ${renderJlptEvaPanel("N3", { view: "listening", lesson: n3CurrentLesson(), textbook })}
      </section>
    `;
  }
  ...
  function renderN3FinalTestPage(textbook) {
    ...
    return `
      <section class="page textbooks-page n5-course-page n3-course-page n5-final-page">
        ...
        ${renderJlptEvaPanel("N3", { view: "final", lesson: n3CurrentLesson(), textbook })}
      </section>
    `;
  }
  ...
  function renderN2OverviewPage(textbook) {
    ...
    return `
      <section class="page textbooks-page n5-course-page n2-course-page">
        ...
        ${renderJlptEvaPanel("N2", { view: "overview", lesson: current, textbook })}
      </section>
    `;
  }
  ...
  function renderN2LessonPage(textbook, lesson) {
    ...
    return `
      <section class="page textbooks-page n5-course-page n2-course-page n5-lesson-page">
        ...
        ${renderJlptEvaPanel("N2", { view: "lesson", lesson, textbook })}
      </section>
    `;
  }
  ...
  function renderN2ReviewPage(textbook) {
    ...
    return `
      <section class="page textbooks-page n5-course-page n2-course-page">
        ...
        ${renderJlptEvaPanel("N2", { view: "review", lesson: n2CurrentLesson(), textbook })}
      </section>
    `;
  }
  ...
  function renderN2KanjiListPage(textbook) {
    ...
    return `
      <section class="page textbooks-page n5-course-page n2-course-page">
        ...
        ${renderJlptEvaPanel("N2", { view: "kanji", lesson: n2CurrentLesson(), textbook })}
      </section>
    `;
  }
  ...
  function renderN2GrammarPage(textbook) {
    ...
    return `
      <section class="page textbooks-page n5-course-page n2-course-page">
        ...
        ${renderJlptEvaPanel("N2", { view: "grammar", lesson: n2CurrentLesson(), textbook })}
      </section>
    `;
  }
  ...
  function renderN2ReadingPage(textbook) {
    ...
    return `
      <section class="page textbooks-page n5-course-page n2-course-page">
        ...
        ${renderJlptEvaPanel("N2", { view: "reading", lesson: n2CurrentLesson(), textbook })}
      </section>
    `;
  }
  ...
  function renderN2ListeningPage(textbook) {
    ...
    return `
      <section class="page textbooks-page n5-course-page n2-course-page">
        ...
        ${renderJlptEvaPanel("N2", { view: "listening", lesson: n2CurrentLesson(), textbook })}
      </section>
    `;
  }
  ...
  function renderN2FinalTestPage(textbook) {
    ...
    return `
      <section class="page textbooks-page n5-course-page n2-course-page n5-final-page">
        ...
        ${renderJlptEvaPanel("N2", { view: "final", lesson: n2CurrentLesson(), textbook })}
      </section>
    `;
  }
    ...
    return `
      <section class="page textbooks-page n5-course-page n1-course-page">
        ...
        <article class="n5-hero n2-hero n1-hero">
          ...
          ${renderMascot("eva", "thinking", "welcome", "n5-hero-mascot")}
        </article>
        ...
        ${renderJlptEvaPanel("N1", { view: "overview", lesson: current, textbook })}
      </section>
    `;
  }
  ...
  function renderN1LessonsPage(textbook) {
    ...
    return `
      <section class="page textbooks-page n5-course-page n1-course-page">
        ...
        ${renderJlptEvaPanel("N1", { view: "lessons", lesson: n1CurrentLesson(), textbook })}
      </section>
    `;
  }
  ...
  function renderN1LessonPage(textbook, lesson) {
    ...
    return `
      <section class="page textbooks-page n5-course-page n1-course-page n5-lesson-page">
        ...
        ${renderJlptEvaPanel("N1", { view: "lesson", lesson, textbook })}
      </section>
    `;
  }
  ...
  function renderN1ReviewPage(textbook) {
    ...
    return `
      <section class="page textbooks-page n5-course-page n1-course-page">
        ...
        ${renderJlptEvaPanel("N1", { view: "review", lesson: n1CurrentLesson(), textbook })}
      </section>
    `;
  }
  ...
  function renderN1KanjiListPage(textbook) {
    ...
    return `
      <section class="page textbooks-page n5-course-page n1-course-page">
        ...
        ${renderJlptEvaPanel("N1", { view: "kanji", lesson: n1CurrentLesson(), textbook })}
      </section>
    `;
  }
  ...
  function renderN1GrammarPage(textbook) {
    ...
    return `
      <section class="page textbooks-page n5-course-page n1-course-page">
        ...
        ${renderJlptEvaPanel("N1", { view: "grammar", lesson: n1CurrentLesson(), textbook })}
      </section>
    `;
  }
  ...
  function renderN1ReadingPage(textbook) {
    ...
    return `
      <section class="page textbooks-page n5-course-page n1-course-page">
        ...
        ${renderJlptEvaPanel("N1", { view: "reading", lesson: n1CurrentLesson(), textbook })}
      </section>
    `;
  }
  ...
  function renderN1ListeningPage(textbook) {
    ...
    return `
      <section class="page textbooks-page n5-course-page n1-course-page">
        ...
        ${renderJlptEvaPanel("N1", { view: "listening", lesson: n1CurrentLesson(), textbook })}
      </section>
    `;
  }
  ...
  function renderN1DiagnosticPage(textbook) {
    ...
    return `
      <section class="page textbooks-page n5-course-page n1-course-page n1-diagnostic-page">
        ...
        ${renderJlptEvaPanel("N1", { view: "diagnostic", lesson: n1CurrentLesson(), textbook })}
      </section>
    `;
  }
  ...
  function renderN1FinalTestPage(textbook) {
    ...
    return `
      <section class="page textbooks-page n5-course-page n1-course-page n5-final-page">
        ...
        ${renderJlptEvaPanel("N1", { view: "final", lesson: n1CurrentLesson(), textbook })}
      </section>
    `;
  }
    ...
    return `
      <div class="reward-backdrop final-test-backdrop">
        <article class="reward-modal is-final-test ${isWarning ? "is-warning" : "is-result"}" role="dialog" aria-modal="true">
          ${renderMascot("eva", mood, isWarning ? "review" : "achievement", "reward-mascot")}
...
const APP_VERSION = '2026-06-15-jlpt-eva-v8'; // Меняйте версию при каждом деплое
...
function registerServiceWorkerWithCacheBuster() {
  if ('serviceWorker' in navigator) {
    ...
    // Регистрируем service-worker.js с cache-buster, чтобы GitHub Pages не держал старую версию.
...
// Код ниже должен находиться внутри вашего sw.js:
  ...
  const CACHE_NAME = 'flash-kanji-cache-v91'; // Версия кэша должна совпадать с APP_VERSION
